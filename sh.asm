...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      22:	c7 04 24 c8 15 00 00 	movl   $0x15c8,(%esp)
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      bc:	00 
      bd:	c7 44 24 04 d0 15 00 	movl   $0x15d0,0x4(%esp)
      c4:	00 
      c5:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      cc:	e8 cf 10 00 00       	call   11a0 <printf>
  ...
  exit(0);
    ...
    panic("fork");
      f1:	c7 04 24 51 15 00 00 	movl   $0x1551,(%esp)
...
00000120 <getcmd>:
{
     120:	55                   	push   %ebp
  printf(2, "$ ");
     121:	b8 18 15 00 00       	mov    $0x1518,%eax
{
  ...
  printf(2, "$ ");
     ...
     142:	e8 59 10 00 00       	call   11a0 <printf>
  memset(buf, 0, nbuf);
...
00000180 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     194:	b8 c4 15 00 00       	mov    $0x15c4,%eax
     199:	89 44 24 04          	mov    %eax,0x4(%esp)
     19d:	e8 fe 0f 00 00       	call   11a0 <printf>
  exit(0);
...
000001b0 <runcmd>:
{
  ...
  char* tempDir = (char*)malloc(BUF_SIZE * sizeof(char));
     ...
     1ca:	e8 61 12 00 00       	call   1430 <malloc>
  switch(cmd->type){
  ...
  switch(cmd->type){
     ...
     1dc:	ff 24 85 00 16 00 00 	jmp    *0x1600(,%eax,4)
    close(rcmd->fd);
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     207:	c7 44 24 04 41 15 00 	movl   $0x1541,0x4(%esp)
     20e:	00 
     20f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     216:	89 44 24 08          	mov    %eax,0x8(%esp)
     21a:	e8 81 0f 00 00       	call   11a0 <printf>
     21f:	90                   	nop
      exit(0);
  ...
  if(pid == -1)
	...
	fd = open("/path", O_RDWR | O_CREATE); /*crate path file if it is not exist*/
     257:	c7 04 24 22 15 00 00 	movl   $0x1522,(%esp)
    ...
    if((ecmd->argv[0])[0] == '/'){ /*check for absolute path*/
     ...
     2c2:	00 
     2c3:	c7 04 24 22 15 00 00 	movl   $0x1522,(%esp)
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     3ba:	c7 04 24 1b 15 00 00 	movl   $0x151b,(%esp)
     3c1:	e8 ba fd ff ff       	call   180 <panic>
    panic("fork");
     3c6:	c7 04 24 51 15 00 00 	movl   $0x1551,(%esp)
     ...
     442:	e8 49 0f 00 00       	call   1390 <free>
        close(fd);
    ...
    break;
     ...
     4b6:	c7 44 24 04 e0 15 00 	movl   $0x15e0,0x4(%esp)
     4bd:	00 
     4be:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     4c5:	e8 d6 0c 00 00       	call   11a0 <printf>
...
00000560 <fork1>:
{
  ...
  return pid;
     ...
     571:	c3                   	ret    
    panic("fork");
     572:	c7 04 24 51 15 00 00 	movl   $0x1551,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     58e:	e8 9d 0e 00 00       	call   1430 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     5ce:	e8 5d 0e 00 00       	call   1430 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     62e:	e8 fd 0d 00 00       	call   1430 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     67e:	e8 ad 0d 00 00       	call   1430 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     6ce:	e8 5d 0d 00 00       	call   1430 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     709:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     728:	c7 04 24 f0 1b 00 00 	movl   $0x1bf0,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     778:	c7 04 24 f0 1b 00 00 	movl   $0x1bf0,(%esp)
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7db:	c7 04 24 e8 1b 00 00 	movl   $0x1be8,(%esp)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7fb:	c7 04 24 f0 1b 00 00 	movl   $0x1bf0,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     888:	c7 04 24 f0 1b 00 00 	movl   $0x1bf0,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     8e0:	b8 78 15 00 00       	mov    $0x1578,%eax
  ...
  return cmd;
     ...
     99a:	c3                   	ret    
      panic("missing file for redirection");
     99b:	c7 04 24 5b 15 00 00 	movl   $0x155b,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     9b1:	ba 7b 15 00 00       	mov    $0x157b,%edx
{
  ...
  while(!peek(ps, es, "|)&;")){
     a16:	b8 92 15 00 00       	mov    $0x1592,%eax
    ...
    if(argc >= MAXARGS)
     ...
     a67:	75 97                	jne    a00 <parseexec+0x50>
      panic("too many args");
     a69:	c7 04 24 84 15 00 00 	movl   $0x1584,(%esp)
  ...
  cmd->eargv[argc] = 0;
     ...
     ab6:	c3                   	ret    
      panic("syntax");
     ab7:	c7 04 24 7d 15 00 00 	movl   $0x157d,(%esp)
...
00000ad0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     af1:	b9 97 15 00 00       	mov    $0x1597,%ecx
...
00000b60 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ba2:	b8 99 15 00 00       	mov    $0x1599,%eax
  ...
  if(peek(ps, es, ";")){
     bbb:	b9 95 15 00 00       	mov    $0x1595,%ecx
...
00000c20 <parseblock>:
{
     c20:	55                   	push   %ebp
  if(!peek(ps, es, "("))
     c21:	b8 7b 15 00 00       	mov    $0x157b,%eax
{
     ...
     c37:	89 44 24 08          	mov    %eax,0x8(%esp)
{
  ...
  if(!peek(ps, es, ")"))
     c7b:	b8 b7 15 00 00       	mov    $0x15b7,%eax
  ...
  cmd = parseredirs(cmd, ps, es);
     ...
     cc1:	c3                   	ret    
    panic("parseblock");
     cc2:	c7 04 24 9b 15 00 00 	movl   $0x159b,(%esp)
     cc9:	e8 b2 f4 ff ff       	call   180 <panic>
    panic("syntax - missing )");
     cce:	c7 04 24 a6 15 00 00 	movl   $0x15a6,(%esp)
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     cf5:	ff 24 85 18 16 00 00 	jmp    *0x1618(,%eax,4)
...
00000d90 <parsecmd>:
{
  ...
  peek(&s, es, "");
     dba:	b8 40 15 00 00       	mov    $0x1540,%eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     dea:	c7 44 24 04 b9 15 00 	movl   $0x15b9,0x4(%esp)
     df1:	00 
     df2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     df9:	e8 a2 03 00 00       	call   11a0 <printf>
    panic("syntax");
     dfe:	c7 04 24 7d 15 00 00 	movl   $0x157d,(%esp)
...
000010e8 <policy>:
SYSCALL(policy)
    10e8:	b8 18 00 00 00       	mov    $0x18,%eax
    10ed:	cd 40                	int    $0x40
    10ef:	c3                   	ret    

000010f0 <wait_stat>:
SYSCALL(wait_stat)
    10f0:	b8 19 00 00 00       	mov    $0x19,%eax
    10f5:	cd 40                	int    $0x40
    10f7:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    1106:	89 d3                	mov    %edx,%ebx
    1108:	c1 eb 1f             	shr    $0x1f,%ebx
{
    110b:	83 ec 4c             	sub    $0x4c,%esp
  if(sgn && xx < 0){
    110e:	84 db                	test   %bl,%bl
{
    1110:	89 45 c0             	mov    %eax,-0x40(%ebp)
    1113:	89 d0                	mov    %edx,%eax
  if(sgn && xx < 0){
    1115:	74 79                	je     1190 <printint+0x90>
    1117:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    111b:	74 73                	je     1190 <printint+0x90>
    neg = 1;
    x = -xx;
    111d:	f7 d8                	neg    %eax
    neg = 1;
    111f:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
  } else {
    x = xx;
  }
  ...
  i = 0;
    ...
    1128:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    112b:	eb 05                	jmp    1132 <printint+0x32>
    112d:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1130:	89 fe                	mov    %edi,%esi
    1132:	31 d2                	xor    %edx,%edx
    1134:	f7 f1                	div    %ecx
    1136:	8d 7e 01             	lea    0x1(%esi),%edi
    1139:	0f b6 92 38 16 00 00 	movzbl 0x1638(%edx),%edx
  }while((x /= base) != 0);
    1140:	85 c0                	test   %eax,%eax
    buf[i++] = digits[x % base];
    1142:	88 14 3b             	mov    %dl,(%ebx,%edi,1)
  }while((x /= base) != 0);
    1145:	75 e9                	jne    1130 <printint+0x30>
  if(neg)
    1147:	8b 55 c4             	mov    -0x3c(%ebp),%edx
    114a:	85 d2                	test   %edx,%edx
    114c:	74 08                	je     1156 <printint+0x56>
    buf[i++] = '-';
    114e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    1153:	8d 7e 02             	lea    0x2(%esi),%edi
    1156:	8d 74 3d d7          	lea    -0x29(%ebp,%edi,1),%esi
    115a:	8b 7d c0             	mov    -0x40(%ebp),%edi
    115d:	8d 76 00             	lea    0x0(%esi),%esi
    1160:	0f b6 06             	movzbl (%esi),%eax
    1163:	4e                   	dec    %esi
  write(fd, &c, 1);
    1164:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    1168:	89 3c 24             	mov    %edi,(%esp)
    116b:	88 45 d7             	mov    %al,-0x29(%ebp)
    116e:	b8 01 00 00 00       	mov    $0x1,%eax
    1173:	89 44 24 08          	mov    %eax,0x8(%esp)
    1177:	e8 dc fe ff ff       	call   1058 <write>

  while(--i >= 0)
    117c:	39 de                	cmp    %ebx,%esi
    117e:	75 e0                	jne    1160 <printint+0x60>
    putc(fd, buf[i]);
}
    1180:	83 c4 4c             	add    $0x4c,%esp
    1183:	5b                   	pop    %ebx
    1184:	5e                   	pop    %esi
    1185:	5f                   	pop    %edi
    1186:	5d                   	pop    %ebp
  ...
  neg = 0;
    1190:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    1197:	eb 8d                	jmp    1126 <printint+0x26>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    11a9:	8b 75 0c             	mov    0xc(%ebp),%esi
    11ac:	0f b6 1e             	movzbl (%esi),%ebx
    11af:	84 db                	test   %bl,%bl
    11b1:	0f 84 d1 00 00 00    	je     1288 <printf+0xe8>
  state = 0;
    11b7:	31 ff                	xor    %edi,%edi
    11b9:	46                   	inc    %esi
  ap = (uint*)(void*)&fmt + 1;
    11ba:	8d 45 10             	lea    0x10(%ebp),%eax
  write(fd, &c, 1);
    11bd:	89 fa                	mov    %edi,%edx
    11bf:	8b 7d 08             	mov    0x8(%ebp),%edi
  ap = (uint*)(void*)&fmt + 1;
    11c2:	89 45 d0             	mov    %eax,-0x30(%ebp)
    11c5:	eb 41                	jmp    1208 <printf+0x68>
    11c7:	89 f6                	mov    %esi,%esi
    11c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    11d0:	83 f8 25             	cmp    $0x25,%eax
    11d3:	89 55 d4             	mov    %edx,-0x2c(%ebp)
        state = '%';
    11d6:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    11db:	74 1e                	je     11fb <printf+0x5b>
  write(fd, &c, 1);
    11dd:	b8 01 00 00 00       	mov    $0x1,%eax
    11e2:	89 44 24 08          	mov    %eax,0x8(%esp)
    11e6:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    11e9:	89 44 24 04          	mov    %eax,0x4(%esp)
    11ed:	89 3c 24             	mov    %edi,(%esp)
    11f0:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    11f3:	e8 60 fe ff ff       	call   1058 <write>
    11f8:	8b 55 d4             	mov    -0x2c(%ebp),%edx
    11fb:	46                   	inc    %esi
  for(i = 0; fmt[i]; i++){
    11fc:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    1200:	84 db                	test   %bl,%bl
    1202:	0f 84 80 00 00 00    	je     1288 <printf+0xe8>
    if(state == 0){
    1208:	85 d2                	test   %edx,%edx
    c = fmt[i] & 0xff;
    120a:	0f be cb             	movsbl %bl,%ecx
    120d:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1210:	74 be                	je     11d0 <printf+0x30>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    1212:	83 fa 25             	cmp    $0x25,%edx
    1215:	75 e4                	jne    11fb <printf+0x5b>
      if(c == 'd'){
    1217:	83 f8 64             	cmp    $0x64,%eax
    121a:	0f 84 f0 00 00 00    	je     1310 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1220:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    1226:	83 f9 70             	cmp    $0x70,%ecx
    1229:	74 65                	je     1290 <printf+0xf0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    122b:	83 f8 73             	cmp    $0x73,%eax
    122e:	0f 84 8c 00 00 00    	je     12c0 <printf+0x120>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1234:	83 f8 63             	cmp    $0x63,%eax
    1237:	0f 84 13 01 00 00    	je     1350 <printf+0x1b0>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    123d:	83 f8 25             	cmp    $0x25,%eax
    1240:	0f 84 e2 00 00 00    	je     1328 <printf+0x188>
  write(fd, &c, 1);
    1246:	b8 01 00 00 00       	mov    $0x1,%eax
    124b:	46                   	inc    %esi
    124c:	89 44 24 08          	mov    %eax,0x8(%esp)
    1250:	8d 45 e7             	lea    -0x19(%ebp),%eax
    1253:	89 44 24 04          	mov    %eax,0x4(%esp)
    1257:	89 3c 24             	mov    %edi,(%esp)
    125a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    125e:	e8 f5 fd ff ff       	call   1058 <write>
    1263:	ba 01 00 00 00       	mov    $0x1,%edx
    1268:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    126b:	89 54 24 08          	mov    %edx,0x8(%esp)
    126f:	89 44 24 04          	mov    %eax,0x4(%esp)
    1273:	89 3c 24             	mov    %edi,(%esp)
    1276:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    1279:	e8 da fd ff ff       	call   1058 <write>
  for(i = 0; fmt[i]; i++){
    127e:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
      } else {
  ...
  for(i = 0; fmt[i]; i++){
    1284:	84 db                	test   %bl,%bl
    1286:	75 80                	jne    1208 <printf+0x68>
    }
  }
}
    1288:	83 c4 3c             	add    $0x3c,%esp
    128b:	5b                   	pop    %ebx
    128c:	5e                   	pop    %esi
    128d:	5f                   	pop    %edi
    128e:	5d                   	pop    %ebp
    ...
    1297:	b9 10 00 00 00       	mov    $0x10,%ecx
    129c:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    129f:	89 f8                	mov    %edi,%eax
    12a1:	8b 13                	mov    (%ebx),%edx
    12a3:	e8 58 fe ff ff       	call   1100 <printint>
        ap++;
    12a8:	89 d8                	mov    %ebx,%eax
      state = 0;
    12aa:	31 d2                	xor    %edx,%edx
        ap++;
    12ac:	83 c0 04             	add    $0x4,%eax
    12af:	89 45 d0             	mov    %eax,-0x30(%ebp)
    12b2:	e9 44 ff ff ff       	jmp    11fb <printf+0x5b>
    12b7:	89 f6                	mov    %esi,%esi
    12b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        s = (char*)*ap;
    12c0:	8b 45 d0             	mov    -0x30(%ebp),%eax
    12c3:	8b 10                	mov    (%eax),%edx
        ap++;
    12c5:	83 c0 04             	add    $0x4,%eax
    12c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    12cb:	85 d2                	test   %edx,%edx
    12cd:	0f 84 aa 00 00 00    	je     137d <printf+0x1dd>
        while(*s != 0){
    12d3:	0f b6 02             	movzbl (%edx),%eax
        s = (char*)*ap;
    12d6:	89 d3                	mov    %edx,%ebx
        while(*s != 0){
    12d8:	84 c0                	test   %al,%al
    12da:	74 27                	je     1303 <printf+0x163>
    12dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    12e0:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    12e3:	b8 01 00 00 00       	mov    $0x1,%eax
          s++;
    12e8:	43                   	inc    %ebx
  write(fd, &c, 1);
    12e9:	89 44 24 08          	mov    %eax,0x8(%esp)
    12ed:	8d 45 e3             	lea    -0x1d(%ebp),%eax
    12f0:	89 44 24 04          	mov    %eax,0x4(%esp)
    12f4:	89 3c 24             	mov    %edi,(%esp)
    12f7:	e8 5c fd ff ff       	call   1058 <write>
        while(*s != 0){
    12fc:	0f b6 03             	movzbl (%ebx),%eax
    12ff:	84 c0                	test   %al,%al
    1301:	75 dd                	jne    12e0 <printf+0x140>
      state = 0;
    1303:	31 d2                	xor    %edx,%edx
    1305:	e9 f1 fe ff ff       	jmp    11fb <printf+0x5b>
    130a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    1310:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1317:	b9 0a 00 00 00       	mov    $0xa,%ecx
    131c:	e9 7b ff ff ff       	jmp    129c <printf+0xfc>
    1321:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  write(fd, &c, 1);
    1328:	b9 01 00 00 00       	mov    $0x1,%ecx
    132d:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    1330:	89 4c 24 08          	mov    %ecx,0x8(%esp)
    1334:	89 44 24 04          	mov    %eax,0x4(%esp)
    1338:	89 3c 24             	mov    %edi,(%esp)
    133b:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    133e:	e8 15 fd ff ff       	call   1058 <write>
      state = 0;
    1343:	31 d2                	xor    %edx,%edx
    1345:	e9 b1 fe ff ff       	jmp    11fb <printf+0x5b>
    134a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, *ap);
    1350:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    1353:	8b 03                	mov    (%ebx),%eax
        ap++;
    1355:	83 c3 04             	add    $0x4,%ebx
  write(fd, &c, 1);
    1358:	89 3c 24             	mov    %edi,(%esp)
        putc(fd, *ap);
    135b:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    135e:	b8 01 00 00 00       	mov    $0x1,%eax
    1363:	89 44 24 08          	mov    %eax,0x8(%esp)
    1367:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    136a:	89 44 24 04          	mov    %eax,0x4(%esp)
    136e:	e8 e5 fc ff ff       	call   1058 <write>
      state = 0;
    1373:	31 d2                	xor    %edx,%edx
        ap++;
    1375:	89 5d d0             	mov    %ebx,-0x30(%ebp)
    1378:	e9 7e fe ff ff       	jmp    11fb <printf+0x5b>
          s = "(null)";
    137d:	bb 30 16 00 00       	mov    $0x1630,%ebx
        while(*s != 0){
    1382:	b0 28                	mov    $0x28,%al
    1384:	e9 57 ff ff ff       	jmp    12e0 <printf+0x140>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1391:	a1 64 1c 00 00       	mov    0x1c64,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    13b4:	73 32                	jae    13e8 <free+0x58>
    13b6:	39 d1                	cmp    %edx,%ecx
    13b8:	72 04                	jb     13be <free+0x2e>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    13ba:	39 d0                	cmp    %edx,%eax
    13bc:	72 32                	jb     13f0 <free+0x60>
      break;
  if(bp + bp->s.size == p->s.ptr){
    13be:	8b 73 fc             	mov    -0x4(%ebx),%esi
    13c1:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    13c4:	39 fa                	cmp    %edi,%edx
    13c6:	74 30                	je     13f8 <free+0x68>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    13c8:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    13cb:	8b 50 04             	mov    0x4(%eax),%edx
    13ce:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    13d1:	39 f1                	cmp    %esi,%ecx
    13d3:	74 3c                	je     1411 <free+0x81>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    13d5:	89 08                	mov    %ecx,(%eax)
  freep = p;
}
    13d7:	5b                   	pop    %ebx
  freep = p;
    13d8:	a3 64 1c 00 00       	mov    %eax,0x1c64
}
    13dd:	5e                   	pop    %esi
    13de:	5f                   	pop    %edi
    13df:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    13e8:	39 d0                	cmp    %edx,%eax
    13ea:	72 04                	jb     13f0 <free+0x60>
    13ec:	39 d1                	cmp    %edx,%ecx
    13ee:	72 ce                	jb     13be <free+0x2e>
{
    13f0:	89 d0                	mov    %edx,%eax
    13f2:	eb bc                	jmp    13b0 <free+0x20>
    13f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
    13f8:	8b 7a 04             	mov    0x4(%edx),%edi
    13fb:	01 fe                	add    %edi,%esi
    13fd:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    1400:	8b 10                	mov    (%eax),%edx
    1402:	8b 12                	mov    (%edx),%edx
    1404:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    1407:	8b 50 04             	mov    0x4(%eax),%edx
    140a:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    140d:	39 f1                	cmp    %esi,%ecx
    140f:	75 c4                	jne    13d5 <free+0x45>
    p->s.size += bp->s.size;
    1411:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
    1414:	a3 64 1c 00 00       	mov    %eax,0x1c64
    p->s.size += bp->s.size;
    1419:	01 ca                	add    %ecx,%edx
    141b:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    141e:	8b 53 f8             	mov    -0x8(%ebx),%edx
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    143c:	8b 15 64 1c 00 00    	mov    0x1c64,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    1456:	39 cf                	cmp    %ecx,%edi
    1458:	76 66                	jbe    14c0 <malloc+0x90>
    145a:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    1460:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1465:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    1468:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    146f:	eb 10                	jmp    1481 <malloc+0x51>
    1471:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1478:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    147a:	8b 48 04             	mov    0x4(%eax),%ecx
    147d:	39 f9                	cmp    %edi,%ecx
    147f:	73 3f                	jae    14c0 <malloc+0x90>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1481:	39 05 64 1c 00 00    	cmp    %eax,0x1c64
    1487:	89 c2                	mov    %eax,%edx
    1489:	75 ed                	jne    1478 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    148b:	89 34 24             	mov    %esi,(%esp)
    148e:	e8 2d fc ff ff       	call   10c0 <sbrk>
  if(p == (char*)-1)
    1493:	83 f8 ff             	cmp    $0xffffffff,%eax
    1496:	74 18                	je     14b0 <malloc+0x80>
  hp->s.size = nu;
    1498:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    149b:	83 c0 08             	add    $0x8,%eax
    149e:	89 04 24             	mov    %eax,(%esp)
    14a1:	e8 ea fe ff ff       	call   1390 <free>
  return freep;
    14a6:	8b 15 64 1c 00 00    	mov    0x1c64,%edx
      if((p = morecore(nunits)) == 0)
    14ac:	85 d2                	test   %edx,%edx
    14ae:	75 c8                	jne    1478 <malloc+0x48>
        return 0;
  }
}
    14b0:	83 c4 1c             	add    $0x1c,%esp
        return 0;
    ...
    14cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    14cf:	89 15 64 1c 00 00    	mov    %edx,0x1c64
}
    14d5:	83 c4 1c             	add    $0x1c,%esp
      return (void*)(p + 1);
    ...
    14df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    14e0:	b8 68 1c 00 00       	mov    $0x1c68,%eax
    14e5:	ba 68 1c 00 00       	mov    $0x1c68,%edx
    base.s.size = 0;
    14ea:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
    14ec:	a3 64 1c 00 00       	mov    %eax,0x1c64
    base.s.size = 0;
    14f1:	b8 68 1c 00 00       	mov    $0x1c68,%eax
    base.s.ptr = freep = prevp = &base;
    14f6:	89 15 68 1c 00 00    	mov    %edx,0x1c68
    base.s.size = 0;
    14fc:	89 0d 6c 1c 00 00    	mov    %ecx,0x1c6c
