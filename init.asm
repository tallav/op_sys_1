   ...
   1:	b9 02 00 00 00       	mov    $0x2,%ecx
{
  ...
  14:	c7 04 24 38 08 00 00 	movl   $0x838,(%esp)
  ...
  50:	ba 40 08 00 00       	mov    $0x840,%edx
  ...
  95:	74 b9                	je     50 <main+0x50>
      printf(1, "zombie!\n");
  97:	b8 7f 08 00 00       	mov    $0x87f,%eax
  ...
  ac:	eb d2                	jmp    80 <main+0x80>
      printf(1, "init: fork failed\n");
  ae:	c7 44 24 04 53 08 00 	movl   $0x853,0x4(%esp)
  b5:	00 
  ...
  c9:	e8 9a 02 00 00       	call   368 <exit>
      exec("sh", argv);
  ce:	c7 44 24 04 20 0b 00 	movl   $0xb20,0x4(%esp)
  d5:	00 
  d6:	c7 04 24 66 08 00 00 	movl   $0x866,(%esp)
  dd:	e8 be 02 00 00       	call   3a0 <exec>
      printf(1, "init: exec sh failed\n");
  e2:	c7 44 24 04 69 08 00 	movl   $0x869,0x4(%esp)
  e9:	00 
  ea:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f1:	e8 ca 03 00 00       	call   4c0 <printf>
      exit(0);
 ...
 111:	00 
 112:	c7 04 24 38 08 00 00 	movl   $0x838,(%esp)
 119:	e8 92 02 00 00       	call   3b0 <mknod>
    open("console", O_RDWR);
 11e:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 125:	00 
 126:	c7 04 24 38 08 00 00 	movl   $0x838,(%esp)
...
free(void *ap)
{
 ...
 6b1:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 6f7:	5b                   	pop    %ebx
  freep = p;
 6f8:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 6fd:	5e                   	pop    %esi
 6fe:	5f                   	pop    %edi
 6ff:	5d                   	pop    %ebp
 ...
 70e:	72 ce                	jb     6de <free+0x2e>
{
 ...
 731:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 734:	a3 28 0b 00 00       	mov    %eax,0xb28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 28 0b 00 00    	mov    0xb28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 3f                	jae    7e0 <malloc+0x90>
    ...
    if(p == freep)
 7a1:	39 05 28 0b 00 00    	cmp    %eax,0xb28
 ...
 7c1:	e8 ea fe ff ff       	call   6b0 <free>
  return freep;
 7c6:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
 805:	ba 2c 0b 00 00       	mov    $0xb2c,%edx
    base.s.size = 0;
 80a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 80c:	a3 28 0b 00 00       	mov    %eax,0xb28
    base.s.size = 0;
 811:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
    base.s.ptr = freep = prevp = &base;
 816:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
    base.s.size = 0;
 81c:	89 0d 30 0b 00 00    	mov    %ecx,0xb30
