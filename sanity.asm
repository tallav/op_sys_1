...
main(int argc, char **argv)
{
   ...
   e:	0f 8e 90 00 00 00    	jle    a4 <main+0xa4>
  ...
  1d:	e8 de 02 00 00       	call   300 <atoi>
	switch(testNum){
  22:	83 f8 02             	cmp    $0x2,%eax
  25:	74 34                	je     5b <main+0x5b>
  27:	83 f8 03             	cmp    $0x3,%eax
  2a:	0f 84 ef 00 00 00    	je     11f <main+0x11f>
  30:	48                   	dec    %eax
  31:	74 07                	je     3a <main+0x3a>
		}else{ /*parent code*/
			wait(0);
		}
		exit(0);
  ...
  39:	c3                   	ret    
        pid = fork();
  3a:	e8 31 03 00 00       	call   370 <fork>
        if (pid == 0) {
  3f:	85 c0                	test   %eax,%eax
  41:	75 21                	jne    64 <main+0x64>
            sleep(300);
  43:	c7 04 24 2c 01 00 00 	movl   $0x12c,(%esp)
  4a:	e8 b9 03 00 00       	call   408 <sleep>
            exit(5);
  4f:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  56:	e8 1d 03 00 00       	call   378 <exit>
		pid = fork();
  5b:	e8 10 03 00 00       	call   370 <fork>
        if (pid == 0) {
  60:	85 c0                	test   %eax,%eax
  62:	74 34                	je     98 <main+0x98>
            wait(&status);
  64:	8d 44 24 1c          	lea    0x1c(%esp),%eax
  68:	89 04 24             	mov    %eax,(%esp)
  6b:	e8 10 03 00 00       	call   380 <wait>
            printf(1, "exit status after is %d\n", status);
  70:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  74:	c7 44 24 04 8f 08 00 	movl   $0x88f,0x4(%esp)
  7b:	00 
  ...
  93:	e8 e0 02 00 00       	call   378 <exit>
            exit(5);
  98:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  9f:	e8 d4 02 00 00       	call   378 <exit>
		pid = fork(); 
  a4:	e8 c7 02 00 00       	call   370 <fork>
		if(pid > 0) {
  a9:	85 c0                	test   %eax,%eax
		pid = fork(); 
  ab:	89 c3                	mov    %eax,%ebx
		if(pid > 0) {
  ad:	7e 64                	jle    113 <main+0x113>
			first_status = detach(pid); // status = 0
  af:	89 04 24             	mov    %eax,(%esp)
  b2:	e8 61 03 00 00       	call   418 <detach>
			printf(1, "first_status: %d\n", first_status);
  b7:	c7 44 24 04 58 08 00 	movl   $0x858,0x4(%esp)
  be:	00 
  ...
  d2:	e8 41 03 00 00       	call   418 <detach>
			printf(1, "second_status: %d\n", second_status);
  d7:	c7 44 24 04 6a 08 00 	movl   $0x86a,0x4(%esp)
  de:	00 
  ...
  ef:	c7 04 24 4d 00 00 00 	movl   $0x4d,(%esp)
  f6:	e8 1d 03 00 00       	call   418 <detach>
			printf(1, "third_status: %d\n", third_status);
  fb:	c7 44 24 04 7d 08 00 	movl   $0x87d,0x4(%esp)
 102:	00 
 ...
 11a:	e8 59 02 00 00       	call   378 <exit>
		pid = fork(); 
 11f:	e8 4c 02 00 00       	call   370 <fork>
		if(pid == 0){ /*child code*/
 124:	85 c0                	test   %eax,%eax
 126:	75 16                	jne    13e <main+0x13e>
			printf(1, "child process\n");
 128:	c7 44 24 04 a8 08 00 	movl   $0x8a8,0x4(%esp)
 12f:	00 
 130:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 137:	e8 a4 03 00 00       	call   4e0 <printf>
 13c:	eb d5                	jmp    113 <main+0x113>
			wait(0);
 13e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 145:	e8 36 02 00 00       	call   380 <wait>
 14a:	eb c7                	jmp    113 <main+0x113>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6b8:	e9 7e fe ff ff       	jmp    53b <printf+0x5b>
          s = "(null)";
 6bd:	bb b7 08 00 00       	mov    $0x8b7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d1:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 717:	5b                   	pop    %ebx
  freep = p;
 718:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 71d:	5e                   	pop    %esi
 71e:	5f                   	pop    %edi
 71f:	5d                   	pop    %ebp
 ...
 72e:	72 ce                	jb     6fe <free+0x2e>
{
 ...
 751:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 754:	a3 58 0b 00 00       	mov    %eax,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 58 0b 00 00    	mov    0xb58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 3f                	jae    800 <malloc+0x90>
    ...
    if(p == freep)
 7c1:	39 05 58 0b 00 00    	cmp    %eax,0xb58
 ...
 7e1:	e8 ea fe ff ff       	call   6d0 <free>
  return freep;
 7e6:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 80f:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	b8 5c 0b 00 00       	mov    $0xb5c,%eax
 825:	ba 5c 0b 00 00       	mov    $0xb5c,%edx
    base.s.size = 0;
 82a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 82c:	a3 58 0b 00 00       	mov    %eax,0xb58
    base.s.size = 0;
 831:	b8 5c 0b 00 00       	mov    $0xb5c,%eax
    base.s.ptr = freep = prevp = &base;
 836:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
    base.s.size = 0;
 83c:	89 0d 60 0b 00 00    	mov    %ecx,0xb60
