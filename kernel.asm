...
801002b8:	e8 23 43 00 00       	call   801045e0 <sleep>
    while(input.r == input.w){
...
801008d4:	a3 24 20 11 80       	mov    %eax,0x80112024
          wakeup(&input.r);
801008d9:	e8 12 3f 00 00       	call   801047f0 <wakeup>
...
801021ce:	e8 1d 26 00 00       	call   801047f0 <wakeup>
...
8010228c:	e8 4f 23 00 00       	call   801045e0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102cb8:	e8 23 19 00 00       	call   801045e0 <sleep>
    if(log.committing){
...
80102dff:	e8 ec 19 00 00       	call   801047f0 <wakeup>
    release(&log.lock);
...
801034ef:	e8 fc 12 00 00       	call   801047f0 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
80103531:	e8 ba 12 00 00       	call   801047f0 <wakeup>
...
801035c3:	e8 28 12 00 00       	call   801047f0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801035c8:	89 7c 24 04          	mov    %edi,0x4(%esp)
801035cc:	89 1c 24             	mov    %ebx,(%esp)
801035cf:	e8 0c 10 00 00       	call   801045e0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010364f:	e8 9c 11 00 00       	call   801047f0 <wakeup>
  release(&p->lock);
...
801036b7:	e8 24 0f 00 00       	call   801045e0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103744:	e8 a7 10 00 00       	call   801047f0 <wakeup>
  release(&p->lock);
...
80103cd5:	0f 84 1d 01 00 00    	je     80103df8 <fork+0x148>
...
80103cf3:	0f 84 09 01 00 00    	je     80103e02 <fork+0x152>
  np->sz = curproc->sz;
...
80103d82:	a1 20 83 11 80       	mov    0x80118320,%eax
  np->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80103d87:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
  if(POLICY == 1)
80103d8d:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
  np->state = RUNNABLE;
80103d94:	c7 46 0c 03 00 00 00 	movl   $0x3,0xc(%esi)
  np->performUt.startRetime = ticks; // update last READY time for performance calculation
80103d9b:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
  np->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80103da1:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
80103da6:	89 96 90 00 00 00    	mov    %edx,0x90(%esi)
80103dac:	89 86 8c 00 00 00    	mov    %eax,0x8c(%esi)
      rrq.enqueue(np);
80103db2:	89 34 24             	mov    %esi,(%esp)
  if(POLICY == 1)
80103db5:	74 39                	je     80103df0 <fork+0x140>
      pq.put(np);
80103db7:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
  np->priority = 5; // set the priority of the new process to 5
80103dbd:	b8 05 00 00 00       	mov    $0x5,%eax
80103dc2:	89 86 80 00 00 00    	mov    %eax,0x80(%esi)
  setAccumulator(np); // set the accumulator of the new process
80103dc8:	89 34 24             	mov    %esi,(%esp)
80103dcb:	e8 a0 fc ff ff       	call   80103a70 <setAccumulator>
  release(&ptable.lock);
80103dd0:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103dd7:	e8 b4 1f 00 00       	call   80105d90 <release>
}
80103ddc:	83 c4 1c             	add    $0x1c,%esp
...
80103de9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      rrq.enqueue(np);
80103df0:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80103df6:	eb c5                	jmp    80103dbd <fork+0x10d>
    return -1;
80103df8:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103dfd:	8d 76 00             	lea    0x0(%esi),%esi
80103e00:	eb da                	jmp    80103ddc <fork+0x12c>
    kfree(np->kstack);
80103e02:	8b 46 08             	mov    0x8(%esi),%eax
    return -1;
80103e05:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    kfree(np->kstack);
80103e0a:	89 04 24             	mov    %eax,(%esp)
80103e0d:	e8 ce e5 ff ff       	call   801023e0 <kfree>
    np->kstack = 0;
80103e12:	c7 46 08 00 00 00 00 	movl   $0x0,0x8(%esi)
    np->state = UNUSED;
80103e19:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
    return -1;
80103e20:	eb ba                	jmp    80103ddc <fork+0x12c>
...
80103e36:	53                   	push   %ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e37:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
{
80103e3c:	83 ec 10             	sub    $0x10,%esp
80103e3f:	eb 15                	jmp    80103e56 <wakeup1+0x26>
80103e41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e48:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80103e4e:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80103e54:	73 75                	jae    80103ecb <wakeup1+0x9b>
    if(p->state == SLEEPING && p->chan == chan){ 
80103e56:	8b 43 0c             	mov    0xc(%ebx),%eax
80103e59:	83 f8 02             	cmp    $0x2,%eax
80103e5c:	75 ea                	jne    80103e48 <wakeup1+0x18>
80103e5e:	39 73 20             	cmp    %esi,0x20(%ebx)
80103e61:	75 e5                	jne    80103e48 <wakeup1+0x18>
      p->state = RUNNABLE;
      
      p->performance.stime += ticks - p->performUt.startStime; // add to SLEEPING time 
80103e63:	8b 15 20 83 11 80    	mov    0x80118320,%edx
80103e69:	8b 83 9c 00 00 00    	mov    0x9c(%ebx),%eax
80103e6f:	8b 8b a8 00 00 00    	mov    0xa8(%ebx),%ecx
      p->performUt.startRetime = ticks; // update last READY time for performance calculation
      p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
      setAccumulator(p); // set the process accumulater after beeing blocked
80103e75:	89 1c 24             	mov    %ebx,(%esp)
      p->performUt.startRetime = ticks; // update last READY time for performance calculation
80103e78:	89 93 ac 00 00 00    	mov    %edx,0xac(%ebx)
      p->performance.stime += ticks - p->performUt.startStime; // add to SLEEPING time 
80103e7e:	01 d0                	add    %edx,%eax
      p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80103e80:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
      p->performance.stime += ticks - p->performUt.startStime; // add to SLEEPING time 
80103e86:	29 c8                	sub    %ecx,%eax
80103e88:	89 83 9c 00 00 00    	mov    %eax,0x9c(%ebx)
      p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80103e8e:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
      p->state = RUNNABLE;
80103e93:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
      p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80103e9a:	89 93 90 00 00 00    	mov    %edx,0x90(%ebx)
80103ea0:	89 83 8c 00 00 00    	mov    %eax,0x8c(%ebx)
      setAccumulator(p); // set the process accumulater after beeing blocked
80103ea6:	e8 c5 fb ff ff       	call   80103a70 <setAccumulator>
      // insert the process to the runnable queue
      if(POLICY == 1)
80103eab:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
        rrq.enqueue(p);
80103eb2:	89 1c 24             	mov    %ebx,(%esp)
      if(POLICY == 1)
80103eb5:	74 21                	je     80103ed8 <wakeup1+0xa8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103eb7:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
      else
        pq.put(p);
80103ebd:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ec3:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80103ec9:	72 8b                	jb     80103e56 <wakeup1+0x26>
    }
}
...
80103ed2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        rrq.enqueue(p);
80103ed8:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80103ede:	e9 65 ff ff ff       	jmp    80103e48 <wakeup1+0x18>
80103ee3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103ee9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80103ef0 <originalScheduler>:
{
...
80103ef9:	8b 7d 0c             	mov    0xc(%ebp),%edi
  asm volatile("sti");
80103efc:	fb                   	sti    
    acquire(&ptable.lock);
80103efd:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f04:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
    acquire(&ptable.lock);
80103f09:	e8 e2 1d 00 00       	call   80105cf0 <acquire>
      swtch(&(c->scheduler), p->context);
80103f0e:	8d 77 04             	lea    0x4(%edi),%esi
80103f11:	eb 0d                	jmp    80103f20 <originalScheduler+0x30>
80103f13:	90                   	nop
80103f14:	90                   	nop
80103f15:	90                   	nop
80103f16:	90                   	nop
...
80103f1f:	90                   	nop
      if(p->state != RUNNABLE)
80103f20:	8b 43 0c             	mov    0xc(%ebx),%eax
80103f23:	83 f8 03             	cmp    $0x3,%eax
80103f26:	75 31                	jne    80103f59 <originalScheduler+0x69>
      c->proc = p;
80103f28:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
      switchuvm(p);
80103f2e:	89 1c 24             	mov    %ebx,(%esp)
80103f31:	e8 da 43 00 00       	call   80108310 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103f36:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103f39:	89 34 24             	mov    %esi,(%esp)
      p->state = RUNNING;
80103f3c:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103f43:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f47:	e8 cd 20 00 00       	call   80106019 <swtch>
      switchkvm();
80103f4c:	e8 9f 43 00 00       	call   801082f0 <switchkvm>
      c->proc = 0;
80103f51:	31 c0                	xor    %eax,%eax
80103f53:	89 87 ac 00 00 00    	mov    %eax,0xac(%edi)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f59:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80103f5f:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80103f65:	72 b9                	jb     80103f20 <originalScheduler+0x30>
    release(&ptable.lock);
80103f67:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
...
80103f74:	5d                   	pop    %ebp
    release(&ptable.lock);
80103f75:	e9 16 1e 00 00       	jmp    80105d90 <release>
80103f7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80103f80 <roundRobinScheduler>:
{
...
80103f8b:	fb                   	sti    
    acquire(&ptable.lock);
80103f8c:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103f93:	e8 58 1d 00 00       	call   80105cf0 <acquire>
    if(!rrq.isEmpty()){
80103f98:	ff 15 dc c5 10 80    	call   *0x8010c5dc
80103f9e:	85 c0                	test   %eax,%eax
80103fa0:	75 70                	jne    80104012 <roundRobinScheduler+0x92>
        p = rrq.dequeue();
80103fa2:	ff 15 e4 c5 10 80    	call   *0x8010c5e4
80103fa8:	89 c3                	mov    %eax,%ebx
        c->proc = p;
80103faa:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
        switchuvm(p);
80103fb0:	89 04 24             	mov    %eax,(%esp)
80103fb3:	e8 58 43 00 00       	call   80108310 <switchuvm>
        p->performance.retime += ticks - p->performUt.startRetime; // add to READY time
80103fb8:	8b 15 20 83 11 80    	mov    0x80118320,%edx
80103fbe:	8b 83 a0 00 00 00    	mov    0xa0(%ebx),%eax
80103fc4:	8b 8b ac 00 00 00    	mov    0xac(%ebx),%ecx
        p->state = RUNNING;
80103fca:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
        p->performUt.startRutime = ticks; // update last RUNNING time for performance calculation
80103fd1:	89 93 b0 00 00 00    	mov    %edx,0xb0(%ebx)
        p->performance.retime += ticks - p->performUt.startRetime; // add to READY time
80103fd7:	01 d0                	add    %edx,%eax
80103fd9:	29 c8                	sub    %ecx,%eax
80103fdb:	89 83 a0 00 00 00    	mov    %eax,0xa0(%ebx)
        rpholder.remove(p); // makes sure the process is not in the queue (avoids overflow)
80103fe1:	89 1c 24             	mov    %ebx,(%esp)
80103fe4:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
        rpholder.add(p); // insert the process to the running holder
80103fea:	89 1c 24             	mov    %ebx,(%esp)
80103fed:	ff 15 d0 c5 10 80    	call   *0x8010c5d0
        swtch(&(c->scheduler), p->context);
80103ff3:	8b 43 1c             	mov    0x1c(%ebx),%eax
        c->proc = 0;
80103ff6:	31 db                	xor    %ebx,%ebx
        swtch(&(c->scheduler), p->context);
80103ff8:	89 44 24 04          	mov    %eax,0x4(%esp)
80103ffc:	8d 46 04             	lea    0x4(%esi),%eax
80103fff:	89 04 24             	mov    %eax,(%esp)
80104002:	e8 12 20 00 00       	call   80106019 <swtch>
        switchkvm();
80104007:	e8 e4 42 00 00       	call   801082f0 <switchkvm>
        c->proc = 0;
8010400c:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
    release(&ptable.lock);
80104012:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
...
8010403b:	fb                   	sti    
    acquire(&ptable.lock);
8010403c:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104043:	e8 a8 1c 00 00       	call   80105cf0 <acquire>
    if(!pq.isEmpty()){
80104048:	ff 15 ec c5 10 80    	call   *0x8010c5ec
8010404e:	85 c0                	test   %eax,%eax
80104050:	75 70                	jne    801040c2 <priorityScheduler+0x92>
        p = pq.extractMin();
80104052:	ff 15 f8 c5 10 80    	call   *0x8010c5f8
80104058:	89 c3                	mov    %eax,%ebx
        c->proc = p;
8010405a:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
        switchuvm(p);
80104060:	89 04 24             	mov    %eax,(%esp)
80104063:	e8 a8 42 00 00       	call   80108310 <switchuvm>
        p->performance.retime += ticks - p->performUt.startRetime; // add to READY time
80104068:	8b 15 20 83 11 80    	mov    0x80118320,%edx
8010406e:	8b 83 a0 00 00 00    	mov    0xa0(%ebx),%eax
80104074:	8b 8b ac 00 00 00    	mov    0xac(%ebx),%ecx
        p->state = RUNNING; 
8010407a:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
        p->performUt.startRutime = ticks; // update last RUNNING time for performance calculation
80104081:	89 93 b0 00 00 00    	mov    %edx,0xb0(%ebx)
        p->performance.retime += ticks - p->performUt.startRetime; // add to READY time
80104087:	01 d0                	add    %edx,%eax
80104089:	29 c8                	sub    %ecx,%eax
8010408b:	89 83 a0 00 00 00    	mov    %eax,0xa0(%ebx)
        rpholder.remove(p); // makes sure the process is not in the queue (avoids overflow)
80104091:	89 1c 24             	mov    %ebx,(%esp)
80104094:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
        rpholder.add(p); // insert the process to the running holder
8010409a:	89 1c 24             	mov    %ebx,(%esp)
8010409d:	ff 15 d0 c5 10 80    	call   *0x8010c5d0
        swtch(&(c->scheduler), p->context);
801040a3:	8b 43 1c             	mov    0x1c(%ebx),%eax
        c->proc = 0;
801040a6:	31 db                	xor    %ebx,%ebx
        swtch(&(c->scheduler), p->context);
801040a8:	89 44 24 04          	mov    %eax,0x4(%esp)
801040ac:	8d 46 04             	lea    0x4(%esi),%eax
801040af:	89 04 24             	mov    %eax,(%esp)
801040b2:	e8 62 1f 00 00       	call   80106019 <swtch>
        switchkvm();
801040b7:	e8 34 42 00 00       	call   801082f0 <switchkvm>
        c->proc = 0;
801040bc:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
    release(&ptable.lock);
801040c2:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
...
801040e6:	83 ec 2c             	sub    $0x2c,%esp
801040e9:	8b 45 0c             	mov    0xc(%ebp),%eax
801040ec:	8b 5d 08             	mov    0x8(%ebp),%ebx
801040ef:	89 45 e0             	mov    %eax,-0x20(%ebp)
801040f2:	fb                   	sti    
    acquire(&ptable.lock);
801040f3:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801040fa:	e8 f1 1b 00 00       	call   80105cf0 <acquire>
    if(!pq.isEmpty()){
801040ff:	ff 15 ec c5 10 80    	call   *0x8010c5ec
80104105:	85 c0                	test   %eax,%eax
80104107:	0f 85 80 00 00 00    	jne    8010418d <extendedPriorityScheduler+0xad>
        if(avoidStarv){ // every 100 time quantums (flag update in yield) 
8010410d:	a1 b8 c5 10 80       	mov    0x8010c5b8,%eax
80104112:	85 c0                	test   %eax,%eax
80104114:	0f 85 86 00 00 00    	jne    801041a0 <extendedPriorityScheduler+0xc0>
            np = pq.extractMin();
8010411a:	ff 15 f8 c5 10 80    	call   *0x8010c5f8
80104120:	89 c3                	mov    %eax,%ebx
        c->proc = np;
80104122:	8b 7d e0             	mov    -0x20(%ebp),%edi
80104125:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
        switchuvm(np);
8010412b:	89 1c 24             	mov    %ebx,(%esp)
8010412e:	e8 dd 41 00 00       	call   80108310 <switchuvm>
        np->performance.retime += ticks - np->performUt.startRetime; // add to READY time
80104133:	8b 0d 20 83 11 80    	mov    0x80118320,%ecx
80104139:	8b 83 a0 00 00 00    	mov    0xa0(%ebx),%eax
8010413f:	8b b3 ac 00 00 00    	mov    0xac(%ebx),%esi
        np->state = RUNNING;
80104145:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
        np->performUt.startRutime = ticks; // update last RUNNING time for performance calculation
8010414c:	89 8b b0 00 00 00    	mov    %ecx,0xb0(%ebx)
        np->performance.retime += ticks - np->performUt.startRetime; // add to READY time
80104152:	01 c8                	add    %ecx,%eax
80104154:	29 f0                	sub    %esi,%eax
80104156:	89 83 a0 00 00 00    	mov    %eax,0xa0(%ebx)
        rpholder.remove(np); // makes sure the process is not in the queue (avoids overflow)
8010415c:	89 1c 24             	mov    %ebx,(%esp)
8010415f:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
        rpholder.add(np); // insert the process to the running holder
80104165:	89 1c 24             	mov    %ebx,(%esp)
80104168:	ff 15 d0 c5 10 80    	call   *0x8010c5d0
        swtch(&(c->scheduler), np->context);
8010416e:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104171:	89 44 24 04          	mov    %eax,0x4(%esp)
80104175:	8d 47 04             	lea    0x4(%edi),%eax
80104178:	89 04 24             	mov    %eax,(%esp)
8010417b:	e8 99 1e 00 00       	call   80106019 <swtch>
        switchkvm();
80104180:	e8 6b 41 00 00       	call   801082f0 <switchkvm>
        c->proc = 0;
80104185:	31 c0                	xor    %eax,%eax
80104187:	89 87 ac 00 00 00    	mov    %eax,0xac(%edi)
                    release(&ptable.lock);
8010418d:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
80104194:	83 c4 2c             	add    $0x2c,%esp
80104197:	5b                   	pop    %ebx
80104198:	5e                   	pop    %esi
80104199:	5f                   	pop    %edi
8010419a:	5d                   	pop    %ebp
                    release(&ptable.lock);
8010419b:	e9 f0 1b 00 00       	jmp    80105d90 <release>
                    if (tqCounter - p->timeStamp > max || np == null){
801041a0:	8b 15 c0 c5 10 80    	mov    0x8010c5c0,%edx
...
801041a6:	b8 d4 4d 11 80       	mov    $0x80114dd4,%eax
                    if (tqCounter - p->timeStamp > max || np == null){
801041ab:	8b 0d c4 c5 10 80    	mov    0x8010c5c4,%ecx
            long long max = 0;
801041b1:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
801041b8:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801041bf:	eb 13                	jmp    801041d4 <extendedPriorityScheduler+0xf4>
801041c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
            for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  // run over all the ptable and look for the process which didn't work for the lonest time
801041c8:	05 b4 00 00 00       	add    $0xb4,%eax
801041cd:	3d d4 7a 11 80       	cmp    $0x80117ad4,%eax
801041d2:	73 3c                	jae    80104210 <extendedPriorityScheduler+0x130>
                if (p->state == RUNNABLE){
801041d4:	8b 70 0c             	mov    0xc(%eax),%esi
801041d7:	83 fe 03             	cmp    $0x3,%esi
801041da:	75 ec                	jne    801041c8 <extendedPriorityScheduler+0xe8>
                    if (tqCounter - p->timeStamp > max || np == null){
801041dc:	89 d6                	mov    %edx,%esi
801041de:	89 cf                	mov    %ecx,%edi
801041e0:	2b b0 8c 00 00 00    	sub    0x8c(%eax),%esi
801041e6:	1b b8 90 00 00 00    	sbb    0x90(%eax),%edi
801041ec:	85 db                	test   %ebx,%ebx
801041ee:	74 10                	je     80104200 <extendedPriorityScheduler+0x120>
801041f0:	3b 7d e4             	cmp    -0x1c(%ebp),%edi
801041f3:	7f 0b                	jg     80104200 <extendedPriorityScheduler+0x120>
801041f5:	7c d1                	jl     801041c8 <extendedPriorityScheduler+0xe8>
801041f7:	3b 75 dc             	cmp    -0x24(%ebp),%esi
801041fa:	76 cc                	jbe    801041c8 <extendedPriorityScheduler+0xe8>
801041fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104200:	89 75 dc             	mov    %esi,-0x24(%ebp)
80104203:	89 c3                	mov    %eax,%ebx
80104205:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80104208:	eb be                	jmp    801041c8 <extendedPriorityScheduler+0xe8>
...
80104212:	85 db                	test   %ebx,%ebx
            avoidStarv = 0;
80104214:	a3 b8 c5 10 80       	mov    %eax,0x8010c5b8
            if (np != null){ // process was found in the ptable
80104219:	74 1d                	je     80104238 <extendedPriorityScheduler+0x158>
                if (!pq.extractProc(np)){ // try to extract it from the runnable queue
8010421b:	89 1c 24             	mov    %ebx,(%esp)
8010421e:	ff 15 00 c6 10 80    	call   *0x8010c600
80104224:	85 c0                	test   %eax,%eax
80104226:	0f 85 f6 fe ff ff    	jne    80104122 <extendedPriorityScheduler+0x42>
8010422c:	e9 5c ff ff ff       	jmp    8010418d <extendedPriorityScheduler+0xad>
80104231:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        c->proc = np;
80104238:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010423b:	31 d2                	xor    %edx,%edx
8010423d:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
        switchuvm(np);
80104243:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010424a:	e8 c1 40 00 00       	call   80108310 <switchuvm>
        np->state = RUNNING;
8010424f:	31 c9                	xor    %ecx,%ecx
80104251:	89 0d 0c 00 00 00    	mov    %ecx,0xc
80104257:	0f 0b                	ud2    
...
80104264:	83 ec 14             	sub    $0x14,%esp
  struct cpu *c = mycpu();
80104267:	e8 b4 f6 ff ff       	call   80103920 <mycpu>
...
801042a1:	e8 3a fe ff ff       	call   801040e0 <extendedPriorityScheduler>
    switch(POLICY){
...
801042bb:	e8 c0 fc ff ff       	call   80103f80 <roundRobinScheduler>
            break;
...
801042d7:	e8 14 fc ff ff       	call   80103ef0 <originalScheduler>
            break;
...
801042eb:	e8 40 fd ff ff       	call   80104030 <priorityScheduler>
            break;
...
80104305:	83 ec 10             	sub    $0x10,%esp
  pushcli();
80104308:	e8 03 19 00 00       	call   80105c10 <pushcli>
  c = mycpu();
8010430d:	e8 0e f6 ff ff       	call   80103920 <mycpu>
  p = c->proc;
80104312:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104318:	e8 33 19 00 00       	call   80105c50 <popcli>
  if(!holding(&ptable.lock))
8010431d:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104324:	e8 87 19 00 00       	call   80105cb0 <holding>
...
8010437e:	c7 04 24 e0 8f 10 80 	movl   $0x80108fe0,(%esp)
80104385:	e8 e6 bf ff ff       	call   80100370 <panic>
    panic("sched interruptible");
8010438a:	c7 04 24 0c 90 10 80 	movl   $0x8010900c,(%esp)
80104391:	e8 da bf ff ff       	call   80100370 <panic>
    panic("sched running");
80104396:	c7 04 24 fe 8f 10 80 	movl   $0x80108ffe,(%esp)
8010439d:	e8 ce bf ff ff       	call   80100370 <panic>
    panic("sched locks");
801043a2:	c7 04 24 f2 8f 10 80 	movl   $0x80108ff2,(%esp)
...
801043b6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801043b9:	e8 52 18 00 00       	call   80105c10 <pushcli>
  c = mycpu();
801043be:	e8 5d f5 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801043c3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801043c9:	e8 82 18 00 00       	call   80105c50 <popcli>
  if(curproc == initproc)
801043ce:	39 35 c8 c5 10 80    	cmp    %esi,0x8010c5c8
801043d4:	0f 84 d5 00 00 00    	je     801044af <exit+0xff>
...
80104415:	a1 20 83 11 80       	mov    0x80118320,%eax
  curproc->cwd = 0;
8010441a:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  curproc->performance.ttime = ticks; // exited process gets ctime
80104421:	89 86 98 00 00 00    	mov    %eax,0x98(%esi)
  acquire(&ptable.lock);
80104427:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010442e:	e8 bd 18 00 00       	call   80105cf0 <acquire>
  wakeup1(curproc->parent);
80104433:	8b 46 14             	mov    0x14(%esi),%eax
80104436:	e8 f5 f9 ff ff       	call   80103e30 <wakeup1>
8010443b:	eb 11                	jmp    8010444e <exit+0x9e>
8010443d:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104440:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80104446:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
8010444c:	73 32                	jae    80104480 <exit+0xd0>
    if(p->parent == curproc){
8010444e:	39 73 14             	cmp    %esi,0x14(%ebx)
80104451:	75 ed                	jne    80104440 <exit+0x90>
      if(p->state == ZOMBIE)
80104453:	8b 53 0c             	mov    0xc(%ebx),%edx
      p->parent = initproc;
80104456:	a1 c8 c5 10 80       	mov    0x8010c5c8,%eax
      if(p->state == ZOMBIE)
8010445b:	83 fa 05             	cmp    $0x5,%edx
      p->parent = initproc;
8010445e:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80104461:	75 dd                	jne    80104440 <exit+0x90>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104463:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
        wakeup1(initproc);
80104469:	e8 c2 f9 ff ff       	call   80103e30 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010446e:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80104474:	72 d8                	jb     8010444e <exit+0x9e>
...
80104483:	89 46 7c             	mov    %eax,0x7c(%esi)
  if(p->state == RUNNING)
80104486:	8b 43 0c             	mov    0xc(%ebx),%eax
80104489:	83 f8 04             	cmp    $0x4,%eax
8010448c:	75 09                	jne    80104497 <exit+0xe7>
      rpholder.remove(p);
8010448e:	89 1c 24             	mov    %ebx,(%esp)
80104491:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
  curproc->state = ZOMBIE;
80104497:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
8010449e:	e8 5d fe ff ff       	call   80104300 <sched>
  panic("zombie exit");
801044a3:	c7 04 24 2d 90 10 80 	movl   $0x8010902d,(%esp)
801044aa:	e8 c1 be ff ff       	call   80100370 <panic>
    panic("init exiting");
801044af:	c7 04 24 20 90 10 80 	movl   $0x80109020,(%esp)
...
801044c7:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801044ce:	e8 1d 18 00 00       	call   80105cf0 <acquire>
  pushcli();
801044d3:	e8 38 17 00 00       	call   80105c10 <pushcli>
  c = mycpu();
801044d8:	e8 43 f4 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801044dd:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801044e3:	e8 68 17 00 00       	call   80105c50 <popcli>
801044e8:	8b 15 20 83 11 80    	mov    0x80118320,%edx
  if(p->state == RUNNING){
801044ee:	8b 43 0c             	mov    0xc(%ebx),%eax
801044f1:	83 f8 04             	cmp    $0x4,%eax
801044f4:	75 25                	jne    8010451b <yield+0x5b>
    rpholder.remove(p);
801044f6:	89 1c 24             	mov    %ebx,(%esp)
801044f9:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
    p->performance.rutime += ticks - p->performUt.startRutime; // add to RUNNING time
801044ff:	8b 83 a4 00 00 00    	mov    0xa4(%ebx),%eax
80104505:	8b 15 20 83 11 80    	mov    0x80118320,%edx
8010450b:	8b 8b b0 00 00 00    	mov    0xb0(%ebx),%ecx
80104511:	01 d0                	add    %edx,%eax
80104513:	29 c8                	sub    %ecx,%eax
80104515:	89 83 a4 00 00 00    	mov    %eax,0xa4(%ebx)
  p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
8010451b:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
  p->performUt.startRetime = ticks; // update last READY time for performance calculation
80104520:	89 93 ac 00 00 00    	mov    %edx,0xac(%ebx)
  p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80104526:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
  p->state = RUNNABLE;
8010452c:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
80104533:	89 83 8c 00 00 00    	mov    %eax,0x8c(%ebx)
  tqCounter++; // update the counter
80104539:	83 c0 01             	add    $0x1,%eax
  p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
8010453c:	89 93 90 00 00 00    	mov    %edx,0x90(%ebx)
  tqCounter++; // update the counter
80104542:	83 d2 00             	adc    $0x0,%edx
  if(POLICY == 1)
80104545:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
  tqCounter++; // update the counter
8010454c:	a3 c0 c5 10 80       	mov    %eax,0x8010c5c0
80104551:	89 15 c4 c5 10 80    	mov    %edx,0x8010c5c4
      rrq.enqueue(p);
80104557:	89 1c 24             	mov    %ebx,(%esp)
  if(POLICY == 1)
8010455a:	74 74                	je     801045d0 <yield+0x110>
      pq.put(p);
8010455c:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
      p->accumulator += p->priority;
80104562:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80104568:	99                   	cltd   
80104569:	01 83 84 00 00 00    	add    %eax,0x84(%ebx)
8010456f:	11 93 88 00 00 00    	adc    %edx,0x88(%ebx)
      if (POLICY == 3 && tqCounter % 100 == 0)
80104575:	83 3d 08 c0 10 80 03 	cmpl   $0x3,0x8010c008
8010457c:	74 1a                	je     80104598 <yield+0xd8>
  sched();
8010457e:	e8 7d fd ff ff       	call   80104300 <sched>
  release(&ptable.lock);
80104583:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010458a:	e8 01 18 00 00       	call   80105d90 <release>
}
8010458f:	83 c4 14             	add    $0x14,%esp
80104592:	5b                   	pop    %ebx
80104593:	5d                   	pop    %ebp
80104594:	c3                   	ret    
80104595:	8d 76 00             	lea    0x0(%esi),%esi
      if (POLICY == 3 && tqCounter % 100 == 0)
80104598:	ba 64 00 00 00       	mov    $0x64,%edx
8010459d:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
801045a2:	31 c9                	xor    %ecx,%ecx
801045a4:	89 54 24 08          	mov    %edx,0x8(%esp)
801045a8:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
801045ae:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801045b2:	89 04 24             	mov    %eax,(%esp)
801045b5:	89 54 24 04          	mov    %edx,0x4(%esp)
801045b9:	e8 e2 13 00 00       	call   801059a0 <__moddi3>
801045be:	09 c2                	or     %eax,%edx
801045c0:	75 bc                	jne    8010457e <yield+0xbe>
         avoidStarv = 1;
801045c2:	b8 01 00 00 00       	mov    $0x1,%eax
801045c7:	a3 b8 c5 10 80       	mov    %eax,0x8010c5b8
801045cc:	eb b0                	jmp    8010457e <yield+0xbe>
801045ce:	66 90                	xchg   %ax,%ax
      rrq.enqueue(p);
801045d0:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
801045d6:	eb a6                	jmp    8010457e <yield+0xbe>
801045d8:	90                   	nop
...
801045e6:	89 5d f4             	mov    %ebx,-0xc(%ebp)
801045e9:	89 75 f8             	mov    %esi,-0x8(%ebp)
801045ec:	8b 75 0c             	mov    0xc(%ebp),%esi
801045ef:	89 7d fc             	mov    %edi,-0x4(%ebp)
801045f2:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
801045f5:	e8 16 16 00 00       	call   80105c10 <pushcli>
  c = mycpu();
801045fa:	e8 21 f3 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801045ff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104605:	e8 46 16 00 00       	call   80105c50 <popcli>
  if(p == 0)
8010460a:	85 db                	test   %ebx,%ebx
8010460c:	0f 84 b7 00 00 00    	je     801046c9 <sleep+0xe9>
  if(lk == 0)
80104612:	85 f6                	test   %esi,%esi
80104614:	0f 84 a3 00 00 00    	je     801046bd <sleep+0xdd>
  if(lk != &ptable.lock){  //DOC: sleeplock0
8010461a:	81 fe a0 4d 11 80    	cmp    $0x80114da0,%esi
80104620:	74 14                	je     80104636 <sleep+0x56>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104622:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104629:	e8 c2 16 00 00       	call   80105cf0 <acquire>
    release(lk); 
8010462e:	89 34 24             	mov    %esi,(%esp)
80104631:	e8 5a 17 00 00       	call   80105d90 <release>
  if(p->state == RUNNING){
80104636:	8b 43 0c             	mov    0xc(%ebx),%eax
80104639:	8b 15 20 83 11 80    	mov    0x80118320,%edx
8010463f:	83 f8 04             	cmp    $0x4,%eax
80104642:	75 25                	jne    80104669 <sleep+0x89>
    rpholder.remove(p);
80104644:	89 1c 24             	mov    %ebx,(%esp)
80104647:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
    p->performance.rutime += ticks - p->performUt.startRutime; // add to RUNNING time
8010464d:	8b 83 a4 00 00 00    	mov    0xa4(%ebx),%eax
80104653:	8b 15 20 83 11 80    	mov    0x80118320,%edx
80104659:	8b 8b b0 00 00 00    	mov    0xb0(%ebx),%ecx
8010465f:	01 d0                	add    %edx,%eax
80104661:	29 c8                	sub    %ecx,%eax
80104663:	89 83 a4 00 00 00    	mov    %eax,0xa4(%ebx)
  p->chan = chan;
80104669:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
8010466c:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  p->performUt.startStime = ticks; // update last SLEEPING time for performance calculation
80104673:	89 93 a8 00 00 00    	mov    %edx,0xa8(%ebx)
  sched();
80104679:	e8 82 fc ff ff       	call   80104300 <sched>
  if(lk != &ptable.lock){  //DOC: sleeplock2
8010467e:	81 fe a0 4d 11 80    	cmp    $0x80114da0,%esi
  p->chan = 0;
80104684:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
8010468b:	74 23                	je     801046b0 <sleep+0xd0>
    release(&ptable.lock);
8010468d:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104694:	e8 f7 16 00 00       	call   80105d90 <release>
}
80104699:	8b 5d f4             	mov    -0xc(%ebp),%ebx
    acquire(lk);
8010469c:	89 75 08             	mov    %esi,0x8(%ebp)
}
8010469f:	8b 7d fc             	mov    -0x4(%ebp),%edi
801046a2:	8b 75 f8             	mov    -0x8(%ebp),%esi
801046a5:	89 ec                	mov    %ebp,%esp
801046a7:	5d                   	pop    %ebp
    acquire(lk);
801046a8:	e9 43 16 00 00       	jmp    80105cf0 <acquire>
801046ad:	8d 76 00             	lea    0x0(%esi),%esi
}
801046b0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801046b3:	8b 75 f8             	mov    -0x8(%ebp),%esi
801046b6:	8b 7d fc             	mov    -0x4(%ebp),%edi
801046b9:	89 ec                	mov    %ebp,%esp
801046bb:	5d                   	pop    %ebp
801046bc:	c3                   	ret    
    panic("sleep without lk");
801046bd:	c7 04 24 3f 90 10 80 	movl   $0x8010903f,(%esp)
801046c4:	e8 a7 bc ff ff       	call   80100370 <panic>
    panic("sleep");
801046c9:	c7 04 24 39 90 10 80 	movl   $0x80109039,(%esp)
801046d0:	e8 9b bc ff ff       	call   80100370 <panic>
...
801046e9:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
801046ec:	e8 1f 15 00 00       	call   80105c10 <pushcli>
  c = mycpu();
801046f1:	e8 2a f2 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801046f6:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801046fc:	e8 4f 15 00 00       	call   80105c50 <popcli>
  acquire(&ptable.lock);
80104701:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104708:	e8 e3 15 00 00       	call   80105cf0 <acquire>
    havekids = 0;
8010470d:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010470f:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
80104714:	eb 18                	jmp    8010472e <wait+0x4e>
80104716:	8d 76 00             	lea    0x0(%esi),%esi
80104719:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80104720:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80104726:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
8010472c:	73 20                	jae    8010474e <wait+0x6e>
      if(p->parent != curproc)
8010472e:	39 73 14             	cmp    %esi,0x14(%ebx)
80104731:	75 ed                	jne    80104720 <wait+0x40>
      if(p->state == ZOMBIE){
80104733:	8b 43 0c             	mov    0xc(%ebx),%eax
80104736:	83 f8 05             	cmp    $0x5,%eax
80104739:	74 35                	je     80104770 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010473b:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
      havekids = 1;
80104741:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104746:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
8010474c:	72 e0                	jb     8010472e <wait+0x4e>
    if(!havekids || curproc->killed){
8010474e:	85 c0                	test   %eax,%eax
80104750:	74 7d                	je     801047cf <wait+0xef>
80104752:	8b 56 24             	mov    0x24(%esi),%edx
80104755:	85 d2                	test   %edx,%edx
80104757:	75 76                	jne    801047cf <wait+0xef>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104759:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
8010475e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104762:	89 34 24             	mov    %esi,(%esp)
80104765:	e8 76 fe ff ff       	call   801045e0 <sleep>
    havekids = 0;
8010476a:	eb a1                	jmp    8010470d <wait+0x2d>
8010476c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        kfree(p->kstack);
80104770:	8b 43 08             	mov    0x8(%ebx),%eax
        pid = p->pid;
80104773:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104776:	89 04 24             	mov    %eax,(%esp)
80104779:	e8 62 dc ff ff       	call   801023e0 <kfree>
        freevm(p->pgdir);
8010477e:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80104781:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104788:	89 04 24             	mov    %eax,(%esp)
8010478b:	e8 30 3f 00 00       	call   801086c0 <freevm>
        if(status != null){ 
80104790:	85 ff                	test   %edi,%edi
        p->pid = 0;
80104792:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104799:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801047a0:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801047a4:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801047ab:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status != null){ 
801047b2:	74 05                	je     801047b9 <wait+0xd9>
            *status = p->exitStatus;
801047b4:	8b 43 7c             	mov    0x7c(%ebx),%eax
801047b7:	89 07                	mov    %eax,(%edi)
        release(&ptable.lock);
801047b9:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801047c0:	e8 cb 15 00 00       	call   80105d90 <release>
}
801047c5:	83 c4 1c             	add    $0x1c,%esp
801047c8:	89 f0                	mov    %esi,%eax
801047ca:	5b                   	pop    %ebx
801047cb:	5e                   	pop    %esi
801047cc:	5f                   	pop    %edi
801047cd:	5d                   	pop    %ebp
801047ce:	c3                   	ret    
      release(&ptable.lock);
801047cf:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
      return -1;
801047d6:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801047db:	e8 b0 15 00 00       	call   80105d90 <release>
      return -1;
801047e0:	eb e3                	jmp    801047c5 <wait+0xe5>
...
801047f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801047fa:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104801:	e8 ea 14 00 00       	call   80105cf0 <acquire>
  wakeup1(chan);
80104806:	89 d8                	mov    %ebx,%eax
80104808:	e8 23 f6 ff ff       	call   80103e30 <wakeup1>
  release(&ptable.lock);
8010480d:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
80104814:	83 c4 14             	add    $0x14,%esp
80104817:	5b                   	pop    %ebx
80104818:	5d                   	pop    %ebp
  release(&ptable.lock);
80104819:	e9 72 15 00 00       	jmp    80105d90 <release>
...
80104824:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104825:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
{
8010482a:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010482d:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
{
80104834:	8b 75 08             	mov    0x8(%ebp),%esi
  acquire(&ptable.lock);
80104837:	e8 b4 14 00 00       	call   80105cf0 <acquire>
8010483c:	eb 14                	jmp    80104852 <kill+0x32>
8010483e:	66 90                	xchg   %ax,%ax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104840:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80104846:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
8010484c:	0f 83 8e 00 00 00    	jae    801048e0 <kill+0xc0>
    if(p->pid == pid){
80104852:	39 73 10             	cmp    %esi,0x10(%ebx)
80104855:	75 e9                	jne    80104840 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING){
80104857:	8b 43 0c             	mov    0xc(%ebx),%eax
      p->killed = 1;
8010485a:	c7 43 24 01 00 00 00 	movl   $0x1,0x24(%ebx)
      if(p->state == SLEEPING){
80104861:	83 f8 02             	cmp    $0x2,%eax
80104864:	74 1a                	je     80104880 <kill+0x60>
        if(POLICY == 1)
            rrq.enqueue(p);
        else
            pq.put(p);
      ...
      release(&ptable.lock);
80104866:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010486d:	e8 1e 15 00 00       	call   80105d90 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010487c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        p->performance.stime += ticks - p->performUt.startStime; // add to SLEEPING time 
80104880:	8b 15 20 83 11 80    	mov    0x80118320,%edx
80104886:	8b 83 9c 00 00 00    	mov    0x9c(%ebx),%eax
8010488c:	8b 8b a8 00 00 00    	mov    0xa8(%ebx),%ecx
        setAccumulator(p); // set the process accumulater after beeing blocked 
80104892:	89 1c 24             	mov    %ebx,(%esp)
        p->performUt.startRetime = ticks; // update last READY time for performance calculation
80104895:	89 93 ac 00 00 00    	mov    %edx,0xac(%ebx)
        p->performance.stime += ticks - p->performUt.startStime; // add to SLEEPING time 
8010489b:	01 d0                	add    %edx,%eax
        p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
8010489d:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
        p->performance.stime += ticks - p->performUt.startStime; // add to SLEEPING time 
801048a3:	29 c8                	sub    %ecx,%eax
801048a5:	89 83 9c 00 00 00    	mov    %eax,0x9c(%ebx)
        p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
801048ab:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
        p->state = RUNNABLE;
801048b0:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
        p->timeStamp = tqCounter; // policy 3 - holds the last time the process executed
801048b7:	89 93 90 00 00 00    	mov    %edx,0x90(%ebx)
801048bd:	89 83 8c 00 00 00    	mov    %eax,0x8c(%ebx)
        setAccumulator(p); // set the process accumulater after beeing blocked 
801048c3:	e8 a8 f1 ff ff       	call   80103a70 <setAccumulator>
        if(POLICY == 1)
801048c8:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
            rrq.enqueue(p);
801048cf:	89 1c 24             	mov    %ebx,(%esp)
        if(POLICY == 1)
801048d2:	74 24                	je     801048f8 <kill+0xd8>
            pq.put(p);
801048d4:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
801048da:	eb 8a                	jmp    80104866 <kill+0x46>
801048dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&ptable.lock);
801048e0:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801048e7:	e8 a4 14 00 00       	call   80105d90 <release>
}
...
801048fe:	e9 63 ff ff ff       	jmp    80104866 <kill+0x46>
...
80104988:	89 55 e4             	mov    %edx,-0x1c(%ebp)
            wakeup1(initproc);
8010498b:	e8 a0 f4 ff ff       	call   80103e30 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104cad:	e8 2e f9 ff ff       	call   801045e0 <sleep>
    havekids = 0;
...
80105ad7:	e8 04 eb ff ff       	call   801045e0 <sleep>
  while (lk->locked) {
...
80105b3a:	e8 b1 ec ff ff       	call   801047f0 <wakeup>
  release(&lk->lk);
}
...
80106df3:	e8 b8 d5 ff ff       	call   801043b0 <exit>
...
80106e3c:	e8 9f d8 ff ff       	call   801046e0 <wait>
  //return wait();
}
80106e41:	c9                   	leave  
80106e42:	c3                   	ret    
...
80106e73:	e8 a8 d9 ff ff       	call   80104820 <kill>
}
80106e78:	c9                   	leave  
80106e79:	c3                   	ret    
...
80106f40:	e8 9b d6 ff ff       	call   801045e0 <sleep>
  while(ticks - ticks0 < n){
...
8010732b:	5d                   	pop    %ebp
      exit(0);
8010732c:	e9 7f d0 ff ff       	jmp    801043b0 <exit>
...
8010733c:	75 80                	jne    801072be <trap+0xee>
    yield();
8010733e:	e8 7d d1 ff ff       	call   801044c0 <yield>
...
80107417:	e8 94 cf ff ff       	call   801043b0 <exit>
...
8010742f:	e8 7c cf ff ff       	call   801043b0 <exit>
...
80107453:	ff 05 20 83 11 80    	incl   0x80118320
      wakeup(&ticks);
80107459:	e8 92 d3 ff ff       	call   801047f0 <wakeup>
      release(&tickslock);
