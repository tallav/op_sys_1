...
8010005c:	e8 af 5a 00 00       	call   80105b10 <initlock>
  bcache.head.prev = &bcache.head;
...
8010009b:	e8 40 59 00 00       	call   801059e0 <initsleeplock>
...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 75 5b 00 00       	call   80105c60 <acquire>
...
80100161:	e8 9a 5b 00 00       	call   80105d00 <release>
      acquiresleep(&b->lock);
80100166:	8d 43 0c             	lea    0xc(%ebx),%eax
80100169:	89 04 24             	mov    %eax,(%esp)
8010016c:	e8 af 58 00 00       	call   80105a20 <acquiresleep>
  struct buf *b;
...
801001b0:	e8 0b 59 00 00       	call   80105ac0 <holdingsleep>
...
801001f1:	e8 ca 58 00 00       	call   80105ac0 <holdingsleep>
...
801001fd:	e8 7e 58 00 00       	call   80105a80 <releasesleep>

  acquire(&bcache.lock);
80100202:	c7 04 24 40 d6 10 80 	movl   $0x8010d640,(%esp)
80100209:	e8 52 5a 00 00       	call   80105c60 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010024e:	5d                   	pop    %ebp
  release(&bcache.lock);
8010024f:	e9 ac 5a 00 00       	jmp    80105d00 <release>
    panic("brelse");
...
8010027e:	e8 dd 59 00 00       	call   80105c60 <acquire>
  while(n > 0){
...
801002de:	e8 1d 5a 00 00       	call   80105d00 <release>
        ilock(ip);
...
8010033a:	e8 c1 59 00 00       	call   80105d00 <release>
  ilock(ip);
...
801003bd:	e8 6e 57 00 00       	call   80105b30 <getcallerpcs>
...
80100429:	e8 22 71 00 00       	call   80107550 <uartputc>
...
801004cc:	e8 7f 70 00 00       	call   80107550 <uartputc>
801004d1:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004d8:	e8 73 70 00 00       	call   80107550 <uartputc>
801004dd:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004e4:	e8 67 70 00 00       	call   80107550 <uartputc>
...
80100508:	e8 03 59 00 00       	call   80105e10 <memmove>
    pos -= 80;
...
80100536:	e8 15 58 00 00       	call   80105d50 <memset>
...
8010060e:	e8 4d 56 00 00       	call   80105c60 <acquire>
  for(i = 0; i < n; i++)
...
80100634:	e8 c7 56 00 00       	call   80105d00 <release>
  ilock(ip);
...
8010070e:	e8 ed 55 00 00       	call   80105d00 <release>
}
...
801007b7:	e8 a4 54 00 00       	call   80105c60 <acquire>
...
801007e1:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&cons.lock);
801007e4:	e8 77 54 00 00       	call   80105c60 <acquire>
...
80100847:	e8 b4 54 00 00       	call   80105d00 <release>
  if(doprocdump) {
...
80100996:	e8 75 51 00 00       	call   80105b10 <initlock>
...
80100a5a:	75 d3                	jne    80100a2f <exec+0x5f>
  if((pgdir = setupkvm()) == 0)
80100a5c:	e8 4f 7c 00 00       	call   801086b0 <setupkvm>
...
80100ac8:	e8 03 7a 00 00       	call   801084d0 <allocuvm>
...
80100b05:	e8 06 79 00 00       	call   80108410 <loaduvm>
...
80100b58:	e8 d3 7a 00 00       	call   80108630 <freevm>
...
80100b92:	e8 39 79 00 00       	call   801084d0 <allocuvm>
...
80100ba6:	e8 85 7a 00 00       	call   80108630 <freevm>
  return -1;
...
80100be7:	e8 64 7b 00 00       	call   80108750 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c18:	e8 53 53 00 00       	call   80105f70 <strlen>
...
80100c2d:	e8 3e 53 00 00       	call   80105f70 <strlen>
80100c32:	40                   	inc    %eax
...
80100c48:	e8 73 7c 00 00       	call   801088c0 <copyout>
...
80100cb2:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cb8:	e8 03 7c 00 00       	call   801088c0 <copyout>
...
80100d01:	e8 2a 52 00 00       	call   80105f30 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d2b:	e8 50 75 00 00       	call   80108280 <switchuvm>
  freevm(oldpgdir);
80100d30:	89 3c 24             	mov    %edi,(%esp)
80100d33:	e8 f8 78 00 00       	call   80108630 <freevm>
  return 0;
...
80100d66:	e8 a5 4d 00 00       	call   80105b10 <initlock>
}
80100d6b:	c9                   	leave  
80100d6c:	c3                   	ret    
...
80100d83:	e8 d8 4e 00 00       	call   80105c60 <acquire>
...
80100db0:	e8 4b 4f 00 00       	call   80105d00 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100dc9:	e8 32 4f 00 00       	call   80105d00 <release>
}
...
80100df1:	e8 6a 4e 00 00       	call   80105c60 <acquire>
  if(f->ref < 1)
...
80100e08:	e8 f3 4e 00 00       	call   80105d00 <release>
  return f;
}
...
80100e46:	89 7d fc             	mov    %edi,-0x4(%ebp)
  acquire(&ftable.lock);
80100e49:	e8 12 4e 00 00       	call   80105c60 <acquire>
  if(f->ref < 1)
...
80100e73:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e74:	e9 87 4e 00 00       	jmp    80105d00 <release>
...
80100e9c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e9f:	e8 5c 4e 00 00       	call   80105d00 <release>
  if(ff.type == FD_PIPE)
...
80101218:	e8 33 4b 00 00       	call   80105d50 <memset>
  log_write(bp);
...
80101259:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
8010125c:	e8 ff 49 00 00       	call   80105c60 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012be:	e8 3d 4a 00 00       	call   80105d00 <release>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 19 4a 00 00       	call   80105d00 <release>
}
...
80101408:	e8 03 4a 00 00       	call   80105e10 <memmove>
}
...
801014cc:	e8 3f 46 00 00       	call   80105b10 <initlock>
...
801014f2:	e8 e9 44 00 00       	call   801059e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015f3:	e8 58 47 00 00       	call   80105d50 <memset>
      dip->type = type;
...
801016a2:	e8 69 47 00 00       	call   80105e10 <memmove>
  log_write(bp);
...
801016d1:	e8 8a 45 00 00       	call   80105c60 <acquire>
  ip->ref++;
801016d6:	ff 43 08             	incl   0x8(%ebx)
  release(&icache.lock);
801016d9:	c7 04 24 60 2a 11 80 	movl   $0x80112a60,(%esp)
801016e0:	e8 1b 46 00 00       	call   80105d00 <release>
}
...
80101714:	e8 07 43 00 00       	call   80105a20 <acquiresleep>
  if(ip->valid == 0){
...
80101796:	e8 75 46 00 00       	call   80105e10 <memmove>
    brelse(bp);
...
801017e9:	e8 d2 42 00 00       	call   80105ac0 <holdingsleep>
...
80101804:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101805:	e9 76 42 00 00       	jmp    80105a80 <releasesleep>
    panic("iunlock");
...
80101838:	e8 e3 41 00 00       	call   80105a20 <acquiresleep>
...
8010184e:	e8 2d 42 00 00       	call   80105a80 <releasesleep>
  acquire(&icache.lock);
80101853:	c7 04 24 60 2a 11 80 	movl   $0x80112a60,(%esp)
8010185a:	e8 01 44 00 00       	call   80105c60 <acquire>
  ip->ref--;
...
80101a83:	e8 88 43 00 00       	call   80105e10 <memmove>
    brelse(bp);
...
80101baf:	e8 5c 42 00 00       	call   80105e10 <memmove>
    log_write(bp);
...
80101c5c:	e8 0f 42 00 00       	call   80105e70 <strncmp>
}
80101c61:	c9                   	leave  
80101c62:	c3                   	ret    
...
80101cdb:	e8 90 41 00 00       	call   80105e70 <strncmp>
      continue;
...
80101d68:	e8 f3 3e 00 00       	call   80105c60 <acquire>
  ip->ref++;
80101d6d:	ff 46 08             	incl   0x8(%esi)
  release(&icache.lock);
80101d70:	c7 04 24 60 2a 11 80 	movl   $0x80112a60,(%esp)
80101d77:	e8 84 3f 00 00       	call   80105d00 <release>
...
80101ddc:	e8 2f 40 00 00       	call   80105e10 <memmove>
    path++;
...
80101e65:	e8 a6 3f 00 00       	call   80105e10 <memmove>
    name[len] = 0;
...
80101f73:	e8 58 3f 00 00       	call   80105ed0 <strncpy>
  de.inum = inum;
...
801020f6:	e8 15 3a 00 00       	call   80105b10 <initlock>
...
80102173:	89 7d fc             	mov    %edi,-0x4(%ebp)
  acquire(&idelock);
80102176:	e8 e5 3a 00 00       	call   80105c60 <acquire>
...
801021e8:	e8 13 3b 00 00       	call   80105d00 <release>
...
80102210:	e8 ab 38 00 00       	call   80105ac0 <holdingsleep>
...
80102247:	e8 14 3a 00 00       	call   80105c60 <acquire>
...
801022a6:	5d                   	pop    %ebp
  release(&idelock);
801022a7:	e9 54 3a 00 00       	jmp    80105d00 <release>
...
80102420:	e8 2b 39 00 00       	call   80105d50 <memset>
...
801024fb:	e8 10 36 00 00       	call   80105b10 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801025e5:	e8 76 36 00 00       	call   80105c60 <acquire>
  r = kmem.freelist;
...
8010260f:	e8 ec 36 00 00       	call   80105d00 <release>
  return (char*)r;
...
80102a20:	e8 8b 33 00 00       	call   80105db0 <memcmp>
...
80102b3c:	e8 cf 32 00 00       	call   80105e10 <memmove>
...
80102c0a:	e8 01 2f 00 00       	call   80105b10 <initlock>
  readsb(dev, &sb);
...
80102c9d:	e8 be 2f 00 00       	call   80105c60 <acquire>
...
80102ce5:	a3 3c 47 11 80       	mov    %eax,0x8011473c
      release(&log.lock);
80102cea:	e8 11 30 00 00       	call   80105d00 <release>
      break;
    }
  }
}
...
80102d10:	e8 4b 2f 00 00       	call   80105c60 <acquire>
  log.outstanding -= 1;
...
80102d44:	89 35 40 47 11 80    	mov    %esi,0x80114740
  release(&log.lock);
80102d4a:	e8 b1 2f 00 00       	call   80105d00 <release>
}
...
80102da9:	e8 62 30 00 00       	call   80105e10 <memmove>
...
80102dec:	e8 6f 2e 00 00       	call   80105c60 <acquire>
    log.committing = 0;
...
80102e0b:	e8 f0 2e 00 00       	call   80105d00 <release>
}
...
80102e6b:	e8 f0 2d 00 00       	call   80105c60 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102eb9:	5d                   	pop    %ebp
  release(&log.lock);
80102eba:	e9 41 2e 00 00       	jmp    80105d00 <release>
80102ebf:	90                   	nop
  log.lh.block[i] = b->blockno;
...
80102f04:	83 ec 14             	sub    $0x14,%esp
  switchkvm();
80102f07:	e8 54 53 00 00       	call   80108260 <switchkvm>
  seginit();
80102f0c:	e8 bf 52 00 00       	call   801081d0 <seginit>
  lapicinit();
...
80102f32:	e8 d9 41 00 00       	call   80107110 <idtinit>
...
80102f9f:	e8 8c 57 00 00       	call   80108730 <kvmalloc>
...
80102fb0:	e8 1b 52 00 00       	call   801081d0 <seginit>
  picinit();       // disable pic
...
80102fc5:	e8 d6 44 00 00       	call   801074a0 <uartinit>
  pinit();         // process table
80102fca:	e8 11 09 00 00       	call   801038e0 <pinit>
80102fcf:	90                   	nop
  tvinit();        // trap vectors
80102fd0:	e8 bb 40 00 00       	call   80107090 <tvinit>
  binit();         // buffer cache
...
80102ffe:	e8 0d 2e 00 00       	call   80105e10 <memmove>
...
801030bc:	e8 bf 1e 00 00       	call   80104f80 <initSchedDS>
	__sync_synchronize();
...
80103123:	e8 28 d5 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80103128:	e8 e3 3f 00 00       	call   80107110 <idtinit>
  scheduler();     // start running processes
...
8010317b:	e8 30 2c 00 00       	call   80105db0 <memcmp>
...
8010323a:	e8 71 2b 00 00       	call   80105db0 <memcmp>
...
80103475:	e8 96 26 00 00       	call   80105b10 <initlock>
  (*f0)->type = FD_PIPE;
...
801034d5:	e8 86 27 00 00       	call   80105c60 <acquire>
  if(writable){
...
80103513:	5d                   	pop    %ebp
    release(&p->lock);
80103514:	e9 e7 27 00 00       	jmp    80105d00 <release>
...
80103543:	e8 b8 27 00 00       	call   80105d00 <release>
}
...
8010356f:	e8 ec 26 00 00       	call   80105c60 <acquire>
  for(i = 0; i < n; i++){
...
80103602:	e8 f9 26 00 00       	call   80105d00 <release>
        return -1;
...
80103657:	e8 a4 26 00 00       	call   80105d00 <release>
  return n;
...
80103682:	e8 d9 25 00 00       	call   80105c60 <acquire>
...
801036e7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
      release(&p->lock);
801036ec:	e8 0f 26 00 00       	call   80105d00 <release>
...
8010374c:	e8 af 25 00 00       	call   80105d00 <release>
}
...
80103783:	e8 d8 24 00 00       	call   80105c60 <acquire>
...
801037c2:	89 15 04 c0 10 80    	mov    %edx,0x8010c004
  release(&ptable.lock);
801037c8:	e8 33 25 00 00       	call   80105d00 <release>
  
  acquire(&tickslock);
801037cd:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
801037d4:	e8 87 24 00 00       	call   80105c60 <acquire>
...
801037eb:	e8 10 25 00 00       	call   80105d00 <release>
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	ba 7f 70 10 80       	mov    $0x8010707f,%edx
  sp -= sizeof *p->context;
...
80103827:	e8 24 25 00 00       	call   80105d50 <memset>
...
80103847:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103849:	e8 b2 24 00 00       	call   80105d00 <release>
}
...
8010387d:	e8 7e 24 00 00       	call   80105d00 <release>
...
801038f6:	e8 15 22 00 00       	call   80105b10 <initlock>
}
801038fb:	c9                   	leave  
801038fc:	c3                   	ret    
...
801039a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039a7:	e8 d4 21 00 00       	call   80105b80 <pushcli>
  c = mycpu();
801039ac:	e8 4f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b7:	e8 04 22 00 00       	call   80105bc0 <popcli>
}
801039bc:	5a                   	pop    %edx
...
801039d8:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801039db:	e8 a0 21 00 00       	call   80105b80 <pushcli>
  c = mycpu();
801039e0:	e8 1b ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039e5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039eb:	e8 d0 21 00 00       	call   80105bc0 <popcli>
  if(n > 0){
...
801039fe:	e8 7d 48 00 00       	call   80108280 <switchuvm>
  return 0;
...
80103a20:	e8 ab 4a 00 00       	call   801084d0 <allocuvm>
...
80103a40:	e8 bb 4b 00 00       	call   80108600 <deallocuvm>
...
80103b43:	e8 68 4b 00 00       	call   801086b0 <setupkvm>
...
80103b68:	e8 13 48 00 00       	call   80108380 <inituvm>
...
80103b88:	e8 c3 21 00 00       	call   80105d50 <memset>
...
80103be9:	e8 42 23 00 00       	call   80105f30 <safestrcpy>
  p->cwd = namei("/");
...
80103c04:	e8 57 20 00 00       	call   80105c60 <acquire>
...
80103c53:	e8 a8 20 00 00       	call   80105d00 <release>
}
...
80103c86:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c89:	e8 f2 1e 00 00       	call   80105b80 <pushcli>
  c = mycpu();
80103c8e:	e8 6d fc ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103c93:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
80103c99:	e8 22 1f 00 00       	call   80105bc0 <popcli>
  if((np = allocproc()) == 0){
...
80103cb9:	e8 c2 4a 00 00       	call   80108780 <copyuvm>
...
80103d3e:	e8 ed 21 00 00       	call   80105f30 <safestrcpy>
  pid = np->pid;
80103d43:	8b 5e 10             	mov    0x10(%esi),%ebx
  acquire(&ptable.lock);
80103d46:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103d4d:	e8 0e 1f 00 00       	call   80105c60 <acquire>
  if(np->state == RUNNING)
...
80103dad:	e8 4e 1f 00 00       	call   80105d00 <release>
}
...
80103ea4:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
    acquire(&ptable.lock);
80103ea9:	e8 b2 1d 00 00       	call   80105c60 <acquire>
...
80103ed1:	e8 aa 43 00 00       	call   80108280 <switchuvm>
      swtch(&(c->scheduler), p->context);
...
80103ee7:	e8 9d 20 00 00       	call   80105f89 <swtch>
      switchkvm();
80103eec:	e8 6f 43 00 00       	call   80108260 <switchkvm>
      c->proc = 0;
...
80103f14:	5d                   	pop    %ebp
    release(&ptable.lock);
80103f15:	e9 e6 1d 00 00       	jmp    80105d00 <release>
...
80103f33:	e8 28 1d 00 00       	call   80105c60 <acquire>
    if(!rrq.isEmpty()){
...
80103f53:	e8 28 43 00 00       	call   80108280 <switchuvm>
            swtch(&(c->scheduler), p->context);
...
80103f6c:	e8 18 20 00 00       	call   80105f89 <swtch>
            switchkvm();
80103f71:	e8 ea 42 00 00       	call   80108260 <switchkvm>
            rpholder.remove(p);
...
80103f9c:	5d                   	pop    %ebp
    release(&ptable.lock);
80103f9d:	e9 5e 1d 00 00       	jmp    80105d00 <release>
...
80103fc3:	e8 98 1c 00 00       	call   80105c60 <acquire>
    if(!pq.isEmpty()){
...
80103fe3:	e8 98 42 00 00       	call   80108280 <switchuvm>
        p->state = RUNNING; 
...
8010400e:	e8 76 1f 00 00       	call   80105f89 <swtch>
        switchkvm();
80104013:	e8 48 42 00 00       	call   80108260 <switchkvm>
        c->proc = 0;
...
8010402c:	5d                   	pop    %ebp
    release(&ptable.lock);
8010402d:	e9 ce 1c 00 00       	jmp    80105d00 <release>
...
8010405a:	e8 01 1c 00 00       	call   80105c60 <acquire>
    if(!pq.isEmpty()){
...
80104087:	e8 f4 41 00 00       	call   80108280 <switchuvm>
            np->state = RUNNING;
...
801040b4:	e8 d0 1e 00 00       	call   80105f89 <swtch>
            switchkvm();
801040b9:	e8 a2 41 00 00       	call   80108260 <switchkvm>
            c->proc = 0;
...
801040d1:	5d                   	pop    %ebp
                            release(&ptable.lock);
801040d2:	e9 29 1c 00 00       	jmp    80105d00 <release>
...
8010418a:	e8 f1 40 00 00       	call   80108280 <switchuvm>
            np->state = RUNNING;
...
801042a7:	e8 dd 1c 00 00       	call   80105f89 <swtch>
  mycpu()->intena = intena;
...
801042f6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801042f9:	e8 82 18 00 00       	call   80105b80 <pushcli>
  c = mycpu();
801042fe:	e8 fd f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104303:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104309:	e8 b2 18 00 00       	call   80105bc0 <popcli>
  if(curproc == initproc)
...
80104363:	e8 f8 18 00 00       	call   80105c60 <acquire>
...
8010437a:	e8 81 19 00 00       	call   80105d00 <release>
  acquire(&ptable.lock);
...
8010441e:	e8 3d 18 00 00       	call   80105c60 <acquire>
  pushcli();
80104423:	e8 58 17 00 00       	call   80105b80 <pushcli>
  c = mycpu();
80104428:	e8 d3 f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010442d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104433:	e8 88 17 00 00       	call   80105bc0 <popcli>
  if(p->state == RUNNING){
...
801044b2:	e8 49 18 00 00       	call   80105d00 <release>
}
...
801044e1:	e8 2a 14 00 00       	call   80105910 <__moddi3>
...
80104522:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
80104525:	e8 56 16 00 00       	call   80105b80 <pushcli>
  c = mycpu();
8010452a:	e8 d1 f3 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010452f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104535:	e8 86 16 00 00       	call   80105bc0 <popcli>
  if(p == 0)
...
80104559:	e8 02 17 00 00       	call   80105c60 <acquire>
    release(lk); 
8010455e:	89 34 24             	mov    %esi,(%esp)
80104561:	e8 9a 17 00 00       	call   80105d00 <release>
  if(p->state == RUNNING)
...
80104594:	e8 67 17 00 00       	call   80105d00 <release>
}
...
801045a7:	5d                   	pop    %ebp
    acquire(lk);
801045a8:	e9 b3 16 00 00       	jmp    80105c60 <acquire>
...
801046ab:	e8 80 3f 00 00       	call   80108630 <freevm>
        if(status != null){ 
...
801046e0:	e8 1b 16 00 00       	call   80105d00 <release>
}
...
801046f6:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801046fb:	e8 00 16 00 00       	call   80105d00 <release>
      return -1;
...
80104721:	e8 3a 15 00 00       	call   80105c60 <acquire>
  wakeup1(chan);
...
80104738:	5d                   	pop    %ebp
  release(&ptable.lock);
80104739:	e9 c2 15 00 00       	jmp    80105d00 <release>
...
80104754:	8b 75 08             	mov    0x8(%ebp),%esi
  acquire(&ptable.lock);
80104757:	e8 04 15 00 00       	call   80105c60 <acquire>
...
80104789:	e8 72 15 00 00       	call   80105d00 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801047e7:	e8 14 15 00 00       	call   80105d00 <release>
}
...
80104809:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
8010480c:	e8 6f 13 00 00       	call   80105b80 <pushcli>
  c = mycpu();
80104811:	e8 ea f0 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104816:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
8010481c:	e8 9f 13 00 00       	call   80105bc0 <popcli>
  struct proc *curproc = myproc();
  struct proc *p;
  int procExist = -1;
...
80104830:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
  acquire(&ptable.lock);
80104835:	e8 26 14 00 00       	call   80105c60 <acquire>
  int procExist = -1;
...
80104895:	e8 66 14 00 00       	call   80105d00 <release>
  return procExist;
}
...
801048cc:	89 75 fc             	mov    %esi,-0x4(%ebp)
  pushcli();
801048cf:	e8 ac 12 00 00       	call   80105b80 <pushcli>
  c = mycpu();
801048d4:	e8 27 f0 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801048d9:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801048df:	e8 dc 12 00 00       	call   80105bc0 <popcli>
  struct proc *curproc = myproc();
...
80104917:	e8 44 13 00 00       	call   80105c60 <acquire>
        curproc->priority = proc_priority;
...
80104931:	5d                   	pop    %ebp
        release(&ptable.lock); 
80104932:	e9 c9 13 00 00       	jmp    80105d00 <release>
...
80104954:	8b 75 08             	mov    0x8(%ebp),%esi
    acquire(&ptable.lock);
80104957:	e8 04 13 00 00       	call   80105c60 <acquire>
...
801049cc:	5d                   	pop    %ebp
    release(&ptable.lock);
801049cd:	e9 2e 13 00 00       	jmp    80105d00 <release>
...
80104abc:	e8 6f 10 00 00       	call   80105b30 <getcallerpcs>
...
80104b19:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pushcli();
80104b1c:	e8 5f 10 00 00       	call   80105b80 <pushcli>
  c = mycpu();
80104b21:	e8 da ed ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104b26:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104b2c:	e8 8f 10 00 00       	call   80105bc0 <popcli>
      struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80104b38:	e8 23 11 00 00       	call   80105c60 <acquire>
  for(;;){
...
80104bc3:	e8 68 3a 00 00       	call   80108630 <freevm>
        if(status != null){ 
...
80104c2e:	e8 cd 10 00 00       	call   80105d00 <release>
  }
}
...
80104c44:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104c49:	e8 b2 10 00 00       	call   80105d00 <release>
      return -1;
...
80104c5d:	e8 fe 0f 00 00       	call   80105c60 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c62:	b8 d4 4d 11 80       	mov    $0x80114dd4,%eax
80104c67:	eb 13                	jmp    80104c7c <updatePerformance+0x2c>
80104c69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104c70:	05 a8 00 00 00       	add    $0xa8,%eax
80104c75:	3d d4 77 11 80       	cmp    $0x801177d4,%eax
80104c7a:	73 40                	jae    80104cbc <updatePerformance+0x6c>
    if(p->state == RUNNABLE){
80104c7c:	8b 50 0c             	mov    0xc(%eax),%edx
80104c7f:	83 fa 03             	cmp    $0x3,%edx
80104c82:	75 06                	jne    80104c8a <updatePerformance+0x3a>
      p->performance.retime++;
80104c84:	ff 80 a0 00 00 00    	incl   0xa0(%eax)
    }
    if(p->state == RUNNING){
80104c8a:	8b 50 0c             	mov    0xc(%eax),%edx
80104c8d:	83 fa 04             	cmp    $0x4,%edx
80104c90:	75 06                	jne    80104c98 <updatePerformance+0x48>
      p->performance.rutime++;
80104c92:	ff 80 a4 00 00 00    	incl   0xa4(%eax)
    }
    if(p->state == SLEEPING && p->performance.ttime == 0){
80104c98:	8b 50 0c             	mov    0xc(%eax),%edx
80104c9b:	83 fa 02             	cmp    $0x2,%edx
80104c9e:	75 d0                	jne    80104c70 <updatePerformance+0x20>
80104ca0:	8b 90 98 00 00 00    	mov    0x98(%eax),%edx
80104ca6:	85 d2                	test   %edx,%edx
80104ca8:	75 c6                	jne    80104c70 <updatePerformance+0x20>
      p->performance.stime++;
80104caa:	ff 80 9c 00 00 00    	incl   0x9c(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cb0:	05 a8 00 00 00       	add    $0xa8,%eax
80104cb5:	3d d4 77 11 80       	cmp    $0x801177d4,%eax
80104cba:	72 c0                	jb     80104c7c <updatePerformance+0x2c>
    }
  }
  release(&ptable.lock);
80104cbc:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104cc3:	e8 38 10 00 00       	call   80105d00 <release>
}
80104cc8:	c9                   	leave  
80104cc9:	c3                   	ret    
...
bool Map::isEmpty() {
	return !root;
80104cd0:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
...
80104cdd:	0f 94 c0             	sete   %al
80104ce0:	0f b6 c0             	movzbl %al,%eax
}
80104ce3:	c3                   	ret    
80104ce4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104cea:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80104cf0 <getMinAccumulatorPriorityQueue>:
	return !root;
80104cf0:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
80104cf5:	8b 10                	mov    (%eax),%edx
...
80104cf9:	74 35                	je     80104d30 <getMinAccumulatorPriorityQueue+0x40>
...
80104cff:	eb 09                	jmp    80104d0a <getMinAccumulatorPriorityQueue+0x1a>
80104d01:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	while(minNode->left)
80104d08:	89 c2                	mov    %eax,%edx
80104d0a:	8b 42 18             	mov    0x18(%edx),%eax
80104d0d:	85 c0                	test   %eax,%eax
80104d0f:	75 f7                	jne    80104d08 <getMinAccumulatorPriorityQueue+0x18>
	*pkey = getMinNode()->key;
80104d11:	8b 45 08             	mov    0x8(%ebp),%eax
80104d14:	8b 5a 04             	mov    0x4(%edx),%ebx
80104d17:	8b 0a                	mov    (%edx),%ecx
80104d19:	89 58 04             	mov    %ebx,0x4(%eax)
80104d1c:	89 08                	mov    %ecx,(%eax)
80104d1e:	b8 01 00 00 00       	mov    $0x1,%eax
}
80104d23:	5b                   	pop    %ebx
80104d24:	5d                   	pop    %ebp
80104d25:	c3                   	ret    
...
80104d40 <isEmptyRoundRobinQueue>:
	return !first;
80104d40:	a1 18 c6 10 80       	mov    0x8010c618,%eax
...
80104d60 <enqueueRoundRobinQueue>:
	if(!freeLinks)
80104d60:	a1 10 c6 10 80       	mov    0x8010c610,%eax
80104d65:	85 c0                	test   %eax,%eax
80104d67:	74 47                	je     80104db0 <enqueueRoundRobinQueue+0x50>
static boolean enqueueRoundRobinQueue(Proc *p) {
80104d69:	55                   	push   %ebp
	return roundRobinQ->enqueue(p);
80104d6a:	8b 0d 18 c6 10 80    	mov    0x8010c618,%ecx
	freeLinks = freeLinks->next;
80104d70:	8b 50 04             	mov    0x4(%eax),%edx
static boolean enqueueRoundRobinQueue(Proc *p) {
80104d73:	89 e5                	mov    %esp,%ebp
	ans->next = null;
80104d75:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = freeLinks->next;
80104d7c:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	ans->p = p;
80104d82:	8b 55 08             	mov    0x8(%ebp),%edx
80104d85:	89 10                	mov    %edx,(%eax)
	if(isEmpty()) first = link;
80104d87:	8b 11                	mov    (%ecx),%edx
80104d89:	85 d2                	test   %edx,%edx
80104d8b:	74 2b                	je     80104db8 <enqueueRoundRobinQueue+0x58>
	else last->next = link;
80104d8d:	8b 51 04             	mov    0x4(%ecx),%edx
80104d90:	89 42 04             	mov    %eax,0x4(%edx)
80104d93:	eb 05                	jmp    80104d9a <enqueueRoundRobinQueue+0x3a>
80104d95:	8d 76 00             	lea    0x0(%esi),%esi
	while(ans->next)
80104d98:	89 d0                	mov    %edx,%eax
80104d9a:	8b 50 04             	mov    0x4(%eax),%edx
80104d9d:	85 d2                	test   %edx,%edx
80104d9f:	75 f7                	jne    80104d98 <enqueueRoundRobinQueue+0x38>
	last = link->getLast();
80104da1:	89 41 04             	mov    %eax,0x4(%ecx)
80104da4:	b8 01 00 00 00       	mov    $0x1,%eax
}
80104da9:	5d                   	pop    %ebp
80104daa:	c3                   	ret    
80104dab:	90                   	nop
...
80104db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(isEmpty()) first = link;
80104db8:	89 01                	mov    %eax,(%ecx)
80104dba:	eb de                	jmp    80104d9a <enqueueRoundRobinQueue+0x3a>
80104dbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104dc0 <dequeueRoundRobinQueue>:
	return roundRobinQ->dequeue();
80104dc0:	8b 0d 18 c6 10 80    	mov    0x8010c618,%ecx
	return !first;
80104dc6:	8b 11                	mov    (%ecx),%edx
	if(isEmpty())
80104dc8:	85 d2                	test   %edx,%edx
80104dca:	74 3c                	je     80104e08 <dequeueRoundRobinQueue+0x48>
static Proc* dequeueRoundRobinQueue() {
80104dcc:	55                   	push   %ebp
80104dcd:	89 e5                	mov    %esp,%ebp
80104dcf:	83 ec 08             	sub    $0x8,%esp
80104dd2:	89 75 fc             	mov    %esi,-0x4(%ebp)
	link->next = freeLinks;
80104dd5:	8b 35 10 c6 10 80    	mov    0x8010c610,%esi
static Proc* dequeueRoundRobinQueue() {
80104ddb:	89 5d f8             	mov    %ebx,-0x8(%ebp)
	Link *next = first->next;
80104dde:	8b 5a 04             	mov    0x4(%edx),%ebx
	Proc *p = first->p;
80104de1:	8b 02                	mov    (%edx),%eax
	link->next = freeLinks;
80104de3:	89 72 04             	mov    %esi,0x4(%edx)
	freeLinks = link;
80104de6:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty())
80104dec:	85 db                	test   %ebx,%ebx
	first = next;
80104dee:	89 19                	mov    %ebx,(%ecx)
	if(isEmpty())
80104df0:	75 07                	jne    80104df9 <dequeueRoundRobinQueue+0x39>
		last = null;
80104df2:	c7 41 04 00 00 00 00 	movl   $0x0,0x4(%ecx)
}
80104df9:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80104dfc:	8b 75 fc             	mov    -0x4(%ebp),%esi
80104dff:	89 ec                	mov    %ebp,%esp
80104e01:	5d                   	pop    %ebp
80104e02:	c3                   	ret    
80104e03:	90                   	nop
...
80104e10 <isEmptyRunningProcessHolder>:
	return !first;
80104e10:	a1 14 c6 10 80       	mov    0x8010c614,%eax
...
80104e1d:	0f 94 c0             	sete   %al
80104e20:	0f b6 c0             	movzbl %al,%eax
}
80104e23:	c3                   	ret    
80104e24:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104e2a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80104e30 <addRunningProcessHolder>:
	if(!freeLinks)
80104e30:	a1 10 c6 10 80       	mov    0x8010c610,%eax
80104e35:	85 c0                	test   %eax,%eax
80104e37:	74 47                	je     80104e80 <addRunningProcessHolder+0x50>
static boolean addRunningProcessHolder(Proc* p) {
80104e39:	55                   	push   %ebp
	return runningProcHolder->enqueue(p);
80104e3a:	8b 0d 14 c6 10 80    	mov    0x8010c614,%ecx
	freeLinks = freeLinks->next;
80104e40:	8b 50 04             	mov    0x4(%eax),%edx
static boolean addRunningProcessHolder(Proc* p) {
80104e43:	89 e5                	mov    %esp,%ebp
	ans->next = null;
80104e45:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = freeLinks->next;
80104e4c:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	ans->p = p;
80104e52:	8b 55 08             	mov    0x8(%ebp),%edx
80104e55:	89 10                	mov    %edx,(%eax)
	if(isEmpty()) first = link;
80104e57:	8b 11                	mov    (%ecx),%edx
80104e59:	85 d2                	test   %edx,%edx
80104e5b:	74 2b                	je     80104e88 <addRunningProcessHolder+0x58>
	else last->next = link;
80104e5d:	8b 51 04             	mov    0x4(%ecx),%edx
80104e60:	89 42 04             	mov    %eax,0x4(%edx)
80104e63:	eb 05                	jmp    80104e6a <addRunningProcessHolder+0x3a>
80104e65:	8d 76 00             	lea    0x0(%esi),%esi
	while(ans->next)
80104e68:	89 d0                	mov    %edx,%eax
80104e6a:	8b 50 04             	mov    0x4(%eax),%edx
80104e6d:	85 d2                	test   %edx,%edx
80104e6f:	75 f7                	jne    80104e68 <addRunningProcessHolder+0x38>
	last = link->getLast();
80104e71:	89 41 04             	mov    %eax,0x4(%ecx)
80104e74:	b8 01 00 00 00       	mov    $0x1,%eax
}
80104e79:	5d                   	pop    %ebp
80104e7a:	c3                   	ret    
80104e7b:	90                   	nop
...
80104e84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(isEmpty()) first = link;
80104e88:	89 01                	mov    %eax,(%ecx)
80104e8a:	eb de                	jmp    80104e6a <addRunningProcessHolder+0x3a>
80104e8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104e90 <_ZL9allocNodeP4procx>:
...
80104e94:	53                   	push   %ebx
	if(!freeNodes)
80104e95:	8b 1d 0c c6 10 80    	mov    0x8010c60c,%ebx
80104e9b:	85 db                	test   %ebx,%ebx
80104e9d:	74 4d                	je     80104eec <_ZL9allocNodeP4procx+0x5c>
	ans->key = key;
80104e9f:	89 13                	mov    %edx,(%ebx)
	if(!freeLinks)
80104ea1:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
	freeNodes = freeNodes->next;
80104ea7:	8b 73 10             	mov    0x10(%ebx),%esi
	ans->key = key;
80104eaa:	89 4b 04             	mov    %ecx,0x4(%ebx)
	ans->next = null;
80104ead:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	if(!freeLinks)
80104eb4:	85 d2                	test   %edx,%edx
	freeNodes = freeNodes->next;
80104eb6:	89 35 0c c6 10 80    	mov    %esi,0x8010c60c
	if(!freeLinks)
80104ebc:	74 3f                	je     80104efd <_ZL9allocNodeP4procx+0x6d>
	freeLinks = freeLinks->next;
80104ebe:	8b 4a 04             	mov    0x4(%edx),%ecx
	ans->p = p;
80104ec1:	89 02                	mov    %eax,(%edx)
	ans->next = null;
80104ec3:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
	if(isEmpty()) first = link;
80104eca:	8b 43 08             	mov    0x8(%ebx),%eax
	freeLinks = freeLinks->next;
80104ecd:	89 0d 10 c6 10 80    	mov    %ecx,0x8010c610
	if(isEmpty()) first = link;
80104ed3:	85 c0                	test   %eax,%eax
80104ed5:	74 21                	je     80104ef8 <_ZL9allocNodeP4procx+0x68>
	else last->next = link;
80104ed7:	8b 43 0c             	mov    0xc(%ebx),%eax
80104eda:	89 50 04             	mov    %edx,0x4(%eax)
80104edd:	eb 03                	jmp    80104ee2 <_ZL9allocNodeP4procx+0x52>
80104edf:	90                   	nop
	while(ans->next)
80104ee0:	89 ca                	mov    %ecx,%edx
80104ee2:	8b 4a 04             	mov    0x4(%edx),%ecx
80104ee5:	85 c9                	test   %ecx,%ecx
80104ee7:	75 f7                	jne    80104ee0 <_ZL9allocNodeP4procx+0x50>
	last = link->getLast();
80104ee9:	89 53 0c             	mov    %edx,0xc(%ebx)
}
...
80104ef2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	if(isEmpty()) first = link;
80104ef8:	89 53 08             	mov    %edx,0x8(%ebx)
80104efb:	eb e5                	jmp    80104ee2 <_ZL9allocNodeP4procx+0x52>
	node->parent = node->left = node->right = null;
80104efd:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
80104f04:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
80104f0b:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
	node->next = freeNodes;
80104f12:	89 73 10             	mov    %esi,0x10(%ebx)
	freeNodes = node;
80104f15:	89 1d 0c c6 10 80    	mov    %ebx,0x8010c60c
		return null;
80104f1b:	31 db                	xor    %ebx,%ebx
80104f1d:	eb cd                	jmp    80104eec <_ZL9allocNodeP4procx+0x5c>
80104f1f:	90                   	nop

80104f20 <_ZL8mymallocj>:
static char* mymalloc(uint size) {
80104f20:	55                   	push   %ebp
80104f21:	89 e5                	mov    %esp,%ebp
80104f23:	53                   	push   %ebx
80104f24:	89 c3                	mov    %eax,%ebx
80104f26:	83 ec 14             	sub    $0x14,%esp
	if(spaceLeft < size) {
80104f29:	8b 15 04 c6 10 80    	mov    0x8010c604,%edx
80104f2f:	39 c2                	cmp    %eax,%edx
80104f31:	73 26                	jae    80104f59 <_ZL8mymallocj+0x39>
		data = kalloc();
80104f33:	e8 78 d6 ff ff       	call   801025b0 <kalloc>
		memset(data, 0, PGSIZE);
80104f38:	ba 00 10 00 00       	mov    $0x1000,%edx
80104f3d:	31 c9                	xor    %ecx,%ecx
80104f3f:	89 54 24 08          	mov    %edx,0x8(%esp)
80104f43:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104f47:	89 04 24             	mov    %eax,(%esp)
		data = kalloc();
80104f4a:	a3 08 c6 10 80       	mov    %eax,0x8010c608
		memset(data, 0, PGSIZE);
80104f4f:	e8 fc 0d 00 00       	call   80105d50 <memset>
80104f54:	ba 00 10 00 00       	mov    $0x1000,%edx
	char* ans = data;
80104f59:	a1 08 c6 10 80       	mov    0x8010c608,%eax
	spaceLeft -= size;
80104f5e:	29 da                	sub    %ebx,%edx
80104f60:	89 15 04 c6 10 80    	mov    %edx,0x8010c604
	data += size;
80104f66:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
80104f69:	89 0d 08 c6 10 80    	mov    %ecx,0x8010c608
}
80104f6f:	83 c4 14             	add    $0x14,%esp
80104f72:	5b                   	pop    %ebx
80104f73:	5d                   	pop    %ebp
80104f74:	c3                   	ret    
...
80104f85:	53                   	push   %ebx
	freeLinks = null;
80104f86:	bb 80 00 00 00       	mov    $0x80,%ebx
void initSchedDS() { //called once by the "pioneer" cpu from the main function in main.c
80104f8b:	83 ec 04             	sub    $0x4,%esp
	data               = null;
80104f8e:	a3 08 c6 10 80       	mov    %eax,0x8010c608
	spaceLeft          = 0u;
80104f93:	31 c0                	xor    %eax,%eax
80104f95:	a3 04 c6 10 80       	mov    %eax,0x8010c604
	priorityQ          = (Map*)mymalloc(sizeof(Map));
80104f9a:	b8 04 00 00 00       	mov    $0x4,%eax
80104f9f:	e8 7c ff ff ff       	call   80104f20 <_ZL8mymallocj>
80104fa4:	a3 1c c6 10 80       	mov    %eax,0x8010c61c
	*priorityQ         = Map();
80104fa9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	roundRobinQ        = (LinkedList*)mymalloc(sizeof(LinkedList));
80104faf:	b8 08 00 00 00       	mov    $0x8,%eax
80104fb4:	e8 67 ff ff ff       	call   80104f20 <_ZL8mymallocj>
80104fb9:	a3 18 c6 10 80       	mov    %eax,0x8010c618
	*roundRobinQ       = LinkedList();
80104fbe:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80104fc4:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	runningProcHolder  = (LinkedList*)mymalloc(sizeof(LinkedList));
80104fcb:	b8 08 00 00 00       	mov    $0x8,%eax
80104fd0:	e8 4b ff ff ff       	call   80104f20 <_ZL8mymallocj>
80104fd5:	a3 14 c6 10 80       	mov    %eax,0x8010c614
	*runningProcHolder = LinkedList();
80104fda:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80104fe0:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = null;
80104fe7:	31 c0                	xor    %eax,%eax
80104fe9:	a3 10 c6 10 80       	mov    %eax,0x8010c610
80104fee:	66 90                	xchg   %ax,%ax
		Link *link = (Link*)mymalloc(sizeof(Link));
80104ff0:	b8 08 00 00 00       	mov    $0x8,%eax
80104ff5:	e8 26 ff ff ff       	call   80104f20 <_ZL8mymallocj>
		link->next = freeLinks;
80104ffa:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
	for(int i = 0; i < NPROCLIST; ++i) {
80105000:	4b                   	dec    %ebx
		*link = Link();
80105001:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		link->next = freeLinks;
80105007:	89 50 04             	mov    %edx,0x4(%eax)
		freeLinks = link;
8010500a:	a3 10 c6 10 80       	mov    %eax,0x8010c610
	for(int i = 0; i < NPROCLIST; ++i) {
8010500f:	75 df                	jne    80104ff0 <initSchedDS+0x70>
	freeNodes = null;
80105011:	31 c0                	xor    %eax,%eax
80105013:	bb 80 00 00 00       	mov    $0x80,%ebx
80105018:	a3 0c c6 10 80       	mov    %eax,0x8010c60c
8010501d:	8d 76 00             	lea    0x0(%esi),%esi
		MapNode *node = (MapNode*)mymalloc(sizeof(MapNode));
80105020:	b8 20 00 00 00       	mov    $0x20,%eax
80105025:	e8 f6 fe ff ff       	call   80104f20 <_ZL8mymallocj>
		node->next = freeNodes;
8010502a:	8b 15 0c c6 10 80    	mov    0x8010c60c,%edx
	for(int i = 0; i < NPROCMAP; ++i) {
80105030:	4b                   	dec    %ebx
		*node = MapNode();
80105031:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
80105038:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
8010503f:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
80105046:	c7 40 18 00 00 00 00 	movl   $0x0,0x18(%eax)
8010504d:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
		node->next = freeNodes;
80105054:	89 50 10             	mov    %edx,0x10(%eax)
		freeNodes = node;
80105057:	a3 0c c6 10 80       	mov    %eax,0x8010c60c
	for(int i = 0; i < NPROCMAP; ++i) {
8010505c:	75 c2                	jne    80105020 <initSchedDS+0xa0>
	pq.isEmpty                      = isEmptyPriorityQueue;
8010505e:	b8 d0 4c 10 80       	mov    $0x80104cd0,%eax
	pq.put                          = putPriorityQueue;
80105063:	ba 50 56 10 80       	mov    $0x80105650,%edx
	pq.isEmpty                      = isEmptyPriorityQueue;
80105068:	a3 ec c5 10 80       	mov    %eax,0x8010c5ec
	pq.switchToRoundRobinPolicy     = switchToRoundRobinPolicyPriorityQueue;
8010506d:	b8 10 58 10 80       	mov    $0x80105810,%eax
	pq.getMinAccumulator            = getMinAccumulatorPriorityQueue;
80105072:	b9 f0 4c 10 80       	mov    $0x80104cf0,%ecx
	pq.switchToRoundRobinPolicy     = switchToRoundRobinPolicyPriorityQueue;
80105077:	a3 fc c5 10 80       	mov    %eax,0x8010c5fc
	pq.extractProc                  = extractProcPriorityQueue;
8010507c:	b8 f0 58 10 80       	mov    $0x801058f0,%eax
	pq.extractMin                   = extractMinPriorityQueue;
80105081:	bb 70 57 10 80       	mov    $0x80105770,%ebx
	pq.extractProc                  = extractProcPriorityQueue;
80105086:	a3 00 c6 10 80       	mov    %eax,0x8010c600
	rrq.isEmpty                     = isEmptyRoundRobinQueue;
8010508b:	b8 40 4d 10 80       	mov    $0x80104d40,%eax
80105090:	a3 dc c5 10 80       	mov    %eax,0x8010c5dc
	rrq.enqueue                     = enqueueRoundRobinQueue;
80105095:	b8 60 4d 10 80       	mov    $0x80104d60,%eax
8010509a:	a3 e0 c5 10 80       	mov    %eax,0x8010c5e0
	rrq.dequeue                     = dequeueRoundRobinQueue;
8010509f:	b8 c0 4d 10 80       	mov    $0x80104dc0,%eax
801050a4:	a3 e4 c5 10 80       	mov    %eax,0x8010c5e4
	rrq.switchToPriorityQueuePolicy = switchToPriorityQueuePolicyRoundRobinQueue;
801050a9:	b8 80 53 10 80       	mov    $0x80105380,%eax
	pq.put                          = putPriorityQueue;
801050ae:	89 15 f0 c5 10 80    	mov    %edx,0x8010c5f0
	rpholder.isEmpty                = isEmptyRunningProcessHolder;
801050b4:	ba 10 4e 10 80       	mov    $0x80104e10,%edx
	pq.getMinAccumulator            = getMinAccumulatorPriorityQueue;
801050b9:	89 0d f4 c5 10 80    	mov    %ecx,0x8010c5f4
	rpholder.add                    = addRunningProcessHolder;
801050bf:	b9 30 4e 10 80       	mov    $0x80104e30,%ecx
	pq.extractMin                   = extractMinPriorityQueue;
801050c4:	89 1d f8 c5 10 80    	mov    %ebx,0x8010c5f8
	rpholder.remove                 = removeRunningProcessHolder;
801050ca:	bb e0 52 10 80       	mov    $0x801052e0,%ebx
	rrq.switchToPriorityQueuePolicy = switchToPriorityQueuePolicyRoundRobinQueue;
801050cf:	a3 e8 c5 10 80       	mov    %eax,0x8010c5e8
	rpholder.getMinAccumulator      = getMinAccumulatorRunningProcessHolder;
801050d4:	b8 10 54 10 80       	mov    $0x80105410,%eax
	rpholder.remove                 = removeRunningProcessHolder;
801050d9:	89 1d d4 c5 10 80    	mov    %ebx,0x8010c5d4
	rpholder.isEmpty                = isEmptyRunningProcessHolder;
801050df:	89 15 cc c5 10 80    	mov    %edx,0x8010c5cc
	rpholder.add                    = addRunningProcessHolder;
801050e5:	89 0d d0 c5 10 80    	mov    %ecx,0x8010c5d0
	rpholder.getMinAccumulator      = getMinAccumulatorRunningProcessHolder;
801050eb:	a3 d8 c5 10 80       	mov    %eax,0x8010c5d8
}
801050f0:	58                   	pop    %eax
801050f1:	5b                   	pop    %ebx
801050f2:	5d                   	pop    %ebp
...
80105100 <_ZN4Link7getLastEv>:
Link* Link::getLast() {
80105100:	55                   	push   %ebp
80105101:	89 e5                	mov    %esp,%ebp
80105103:	8b 45 08             	mov    0x8(%ebp),%eax
80105106:	eb 0a                	jmp    80105112 <_ZN4Link7getLastEv+0x12>
80105108:	90                   	nop
80105109:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105110:	89 d0                	mov    %edx,%eax
	while(ans->next)
80105112:	8b 50 04             	mov    0x4(%eax),%edx
80105115:	85 d2                	test   %edx,%edx
80105117:	75 f7                	jne    80105110 <_ZN4Link7getLastEv+0x10>
}
80105119:	5d                   	pop    %ebp
8010511a:	c3                   	ret    
8010511b:	90                   	nop
...
80105120 <_ZN10LinkedList7isEmptyEv>:
...
8010512b:	0f 94 c0             	sete   %al
}
8010512e:	c3                   	ret    
8010512f:	90                   	nop

80105130 <_ZN10LinkedList6appendEP4Link>:
...
8010513b:	74 1f                	je     8010515c <_ZN10LinkedList6appendEP4Link+0x2c>
	if(isEmpty()) first = link;
8010513d:	8b 01                	mov    (%ecx),%eax
8010513f:	85 c0                	test   %eax,%eax
80105141:	74 1d                	je     80105160 <_ZN10LinkedList6appendEP4Link+0x30>
	else last->next = link;
80105143:	8b 41 04             	mov    0x4(%ecx),%eax
80105146:	89 50 04             	mov    %edx,0x4(%eax)
80105149:	eb 07                	jmp    80105152 <_ZN10LinkedList6appendEP4Link+0x22>
8010514b:	90                   	nop
8010514c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	while(ans->next)
80105150:	89 c2                	mov    %eax,%edx
80105152:	8b 42 04             	mov    0x4(%edx),%eax
80105155:	85 c0                	test   %eax,%eax
80105157:	75 f7                	jne    80105150 <_ZN10LinkedList6appendEP4Link+0x20>
	last = link->getLast();
80105159:	89 51 04             	mov    %edx,0x4(%ecx)
}
8010515c:	5d                   	pop    %ebp
8010515d:	c3                   	ret    
8010515e:	66 90                	xchg   %ax,%ax
	if(isEmpty()) first = link;
80105160:	89 11                	mov    %edx,(%ecx)
80105162:	eb ee                	jmp    80105152 <_ZN10LinkedList6appendEP4Link+0x22>
80105164:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010516a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105170 <_ZN10LinkedList7enqueueEP4proc>:
	if(!freeLinks)
80105170:	a1 10 c6 10 80       	mov    0x8010c610,%eax
bool LinkedList::enqueue(Proc *p) {
80105175:	55                   	push   %ebp
80105176:	89 e5                	mov    %esp,%ebp
80105178:	8b 4d 08             	mov    0x8(%ebp),%ecx
	if(!freeLinks)
8010517b:	85 c0                	test   %eax,%eax
8010517d:	74 41                	je     801051c0 <_ZN10LinkedList7enqueueEP4proc+0x50>
	freeLinks = freeLinks->next;
8010517f:	8b 50 04             	mov    0x4(%eax),%edx
	ans->next = null;
80105182:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = freeLinks->next;
80105189:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	ans->p = p;
8010518f:	8b 55 0c             	mov    0xc(%ebp),%edx
80105192:	89 10                	mov    %edx,(%eax)
	if(isEmpty()) first = link;
80105194:	8b 11                	mov    (%ecx),%edx
80105196:	85 d2                	test   %edx,%edx
80105198:	74 2e                	je     801051c8 <_ZN10LinkedList7enqueueEP4proc+0x58>
	else last->next = link;
8010519a:	8b 51 04             	mov    0x4(%ecx),%edx
8010519d:	89 42 04             	mov    %eax,0x4(%edx)
801051a0:	eb 08                	jmp    801051aa <_ZN10LinkedList7enqueueEP4proc+0x3a>
801051a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	while(ans->next)
801051a8:	89 d0                	mov    %edx,%eax
801051aa:	8b 50 04             	mov    0x4(%eax),%edx
801051ad:	85 d2                	test   %edx,%edx
801051af:	75 f7                	jne    801051a8 <_ZN10LinkedList7enqueueEP4proc+0x38>
	last = link->getLast();
801051b1:	89 41 04             	mov    %eax,0x4(%ecx)
	return true;
801051b4:	b0 01                	mov    $0x1,%al
}
801051b6:	5d                   	pop    %ebp
801051b7:	c3                   	ret    
801051b8:	90                   	nop
...
801051c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(isEmpty()) first = link;
801051c8:	89 01                	mov    %eax,(%ecx)
801051ca:	eb de                	jmp    801051aa <_ZN10LinkedList7enqueueEP4proc+0x3a>
801051cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801051d0 <_ZN10LinkedList7dequeueEv>:
Proc* LinkedList::dequeue() {
801051d0:	55                   	push   %ebp
801051d1:	89 e5                	mov    %esp,%ebp
801051d3:	83 ec 08             	sub    $0x8,%esp
801051d6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801051d9:	89 5d f8             	mov    %ebx,-0x8(%ebp)
801051dc:	89 75 fc             	mov    %esi,-0x4(%ebp)
	return !first;
801051df:	8b 11                	mov    (%ecx),%edx
	if(isEmpty())
801051e1:	85 d2                	test   %edx,%edx
801051e3:	74 2b                	je     80105210 <_ZN10LinkedList7dequeueEv+0x40>
	Link *next = first->next;
801051e5:	8b 5a 04             	mov    0x4(%edx),%ebx
	link->next = freeLinks;
801051e8:	8b 35 10 c6 10 80    	mov    0x8010c610,%esi
	Proc *p = first->p;
801051ee:	8b 02                	mov    (%edx),%eax
	freeLinks = link;
801051f0:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty())
801051f6:	85 db                	test   %ebx,%ebx
	link->next = freeLinks;
801051f8:	89 72 04             	mov    %esi,0x4(%edx)
	first = next;
801051fb:	89 19                	mov    %ebx,(%ecx)
	if(isEmpty())
801051fd:	75 07                	jne    80105206 <_ZN10LinkedList7dequeueEv+0x36>
		last = null;
801051ff:	c7 41 04 00 00 00 00 	movl   $0x0,0x4(%ecx)
}
80105206:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105209:	8b 75 fc             	mov    -0x4(%ebp),%esi
8010520c:	89 ec                	mov    %ebp,%esp
8010520e:	5d                   	pop    %ebp
8010520f:	c3                   	ret    
		return null;
80105210:	31 c0                	xor    %eax,%eax
80105212:	eb f2                	jmp    80105206 <_ZN10LinkedList7dequeueEv+0x36>
80105214:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010521a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105220 <_ZN10LinkedList6removeEP4proc>:
bool LinkedList::remove(Proc *p) {
80105220:	55                   	push   %ebp
80105221:	89 e5                	mov    %esp,%ebp
80105223:	56                   	push   %esi
80105224:	8b 75 08             	mov    0x8(%ebp),%esi
80105227:	53                   	push   %ebx
80105228:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	return !first;
8010522b:	8b 1e                	mov    (%esi),%ebx
	if(isEmpty())
8010522d:	85 db                	test   %ebx,%ebx
8010522f:	74 2f                	je     80105260 <_ZN10LinkedList6removeEP4proc+0x40>
	if(first->p == p) {
80105231:	39 0b                	cmp    %ecx,(%ebx)
80105233:	8b 53 04             	mov    0x4(%ebx),%edx
80105236:	74 70                	je     801052a8 <_ZN10LinkedList6removeEP4proc+0x88>
	while(cur) {
80105238:	85 d2                	test   %edx,%edx
8010523a:	74 24                	je     80105260 <_ZN10LinkedList6removeEP4proc+0x40>
		if(cur->p == p) {
8010523c:	3b 0a                	cmp    (%edx),%ecx
8010523e:	66 90                	xchg   %ax,%ax
80105240:	75 0c                	jne    8010524e <_ZN10LinkedList6removeEP4proc+0x2e>
80105242:	eb 2c                	jmp    80105270 <_ZN10LinkedList6removeEP4proc+0x50>
80105244:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105248:	39 08                	cmp    %ecx,(%eax)
8010524a:	74 34                	je     80105280 <_ZN10LinkedList6removeEP4proc+0x60>
8010524c:	89 c2                	mov    %eax,%edx
		cur = cur->next;
8010524e:	8b 42 04             	mov    0x4(%edx),%eax
	while(cur) {
80105251:	85 c0                	test   %eax,%eax
80105253:	75 f3                	jne    80105248 <_ZN10LinkedList6removeEP4proc+0x28>
}
80105255:	5b                   	pop    %ebx
80105256:	5e                   	pop    %esi
80105257:	5d                   	pop    %ebp
...
80105272:	89 da                	mov    %ebx,%edx
80105274:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010527a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
			prev->next = cur->next;
80105280:	8b 48 04             	mov    0x4(%eax),%ecx
80105283:	89 4a 04             	mov    %ecx,0x4(%edx)
			if(!(cur->next)) //removes the last link
80105286:	8b 48 04             	mov    0x4(%eax),%ecx
80105289:	85 c9                	test   %ecx,%ecx
8010528b:	74 43                	je     801052d0 <_ZN10LinkedList6removeEP4proc+0xb0>
	link->next = freeLinks;
8010528d:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
	freeLinks = link;
80105293:	a3 10 c6 10 80       	mov    %eax,0x8010c610
	link->next = freeLinks;
80105298:	89 50 04             	mov    %edx,0x4(%eax)
			return true;
8010529b:	b0 01                	mov    $0x1,%al
}
8010529d:	5b                   	pop    %ebx
8010529e:	5e                   	pop    %esi
8010529f:	5d                   	pop    %ebp
...
801052a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	link->next = freeLinks;
801052a8:	a1 10 c6 10 80       	mov    0x8010c610,%eax
	if(isEmpty())
801052ad:	85 d2                	test   %edx,%edx
	freeLinks = link;
801052af:	89 1d 10 c6 10 80    	mov    %ebx,0x8010c610
	link->next = freeLinks;
801052b5:	89 43 04             	mov    %eax,0x4(%ebx)
		return true;
801052b8:	b0 01                	mov    $0x1,%al
	first = next;
801052ba:	89 16                	mov    %edx,(%esi)
	if(isEmpty())
801052bc:	75 97                	jne    80105255 <_ZN10LinkedList6removeEP4proc+0x35>
		last = null;
801052be:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
801052c5:	eb 8e                	jmp    80105255 <_ZN10LinkedList6removeEP4proc+0x35>
801052c7:	89 f6                	mov    %esi,%esi
801052c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
				last = prev;
801052d0:	89 56 04             	mov    %edx,0x4(%esi)
801052d3:	eb b8                	jmp    8010528d <_ZN10LinkedList6removeEP4proc+0x6d>
801052d5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801052d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801052e0 <removeRunningProcessHolder>:
...
801052ed:	a1 14 c6 10 80       	mov    0x8010c614,%eax
801052f2:	89 04 24             	mov    %eax,(%esp)
801052f5:	e8 26 ff ff ff       	call   80105220 <_ZN10LinkedList6removeEP4proc>
}
801052fa:	c9                   	leave  
	return runningProcHolder->remove(p);
...
80105300 <_ZN10LinkedList8transferEv>:
	if(!priorityQ->isEmpty())
80105300:	8b 15 1c c6 10 80    	mov    0x8010c61c,%edx
		return false;
80105306:	31 c0                	xor    %eax,%eax
...
8010530c:	8b 4d 08             	mov    0x8(%ebp),%ecx
	if(!priorityQ->isEmpty())
8010530f:	8b 1a                	mov    (%edx),%ebx
80105311:	85 db                	test   %ebx,%ebx
80105313:	74 0b                	je     80105320 <_ZN10LinkedList8transferEv+0x20>
}
80105315:	5b                   	pop    %ebx
80105316:	5d                   	pop    %ebp
80105317:	c3                   	ret    
...
80105319:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	if(!isEmpty()) {
80105320:	8b 19                	mov    (%ecx),%ebx
80105322:	85 db                	test   %ebx,%ebx
80105324:	74 4a                	je     80105370 <_ZN10LinkedList8transferEv+0x70>
	if(!freeNodes)
80105326:	8b 1d 0c c6 10 80    	mov    0x8010c60c,%ebx
8010532c:	85 db                	test   %ebx,%ebx
8010532e:	74 e5                	je     80105315 <_ZN10LinkedList8transferEv+0x15>
	freeNodes = freeNodes->next;
80105330:	8b 43 10             	mov    0x10(%ebx),%eax
	ans->key = key;
80105333:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	ans->next = null;
80105339:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	ans->key = key;
80105340:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	freeNodes = freeNodes->next;
80105347:	a3 0c c6 10 80       	mov    %eax,0x8010c60c
		node->listOfProcs.first = first;
8010534c:	8b 01                	mov    (%ecx),%eax
8010534e:	89 43 08             	mov    %eax,0x8(%ebx)
		node->listOfProcs.last = last;
80105351:	8b 41 04             	mov    0x4(%ecx),%eax
80105354:	89 43 0c             	mov    %eax,0xc(%ebx)
	return true;
80105357:	b0 01                	mov    $0x1,%al
		first = last = null;
80105359:	c7 41 04 00 00 00 00 	movl   $0x0,0x4(%ecx)
80105360:	c7 01 00 00 00 00    	movl   $0x0,(%ecx)
		priorityQ->root = node;
80105366:	89 1a                	mov    %ebx,(%edx)
}
80105368:	5b                   	pop    %ebx
80105369:	5d                   	pop    %ebp
8010536a:	c3                   	ret    
...
8010536c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	return true;
80105370:	b0 01                	mov    $0x1,%al
80105372:	eb a1                	jmp    80105315 <_ZN10LinkedList8transferEv+0x15>
80105374:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010537a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105380 <switchToPriorityQueuePolicyRoundRobinQueue>:
...
80105386:	a1 18 c6 10 80       	mov    0x8010c618,%eax
8010538b:	89 04 24             	mov    %eax,(%esp)
8010538e:	e8 6d ff ff ff       	call   80105300 <_ZN10LinkedList8transferEv>
}
80105393:	c9                   	leave  
	return roundRobinQ->transfer();
80105394:	0f b6 c0             	movzbl %al,%eax
}
80105397:	c3                   	ret    
80105398:	90                   	nop
80105399:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801053a0 <_ZN10LinkedList9getMinKeyEPx>:
...
801053a8:	83 ec 1c             	sub    $0x1c,%esp
801053ab:	8b 7d 08             	mov    0x8(%ebp),%edi
	return !first;
801053ae:	8b 17                	mov    (%edi),%edx
	if(isEmpty())
801053b0:	85 d2                	test   %edx,%edx
801053b2:	74 41                	je     801053f5 <_ZN10LinkedList9getMinKeyEPx+0x55>
	long long minKey = getAccumulator(first->p);
801053b4:	8b 02                	mov    (%edx),%eax
801053b6:	89 04 24             	mov    %eax,(%esp)
801053b9:	e8 02 e5 ff ff       	call   801038c0 <getAccumulator>
	forEach([&](Proc *p) {
801053be:	8b 3f                	mov    (%edi),%edi
	...
	void forEach(const Func& accept) { //for-each loop. gets a function that applies the procin each link node.
		Link *link = first;
		while(link) {
801053c0:	85 ff                	test   %edi,%edi
	long long minKey = getAccumulator(first->p);
801053c2:	89 c6                	mov    %eax,%esi
801053c4:	89 d3                	mov    %edx,%ebx
801053c6:	74 23                	je     801053eb <_ZN10LinkedList9getMinKeyEPx+0x4b>
801053c8:	90                   	nop
801053c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		long long key = getAccumulator(p);
801053d0:	8b 07                	mov    (%edi),%eax
801053d2:	89 04 24             	mov    %eax,(%esp)
801053d5:	e8 e6 e4 ff ff       	call   801038c0 <getAccumulator>
801053da:	39 d3                	cmp    %edx,%ebx
801053dc:	7c 06                	jl     801053e4 <_ZN10LinkedList9getMinKeyEPx+0x44>
801053de:	7f 20                	jg     80105400 <_ZN10LinkedList9getMinKeyEPx+0x60>
801053e0:	39 c6                	cmp    %eax,%esi
801053e2:	77 1c                	ja     80105400 <_ZN10LinkedList9getMinKeyEPx+0x60>
			accept(link->p);
			link = link->next;
801053e4:	8b 7f 04             	mov    0x4(%edi),%edi
		while(link) {
801053e7:	85 ff                	test   %edi,%edi
801053e9:	75 e5                	jne    801053d0 <_ZN10LinkedList9getMinKeyEPx+0x30>
	*pkey = minKey;
801053eb:	8b 45 0c             	mov    0xc(%ebp),%eax
801053ee:	89 30                	mov    %esi,(%eax)
801053f0:	89 58 04             	mov    %ebx,0x4(%eax)
	return true;
801053f3:	b0 01                	mov    $0x1,%al
}
801053f5:	83 c4 1c             	add    $0x1c,%esp
801053f8:	5b                   	pop    %ebx
801053f9:	5e                   	pop    %esi
801053fa:	5f                   	pop    %edi
801053fb:	5d                   	pop    %ebp
...
801053fd:	8d 76 00             	lea    0x0(%esi),%esi
			link = link->next;
80105400:	8b 7f 04             	mov    0x4(%edi),%edi
80105403:	89 c6                	mov    %eax,%esi
80105405:	89 d3                	mov    %edx,%ebx
		while(link) {
80105407:	85 ff                	test   %edi,%edi
80105409:	75 c5                	jne    801053d0 <_ZN10LinkedList9getMinKeyEPx+0x30>
8010540b:	eb de                	jmp    801053eb <_ZN10LinkedList9getMinKeyEPx+0x4b>
8010540d:	8d 76 00             	lea    0x0(%esi),%esi

80105410 <getMinAccumulatorRunningProcessHolder>:
...
8010541d:	a1 14 c6 10 80       	mov    0x8010c614,%eax
80105422:	89 04 24             	mov    %eax,(%esp)
80105425:	e8 76 ff ff ff       	call   801053a0 <_ZN10LinkedList9getMinKeyEPx>
}
8010542a:	c9                   	leave  
	return runningProcHolder->getMinKey(pkey);
...
80105430 <_ZN7MapNode7isEmptyEv>:
...
80105436:	5d                   	pop    %ebp
	return !first;
80105437:	8b 40 08             	mov    0x8(%eax),%eax
8010543a:	85 c0                	test   %eax,%eax
8010543c:	0f 94 c0             	sete   %al
}
8010543f:	c3                   	ret    

80105440 <_ZN7MapNode3putEP4proc>:
...
80105446:	83 ec 2c             	sub    $0x2c,%esp
	long long key = getAccumulator(p);
80105449:	8b 45 0c             	mov    0xc(%ebp),%eax
bool MapNode::put(Proc *p) { //we can not use recursion, since the stack of xv6 is too small....
8010544c:	8b 5d 08             	mov    0x8(%ebp),%ebx
	long long key = getAccumulator(p);
8010544f:	89 04 24             	mov    %eax,(%esp)
80105452:	e8 69 e4 ff ff       	call   801038c0 <getAccumulator>
80105457:	89 d1                	mov    %edx,%ecx
80105459:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010545c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		if(key == node->key)
80105460:	8b 13                	mov    (%ebx),%edx
80105462:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80105465:	8b 43 04             	mov    0x4(%ebx),%eax
80105468:	31 d7                	xor    %edx,%edi
8010546a:	89 fe                	mov    %edi,%esi
8010546c:	89 c7                	mov    %eax,%edi
8010546e:	31 cf                	xor    %ecx,%edi
80105470:	09 fe                	or     %edi,%esi
80105472:	74 4c                	je     801054c0 <_ZN7MapNode3putEP4proc+0x80>
		else if(key < node->key) { //left
80105474:	39 c8                	cmp    %ecx,%eax
80105476:	7c 20                	jl     80105498 <_ZN7MapNode3putEP4proc+0x58>
80105478:	7f 08                	jg     80105482 <_ZN7MapNode3putEP4proc+0x42>
8010547a:	3b 55 e4             	cmp    -0x1c(%ebp),%edx
8010547d:	8d 76 00             	lea    0x0(%esi),%esi
80105480:	76 16                	jbe    80105498 <_ZN7MapNode3putEP4proc+0x58>
			if(node->left)
80105482:	8b 43 18             	mov    0x18(%ebx),%eax
80105485:	85 c0                	test   %eax,%eax
80105487:	0f 84 83 00 00 00    	je     80105510 <_ZN7MapNode3putEP4proc+0xd0>
bool MapNode::put(Proc *p) { //we can not use recursion, since the stack of xv6 is too small....
8010548d:	89 c3                	mov    %eax,%ebx
8010548f:	eb cf                	jmp    80105460 <_ZN7MapNode3putEP4proc+0x20>
80105491:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			if(node->right)
80105498:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010549b:	85 c0                	test   %eax,%eax
8010549d:	75 ee                	jne    8010548d <_ZN7MapNode3putEP4proc+0x4d>
8010549f:	8b 75 e4             	mov    -0x1c(%ebp),%esi
				node->right = allocNode(p, key);
801054a2:	8b 45 0c             	mov    0xc(%ebp),%eax
801054a5:	89 f2                	mov    %esi,%edx
801054a7:	e8 e4 f9 ff ff       	call   80104e90 <_ZL9allocNodeP4procx>
				if(node->right) {
801054ac:	85 c0                	test   %eax,%eax
				node->right = allocNode(p, key);
801054ae:	89 43 1c             	mov    %eax,0x1c(%ebx)
				if(node->right) {
801054b1:	74 71                	je     80105524 <_ZN7MapNode3putEP4proc+0xe4>
					node->right->parent = node;
801054b3:	89 58 14             	mov    %ebx,0x14(%eax)
}
801054b6:	83 c4 2c             	add    $0x2c,%esp
					return true;
801054b9:	b0 01                	mov    $0x1,%al
}
801054bb:	5b                   	pop    %ebx
801054bc:	5e                   	pop    %esi
801054bd:	5f                   	pop    %edi
...
801054bf:	c3                   	ret    
	if(!freeLinks)
801054c0:	a1 10 c6 10 80       	mov    0x8010c610,%eax
801054c5:	85 c0                	test   %eax,%eax
801054c7:	74 5b                	je     80105524 <_ZN7MapNode3putEP4proc+0xe4>
	ans->p = p;
801054c9:	8b 75 0c             	mov    0xc(%ebp),%esi
	freeLinks = freeLinks->next;
801054cc:	8b 50 04             	mov    0x4(%eax),%edx
	ans->next = null;
801054cf:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	ans->p = p;
801054d6:	89 30                	mov    %esi,(%eax)
	freeLinks = freeLinks->next;
801054d8:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty()) first = link;
801054de:	8b 53 08             	mov    0x8(%ebx),%edx
801054e1:	85 d2                	test   %edx,%edx
801054e3:	74 4b                	je     80105530 <_ZN7MapNode3putEP4proc+0xf0>
	else last->next = link;
801054e5:	8b 53 0c             	mov    0xc(%ebx),%edx
801054e8:	89 42 04             	mov    %eax,0x4(%edx)
801054eb:	eb 05                	jmp    801054f2 <_ZN7MapNode3putEP4proc+0xb2>
801054ed:	8d 76 00             	lea    0x0(%esi),%esi
	while(ans->next)
801054f0:	89 d0                	mov    %edx,%eax
801054f2:	8b 50 04             	mov    0x4(%eax),%edx
801054f5:	85 d2                	test   %edx,%edx
801054f7:	75 f7                	jne    801054f0 <_ZN7MapNode3putEP4proc+0xb0>
	last = link->getLast();
801054f9:	89 43 0c             	mov    %eax,0xc(%ebx)
}
801054fc:	83 c4 2c             	add    $0x2c,%esp
	return true;
801054ff:	b0 01                	mov    $0x1,%al
}
80105501:	5b                   	pop    %ebx
80105502:	5e                   	pop    %esi
80105503:	5f                   	pop    %edi
...
80105510:	8b 75 e4             	mov    -0x1c(%ebp),%esi
				node->left = allocNode(p, key);
80105513:	8b 45 0c             	mov    0xc(%ebp),%eax
80105516:	89 f2                	mov    %esi,%edx
80105518:	e8 73 f9 ff ff       	call   80104e90 <_ZL9allocNodeP4procx>
				if(node->left) {
8010551d:	85 c0                	test   %eax,%eax
				node->left = allocNode(p, key);
8010551f:	89 43 18             	mov    %eax,0x18(%ebx)
				if(node->left) {
80105522:	75 8f                	jne    801054b3 <_ZN7MapNode3putEP4proc+0x73>
}
80105524:	83 c4 2c             	add    $0x2c,%esp
		return false;
...
8010552e:	66 90                	xchg   %ax,%ax
	if(isEmpty()) first = link;
80105530:	89 43 08             	mov    %eax,0x8(%ebx)
80105533:	eb bd                	jmp    801054f2 <_ZN7MapNode3putEP4proc+0xb2>
80105535:	90                   	nop
80105536:	8d 76 00             	lea    0x0(%esi),%esi
80105539:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105540 <_ZN7MapNode10getMinNodeEv>:
MapNode* MapNode::getMinNode() { //no recursion.
80105540:	55                   	push   %ebp
80105541:	89 e5                	mov    %esp,%ebp
80105543:	8b 45 08             	mov    0x8(%ebp),%eax
80105546:	eb 0a                	jmp    80105552 <_ZN7MapNode10getMinNodeEv+0x12>
80105548:	90                   	nop
80105549:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105550:	89 d0                	mov    %edx,%eax
	while(minNode->left)
80105552:	8b 50 18             	mov    0x18(%eax),%edx
80105555:	85 d2                	test   %edx,%edx
80105557:	75 f7                	jne    80105550 <_ZN7MapNode10getMinNodeEv+0x10>
}
80105559:	5d                   	pop    %ebp
8010555a:	c3                   	ret    
8010555b:	90                   	nop
...
80105560 <_ZN7MapNode9getMinKeyEPx>:
void MapNode::getMinKey(long long *pkey) {
80105560:	55                   	push   %ebp
80105561:	89 e5                	mov    %esp,%ebp
80105563:	8b 55 08             	mov    0x8(%ebp),%edx
80105566:	53                   	push   %ebx
80105567:	eb 09                	jmp    80105572 <_ZN7MapNode9getMinKeyEPx+0x12>
...
80105577:	75 f7                	jne    80105570 <_ZN7MapNode9getMinKeyEPx+0x10>
	*pkey = getMinNode()->key;
80105579:	8b 5a 04             	mov    0x4(%edx),%ebx
...
80105590 <_ZN7MapNode7dequeueEv>:
Proc* MapNode::dequeue() {
80105590:	55                   	push   %ebp
80105591:	89 e5                	mov    %esp,%ebp
80105593:	83 ec 08             	sub    $0x8,%esp
80105596:	8b 4d 08             	mov    0x8(%ebp),%ecx
80105599:	89 5d f8             	mov    %ebx,-0x8(%ebp)
8010559c:	89 75 fc             	mov    %esi,-0x4(%ebp)
	return !first;
8010559f:	8b 51 08             	mov    0x8(%ecx),%edx
	if(isEmpty())
801055a2:	85 d2                	test   %edx,%edx
801055a4:	74 32                	je     801055d8 <_ZN7MapNode7dequeueEv+0x48>
	Link *next = first->next;
801055a6:	8b 5a 04             	mov    0x4(%edx),%ebx
	link->next = freeLinks;
801055a9:	8b 35 10 c6 10 80    	mov    0x8010c610,%esi
	Proc *p = first->p;
801055af:	8b 02                	mov    (%edx),%eax
	freeLinks = link;
801055b1:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty())
801055b7:	85 db                	test   %ebx,%ebx
	link->next = freeLinks;
801055b9:	89 72 04             	mov    %esi,0x4(%edx)
	first = next;
801055bc:	89 59 08             	mov    %ebx,0x8(%ecx)
	if(isEmpty())
801055bf:	75 07                	jne    801055c8 <_ZN7MapNode7dequeueEv+0x38>
		last = null;
801055c1:	c7 41 0c 00 00 00 00 	movl   $0x0,0xc(%ecx)
}
801055c8:	8b 5d f8             	mov    -0x8(%ebp),%ebx
801055cb:	8b 75 fc             	mov    -0x4(%ebp),%esi
801055ce:	89 ec                	mov    %ebp,%esp
801055d0:	5d                   	pop    %ebp
801055d1:	c3                   	ret    
...
801055d8:	31 c0                	xor    %eax,%eax
	return listOfProcs.dequeue();
801055da:	eb ec                	jmp    801055c8 <_ZN7MapNode7dequeueEv+0x38>
801055dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801055e0 <_ZN3Map7isEmptyEv>:
bool Map::isEmpty() {
...
801055eb:	0f 94 c0             	sete   %al
}
801055ee:	c3                   	ret    
801055ef:	90                   	nop

801055f0 <_ZN3Map3putEP4proc>:
bool Map::put(Proc *p) {
801055f0:	55                   	push   %ebp
801055f1:	89 e5                	mov    %esp,%ebp
801055f3:	83 ec 18             	sub    $0x18,%esp
801055f6:	89 5d f8             	mov    %ebx,-0x8(%ebp)
801055f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
801055fc:	89 75 fc             	mov    %esi,-0x4(%ebp)
801055ff:	8b 75 08             	mov    0x8(%ebp),%esi
	long long key = getAccumulator(p);
80105602:	89 1c 24             	mov    %ebx,(%esp)
80105605:	e8 b6 e2 ff ff       	call   801038c0 <getAccumulator>
	return !root;
8010560a:	8b 0e                	mov    (%esi),%ecx
	if(isEmpty()) {
8010560c:	85 c9                	test   %ecx,%ecx
8010560e:	74 18                	je     80105628 <_ZN3Map3putEP4proc+0x38>
	return root->put(p);
80105610:	89 5d 0c             	mov    %ebx,0xc(%ebp)
}
80105613:	8b 75 fc             	mov    -0x4(%ebp),%esi
	return root->put(p);
80105616:	89 4d 08             	mov    %ecx,0x8(%ebp)
}
80105619:	8b 5d f8             	mov    -0x8(%ebp),%ebx
8010561c:	89 ec                	mov    %ebp,%esp
8010561e:	5d                   	pop    %ebp
	return root->put(p);
8010561f:	e9 1c fe ff ff       	jmp    80105440 <_ZN7MapNode3putEP4proc>
...
8010562e:	e8 5d f8 ff ff       	call   80104e90 <_ZL9allocNodeP4procx>
80105633:	89 06                	mov    %eax,(%esi)
		return !isEmpty();
80105635:	85 c0                	test   %eax,%eax
80105637:	0f 95 c0             	setne  %al
}
8010563a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
8010563d:	8b 75 fc             	mov    -0x4(%ebp),%esi
80105640:	89 ec                	mov    %ebp,%esp
80105642:	5d                   	pop    %ebp
80105643:	c3                   	ret    
80105644:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010564a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105650 <putPriorityQueue>:
...
8010565d:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
80105662:	89 04 24             	mov    %eax,(%esp)
80105665:	e8 86 ff ff ff       	call   801055f0 <_ZN3Map3putEP4proc>
}
8010566a:	c9                   	leave  
	return priorityQ->put(p);
8010566b:	0f b6 c0             	movzbl %al,%eax
}
8010566e:	c3                   	ret    
8010566f:	90                   	nop

80105670 <_ZN3Map9getMinKeyEPx>:
bool Map::getMinKey(long long *pkey) {
...
80105677:	8b 10                	mov    (%eax),%edx
	if(isEmpty())
80105679:	85 d2                	test   %edx,%edx
8010567b:	75 05                	jne    80105682 <_ZN3Map9getMinKeyEPx+0x12>
8010567d:	eb 21                	jmp    801056a0 <_ZN3Map9getMinKeyEPx+0x30>
8010567f:	90                   	nop
	while(minNode->left)
80105680:	89 c2                	mov    %eax,%edx
80105682:	8b 42 18             	mov    0x18(%edx),%eax
80105685:	85 c0                	test   %eax,%eax
80105687:	75 f7                	jne    80105680 <_ZN3Map9getMinKeyEPx+0x10>
	*pkey = getMinNode()->key;
80105689:	8b 45 0c             	mov    0xc(%ebp),%eax
8010568c:	8b 5a 04             	mov    0x4(%edx),%ebx
8010568f:	8b 0a                	mov    (%edx),%ecx
80105691:	89 58 04             	mov    %ebx,0x4(%eax)
80105694:	89 08                	mov    %ecx,(%eax)
		return false;

	root->getMinKey(pkey);
	return true;
80105696:	b0 01                	mov    $0x1,%al
}
80105698:	5b                   	pop    %ebx
80105699:	5d                   	pop    %ebp
8010569a:	c3                   	ret    
...
801056b0 <_ZN3Map10extractMinEv>:
...
801056b8:	53                   	push   %ebx
	return !root;
801056b9:	8b 1e                	mov    (%esi),%ebx
	if(isEmpty())
801056bb:	85 db                	test   %ebx,%ebx
801056bd:	0f 84 a5 00 00 00    	je     80105768 <_ZN3Map10extractMinEv+0xb8>
801056c3:	89 da                	mov    %ebx,%edx
801056c5:	eb 0b                	jmp    801056d2 <_ZN3Map10extractMinEv+0x22>
801056c7:	89 f6                	mov    %esi,%esi
801056c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
	while(minNode->left)
801056d0:	89 c2                	mov    %eax,%edx
801056d2:	8b 42 18             	mov    0x18(%edx),%eax
801056d5:	85 c0                	test   %eax,%eax
801056d7:	75 f7                	jne    801056d0 <_ZN3Map10extractMinEv+0x20>
	return !first;
801056d9:	8b 4a 08             	mov    0x8(%edx),%ecx
	if(isEmpty())
801056dc:	85 c9                	test   %ecx,%ecx
801056de:	74 70                	je     80105750 <_ZN3Map10extractMinEv+0xa0>
	Link *next = first->next;
801056e0:	8b 59 04             	mov    0x4(%ecx),%ebx
	link->next = freeLinks;
801056e3:	8b 3d 10 c6 10 80    	mov    0x8010c610,%edi
	Proc *p = first->p;
801056e9:	8b 01                	mov    (%ecx),%eax
	freeLinks = link;
801056eb:	89 0d 10 c6 10 80    	mov    %ecx,0x8010c610
	if(isEmpty())
801056f1:	85 db                	test   %ebx,%ebx
	link->next = freeLinks;
801056f3:	89 79 04             	mov    %edi,0x4(%ecx)
	first = next;
801056f6:	89 5a 08             	mov    %ebx,0x8(%edx)
	if(isEmpty())
801056f9:	74 05                	je     80105700 <_ZN3Map10extractMinEv+0x50>
		}
		deallocNode(minNode);
	}
...
801056ff:	c3                   	ret    
		last = null;
80105700:	c7 42 0c 00 00 00 00 	movl   $0x0,0xc(%edx)
80105707:	8b 4a 1c             	mov    0x1c(%edx),%ecx
8010570a:	8b 1e                	mov    (%esi),%ebx
		if(minNode == root) {
8010570c:	39 da                	cmp    %ebx,%edx
8010570e:	74 49                	je     80105759 <_ZN3Map10extractMinEv+0xa9>
			MapNode *parent = minNode->parent;
80105710:	8b 5a 14             	mov    0x14(%edx),%ebx
			parent->left = minNode->right;
80105713:	89 4b 18             	mov    %ecx,0x18(%ebx)
			if(minNode->right)
80105716:	8b 4a 1c             	mov    0x1c(%edx),%ecx
80105719:	85 c9                	test   %ecx,%ecx
8010571b:	74 03                	je     80105720 <_ZN3Map10extractMinEv+0x70>
				minNode->right->parent = parent;
8010571d:	89 59 14             	mov    %ebx,0x14(%ecx)
	node->next = freeNodes;
80105720:	8b 0d 0c c6 10 80    	mov    0x8010c60c,%ecx
	node->parent = node->left = node->right = null;
80105726:	c7 42 1c 00 00 00 00 	movl   $0x0,0x1c(%edx)
8010572d:	c7 42 18 00 00 00 00 	movl   $0x0,0x18(%edx)
80105734:	c7 42 14 00 00 00 00 	movl   $0x0,0x14(%edx)
	node->next = freeNodes;
8010573b:	89 4a 10             	mov    %ecx,0x10(%edx)
}
8010573e:	5b                   	pop    %ebx
	freeNodes = node;
8010573f:	89 15 0c c6 10 80    	mov    %edx,0x8010c60c
}
80105745:	5e                   	pop    %esi
80105746:	5f                   	pop    %edi
80105747:	5d                   	pop    %ebp
...
80105750:	31 c0                	xor    %eax,%eax
		if(minNode == root) {
80105752:	39 da                	cmp    %ebx,%edx
80105754:	8b 4a 1c             	mov    0x1c(%edx),%ecx
80105757:	75 b7                	jne    80105710 <_ZN3Map10extractMinEv+0x60>
			if(!isEmpty())
80105759:	85 c9                	test   %ecx,%ecx
			root = minNode->right;
8010575b:	89 0e                	mov    %ecx,(%esi)
			if(!isEmpty())
8010575d:	74 c1                	je     80105720 <_ZN3Map10extractMinEv+0x70>
				root->parent = null;
8010575f:	c7 41 14 00 00 00 00 	movl   $0x0,0x14(%ecx)
80105766:	eb b8                	jmp    80105720 <_ZN3Map10extractMinEv+0x70>
		return null;
80105768:	31 c0                	xor    %eax,%eax
8010576a:	eb 8f                	jmp    801056fb <_ZN3Map10extractMinEv+0x4b>
8010576c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105770 <extractMinPriorityQueue>:
static Proc* extractMinPriorityQueue() {
80105770:	55                   	push   %ebp
80105771:	89 e5                	mov    %esp,%ebp
80105773:	83 ec 04             	sub    $0x4,%esp
	return priorityQ->extractMin();
80105776:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
8010577b:	89 04 24             	mov    %eax,(%esp)
8010577e:	e8 2d ff ff ff       	call   801056b0 <_ZN3Map10extractMinEv>
}
80105783:	c9                   	leave  
80105784:	c3                   	ret    
80105785:	90                   	nop
...
80105790 <_ZN3Map8transferEv.part.1>:
...
8010579a:	eb 16                	jmp    801057b2 <_ZN3Map8transferEv.part.1+0x22>
...
801057a3:	e8 08 ff ff ff       	call   801056b0 <_ZN3Map10extractMinEv>
	if(!freeLinks)
801057a8:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
801057ae:	85 d2                	test   %edx,%edx
801057b0:	75 0e                	jne    801057c0 <_ZN3Map8transferEv.part.1+0x30>
	while(!isEmpty()) {
801057b2:	8b 03                	mov    (%ebx),%eax
801057b4:	85 c0                	test   %eax,%eax
801057b6:	75 e8                	jne    801057a0 <_ZN3Map8transferEv.part.1+0x10>
...
801057bf:	90                   	nop
	freeLinks = freeLinks->next;
801057c0:	8b 72 04             	mov    0x4(%edx),%esi
		roundRobinQ->enqueue(p); //should succeed.
801057c3:	8b 0d 18 c6 10 80    	mov    0x8010c618,%ecx
	ans->next = null;
801057c9:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
	ans->p = p;
801057d0:	89 02                	mov    %eax,(%edx)
	freeLinks = freeLinks->next;
801057d2:	89 35 10 c6 10 80    	mov    %esi,0x8010c610
	if(isEmpty()) first = link;
801057d8:	8b 31                	mov    (%ecx),%esi
801057da:	85 f6                	test   %esi,%esi
801057dc:	74 22                	je     80105800 <_ZN3Map8transferEv.part.1+0x70>
	else last->next = link;
801057de:	8b 41 04             	mov    0x4(%ecx),%eax
801057e1:	89 50 04             	mov    %edx,0x4(%eax)
801057e4:	eb 0c                	jmp    801057f2 <_ZN3Map8transferEv.part.1+0x62>
801057e6:	8d 76 00             	lea    0x0(%esi),%esi
801057e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
	while(ans->next)
801057f0:	89 c2                	mov    %eax,%edx
801057f2:	8b 42 04             	mov    0x4(%edx),%eax
801057f5:	85 c0                	test   %eax,%eax
801057f7:	75 f7                	jne    801057f0 <_ZN3Map8transferEv.part.1+0x60>
	last = link->getLast();
801057f9:	89 51 04             	mov    %edx,0x4(%ecx)
801057fc:	eb b4                	jmp    801057b2 <_ZN3Map8transferEv.part.1+0x22>
801057fe:	66 90                	xchg   %ax,%ax
	if(isEmpty()) first = link;
80105800:	89 11                	mov    %edx,(%ecx)
80105802:	eb ee                	jmp    801057f2 <_ZN3Map8transferEv.part.1+0x62>
80105804:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010580a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105810 <switchToRoundRobinPolicyPriorityQueue>:
	if(!roundRobinQ->isEmpty())
80105810:	8b 15 18 c6 10 80    	mov    0x8010c618,%edx
80105816:	8b 02                	mov    (%edx),%eax
80105818:	85 c0                	test   %eax,%eax
8010581a:	74 04                	je     80105820 <switchToRoundRobinPolicyPriorityQueue+0x10>
8010581c:	31 c0                	xor    %eax,%eax
}
8010581e:	c3                   	ret    
8010581f:	90                   	nop
80105820:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
static boolean switchToRoundRobinPolicyPriorityQueue() {
80105825:	55                   	push   %ebp
80105826:	89 e5                	mov    %esp,%ebp
80105828:	e8 63 ff ff ff       	call   80105790 <_ZN3Map8transferEv.part.1>
}
8010582d:	5d                   	pop    %ebp
8010582e:	0f b6 c0             	movzbl %al,%eax
80105831:	c3                   	ret    
80105832:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105839:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105840 <_ZN3Map8transferEv>:
	return !first;
80105840:	8b 15 18 c6 10 80    	mov    0x8010c618,%edx
bool Map::transfer() {
80105846:	55                   	push   %ebp
80105847:	89 e5                	mov    %esp,%ebp
80105849:	8b 45 08             	mov    0x8(%ebp),%eax
	if(!roundRobinQ->isEmpty())
8010584c:	8b 12                	mov    (%edx),%edx
8010584e:	85 d2                	test   %edx,%edx
80105850:	74 0e                	je     80105860 <_ZN3Map8transferEv+0x20>
}
...
80105860:	5d                   	pop    %ebp
80105861:	e9 2a ff ff ff       	jmp    80105790 <_ZN3Map8transferEv.part.1>
80105866:	8d 76 00             	lea    0x0(%esi),%esi
80105869:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105870 <_ZN3Map11extractProcEP4proc>:
...
80105875:	83 ec 30             	sub    $0x30,%esp
	if(!freeNodes)
80105878:	8b 15 0c c6 10 80    	mov    0x8010c60c,%edx
bool Map::extractProc(Proc *p) {
8010587e:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105881:	8b 75 0c             	mov    0xc(%ebp),%esi
	if(!freeNodes)
80105884:	85 d2                	test   %edx,%edx
80105886:	74 50                	je     801058d8 <_ZN3Map11extractProcEP4proc+0x68>
...
80105888:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	...
	bool ans = false;
8010588f:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
80105893:	eb 13                	jmp    801058a8 <_ZN3Map11extractProcEP4proc+0x38>
80105895:	8d 76 00             	lea    0x0(%esi),%esi
	Map tempMap;
	while(!isEmpty()) {
		Proc *otherP = extractMin();
80105898:	89 1c 24             	mov    %ebx,(%esp)
8010589b:	e8 10 fe ff ff       	call   801056b0 <_ZN3Map10extractMinEv>
		if(otherP != p)
801058a0:	39 f0                	cmp    %esi,%eax
801058a2:	75 1c                	jne    801058c0 <_ZN3Map11extractProcEP4proc+0x50>
			tempMap.put(otherP); //should scucceed.
		else ans = true;
801058a4:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	while(!isEmpty()) {
801058a8:	8b 03                	mov    (%ebx),%eax
801058aa:	85 c0                	test   %eax,%eax
801058ac:	75 ea                	jne    80105898 <_ZN3Map11extractProcEP4proc+0x28>
	}
	root = tempMap.root;
801058ae:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058b1:	89 03                	mov    %eax,(%ebx)
	return ans;
}
801058b3:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801058b7:	83 c4 30             	add    $0x30,%esp
801058ba:	5b                   	pop    %ebx
801058bb:	5e                   	pop    %esi
801058bc:	5d                   	pop    %ebp
801058bd:	c3                   	ret    
...
801058ca:	e8 21 fd ff ff       	call   801055f0 <_ZN3Map3putEP4proc>
801058cf:	eb d7                	jmp    801058a8 <_ZN3Map11extractProcEP4proc+0x38>
801058d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		return false;
801058d8:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
}
801058dc:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801058e0:	83 c4 30             	add    $0x30,%esp
801058e3:	5b                   	pop    %ebx
801058e4:	5e                   	pop    %esi
801058e5:	5d                   	pop    %ebp
801058e6:	c3                   	ret    
...
801058f0 <extractProcPriorityQueue>:
...
801058fd:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
80105902:	89 04 24             	mov    %eax,(%esp)
80105905:	e8 66 ff ff ff       	call   80105870 <_ZN3Map11extractProcEP4proc>
}
8010590a:	c9                   	leave  
	return priorityQ->extractProc(p);
8010590b:	0f b6 c0             	movzbl %al,%eax
}
8010590e:	c3                   	ret    
8010590f:	90                   	nop
...
80105916:	83 ec 2c             	sub    $0x2c,%esp
80105919:	8b 45 08             	mov    0x8(%ebp),%eax
8010591c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010591f:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105922:	8b 45 10             	mov    0x10(%ebp),%eax
80105925:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80105928:	8b 55 14             	mov    0x14(%ebp),%edx
8010592b:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010592e:	89 d7                	mov    %edx,%edi
	if(divisor == 0)
80105930:	09 c2                	or     %eax,%edx
80105932:	0f 84 9a 00 00 00    	je     801059d2 <__moddi3+0xc2>
		panic((char*)"divide by zero!!!\n");

	bool isNumberNegative = false;
	if(number < 0) {
80105938:	8b 45 e4             	mov    -0x1c(%ebp),%eax
	bool isNumberNegative = false;
8010593b:	c6 45 df 00          	movb   $0x0,-0x21(%ebp)
	if(number < 0) {
8010593f:	85 c0                	test   %eax,%eax
80105941:	79 0e                	jns    80105951 <__moddi3+0x41>
		number = -number;
80105943:	f7 5d e0             	negl   -0x20(%ebp)
		isNumberNegative = true;
80105946:	c6 45 df 01          	movb   $0x1,-0x21(%ebp)
		number = -number;
8010594a:	83 55 e4 00          	adcl   $0x0,-0x1c(%ebp)
8010594e:	f7 5d e4             	negl   -0x1c(%ebp)
80105951:	8b 55 d8             	mov    -0x28(%ebp),%edx
80105954:	89 f8                	mov    %edi,%eax
80105956:	c1 ff 1f             	sar    $0x1f,%edi
80105959:	31 f8                	xor    %edi,%eax
8010595b:	89 f9                	mov    %edi,%ecx
8010595d:	31 fa                	xor    %edi,%edx
8010595f:	89 c7                	mov    %eax,%edi
80105961:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105964:	89 d6                	mov    %edx,%esi
80105966:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105969:	29 ce                	sub    %ecx,%esi
8010596b:	19 cf                	sbb    %ecx,%edi
	if(divisor < 0)
		divisor = -divisor;
...
8010596d:	39 fa                	cmp    %edi,%edx
8010596f:	7d 1f                	jge    80105990 <__moddi3+0x80>
...
80105971:	80 7d df 00          	cmpb   $0x0,-0x21(%ebp)
80105975:	74 07                	je     8010597e <__moddi3+0x6e>
80105977:	f7 d8                	neg    %eax
80105979:	83 d2 00             	adc    $0x0,%edx
8010597c:	f7 da                	neg    %edx
	}
}
8010597e:	83 c4 2c             	add    $0x2c,%esp
80105981:	5b                   	pop    %ebx
80105982:	5e                   	pop    %esi
80105983:	5f                   	pop    %edi
80105984:	5d                   	pop    %ebp
...
80105989:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
		while(number >= divisor2) {
80105990:	7f 04                	jg     80105996 <__moddi3+0x86>
80105992:	39 f0                	cmp    %esi,%eax
80105994:	72 db                	jb     80105971 <__moddi3+0x61>
80105996:	89 f1                	mov    %esi,%ecx
80105998:	89 fb                	mov    %edi,%ebx
8010599a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
			number -= divisor2;
801059a0:	29 c8                	sub    %ecx,%eax
801059a2:	19 da                	sbb    %ebx,%edx
				divisor2 += divisor2;
801059a4:	0f a4 cb 01          	shld   $0x1,%ecx,%ebx
801059a8:	01 c9                	add    %ecx,%ecx
		while(number >= divisor2) {
801059aa:	39 da                	cmp    %ebx,%edx
801059ac:	7f f2                	jg     801059a0 <__moddi3+0x90>
801059ae:	7d 18                	jge    801059c8 <__moddi3+0xb8>
		if(number < divisor)
801059b0:	39 d7                	cmp    %edx,%edi
801059b2:	7c b9                	jl     8010596d <__moddi3+0x5d>
801059b4:	7f bb                	jg     80105971 <__moddi3+0x61>
801059b6:	39 c6                	cmp    %eax,%esi
801059b8:	76 b3                	jbe    8010596d <__moddi3+0x5d>
801059ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801059c0:	eb af                	jmp    80105971 <__moddi3+0x61>
801059c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		while(number >= divisor2) {
801059c8:	39 c8                	cmp    %ecx,%eax
801059ca:	73 d4                	jae    801059a0 <__moddi3+0x90>
801059cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801059d0:	eb de                	jmp    801059b0 <__moddi3+0xa0>
		panic((char*)"divide by zero!!!\n");
801059d2:	c7 04 24 3c 90 10 80 	movl   $0x8010903c,(%esp)
...
801059e1:	b8 4f 90 10 80       	mov    $0x8010904f,%eax
{
801059e6:	89 e5                	mov    %esp,%ebp
801059e8:	53                   	push   %ebx
801059e9:	83 ec 14             	sub    $0x14,%esp
801059ec:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
801059ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801059f3:	8d 43 04             	lea    0x4(%ebx),%eax
801059f6:	89 04 24             	mov    %eax,(%esp)
801059f9:	e8 12 01 00 00       	call   80105b10 <initlock>
  lk->name = name;
801059fe:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
80105a01:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80105a07:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
80105a0e:	89 43 38             	mov    %eax,0x38(%ebx)
}
80105a11:	83 c4 14             	add    $0x14,%esp
80105a14:	5b                   	pop    %ebx
80105a15:	5d                   	pop    %ebp
80105a16:	c3                   	ret    
...
80105a28:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80105a2b:	8d 73 04             	lea    0x4(%ebx),%esi
80105a2e:	89 34 24             	mov    %esi,(%esp)
80105a31:	e8 2a 02 00 00       	call   80105c60 <acquire>
  while (lk->locked) {
80105a36:	8b 13                	mov    (%ebx),%edx
80105a38:	85 d2                	test   %edx,%edx
80105a3a:	74 16                	je     80105a52 <acquiresleep+0x32>
80105a3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80105a40:	89 74 24 04          	mov    %esi,0x4(%esp)
80105a44:	89 1c 24             	mov    %ebx,(%esp)
80105a47:	e8 c4 ea ff ff       	call   80104510 <sleep>
  while (lk->locked) {
80105a4c:	8b 03                	mov    (%ebx),%eax
80105a4e:	85 c0                	test   %eax,%eax
80105a50:	75 ee                	jne    80105a40 <acquiresleep+0x20>
  }
  lk->locked = 1;
80105a52:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80105a58:	e8 43 df ff ff       	call   801039a0 <myproc>
80105a5d:	8b 40 10             	mov    0x10(%eax),%eax
80105a60:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80105a63:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
80105a6b:	5d                   	pop    %ebp
  release(&lk->lk);
80105a6c:	e9 8f 02 00 00       	jmp    80105d00 <release>
80105a71:	eb 0d                	jmp    80105a80 <releasesleep>
80105a73:	90                   	nop
80105a74:	90                   	nop
80105a75:	90                   	nop
80105a76:	90                   	nop
...
80105a86:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80105a89:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105a8c:	89 75 fc             	mov    %esi,-0x4(%ebp)
  acquire(&lk->lk);
80105a8f:	8d 73 04             	lea    0x4(%ebx),%esi
80105a92:	89 34 24             	mov    %esi,(%esp)
80105a95:	e8 c6 01 00 00       	call   80105c60 <acquire>
  lk->locked = 0;
80105a9a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80105aa0:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80105aa7:	89 1c 24             	mov    %ebx,(%esp)
80105aaa:	e8 61 ec ff ff       	call   80104710 <wakeup>
  release(&lk->lk);
}
...
80105ab5:	8b 75 fc             	mov    -0x4(%ebp),%esi
80105ab8:	89 ec                	mov    %ebp,%esp
80105aba:	5d                   	pop    %ebp
  release(&lk->lk);
80105abb:	e9 40 02 00 00       	jmp    80105d00 <release>
...
80105ac6:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80105ac9:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105acc:	89 7d fc             	mov    %edi,-0x4(%ebp)
80105acf:	89 75 f8             	mov    %esi,-0x8(%ebp)
80105ad2:	31 f6                	xor    %esi,%esi
  int r;
  
  acquire(&lk->lk);
80105ad4:	8d 7b 04             	lea    0x4(%ebx),%edi
80105ad7:	89 3c 24             	mov    %edi,(%esp)
80105ada:	e8 81 01 00 00       	call   80105c60 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80105adf:	8b 03                	mov    (%ebx),%eax
80105ae1:	85 c0                	test   %eax,%eax
80105ae3:	74 11                	je     80105af6 <holdingsleep+0x36>
80105ae5:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80105ae8:	e8 b3 de ff ff       	call   801039a0 <myproc>
80105aed:	39 58 10             	cmp    %ebx,0x10(%eax)
80105af0:	0f 94 c0             	sete   %al
80105af3:	0f b6 f0             	movzbl %al,%esi
  release(&lk->lk);
80105af6:	89 3c 24             	mov    %edi,(%esp)
80105af9:	e8 02 02 00 00       	call   80105d00 <release>
  return r;
}
80105afe:	89 f0                	mov    %esi,%eax
80105b00:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105b03:	8b 75 f8             	mov    -0x8(%ebp),%esi
80105b06:	8b 7d fc             	mov    -0x4(%ebp),%edi
80105b09:	89 ec                	mov    %ebp,%esp
80105b0b:	5d                   	pop    %ebp
80105b0c:	c3                   	ret    
...
{
80105b38:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80105b4c:	77 12                	ja     80105b60 <getcallerpcs+0x30>
      break;
...
80105b51:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
80105b54:	42                   	inc    %edx
80105b55:	83 fa 0a             	cmp    $0xa,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
80105b58:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80105b5a:	75 e4                	jne    80105b40 <getcallerpcs+0x10>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80105b5e:	c3                   	ret    
80105b5f:	90                   	nop
80105b60:	8d 04 91             	lea    (%ecx,%edx,4),%eax
80105b63:	83 c1 28             	add    $0x28,%ecx
...
80105b89:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80105b8a:	e8 71 dd ff ff       	call   80103900 <mycpu>
80105b8f:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105b95:	85 d2                	test   %edx,%edx
80105b97:	75 11                	jne    80105baa <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
80105b99:	e8 62 dd ff ff       	call   80103900 <mycpu>
80105b9e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80105ba4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
80105baa:	e8 51 dd ff ff       	call   80103900 <mycpu>
80105baf:	ff 80 a4 00 00 00    	incl   0xa4(%eax)
}
80105bb5:	58                   	pop    %eax
80105bb6:	5b                   	pop    %ebx
80105bb7:	5d                   	pop    %ebp
...
80105bcb:	75 35                	jne    80105c02 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
80105bcd:	e8 2e dd ff ff       	call   80103900 <mycpu>
80105bd2:	ff 88 a4 00 00 00    	decl   0xa4(%eax)
80105bd8:	78 34                	js     80105c0e <popcli+0x4e>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105bda:	e8 21 dd ff ff       	call   80103900 <mycpu>
80105bdf:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105be5:	85 d2                	test   %edx,%edx
80105be7:	74 07                	je     80105bf0 <popcli+0x30>
    sti();
}
80105be9:	c9                   	leave  
80105bea:	c3                   	ret    
...
80105bec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105bf0:	e8 0b dd ff ff       	call   80103900 <mycpu>
80105bf5:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80105bfb:	85 c0                	test   %eax,%eax
80105bfd:	74 ea                	je     80105be9 <popcli+0x29>
  asm volatile("sti");
80105bff:	fb                   	sti    
}
80105c00:	c9                   	leave  
80105c01:	c3                   	ret    
    panic("popcli - interruptible");
80105c02:	c7 04 24 5a 90 10 80 	movl   $0x8010905a,(%esp)
80105c09:	e8 62 a7 ff ff       	call   80100370 <panic>
    panic("popcli");
80105c0e:	c7 04 24 71 90 10 80 	movl   $0x80109071,(%esp)
80105c15:	e8 56 a7 ff ff       	call   80100370 <panic>
...
80105c26:	89 75 fc             	mov    %esi,-0x4(%ebp)
80105c29:	8b 75 08             	mov    0x8(%ebp),%esi
80105c2c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80105c2f:	31 db                	xor    %ebx,%ebx
  pushcli();
80105c31:	e8 4a ff ff ff       	call   80105b80 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80105c36:	8b 06                	mov    (%esi),%eax
80105c38:	85 c0                	test   %eax,%eax
80105c3a:	74 10                	je     80105c4c <holding+0x2c>
80105c3c:	8b 5e 08             	mov    0x8(%esi),%ebx
80105c3f:	e8 bc dc ff ff       	call   80103900 <mycpu>
80105c44:	39 c3                	cmp    %eax,%ebx
80105c46:	0f 94 c3             	sete   %bl
80105c49:	0f b6 db             	movzbl %bl,%ebx
  popcli();
80105c4c:	e8 6f ff ff ff       	call   80105bc0 <popcli>
}
80105c51:	89 d8                	mov    %ebx,%eax
80105c53:	8b 75 fc             	mov    -0x4(%ebp),%esi
80105c56:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105c59:	89 ec                	mov    %ebp,%esp
80105c5b:	5d                   	pop    %ebp
80105c5c:	c3                   	ret    
...
80105c68:	e8 13 ff ff ff       	call   80105b80 <pushcli>
  if(holding(lk))
80105c6d:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105c70:	89 1c 24             	mov    %ebx,(%esp)
80105c73:	e8 a8 ff ff ff       	call   80105c20 <holding>
80105c78:	85 c0                	test   %eax,%eax
80105c7a:	75 78                	jne    80105cf4 <acquire+0x94>
80105c7c:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80105c7e:	ba 01 00 00 00       	mov    $0x1,%edx
80105c83:	eb 06                	jmp    80105c8b <acquire+0x2b>
80105c85:	8d 76 00             	lea    0x0(%esi),%esi
80105c88:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105c8b:	89 d0                	mov    %edx,%eax
80105c8d:	f0 87 03             	lock xchg %eax,(%ebx)
...
80105c9c:	e8 5f dc ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80105ca1:	8d 53 0c             	lea    0xc(%ebx),%edx
  lk->cpu = mycpu();
80105ca4:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
80105ca7:	89 e8                	mov    %ebp,%eax
80105ca9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105cb0:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
80105cb6:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80105cbc:	77 1a                	ja     80105cd8 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
80105cbe:	8b 48 04             	mov    0x4(%eax),%ecx
80105cc1:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
  for(i = 0; i < 10; i++){
80105cc4:	46                   	inc    %esi
80105cc5:	83 fe 0a             	cmp    $0xa,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80105cc8:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80105cca:	75 e4                	jne    80105cb0 <acquire+0x50>
}
...
80105cd8:	8d 04 b2             	lea    (%edx,%esi,4),%eax
80105cdb:	83 c2 28             	add    $0x28,%edx
...
80105cf3:	c3                   	ret    
    panic("acquire");
80105cf4:	c7 04 24 78 90 10 80 	movl   $0x80109078,(%esp)
80105cfb:	e8 70 a6 ff ff       	call   80100370 <panic>
...
80105d07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
80105d0a:	89 1c 24             	mov    %ebx,(%esp)
80105d0d:	e8 0e ff ff ff       	call   80105c20 <holding>
80105d12:	85 c0                	test   %eax,%eax
80105d14:	74 23                	je     80105d39 <release+0x39>
  lk->pcs[0] = 0;
80105d16:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80105d1d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80105d24:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80105d29:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80105d2f:	83 c4 14             	add    $0x14,%esp
80105d32:	5b                   	pop    %ebx
80105d33:	5d                   	pop    %ebp
  popcli();
80105d34:	e9 87 fe ff ff       	jmp    80105bc0 <popcli>
    panic("release");
80105d39:	c7 04 24 80 90 10 80 	movl   $0x80109080,(%esp)
80105d40:	e8 2b a6 ff ff       	call   80100370 <panic>
...
80105d56:	8b 55 08             	mov    0x8(%ebp),%edx
80105d59:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80105d5c:	8b 4d 10             	mov    0x10(%ebp),%ecx
80105d5f:	89 7d fc             	mov    %edi,-0x4(%ebp)
  if ((int)dst%4 == 0 && n%4 == 0){
80105d62:	f6 c2 03             	test   $0x3,%dl
80105d65:	75 05                	jne    80105d6c <memset+0x1c>
80105d67:	f6 c1 03             	test   $0x3,%cl
80105d6a:	74 14                	je     80105d80 <memset+0x30>
  asm volatile("cld; rep stosb" :
80105d6c:	89 d7                	mov    %edx,%edi
80105d6e:	8b 45 0c             	mov    0xc(%ebp),%eax
80105d71:	fc                   	cld    
80105d72:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80105d74:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105d77:	89 d0                	mov    %edx,%eax
80105d79:	8b 7d fc             	mov    -0x4(%ebp),%edi
80105d7c:	89 ec                	mov    %ebp,%esp
80105d7e:	5d                   	pop    %ebp
80105d7f:	c3                   	ret    
    c &= 0xFF;
80105d80:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105d84:	c1 e9 02             	shr    $0x2,%ecx
80105d87:	89 f8                	mov    %edi,%eax
80105d89:	89 fb                	mov    %edi,%ebx
80105d8b:	c1 e0 18             	shl    $0x18,%eax
80105d8e:	c1 e3 10             	shl    $0x10,%ebx
80105d91:	09 d8                	or     %ebx,%eax
80105d93:	09 f8                	or     %edi,%eax
80105d95:	c1 e7 08             	shl    $0x8,%edi
80105d98:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80105d9a:	89 d7                	mov    %edx,%edi
80105d9c:	fc                   	cld    
80105d9d:	f3 ab                	rep stos %eax,%es:(%edi)
}
80105d9f:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105da2:	89 d0                	mov    %edx,%eax
80105da4:	8b 7d fc             	mov    -0x4(%ebp),%edi
80105da7:	89 ec                	mov    %ebp,%esp
80105da9:	5d                   	pop    %ebp
80105daa:	c3                   	ret    
80105dab:	90                   	nop
...
80105db8:	8b 75 08             	mov    0x8(%ebp),%esi
80105dbb:	53                   	push   %ebx
80105dbc:	8b 5d 10             	mov    0x10(%ebp),%ebx
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80105dbf:	85 db                	test   %ebx,%ebx
80105dc1:	74 27                	je     80105dea <memcmp+0x3a>
    if(*s1 != *s2)
80105dc3:	0f b6 16             	movzbl (%esi),%edx
80105dc6:	0f b6 0f             	movzbl (%edi),%ecx
80105dc9:	38 d1                	cmp    %dl,%cl
80105dcb:	75 2b                	jne    80105df8 <memcmp+0x48>
80105dcd:	b8 01 00 00 00       	mov    $0x1,%eax
80105dd2:	eb 12                	jmp    80105de6 <memcmp+0x36>
80105dd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105dd8:	0f b6 14 06          	movzbl (%esi,%eax,1),%edx
80105ddc:	40                   	inc    %eax
80105ddd:	0f b6 4c 07 ff       	movzbl -0x1(%edi,%eax,1),%ecx
80105de2:	38 ca                	cmp    %cl,%dl
80105de4:	75 12                	jne    80105df8 <memcmp+0x48>
  while(n-- > 0){
80105de6:	39 d8                	cmp    %ebx,%eax
80105de8:	75 ee                	jne    80105dd8 <memcmp+0x28>
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105df8:	5b                   	pop    %ebx
      return *s1 - *s2;
80105df9:	0f b6 c2             	movzbl %dl,%eax
80105dfc:	29 c8                	sub    %ecx,%eax
}
80105dfe:	5e                   	pop    %esi
80105dff:	5f                   	pop    %edi
80105e00:	5d                   	pop    %ebp
...
80105e18:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80105e1b:	8b 75 10             	mov    0x10(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105e1e:	39 c3                	cmp    %eax,%ebx
80105e20:	73 26                	jae    80105e48 <memmove+0x38>
80105e22:	8d 0c 33             	lea    (%ebx,%esi,1),%ecx
80105e25:	39 c8                	cmp    %ecx,%eax
80105e27:	73 1f                	jae    80105e48 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80105e29:	85 f6                	test   %esi,%esi
80105e2b:	8d 56 ff             	lea    -0x1(%esi),%edx
80105e2e:	74 0d                	je     80105e3d <memmove+0x2d>
      *--d = *--s;
80105e30:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
80105e34:	88 0c 10             	mov    %cl,(%eax,%edx,1)
    while(n-- > 0)
80105e37:	4a                   	dec    %edx
80105e38:	83 fa ff             	cmp    $0xffffffff,%edx
80105e3b:	75 f3                	jne    80105e30 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80105e41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    while(n-- > 0)
80105e48:	31 d2                	xor    %edx,%edx
80105e4a:	85 f6                	test   %esi,%esi
80105e4c:	74 ef                	je     80105e3d <memmove+0x2d>
80105e4e:	66 90                	xchg   %ax,%ax
      *d++ = *s++;
80105e50:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
80105e54:	88 0c 10             	mov    %cl,(%eax,%edx,1)
80105e57:	42                   	inc    %edx
    while(n-- > 0)
80105e58:	39 d6                	cmp    %edx,%esi
80105e5a:	75 f4                	jne    80105e50 <memmove+0x40>
}
80105e5c:	5b                   	pop    %ebx
80105e5d:	5e                   	pop    %esi
80105e5e:	5d                   	pop    %ebp
...
80105e63:	5d                   	pop    %ebp
  return memmove(dst, src, n);
80105e64:	eb aa                	jmp    80105e10 <memmove>
...
80105e74:	8b 7d 10             	mov    0x10(%ebp),%edi
80105e77:	56                   	push   %esi
80105e78:	8b 75 0c             	mov    0xc(%ebp),%esi
80105e7b:	53                   	push   %ebx
80105e7c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while(n > 0 && *p && *p == *q)
80105e7f:	85 ff                	test   %edi,%edi
80105e81:	74 2d                	je     80105eb0 <strncmp+0x40>
80105e83:	0f b6 03             	movzbl (%ebx),%eax
80105e86:	0f b6 0e             	movzbl (%esi),%ecx
80105e89:	84 c0                	test   %al,%al
80105e8b:	74 37                	je     80105ec4 <strncmp+0x54>
80105e8d:	38 c1                	cmp    %al,%cl
80105e8f:	75 33                	jne    80105ec4 <strncmp+0x54>
80105e91:	01 f7                	add    %esi,%edi
80105e93:	eb 13                	jmp    80105ea8 <strncmp+0x38>
80105e95:	8d 76 00             	lea    0x0(%esi),%esi
80105e98:	0f b6 03             	movzbl (%ebx),%eax
80105e9b:	84 c0                	test   %al,%al
80105e9d:	74 21                	je     80105ec0 <strncmp+0x50>
80105e9f:	0f b6 0a             	movzbl (%edx),%ecx
80105ea2:	89 d6                	mov    %edx,%esi
80105ea4:	38 c8                	cmp    %cl,%al
80105ea6:	75 1c                	jne    80105ec4 <strncmp+0x54>
    n--, p++, q++;
80105ea8:	8d 56 01             	lea    0x1(%esi),%edx
80105eab:	43                   	inc    %ebx
  while(n > 0 && *p && *p == *q)
80105eac:	39 fa                	cmp    %edi,%edx
80105eae:	75 e8                	jne    80105e98 <strncmp+0x28>
  if(n == 0)
    return 0;
...
80105ec0:	0f b6 4e 01          	movzbl 0x1(%esi),%ecx
80105ec4:	5b                   	pop    %ebx
  return (uchar)*p - (uchar)*q;
80105ec5:	29 c8                	sub    %ecx,%eax
}
80105ec7:	5e                   	pop    %esi
80105ec8:	5f                   	pop    %edi
80105ec9:	5d                   	pop    %ebp
...
80105ed7:	8b 4d 10             	mov    0x10(%ebp),%ecx
80105eda:	53                   	push   %ebx
80105edb:	8b 75 0c             	mov    0xc(%ebp),%esi
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80105ede:	89 c2                	mov    %eax,%edx
80105ee0:	eb 15                	jmp    80105ef7 <strncpy+0x27>
80105ee2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105ee8:	46                   	inc    %esi
80105ee9:	0f b6 4e ff          	movzbl -0x1(%esi),%ecx
80105eed:	42                   	inc    %edx
80105eee:	84 c9                	test   %cl,%cl
80105ef0:	88 4a ff             	mov    %cl,-0x1(%edx)
80105ef3:	74 09                	je     80105efe <strncpy+0x2e>
80105ef5:	89 d9                	mov    %ebx,%ecx
80105ef7:	85 c9                	test   %ecx,%ecx
80105ef9:	8d 59 ff             	lea    -0x1(%ecx),%ebx
80105efc:	7f ea                	jg     80105ee8 <strncpy+0x18>
    ;
  while(n-- > 0)
80105efe:	31 c9                	xor    %ecx,%ecx
80105f00:	85 db                	test   %ebx,%ebx
80105f02:	7e 19                	jle    80105f1d <strncpy+0x4d>
80105f04:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105f0a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
    *s++ = 0;
80105f10:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
80105f14:	89 de                	mov    %ebx,%esi
80105f16:	41                   	inc    %ecx
80105f17:	29 ce                	sub    %ecx,%esi
  while(n-- > 0)
80105f19:	85 f6                	test   %esi,%esi
80105f1b:	7f f3                	jg     80105f10 <strncpy+0x40>
  return os;
}
80105f1d:	5b                   	pop    %ebx
80105f1e:	5e                   	pop    %esi
80105f1f:	5d                   	pop    %ebp
80105f20:	c3                   	ret    
80105f21:	eb 0d                	jmp    80105f30 <safestrcpy>
80105f23:	90                   	nop
80105f24:	90                   	nop
80105f25:	90                   	nop
80105f26:	90                   	nop
...
80105f33:	8b 4d 10             	mov    0x10(%ebp),%ecx
80105f36:	56                   	push   %esi
80105f37:	8b 45 08             	mov    0x8(%ebp),%eax
80105f3a:	53                   	push   %ebx
80105f3b:	8b 55 0c             	mov    0xc(%ebp),%edx
  char *os;

  os = s;
  if(n <= 0)
80105f3e:	85 c9                	test   %ecx,%ecx
80105f40:	7e 22                	jle    80105f64 <safestrcpy+0x34>
80105f42:	8d 74 0a ff          	lea    -0x1(%edx,%ecx,1),%esi
80105f46:	89 c1                	mov    %eax,%ecx
80105f48:	eb 13                	jmp    80105f5d <safestrcpy+0x2d>
80105f4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80105f50:	42                   	inc    %edx
80105f51:	0f b6 5a ff          	movzbl -0x1(%edx),%ebx
80105f55:	41                   	inc    %ecx
80105f56:	84 db                	test   %bl,%bl
80105f58:	88 59 ff             	mov    %bl,-0x1(%ecx)
80105f5b:	74 04                	je     80105f61 <safestrcpy+0x31>
80105f5d:	39 f2                	cmp    %esi,%edx
80105f5f:	75 ef                	jne    80105f50 <safestrcpy+0x20>
    ;
  *s = 0;
80105f61:	c6 01 00             	movb   $0x0,(%ecx)
  return os;
}
80105f64:	5b                   	pop    %ebx
80105f65:	5e                   	pop    %esi
...
80105f75:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
80105f78:	80 3a 00             	cmpb   $0x0,(%edx)
80105f7b:	74 0a                	je     80105f87 <strlen+0x17>
80105f7d:	8d 76 00             	lea    0x0(%esi),%esi
80105f80:	40                   	inc    %eax
80105f81:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80105f85:	75 f9                	jne    80105f80 <strlen+0x10>
    ;
  return n;
}
80105f87:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80105f89:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105f8d:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105f94:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105f95:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105f97:	89 d4                	mov    %edx,%esp
...
80105fa7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80105faa:	e8 f1 d9 ff ff       	call   801039a0 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80105faf:	8b 00                	mov    (%eax),%eax
80105fb1:	39 d8                	cmp    %ebx,%eax
80105fb3:	76 1b                	jbe    80105fd0 <fetchint+0x30>
80105fb5:	8d 53 04             	lea    0x4(%ebx),%edx
80105fb8:	39 d0                	cmp    %edx,%eax
80105fba:	72 14                	jb     80105fd0 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80105fbc:	8b 45 0c             	mov    0xc(%ebp),%eax
80105fbf:	8b 13                	mov    (%ebx),%edx
80105fc1:	89 10                	mov    %edx,(%eax)
  return 0;
...
80105fd5:	eb ee                	jmp    80105fc5 <fetchint+0x25>
...
80105fea:	e8 b1 d9 ff ff       	call   801039a0 <myproc>
  ...
  if(addr >= curproc->sz)
80105fef:	39 18                	cmp    %ebx,(%eax)
80105ff1:	76 27                	jbe    8010601a <fetchstr+0x3a>
    return -1;
  *pp = (char*)addr;
80105ff3:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105ff6:	89 da                	mov    %ebx,%edx
80105ff8:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80105ffa:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80105ffc:	39 c3                	cmp    %eax,%ebx
80105ffe:	73 1a                	jae    8010601a <fetchstr+0x3a>
    if(*s == 0)
80106000:	80 3b 00             	cmpb   $0x0,(%ebx)
80106003:	75 10                	jne    80106015 <fetchstr+0x35>
80106005:	eb 29                	jmp    80106030 <fetchstr+0x50>
80106007:	89 f6                	mov    %esi,%esi
80106009:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80106010:	80 3a 00             	cmpb   $0x0,(%edx)
80106013:	74 13                	je     80106028 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80106015:	42                   	inc    %edx
80106016:	39 d0                	cmp    %edx,%eax
80106018:	77 f6                	ja     80106010 <fetchstr+0x30>
    return -1;
...
80106028:	89 d0                	mov    %edx,%eax
8010602a:	5a                   	pop    %edx
8010602b:	29 d8                	sub    %ebx,%eax
8010602d:	5b                   	pop    %ebx
8010602e:	5d                   	pop    %ebp
8010602f:	c3                   	ret    
    if(*s == 0)
80106030:	31 c0                	xor    %eax,%eax
      return s - *pp;
80106032:	eb eb                	jmp    8010601f <fetchstr+0x3f>
...
80106045:	e8 56 d9 ff ff       	call   801039a0 <myproc>
...
80106053:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80106056:	e8 45 d9 ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80106095:	83 ec 20             	sub    $0x20,%esp
80106098:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010609b:	e8 00 d9 ff ff       	call   801039a0 <myproc>
801060a0:	89 c6                	mov    %eax,%esi
...
801060af:	e8 8c ff ff ff       	call   80106040 <argint>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
801060b4:	c1 e8 1f             	shr    $0x1f,%eax
801060b7:	84 c0                	test   %al,%al
801060b9:	75 2d                	jne    801060e8 <argptr+0x58>
801060bb:	89 d8                	mov    %ebx,%eax
801060bd:	c1 e8 1f             	shr    $0x1f,%eax
801060c0:	84 c0                	test   %al,%al
801060c2:	75 24                	jne    801060e8 <argptr+0x58>
801060c4:	8b 16                	mov    (%esi),%edx
801060c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060c9:	39 c2                	cmp    %eax,%edx
801060cb:	76 1b                	jbe    801060e8 <argptr+0x58>
801060cd:	01 c3                	add    %eax,%ebx
801060cf:	39 da                	cmp    %ebx,%edx
801060d1:	72 15                	jb     801060e8 <argptr+0x58>
    return -1;
  *pp = (char*)i;
801060d3:	8b 55 0c             	mov    0xc(%ebp),%edx
801060d6:	89 02                	mov    %eax,(%edx)
  return 0;
...
801060ed:	eb eb                	jmp    801060da <argptr+0x4a>
801060ef:	90                   	nop
...
80106103:	e8 38 ff ff ff       	call   80106040 <argint>
80106108:	85 c0                	test   %eax,%eax
8010610a:	78 14                	js     80106120 <argstr+0x30>
    return -1;
...
80106119:	e8 c2 fe ff ff       	call   80105fe0 <fetchstr>
}
8010611e:	c9                   	leave  
8010611f:	c3                   	ret    
    return -1;
...
80106134:	83 ec 14             	sub    $0x14,%esp
  int num;
  struct proc *curproc = myproc();
80106137:	e8 64 d8 ff ff       	call   801039a0 <myproc>
8010613c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
8010613e:	8b 40 18             	mov    0x18(%eax),%eax
80106141:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80106144:	8d 50 ff             	lea    -0x1(%eax),%edx
80106147:	83 fa 18             	cmp    $0x18,%edx
8010614a:	77 1c                	ja     80106168 <syscall+0x38>
8010614c:	8b 14 85 c0 90 10 80 	mov    -0x7fef6f40(,%eax,4),%edx
80106153:	85 d2                	test   %edx,%edx
80106155:	74 11                	je     80106168 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80106157:	ff d2                	call   *%edx
80106159:	8b 53 18             	mov    0x18(%ebx),%edx
8010615c:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80106165:	8d 76 00             	lea    0x0(%esi),%esi
    cprintf("%d %s: unknown sys call %d\n",
80106168:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010616c:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010616f:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
80106173:	8b 43 10             	mov    0x10(%ebx),%eax
80106176:	c7 04 24 88 90 10 80 	movl   $0x80109088,(%esp)
8010617d:	89 44 24 04          	mov    %eax,0x4(%esp)
80106181:	e8 ca a4 ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80106186:	8b 43 18             	mov    0x18(%ebx),%eax
80106189:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
801061a1:	0f bf d2             	movswl %dx,%edx
801061a4:	89 e5                	mov    %esp,%ebp
801061a6:	83 ec 58             	sub    $0x58,%esp
801061a9:	89 7d fc             	mov    %edi,-0x4(%ebp)
801061ac:	0f bf 7d 08          	movswl 0x8(%ebp),%edi
801061b0:	0f bf c9             	movswl %cx,%ecx
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
{
801061b6:	89 5d f4             	mov    %ebx,-0xc(%ebp)
801061b9:	89 75 f8             	mov    %esi,-0x8(%ebp)
801061bc:	89 7d bc             	mov    %edi,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801061bf:	8d 7d da             	lea    -0x26(%ebp),%edi
801061c2:	89 7c 24 04          	mov    %edi,0x4(%esp)
{
801061c6:	89 55 c4             	mov    %edx,-0x3c(%ebp)
801061c9:	89 4d c0             	mov    %ecx,-0x40(%ebp)
  if((dp = nameiparent(path, name)) == 0)
801061cc:	e8 1f be ff ff       	call   80101ff0 <nameiparent>
801061d1:	85 c0                	test   %eax,%eax
801061d3:	0f 84 4f 01 00 00    	je     80106328 <create+0x188>
    return 0;
  ilock(dp);
801061d9:	89 04 24             	mov    %eax,(%esp)
801061dc:	89 c3                	mov    %eax,%ebx
801061de:	e8 0d b5 ff ff       	call   801016f0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
801061e3:	8d 45 d4             	lea    -0x2c(%ebp),%eax
801061e6:	89 44 24 08          	mov    %eax,0x8(%esp)
801061ea:	89 7c 24 04          	mov    %edi,0x4(%esp)
801061ee:	89 1c 24             	mov    %ebx,(%esp)
801061f1:	e8 7a ba ff ff       	call   80101c70 <dirlookup>
801061f6:	85 c0                	test   %eax,%eax
801061f8:	89 c6                	mov    %eax,%esi
801061fa:	74 34                	je     80106230 <create+0x90>
    iunlockput(dp);
801061fc:	89 1c 24             	mov    %ebx,(%esp)
801061ff:	e8 7c b7 ff ff       	call   80101980 <iunlockput>
    ilock(ip);
80106204:	89 34 24             	mov    %esi,(%esp)
80106207:	e8 e4 b4 ff ff       	call   801016f0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010620c:	83 7d c4 02          	cmpl   $0x2,-0x3c(%ebp)
80106210:	0f 85 9a 00 00 00    	jne    801062b0 <create+0x110>
80106216:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010621b:	0f 85 8f 00 00 00    	jne    801062b0 <create+0x110>
...
80106223:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80106226:	8b 75 f8             	mov    -0x8(%ebp),%esi
80106229:	8b 7d fc             	mov    -0x4(%ebp),%edi
8010622c:	89 ec                	mov    %ebp,%esp
8010622e:	5d                   	pop    %ebp
8010622f:	c3                   	ret    
  if((ip = ialloc(dp->dev, type)) == 0)
80106230:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80106233:	89 44 24 04          	mov    %eax,0x4(%esp)
80106237:	8b 03                	mov    (%ebx),%eax
80106239:	89 04 24             	mov    %eax,(%esp)
8010623c:	e8 2f b3 ff ff       	call   80101570 <ialloc>
80106241:	85 c0                	test   %eax,%eax
80106243:	89 c6                	mov    %eax,%esi
80106245:	0f 84 f0 00 00 00    	je     8010633b <create+0x19b>
  ilock(ip);
8010624b:	89 04 24             	mov    %eax,(%esp)
8010624e:	e8 9d b4 ff ff       	call   801016f0 <ilock>
  ip->major = major;
80106253:	8b 45 c0             	mov    -0x40(%ebp),%eax
  ip->nlink = 1;
80106256:	66 c7 46 56 01 00    	movw   $0x1,0x56(%esi)
  ip->major = major;
8010625c:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
80106260:	8b 45 bc             	mov    -0x44(%ebp),%eax
80106263:	66 89 46 54          	mov    %ax,0x54(%esi)
  iupdate(ip);
80106267:	89 34 24             	mov    %esi,(%esp)
8010626a:	e8 c1 b3 ff ff       	call   80101630 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
8010626f:	83 7d c4 01          	cmpl   $0x1,-0x3c(%ebp)
80106273:	74 5b                	je     801062d0 <create+0x130>
  if(dirlink(dp, name, ip->inum) < 0)
80106275:	8b 46 04             	mov    0x4(%esi),%eax
80106278:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010627c:	89 1c 24             	mov    %ebx,(%esp)
8010627f:	89 44 24 08          	mov    %eax,0x8(%esp)
80106283:	e8 68 bc ff ff       	call   80101ef0 <dirlink>
80106288:	85 c0                	test   %eax,%eax
8010628a:	0f 88 9f 00 00 00    	js     8010632f <create+0x18f>
  iunlockput(dp);
80106290:	89 1c 24             	mov    %ebx,(%esp)
80106293:	e8 e8 b6 ff ff       	call   80101980 <iunlockput>
}
80106298:	89 f0                	mov    %esi,%eax
8010629a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010629d:	8b 75 f8             	mov    -0x8(%ebp),%esi
801062a0:	8b 7d fc             	mov    -0x4(%ebp),%edi
801062a3:	89 ec                	mov    %ebp,%esp
801062a5:	5d                   	pop    %ebp
801062a6:	c3                   	ret    
...
801062b0:	89 34 24             	mov    %esi,(%esp)
    return 0;
801062b3:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
801062b5:	e8 c6 b6 ff ff       	call   80101980 <iunlockput>
}
801062ba:	89 f0                	mov    %esi,%eax
801062bc:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801062bf:	8b 75 f8             	mov    -0x8(%ebp),%esi
801062c2:	8b 7d fc             	mov    -0x4(%ebp),%edi
801062c5:	89 ec                	mov    %ebp,%esp
801062c7:	5d                   	pop    %ebp
801062c8:	c3                   	ret    
801062c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink++;  // for ".."
801062d0:	66 ff 43 56          	incw   0x56(%ebx)
    iupdate(dp);
801062d4:	89 1c 24             	mov    %ebx,(%esp)
801062d7:	e8 54 b3 ff ff       	call   80101630 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801062dc:	8b 46 04             	mov    0x4(%esi),%eax
801062df:	ba 44 91 10 80       	mov    $0x80109144,%edx
801062e4:	89 54 24 04          	mov    %edx,0x4(%esp)
801062e8:	89 34 24             	mov    %esi,(%esp)
801062eb:	89 44 24 08          	mov    %eax,0x8(%esp)
801062ef:	e8 fc bb ff ff       	call   80101ef0 <dirlink>
801062f4:	85 c0                	test   %eax,%eax
801062f6:	78 20                	js     80106318 <create+0x178>
801062f8:	8b 43 04             	mov    0x4(%ebx),%eax
801062fb:	89 34 24             	mov    %esi,(%esp)
801062fe:	89 44 24 08          	mov    %eax,0x8(%esp)
80106302:	b8 43 91 10 80       	mov    $0x80109143,%eax
80106307:	89 44 24 04          	mov    %eax,0x4(%esp)
8010630b:	e8 e0 bb ff ff       	call   80101ef0 <dirlink>
80106310:	85 c0                	test   %eax,%eax
80106312:	0f 89 5d ff ff ff    	jns    80106275 <create+0xd5>
      panic("create dots");
80106318:	c7 04 24 37 91 10 80 	movl   $0x80109137,(%esp)
8010631f:	e8 4c a0 ff ff       	call   80100370 <panic>
80106324:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return 0;
80106328:	31 f6                	xor    %esi,%esi
8010632a:	e9 f2 fe ff ff       	jmp    80106221 <create+0x81>
    panic("create: dirlink");
8010632f:	c7 04 24 46 91 10 80 	movl   $0x80109146,(%esp)
80106336:	e8 35 a0 ff ff       	call   80100370 <panic>
    panic("create: ialloc");
8010633b:	c7 04 24 28 91 10 80 	movl   $0x80109128,(%esp)
80106342:	e8 29 a0 ff ff       	call   80100370 <panic>
80106347:	89 f6                	mov    %esi,%esi
80106349:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80106350 <argfd.constprop.0>:
argfd(int n, int *pfd, struct file **pf)
80106350:	55                   	push   %ebp
80106351:	89 e5                	mov    %esp,%ebp
80106353:	56                   	push   %esi
80106354:	89 d6                	mov    %edx,%esi
80106356:	53                   	push   %ebx
80106357:	89 c3                	mov    %eax,%ebx
80106359:	83 ec 20             	sub    $0x20,%esp
  if(argint(n, &fd) < 0)
8010635c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010635f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106363:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010636a:	e8 d1 fc ff ff       	call   80106040 <argint>
8010636f:	85 c0                	test   %eax,%eax
80106371:	78 2d                	js     801063a0 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80106373:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80106377:	77 27                	ja     801063a0 <argfd.constprop.0+0x50>
80106379:	e8 22 d6 ff ff       	call   801039a0 <myproc>
8010637e:	8b 55 f4             	mov    -0xc(%ebp),%edx
80106381:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80106385:	85 c0                	test   %eax,%eax
80106387:	74 17                	je     801063a0 <argfd.constprop.0+0x50>
  if(pfd)
80106389:	85 db                	test   %ebx,%ebx
8010638b:	74 02                	je     8010638f <argfd.constprop.0+0x3f>
    *pfd = fd;
8010638d:	89 13                	mov    %edx,(%ebx)
    *pf = f;
8010638f:	89 06                	mov    %eax,(%esi)
  return 0;
80106391:	31 c0                	xor    %eax,%eax
}
80106393:	83 c4 20             	add    $0x20,%esp
80106396:	5b                   	pop    %ebx
80106397:	5e                   	pop    %esi
80106398:	5d                   	pop    %ebp
80106399:	c3                   	ret    
...
801063a5:	eb ec                	jmp    80106393 <argfd.constprop.0+0x43>
...
801063b7:	83 ec 20             	sub    $0x20,%esp
  if(argfd(0, 0, &f) < 0)
801063ba:	8d 55 f4             	lea    -0xc(%ebp),%edx
801063bd:	e8 8e ff ff ff       	call   80106350 <argfd.constprop.0>
801063c2:	85 c0                	test   %eax,%eax
801063c4:	78 3a                	js     80106400 <sys_dup+0x50>
  if((fd=fdalloc(f)) < 0)
801063c6:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
801063c9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801063cb:	e8 d0 d5 ff ff       	call   801039a0 <myproc>
801063d0:	eb 0c                	jmp    801063de <sys_dup+0x2e>
801063d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
801063d8:	43                   	inc    %ebx
801063d9:	83 fb 10             	cmp    $0x10,%ebx
801063dc:	74 22                	je     80106400 <sys_dup+0x50>
    if(curproc->ofile[fd] == 0){
801063de:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
801063e2:	85 d2                	test   %edx,%edx
801063e4:	75 f2                	jne    801063d8 <sys_dup+0x28>
      curproc->ofile[fd] = f;
801063e6:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
801063ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063ed:	89 04 24             	mov    %eax,(%esp)
801063f0:	e8 eb a9 ff ff       	call   80100de0 <filedup>
}
...
80106400:	83 c4 20             	add    $0x20,%esp
    return -1;
80106403:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80106415:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80106418:	8d 55 ec             	lea    -0x14(%ebp),%edx
8010641b:	e8 30 ff ff ff       	call   80106350 <argfd.constprop.0>
80106420:	85 c0                	test   %eax,%eax
80106422:	78 54                	js     80106478 <sys_read+0x68>
80106424:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106427:	89 44 24 04          	mov    %eax,0x4(%esp)
8010642b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106432:	e8 09 fc ff ff       	call   80106040 <argint>
80106437:	85 c0                	test   %eax,%eax
80106439:	78 3d                	js     80106478 <sys_read+0x68>
8010643b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010643e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106445:	89 44 24 08          	mov    %eax,0x8(%esp)
80106449:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010644c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106450:	e8 3b fc ff ff       	call   80106090 <argptr>
80106455:	85 c0                	test   %eax,%eax
80106457:	78 1f                	js     80106478 <sys_read+0x68>
  return fileread(f, p, n);
80106459:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010645c:	89 44 24 08          	mov    %eax,0x8(%esp)
...
8010646d:	e8 ee aa ff ff       	call   80100f60 <fileread>
}
80106472:	c9                   	leave  
80106473:	c3                   	ret    
...
8010648b:	e8 c0 fe ff ff       	call   80106350 <argfd.constprop.0>
80106490:	85 c0                	test   %eax,%eax
80106492:	78 54                	js     801064e8 <sys_write+0x68>
80106494:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106497:	89 44 24 04          	mov    %eax,0x4(%esp)
8010649b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801064a2:	e8 99 fb ff ff       	call   80106040 <argint>
801064a7:	85 c0                	test   %eax,%eax
801064a9:	78 3d                	js     801064e8 <sys_write+0x68>
...
801064c0:	e8 cb fb ff ff       	call   80106090 <argptr>
801064c5:	85 c0                	test   %eax,%eax
801064c7:	78 1f                	js     801064e8 <sys_write+0x68>
...
801064dd:	e8 2e ab ff ff       	call   80101010 <filewrite>
}
801064e2:	c9                   	leave  
801064e3:	c3                   	ret    
...
801064f3:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, &fd, &f) < 0)
801064f6:	8d 55 f4             	lea    -0xc(%ebp),%edx
801064f9:	8d 45 f0             	lea    -0x10(%ebp),%eax
801064fc:	e8 4f fe ff ff       	call   80106350 <argfd.constprop.0>
80106501:	85 c0                	test   %eax,%eax
80106503:	78 23                	js     80106528 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80106505:	e8 96 d4 ff ff       	call   801039a0 <myproc>
8010650a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010650d:	31 c9                	xor    %ecx,%ecx
8010650f:	89 4c 90 28          	mov    %ecx,0x28(%eax,%edx,4)
  fileclose(f);
80106513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106516:	89 04 24             	mov    %eax,(%esp)
80106519:	e8 12 a9 ff ff       	call   80100e30 <fileclose>
  return 0;
...
80106535:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80106538:	8d 55 f0             	lea    -0x10(%ebp),%edx
8010653b:	e8 10 fe ff ff       	call   80106350 <argfd.constprop.0>
80106540:	85 c0                	test   %eax,%eax
80106542:	78 3c                	js     80106580 <sys_fstat+0x50>
80106544:	b8 14 00 00 00       	mov    $0x14,%eax
...
8010655b:	e8 30 fb ff ff       	call   80106090 <argptr>
80106560:	85 c0                	test   %eax,%eax
80106562:	78 1c                	js     80106580 <sys_fstat+0x50>
...
80106571:	e8 9a a9 ff ff       	call   80100f10 <filestat>
}
80106576:	c9                   	leave  
80106577:	c3                   	ret    
80106578:	90                   	nop
...
80106596:	83 ec 3c             	sub    $0x3c,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80106599:	8d 45 d4             	lea    -0x2c(%ebp),%eax
8010659c:	89 44 24 04          	mov    %eax,0x4(%esp)
801065a0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801065a7:	e8 44 fb ff ff       	call   801060f0 <argstr>
801065ac:	85 c0                	test   %eax,%eax
801065ae:	0f 88 e5 00 00 00    	js     80106699 <sys_link+0x109>
801065b4:	8d 45 d0             	lea    -0x30(%ebp),%eax
801065b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801065bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801065c2:	e8 29 fb ff ff       	call   801060f0 <argstr>
801065c7:	85 c0                	test   %eax,%eax
801065c9:	0f 88 ca 00 00 00    	js     80106699 <sys_link+0x109>
  begin_op();
801065cf:	e8 bc c6 ff ff       	call   80102c90 <begin_op>
  if((ip = namei(old)) == 0){
801065d4:	8b 45 d4             	mov    -0x2c(%ebp),%eax
801065d7:	89 04 24             	mov    %eax,(%esp)
801065da:	e8 f1 b9 ff ff       	call   80101fd0 <namei>
801065df:	85 c0                	test   %eax,%eax
801065e1:	89 c3                	mov    %eax,%ebx
801065e3:	0f 84 ab 00 00 00    	je     80106694 <sys_link+0x104>
  ilock(ip);
801065e9:	89 04 24             	mov    %eax,(%esp)
801065ec:	e8 ff b0 ff ff       	call   801016f0 <ilock>
  if(ip->type == T_DIR){
801065f1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801065f6:	0f 84 90 00 00 00    	je     8010668c <sys_link+0xfc>
  ip->nlink++;
801065fc:	66 ff 43 56          	incw   0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80106600:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80106603:	89 1c 24             	mov    %ebx,(%esp)
80106606:	e8 25 b0 ff ff       	call   80101630 <iupdate>
  iunlock(ip);
8010660b:	89 1c 24             	mov    %ebx,(%esp)
8010660e:	e8 bd b1 ff ff       	call   801017d0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80106613:	8b 45 d0             	mov    -0x30(%ebp),%eax
80106616:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010661a:	89 04 24             	mov    %eax,(%esp)
8010661d:	e8 ce b9 ff ff       	call   80101ff0 <nameiparent>
80106622:	85 c0                	test   %eax,%eax
80106624:	89 c6                	mov    %eax,%esi
80106626:	74 50                	je     80106678 <sys_link+0xe8>
  ilock(dp);
80106628:	89 04 24             	mov    %eax,(%esp)
8010662b:	e8 c0 b0 ff ff       	call   801016f0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80106630:	8b 03                	mov    (%ebx),%eax
80106632:	39 06                	cmp    %eax,(%esi)
80106634:	75 3a                	jne    80106670 <sys_link+0xe0>
80106636:	8b 43 04             	mov    0x4(%ebx),%eax
80106639:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010663d:	89 34 24             	mov    %esi,(%esp)
80106640:	89 44 24 08          	mov    %eax,0x8(%esp)
80106644:	e8 a7 b8 ff ff       	call   80101ef0 <dirlink>
80106649:	85 c0                	test   %eax,%eax
8010664b:	78 23                	js     80106670 <sys_link+0xe0>
  iunlockput(dp);
8010664d:	89 34 24             	mov    %esi,(%esp)
80106650:	e8 2b b3 ff ff       	call   80101980 <iunlockput>
  iput(ip);
80106655:	89 1c 24             	mov    %ebx,(%esp)
80106658:	e8 c3 b1 ff ff       	call   80101820 <iput>
  end_op();
8010665d:	e8 9e c6 ff ff       	call   80102d00 <end_op>
}
80106662:	83 c4 3c             	add    $0x3c,%esp
  return 0;
80106665:	31 c0                	xor    %eax,%eax
}
80106667:	5b                   	pop    %ebx
80106668:	5e                   	pop    %esi
80106669:	5f                   	pop    %edi
...
8010666c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    iunlockput(dp);
80106670:	89 34 24             	mov    %esi,(%esp)
80106673:	e8 08 b3 ff ff       	call   80101980 <iunlockput>
  ilock(ip);
80106678:	89 1c 24             	mov    %ebx,(%esp)
8010667b:	e8 70 b0 ff ff       	call   801016f0 <ilock>
  ip->nlink--;
80106680:	66 ff 4b 56          	decw   0x56(%ebx)
  iupdate(ip);
80106684:	89 1c 24             	mov    %ebx,(%esp)
80106687:	e8 a4 af ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
8010668c:	89 1c 24             	mov    %ebx,(%esp)
8010668f:	e8 ec b2 ff ff       	call   80101980 <iunlockput>
  end_op();
80106694:	e8 67 c6 ff ff       	call   80102d00 <end_op>
}
80106699:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
801066b6:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
801066b9:	8d 45 c0             	lea    -0x40(%ebp),%eax
801066bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801066c0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801066c7:	e8 24 fa ff ff       	call   801060f0 <argstr>
801066cc:	85 c0                	test   %eax,%eax
801066ce:	0f 88 68 01 00 00    	js     8010683c <sys_unlink+0x18c>
  begin_op();
801066d4:	e8 b7 c5 ff ff       	call   80102c90 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801066d9:	8b 45 c0             	mov    -0x40(%ebp),%eax
801066dc:	8d 5d ca             	lea    -0x36(%ebp),%ebx
801066df:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801066e3:	89 04 24             	mov    %eax,(%esp)
801066e6:	e8 05 b9 ff ff       	call   80101ff0 <nameiparent>
801066eb:	85 c0                	test   %eax,%eax
801066ed:	89 c6                	mov    %eax,%esi
801066ef:	0f 84 42 01 00 00    	je     80106837 <sys_unlink+0x187>
  ilock(dp);
801066f5:	89 04 24             	mov    %eax,(%esp)
801066f8:	e8 f3 af ff ff       	call   801016f0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801066fd:	b8 44 91 10 80       	mov    $0x80109144,%eax
80106702:	89 44 24 04          	mov    %eax,0x4(%esp)
80106706:	89 1c 24             	mov    %ebx,(%esp)
80106709:	e8 32 b5 ff ff       	call   80101c40 <namecmp>
8010670e:	85 c0                	test   %eax,%eax
80106710:	0f 84 19 01 00 00    	je     8010682f <sys_unlink+0x17f>
80106716:	b8 43 91 10 80       	mov    $0x80109143,%eax
8010671b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010671f:	89 1c 24             	mov    %ebx,(%esp)
80106722:	e8 19 b5 ff ff       	call   80101c40 <namecmp>
80106727:	85 c0                	test   %eax,%eax
80106729:	0f 84 00 01 00 00    	je     8010682f <sys_unlink+0x17f>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010672f:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80106732:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106736:	89 44 24 08          	mov    %eax,0x8(%esp)
8010673a:	89 34 24             	mov    %esi,(%esp)
8010673d:	e8 2e b5 ff ff       	call   80101c70 <dirlookup>
80106742:	85 c0                	test   %eax,%eax
80106744:	89 c3                	mov    %eax,%ebx
80106746:	0f 84 e3 00 00 00    	je     8010682f <sys_unlink+0x17f>
  ilock(ip);
8010674c:	89 04 24             	mov    %eax,(%esp)
8010674f:	e8 9c af ff ff       	call   801016f0 <ilock>
  if(ip->nlink < 1)
80106754:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80106759:	0f 8e 0e 01 00 00    	jle    8010686d <sys_unlink+0x1bd>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010675f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106764:	8d 7d d8             	lea    -0x28(%ebp),%edi
80106767:	74 77                	je     801067e0 <sys_unlink+0x130>
  memset(&de, 0, sizeof(de));
80106769:	31 d2                	xor    %edx,%edx
8010676b:	b8 10 00 00 00       	mov    $0x10,%eax
80106770:	89 54 24 04          	mov    %edx,0x4(%esp)
80106774:	89 44 24 08          	mov    %eax,0x8(%esp)
80106778:	89 3c 24             	mov    %edi,(%esp)
8010677b:	e8 d0 f5 ff ff       	call   80105d50 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80106780:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80106783:	b9 10 00 00 00       	mov    $0x10,%ecx
80106788:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010678c:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106790:	89 34 24             	mov    %esi,(%esp)
80106793:	89 44 24 08          	mov    %eax,0x8(%esp)
80106797:	e8 54 b3 ff ff       	call   80101af0 <writei>
8010679c:	83 f8 10             	cmp    $0x10,%eax
8010679f:	0f 85 d4 00 00 00    	jne    80106879 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
801067a5:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801067aa:	0f 84 a0 00 00 00    	je     80106850 <sys_unlink+0x1a0>
  iunlockput(dp);
801067b0:	89 34 24             	mov    %esi,(%esp)
801067b3:	e8 c8 b1 ff ff       	call   80101980 <iunlockput>
  ip->nlink--;
801067b8:	66 ff 4b 56          	decw   0x56(%ebx)
  iupdate(ip);
801067bc:	89 1c 24             	mov    %ebx,(%esp)
801067bf:	e8 6c ae ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
801067c4:	89 1c 24             	mov    %ebx,(%esp)
801067c7:	e8 b4 b1 ff ff       	call   80101980 <iunlockput>
  end_op();
801067cc:	e8 2f c5 ff ff       	call   80102d00 <end_op>
}
801067d1:	83 c4 5c             	add    $0x5c,%esp
  return 0;
801067d4:	31 c0                	xor    %eax,%eax
}
801067d6:	5b                   	pop    %ebx
801067d7:	5e                   	pop    %esi
801067d8:	5f                   	pop    %edi
...
801067e0:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
801067e4:	76 83                	jbe    80106769 <sys_unlink+0xb9>
801067e6:	ba 20 00 00 00       	mov    $0x20,%edx
801067eb:	eb 0f                	jmp    801067fc <sys_unlink+0x14c>
801067ed:	8d 76 00             	lea    0x0(%esi),%esi
801067f0:	83 c2 10             	add    $0x10,%edx
801067f3:	3b 53 58             	cmp    0x58(%ebx),%edx
801067f6:	0f 83 6d ff ff ff    	jae    80106769 <sys_unlink+0xb9>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801067fc:	b8 10 00 00 00       	mov    $0x10,%eax
80106801:	89 54 24 08          	mov    %edx,0x8(%esp)
80106805:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106809:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010680d:	89 1c 24             	mov    %ebx,(%esp)
80106810:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80106813:	e8 b8 b1 ff ff       	call   801019d0 <readi>
80106818:	8b 55 b4             	mov    -0x4c(%ebp),%edx
8010681b:	83 f8 10             	cmp    $0x10,%eax
8010681e:	75 41                	jne    80106861 <sys_unlink+0x1b1>
    if(de.inum != 0)
80106820:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80106825:	74 c9                	je     801067f0 <sys_unlink+0x140>
    iunlockput(ip);
80106827:	89 1c 24             	mov    %ebx,(%esp)
8010682a:	e8 51 b1 ff ff       	call   80101980 <iunlockput>
  iunlockput(dp);
8010682f:	89 34 24             	mov    %esi,(%esp)
80106832:	e8 49 b1 ff ff       	call   80101980 <iunlockput>
  end_op();
80106837:	e8 c4 c4 ff ff       	call   80102d00 <end_op>
}
8010683c:	83 c4 5c             	add    $0x5c,%esp
  return -1;
...
80106849:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink--;
80106850:	66 ff 4e 56          	decw   0x56(%esi)
    iupdate(dp);
80106854:	89 34 24             	mov    %esi,(%esp)
80106857:	e8 d4 ad ff ff       	call   80101630 <iupdate>
8010685c:	e9 4f ff ff ff       	jmp    801067b0 <sys_unlink+0x100>
      panic("isdirempty: readi");
80106861:	c7 04 24 68 91 10 80 	movl   $0x80109168,(%esp)
80106868:	e8 03 9b ff ff       	call   80100370 <panic>
    panic("unlink: nlink < 1");
8010686d:	c7 04 24 56 91 10 80 	movl   $0x80109156,(%esp)
80106874:	e8 f7 9a ff ff       	call   80100370 <panic>
    panic("unlink: writei");
80106879:	c7 04 24 7a 91 10 80 	movl   $0x8010917a,(%esp)
80106880:	e8 eb 9a ff ff       	call   80100370 <panic>
...
801068a7:	e8 44 f8 ff ff       	call   801060f0 <argstr>
801068ac:	85 c0                	test   %eax,%eax
801068ae:	0f 88 e9 00 00 00    	js     8010699d <sys_open+0x10d>
801068b4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801068b7:	89 44 24 04          	mov    %eax,0x4(%esp)
801068bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801068c2:	e8 79 f7 ff ff       	call   80106040 <argint>
801068c7:	85 c0                	test   %eax,%eax
801068c9:	0f 88 ce 00 00 00    	js     8010699d <sys_open+0x10d>
    return -1;

  begin_op();
801068cf:	e8 bc c3 ff ff       	call   80102c90 <begin_op>

  if(omode & O_CREATE){
801068d4:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
801068d8:	0f 85 9a 00 00 00    	jne    80106978 <sys_open+0xe8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
801068e4:	e8 e7 b6 ff ff       	call   80101fd0 <namei>
801068e9:	85 c0                	test   %eax,%eax
801068eb:	89 c6                	mov    %eax,%esi
801068ed:	0f 84 a5 00 00 00    	je     80106998 <sys_open+0x108>
      end_op();
      return -1;
    }
    ilock(ip);
801068f3:	89 04 24             	mov    %eax,(%esp)
801068f6:	e8 f5 ad ff ff       	call   801016f0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801068fb:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80106900:	0f 84 a2 00 00 00    	je     801069a8 <sys_open+0x118>
      end_op();
      return -1;
    }
  }
...
80106906:	e8 65 a4 ff ff       	call   80100d70 <filealloc>
8010690b:	85 c0                	test   %eax,%eax
8010690d:	89 c7                	mov    %eax,%edi
8010690f:	0f 84 9e 00 00 00    	je     801069b3 <sys_open+0x123>
  struct proc *curproc = myproc();
80106915:	e8 86 d0 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010691a:	31 db                	xor    %ebx,%ebx
8010691c:	eb 0c                	jmp    8010692a <sys_open+0x9a>
8010691e:	66 90                	xchg   %ax,%ax
80106920:	43                   	inc    %ebx
80106921:	83 fb 10             	cmp    $0x10,%ebx
80106924:	0f 84 96 00 00 00    	je     801069c0 <sys_open+0x130>
    if(curproc->ofile[fd] == 0){
8010692a:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
8010692e:	85 d2                	test   %edx,%edx
80106930:	75 ee                	jne    80106920 <sys_open+0x90>
      curproc->ofile[fd] = f;
80106932:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80106936:	89 34 24             	mov    %esi,(%esp)
80106939:	e8 92 ae ff ff       	call   801017d0 <iunlock>
  end_op();
8010693e:	e8 bd c3 ff ff       	call   80102d00 <end_op>

  f->type = FD_INODE;
80106943:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80106949:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->ip = ip;
8010694c:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
8010694f:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80106956:	89 d0                	mov    %edx,%eax
80106958:	f7 d0                	not    %eax
8010695a:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010695d:	f6 c2 03             	test   $0x3,%dl
  f->readable = !(omode & O_WRONLY);
80106960:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80106963:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80106967:	83 c4 2c             	add    $0x2c,%esp
8010696a:	89 d8                	mov    %ebx,%eax
8010696c:	5b                   	pop    %ebx
8010696d:	5e                   	pop    %esi
8010696e:	5f                   	pop    %edi
8010696f:	5d                   	pop    %ebp
...
80106978:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010697b:	31 c9                	xor    %ecx,%ecx
8010697d:	ba 02 00 00 00       	mov    $0x2,%edx
80106982:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106989:	e8 12 f8 ff ff       	call   801061a0 <create>
    if(ip == 0){
8010698e:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
80106990:	89 c6                	mov    %eax,%esi
    if(ip == 0){
80106992:	0f 85 6e ff ff ff    	jne    80106906 <sys_open+0x76>
    end_op();
80106998:	e8 63 c3 ff ff       	call   80102d00 <end_op>
    return -1;
8010699d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801069a2:	eb c3                	jmp    80106967 <sys_open+0xd7>
801069a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
801069a8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801069ab:	85 c9                	test   %ecx,%ecx
801069ad:	0f 84 53 ff ff ff    	je     80106906 <sys_open+0x76>
    iunlockput(ip);
801069b3:	89 34 24             	mov    %esi,(%esp)
801069b6:	e8 c5 af ff ff       	call   80101980 <iunlockput>
801069bb:	eb db                	jmp    80106998 <sys_open+0x108>
801069bd:	8d 76 00             	lea    0x0(%esi),%esi
      fileclose(f);
801069c0:	89 3c 24             	mov    %edi,(%esp)
801069c3:	e8 68 a4 ff ff       	call   80100e30 <fileclose>
801069c8:	eb e9                	jmp    801069b3 <sys_open+0x123>
...
801069d3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801069d6:	e8 b5 c2 ff ff       	call   80102c90 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801069db:	8d 45 f4             	lea    -0xc(%ebp),%eax
801069de:	89 44 24 04          	mov    %eax,0x4(%esp)
801069e2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069e9:	e8 02 f7 ff ff       	call   801060f0 <argstr>
801069ee:	85 c0                	test   %eax,%eax
801069f0:	78 2e                	js     80106a20 <sys_mkdir+0x50>
801069f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801069f5:	31 c9                	xor    %ecx,%ecx
801069f7:	ba 01 00 00 00       	mov    $0x1,%edx
801069fc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a03:	e8 98 f7 ff ff       	call   801061a0 <create>
80106a08:	85 c0                	test   %eax,%eax
80106a0a:	74 14                	je     80106a20 <sys_mkdir+0x50>
    end_op();
    return -1;
  }
  iunlockput(ip);
80106a0c:	89 04 24             	mov    %eax,(%esp)
80106a0f:	e8 6c af ff ff       	call   80101980 <iunlockput>
  end_op();
80106a14:	e8 e7 c2 ff ff       	call   80102d00 <end_op>
  return 0;
80106a19:	31 c0                	xor    %eax,%eax
}
80106a1b:	c9                   	leave  
80106a1c:	c3                   	ret    
80106a1d:	8d 76 00             	lea    0x0(%esi),%esi
    end_op();
80106a20:	e8 db c2 ff ff       	call   80102d00 <end_op>
    return -1;
...
80106a33:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106a36:	e8 55 c2 ff ff       	call   80102c90 <begin_op>
  if((argstr(0, &path)) < 0 ||
80106a3b:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106a3e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a42:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106a49:	e8 a2 f6 ff ff       	call   801060f0 <argstr>
80106a4e:	85 c0                	test   %eax,%eax
80106a50:	78 5e                	js     80106ab0 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
80106a52:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106a55:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106a60:	e8 db f5 ff ff       	call   80106040 <argint>
  if((argstr(0, &path)) < 0 ||
80106a65:	85 c0                	test   %eax,%eax
80106a67:	78 47                	js     80106ab0 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
80106a69:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106a6c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a70:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106a77:	e8 c4 f5 ff ff       	call   80106040 <argint>
     argint(1, &major) < 0 ||
80106a7c:	85 c0                	test   %eax,%eax
80106a7e:	78 30                	js     80106ab0 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
80106a80:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
80106a84:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
80106a89:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
80106a8d:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
80106a90:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106a93:	e8 08 f7 ff ff       	call   801061a0 <create>
80106a98:	85 c0                	test   %eax,%eax
80106a9a:	74 14                	je     80106ab0 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80106ac5:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80106ac8:	e8 d3 ce ff ff       	call   801039a0 <myproc>
80106acd:	89 c6                	mov    %eax,%esi
  
  begin_op();
80106acf:	e8 bc c1 ff ff       	call   80102c90 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106ad4:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106ad7:	89 44 24 04          	mov    %eax,0x4(%esp)
80106adb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ae2:	e8 09 f6 ff ff       	call   801060f0 <argstr>
80106ae7:	85 c0                	test   %eax,%eax
80106ae9:	78 4a                	js     80106b35 <sys_chdir+0x75>
80106aeb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106aee:	89 04 24             	mov    %eax,(%esp)
80106af1:	e8 da b4 ff ff       	call   80101fd0 <namei>
80106af6:	85 c0                	test   %eax,%eax
80106af8:	89 c3                	mov    %eax,%ebx
80106afa:	74 39                	je     80106b35 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
80106afc:	89 04 24             	mov    %eax,(%esp)
80106aff:	e8 ec ab ff ff       	call   801016f0 <ilock>
  if(ip->type != T_DIR){
80106b04:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
80106b09:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
80106b0c:	75 22                	jne    80106b30 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
80106b0e:	e8 bd ac ff ff       	call   801017d0 <iunlock>
  iput(curproc->cwd);
80106b13:	8b 46 68             	mov    0x68(%esi),%eax
80106b16:	89 04 24             	mov    %eax,(%esp)
80106b19:	e8 02 ad ff ff       	call   80101820 <iput>
  end_op();
80106b1e:	e8 dd c1 ff ff       	call   80102d00 <end_op>
  curproc->cwd = ip;
  return 0;
80106b23:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80106b25:	89 5e 68             	mov    %ebx,0x68(%esi)
}
...
80106b2f:	90                   	nop
    iunlockput(ip);
80106b30:	e8 4b ae ff ff       	call   80101980 <iunlockput>
    end_op();
80106b35:	e8 c6 c1 ff ff       	call   80102d00 <end_op>
    return -1;
80106b3a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b3f:	eb e7                	jmp    80106b28 <sys_chdir+0x68>
80106b41:	eb 0d                	jmp    80106b50 <sys_exec>
80106b43:	90                   	nop
80106b44:	90                   	nop
80106b45:	90                   	nop
80106b46:	90                   	nop
...
80106b56:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
80106b5c:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
80106b62:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b66:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106b6d:	e8 7e f5 ff ff       	call   801060f0 <argstr>
80106b72:	85 c0                	test   %eax,%eax
80106b74:	0f 88 8e 00 00 00    	js     80106c08 <sys_exec+0xb8>
80106b7a:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
80106b80:	89 44 24 04          	mov    %eax,0x4(%esp)
80106b84:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106b8b:	e8 b0 f4 ff ff       	call   80106040 <argint>
80106b90:	85 c0                	test   %eax,%eax
80106b92:	78 74                	js     80106c08 <sys_exec+0xb8>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80106b94:	ba 80 00 00 00       	mov    $0x80,%edx
80106b99:	31 c9                	xor    %ecx,%ecx
80106b9b:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
80106ba1:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
80106ba3:	89 54 24 08          	mov    %edx,0x8(%esp)
80106ba7:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80106bad:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106bb1:	89 04 24             	mov    %eax,(%esp)
80106bb4:	e8 97 f1 ff ff       	call   80105d50 <memset>
80106bb9:	eb 2e                	jmp    80106be9 <sys_exec+0x99>
80106bbb:	90                   	nop
80106bbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
      return -1;
    if(uarg == 0){
80106bc0:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
80106bc6:	85 c0                	test   %eax,%eax
80106bc8:	74 56                	je     80106c20 <sys_exec+0xd0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80106bca:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80106bd0:	8d 14 31             	lea    (%ecx,%esi,1),%edx
80106bd3:	89 54 24 04          	mov    %edx,0x4(%esp)
80106bd7:	89 04 24             	mov    %eax,(%esp)
80106bda:	e8 01 f4 ff ff       	call   80105fe0 <fetchstr>
80106bdf:	85 c0                	test   %eax,%eax
80106be1:	78 25                	js     80106c08 <sys_exec+0xb8>
  for(i=0;; i++){
80106be3:	43                   	inc    %ebx
    if(i >= NELEM(argv))
80106be4:	83 fb 20             	cmp    $0x20,%ebx
80106be7:	74 1f                	je     80106c08 <sys_exec+0xb8>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106be9:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80106bef:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80106bf6:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106bfa:	01 f0                	add    %esi,%eax
80106bfc:	89 04 24             	mov    %eax,(%esp)
80106bff:	e8 9c f3 ff ff       	call   80105fa0 <fetchint>
80106c04:	85 c0                	test   %eax,%eax
80106c06:	79 b8                	jns    80106bc0 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
80106c08:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
80106c22:	89 84 9d 68 ff ff ff 	mov    %eax,-0x98(%ebp,%ebx,4)
  return exec(path, argv);
80106c29:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106c2f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c33:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
80106c39:	89 04 24             	mov    %eax,(%esp)
80106c3c:	e8 8f 9d ff ff       	call   801009d0 <exec>
}
80106c41:	81 c4 ac 00 00 00    	add    $0xac,%esp
80106c47:	5b                   	pop    %ebx
80106c48:	5e                   	pop    %esi
80106c49:	5f                   	pop    %edi
80106c4a:	5d                   	pop    %ebp
...
80106c54:	bf 08 00 00 00       	mov    $0x8,%edi
{
80106c59:	56                   	push   %esi
80106c5a:	53                   	push   %ebx
80106c5b:	83 ec 2c             	sub    $0x2c,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106c5e:	8d 45 dc             	lea    -0x24(%ebp),%eax
80106c61:	89 7c 24 08          	mov    %edi,0x8(%esp)
80106c65:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c69:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106c70:	e8 1b f4 ff ff       	call   80106090 <argptr>
80106c75:	85 c0                	test   %eax,%eax
80106c77:	0f 88 a9 00 00 00    	js     80106d26 <sys_pipe+0xd6>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80106c7d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106c80:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c84:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106c87:	89 04 24             	mov    %eax,(%esp)
80106c8a:	e8 31 c7 ff ff       	call   801033c0 <pipealloc>
80106c8f:	85 c0                	test   %eax,%eax
80106c91:	0f 88 8f 00 00 00    	js     80106d26 <sys_pipe+0xd6>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106c97:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80106c9a:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80106c9c:	e8 ff cc ff ff       	call   801039a0 <myproc>
80106ca1:	eb 0b                	jmp    80106cae <sys_pipe+0x5e>
80106ca3:	90                   	nop
80106ca4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(fd = 0; fd < NOFILE; fd++){
80106ca8:	43                   	inc    %ebx
80106ca9:	83 fb 10             	cmp    $0x10,%ebx
80106cac:	74 62                	je     80106d10 <sys_pipe+0xc0>
    if(curproc->ofile[fd] == 0){
80106cae:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80106cb2:	85 f6                	test   %esi,%esi
80106cb4:	75 f2                	jne    80106ca8 <sys_pipe+0x58>
      curproc->ofile[fd] = f;
80106cb6:	8d 73 08             	lea    0x8(%ebx),%esi
80106cb9:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106cbd:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80106cc0:	e8 db cc ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80106cc5:	31 d2                	xor    %edx,%edx
80106cc7:	eb 0d                	jmp    80106cd6 <sys_pipe+0x86>
80106cc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106cd0:	42                   	inc    %edx
80106cd1:	83 fa 10             	cmp    $0x10,%edx
80106cd4:	74 2a                	je     80106d00 <sys_pipe+0xb0>
    if(curproc->ofile[fd] == 0){
80106cd6:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80106cda:	85 c9                	test   %ecx,%ecx
80106cdc:	75 f2                	jne    80106cd0 <sys_pipe+0x80>
      curproc->ofile[fd] = f;
80106cde:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80106ce2:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106ce5:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
80106ce7:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106cea:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
80106ced:	31 c0                	xor    %eax,%eax
}
80106cef:	83 c4 2c             	add    $0x2c,%esp
80106cf2:	5b                   	pop    %ebx
80106cf3:	5e                   	pop    %esi
80106cf4:	5f                   	pop    %edi
80106cf5:	5d                   	pop    %ebp
...
80106cf9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      myproc()->ofile[fd0] = 0;
80106d00:	e8 9b cc ff ff       	call   801039a0 <myproc>
80106d05:	31 d2                	xor    %edx,%edx
80106d07:	89 54 b0 08          	mov    %edx,0x8(%eax,%esi,4)
80106d0b:	90                   	nop
80106d0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    fileclose(rf);
80106d10:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d13:	89 04 24             	mov    %eax,(%esp)
80106d16:	e8 15 a1 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80106d1b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106d1e:	89 04 24             	mov    %eax,(%esp)
80106d21:	e8 0a a1 ff ff       	call   80100e30 <fileclose>
    return -1;
80106d26:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d2b:	eb c2                	jmp    80106cef <sys_pipe+0x9f>
...
80106d33:	5d                   	pop    %ebp
  return fork();
80106d34:	e9 47 cf ff ff       	jmp    80103c80 <fork>
...
80106d54:	e8 e7 f2 ff ff       	call   80106040 <argint>
80106d59:	85 c0                	test   %eax,%eax
80106d5b:	78 13                	js     80106d70 <sys_exit+0x30>
    return -1;
  exit(status);
80106d5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106d60:	89 04 24             	mov    %eax,(%esp)
80106d63:	e8 88 d5 ff ff       	call   801042f0 <exit>
...
80106d81:	b8 04 00 00 00       	mov    $0x4,%eax
{
80106d86:	89 e5                	mov    %esp,%ebp
80106d88:	83 ec 28             	sub    $0x28,%esp
  if(argptr(0, (char**)(&status), sizeof(int)) < 0)
80106d8b:	89 44 24 08          	mov    %eax,0x8(%esp)
80106d8f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106d92:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d96:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106d9d:	e8 ee f2 ff ff       	call   80106090 <argptr>
80106da2:	85 c0                	test   %eax,%eax
80106da4:	78 12                	js     80106db8 <sys_wait+0x38>
    return -1;
  return wait(status);
80106da6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106da9:	89 04 24             	mov    %eax,(%esp)
80106dac:	e8 4f d8 ff ff       	call   80104600 <wait>
  //return wait();
}
80106db1:	c9                   	leave  
80106db2:	c3                   	ret    
...
80106dd4:	e8 67 f2 ff ff       	call   80106040 <argint>
80106dd9:	85 c0                	test   %eax,%eax
80106ddb:	78 13                	js     80106df0 <sys_kill+0x30>
    return -1;
  return kill(pid);
80106ddd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106de0:	89 04 24             	mov    %eax,(%esp)
80106de3:	e8 58 d9 ff ff       	call   80104740 <kill>
}
80106de8:	c9                   	leave  
80106de9:	c3                   	ret    
...
80106e03:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106e06:	e8 95 cb ff ff       	call   801039a0 <myproc>
80106e0b:	8b 40 10             	mov    0x10(%eax),%eax
}
80106e0e:	c9                   	leave  
80106e0f:	c3                   	ret    
...
80106e14:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80106e17:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106e1a:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e1e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e25:	e8 16 f2 ff ff       	call   80106040 <argint>
80106e2a:	85 c0                	test   %eax,%eax
80106e2c:	78 22                	js     80106e50 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80106e2e:	e8 6d cb ff ff       	call   801039a0 <myproc>
80106e33:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80106e35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e38:	89 04 24             	mov    %eax,(%esp)
80106e3b:	e8 90 cb ff ff       	call   801039d0 <growproc>
80106e40:	85 c0                	test   %eax,%eax
80106e42:	78 0c                	js     80106e50 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80106e44:	83 c4 24             	add    $0x24,%esp
80106e47:	89 d8                	mov    %ebx,%eax
80106e49:	5b                   	pop    %ebx
80106e4a:	5d                   	pop    %ebp
80106e4b:	c3                   	ret    
80106e4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80106e50:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80106e55:	eb ed                	jmp    80106e44 <sys_sbrk+0x34>
...
80106e64:	83 ec 24             	sub    $0x24,%esp
  int n;
  uint ticks0;
...
80106e75:	e8 c6 f1 ff ff       	call   80106040 <argint>
80106e7a:	85 c0                	test   %eax,%eax
80106e7c:	78 7e                	js     80106efc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
80106e7e:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
80106e85:	e8 d6 ed ff ff       	call   80105c60 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106e8a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  ticks0 = ticks;
80106e8d:	8b 1d 20 80 11 80    	mov    0x80118020,%ebx
  while(ticks - ticks0 < n){
80106e93:	85 c9                	test   %ecx,%ecx
80106e95:	75 2a                	jne    80106ec1 <sys_sleep+0x61>
80106e97:	eb 4f                	jmp    80106ee8 <sys_sleep+0x88>
...
80106ea0:	b8 e0 77 11 80       	mov    $0x801177e0,%eax
80106ea5:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ea9:	c7 04 24 20 80 11 80 	movl   $0x80118020,(%esp)
80106eb0:	e8 5b d6 ff ff       	call   80104510 <sleep>
  while(ticks - ticks0 < n){
80106eb5:	a1 20 80 11 80       	mov    0x80118020,%eax
80106eba:	29 d8                	sub    %ebx,%eax
80106ebc:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80106ebf:	73 27                	jae    80106ee8 <sys_sleep+0x88>
    if(myproc()->killed){
80106ec1:	e8 da ca ff ff       	call   801039a0 <myproc>
80106ec6:	8b 50 24             	mov    0x24(%eax),%edx
80106ec9:	85 d2                	test   %edx,%edx
80106ecb:	74 d3                	je     80106ea0 <sys_sleep+0x40>
      release(&tickslock);
80106ecd:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
80106ed4:	e8 27 ee ff ff       	call   80105d00 <release>
  }
  release(&tickslock);
  return 0;
}
80106ed9:	83 c4 24             	add    $0x24,%esp
      return -1;
...
80106ee4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80106ee8:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
80106eef:	e8 0c ee ff ff       	call   80105d00 <release>
  return 0;
80106ef4:	31 c0                	xor    %eax,%eax
}
80106ef6:	83 c4 24             	add    $0x24,%esp
80106ef9:	5b                   	pop    %ebx
80106efa:	5d                   	pop    %ebp
80106efb:	c3                   	ret    
    return -1;
80106efc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106f01:	eb f3                	jmp    80106ef6 <sys_sleep+0x96>
...
80106f14:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
80106f17:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
80106f1e:	e8 3d ed ff ff       	call   80105c60 <acquire>
  xticks = ticks;
80106f23:	8b 1d 20 80 11 80    	mov    0x80118020,%ebx
  release(&tickslock);
80106f29:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
80106f30:	e8 cb ed ff ff       	call   80105d00 <release>
  return xticks;
}
80106f35:	83 c4 14             	add    $0x14,%esp
80106f38:	89 d8                	mov    %ebx,%eax
80106f3a:	5b                   	pop    %ebx
80106f3b:	5d                   	pop    %ebp
80106f3c:	c3                   	ret    
...
80106f54:	e8 e7 f0 ff ff       	call   80106040 <argint>
80106f59:	85 c0                	test   %eax,%eax
80106f5b:	78 13                	js     80106f70 <sys_detach+0x30>
    return -1;
  return detach(pid);
80106f5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106f60:	89 04 24             	mov    %eax,(%esp)
80106f63:	e8 98 d8 ff ff       	call   80104800 <detach>
}
80106f68:	c9                   	leave  
80106f69:	c3                   	ret    
...
80106f89:	89 44 24 04          	mov    %eax,0x4(%esp)
80106f8d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106f94:	e8 a7 f0 ff ff       	call   80106040 <argint>
80106f99:	85 c0                	test   %eax,%eax
80106f9b:	78 13                	js     80106fb0 <sys_priority+0x30>
    return -1;
  priority(proc_priority);
80106f9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106fa0:	89 04 24             	mov    %eax,(%esp)
80106fa3:	e8 18 d9 ff ff       	call   801048c0 <priority>
  return 0;
...
80106fd4:	e8 67 f0 ff ff       	call   80106040 <argint>
80106fd9:	85 c0                	test   %eax,%eax
80106fdb:	78 13                	js     80106ff0 <sys_policy+0x30>
    return -1;
  policy(policy_id);
80106fdd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106fe0:	89 04 24             	mov    %eax,(%esp)
80106fe3:	e8 58 d9 ff ff       	call   80104940 <policy>
  return 0;
...
80107001:	ba 04 00 00 00       	mov    $0x4,%edx
{
80107006:	89 e5                	mov    %esp,%ebp
80107008:	83 ec 28             	sub    $0x28,%esp
     if ((argptr(0, (char**)(&status), sizeof(int)) < 0) || (argptr(1, (void*)(&perform), sizeof(*perform)) < 0))
8010700b:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010700e:	89 54 24 08          	mov    %edx,0x8(%esp)
80107012:	89 44 24 04          	mov    %eax,0x4(%esp)
80107016:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010701d:	e8 6e f0 ff ff       	call   80106090 <argptr>
80107022:	85 c0                	test   %eax,%eax
80107024:	78 3a                	js     80107060 <sys_wait_stat+0x60>
80107026:	b8 14 00 00 00       	mov    $0x14,%eax
8010702b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010702f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80107032:	89 44 24 04          	mov    %eax,0x4(%esp)
80107036:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010703d:	e8 4e f0 ff ff       	call   80106090 <argptr>
80107042:	85 c0                	test   %eax,%eax
80107044:	78 1a                	js     80107060 <sys_wait_stat+0x60>
        return -1;
    return wait_stat(status,perform);
80107046:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107049:	89 44 24 04          	mov    %eax,0x4(%esp)
8010704d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107050:	89 04 24             	mov    %eax,(%esp)
80107053:	e8 b8 da ff ff       	call   80104b10 <wait_stat>
}
80107058:	c9                   	leave  
80107059:	c3                   	ret    
...
80107068:	06                   	push   %es
  pushl %fs
80107069:	0f a0                	push   %fs
  pushl %gs
8010706b:	0f a8                	push   %gs
  pushal
8010706d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010706e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80107072:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80107074:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80107076:	54                   	push   %esp
  call trap
80107077:	e8 c4 00 00 00       	call   80107140 <trap>
  addl $4, %esp
...
8010707f:	61                   	popa   
  popl %gs
80107080:	0f a9                	pop    %gs
  popl %fs
80107082:	0f a1                	pop    %fs
  popl %es
80107084:	07                   	pop    %es
  popl %ds
80107085:	1f                   	pop    %ds
...
801070a0:	8b 14 85 0c c0 10 80 	mov    -0x7fef3ff4(,%eax,4),%edx
801070a7:	b9 08 00 00 8e       	mov    $0x8e000008,%ecx
801070ac:	89 0c c5 22 78 11 80 	mov    %ecx,-0x7fee87de(,%eax,8)
801070b3:	66 89 14 c5 20 78 11 	mov    %dx,-0x7fee87e0(,%eax,8)
801070ba:	80 
801070bb:	c1 ea 10             	shr    $0x10,%edx
801070be:	66 89 14 c5 26 78 11 	mov    %dx,-0x7fee87da(,%eax,8)
801070c5:	80 
  for(i = 0; i < 256; i++)
801070c6:	40                   	inc    %eax
801070c7:	3d 00 01 00 00       	cmp    $0x100,%eax
801070cc:	75 d2                	jne    801070a0 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801070ce:	a1 0c c1 10 80       	mov    0x8010c10c,%eax

  initlock(&tickslock, "time");
801070d3:	b9 89 91 10 80       	mov    $0x80109189,%ecx
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801070d8:	ba 08 00 00 ef       	mov    $0xef000008,%edx
  initlock(&tickslock, "time");
801070dd:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801070e1:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801070e8:	89 15 22 7a 11 80    	mov    %edx,0x80117a22
801070ee:	66 a3 20 7a 11 80    	mov    %ax,0x80117a20
801070f4:	c1 e8 10             	shr    $0x10,%eax
801070f7:	66 a3 26 7a 11 80    	mov    %ax,0x80117a26
  initlock(&tickslock, "time");
801070fd:	e8 0e ea ff ff       	call   80105b10 <initlock>
}
80107102:	c9                   	leave  
80107103:	c3                   	ret    
...
80107110:	55                   	push   %ebp
  pd[1] = (uint)p;
80107111:	b8 20 78 11 80       	mov    $0x80117820,%eax
80107116:	89 e5                	mov    %esp,%ebp
80107118:	0f b7 d0             	movzwl %ax,%edx
  pd[2] = (uint)p >> 16;
8010711b:	c1 e8 10             	shr    $0x10,%eax
8010711e:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80107121:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80107127:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010712b:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
8010712f:	8d 45 fa             	lea    -0x6(%ebp),%eax
80107132:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80107135:	c9                   	leave  
80107136:	c3                   	ret    
...
80107143:	83 ec 48             	sub    $0x48,%esp
80107146:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80107149:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010714c:	89 75 f8             	mov    %esi,-0x8(%ebp)
8010714f:	89 7d fc             	mov    %edi,-0x4(%ebp)
  if(tf->trapno == T_SYSCALL){
80107152:	8b 43 30             	mov    0x30(%ebx),%eax
80107155:	83 f8 40             	cmp    $0x40,%eax
80107158:	0f 84 02 01 00 00    	je     80107260 <trap+0x120>
    if(myproc()->killed)
      exit(0);
    return;
  }
  ...
  switch(tf->trapno){
8010715e:	83 e8 20             	sub    $0x20,%eax
80107161:	83 f8 1f             	cmp    $0x1f,%eax
80107164:	77 0a                	ja     80107170 <trap+0x30>
80107166:	ff 24 85 30 92 10 80 	jmp    *-0x7fef6dd0(,%eax,4)
...
80107170:	e8 2b c8 ff ff       	call   801039a0 <myproc>
80107175:	8b 7b 38             	mov    0x38(%ebx),%edi
80107178:	85 c0                	test   %eax,%eax
8010717a:	0f 84 64 02 00 00    	je     801073e4 <trap+0x2a4>
80107180:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80107184:	0f 84 5a 02 00 00    	je     801073e4 <trap+0x2a4>
...
8010718a:	0f 20 d1             	mov    %cr2,%ecx
8010718d:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80107190:	e8 eb c7 ff ff       	call   80103980 <cpuid>
80107195:	8b 73 30             	mov    0x30(%ebx),%esi
80107198:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010719b:	8b 43 34             	mov    0x34(%ebx),%eax
8010719e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801071a1:	e8 fa c7 ff ff       	call   801039a0 <myproc>
801071a6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801071a9:	e8 f2 c7 ff ff       	call   801039a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071ae:	8b 55 dc             	mov    -0x24(%ebp),%edx
801071b1:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801071b5:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071b8:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801071bb:	89 7c 24 18          	mov    %edi,0x18(%esp)
801071bf:	89 54 24 14          	mov    %edx,0x14(%esp)
801071c3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801071c6:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071c9:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801071cd:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801071d1:	89 54 24 10          	mov    %edx,0x10(%esp)
801071d5:	8b 40 10             	mov    0x10(%eax),%eax
801071d8:	c7 04 24 ec 91 10 80 	movl   $0x801091ec,(%esp)
801071df:	89 44 24 04          	mov    %eax,0x4(%esp)
801071e3:	e8 68 94 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801071e8:	e8 b3 c7 ff ff       	call   801039a0 <myproc>
801071ed:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
801071f4:	e8 a7 c7 ff ff       	call   801039a0 <myproc>
801071f9:	85 c0                	test   %eax,%eax
801071fb:	74 1b                	je     80107218 <trap+0xd8>
801071fd:	e8 9e c7 ff ff       	call   801039a0 <myproc>
80107202:	8b 50 24             	mov    0x24(%eax),%edx
80107205:	85 d2                	test   %edx,%edx
80107207:	74 0f                	je     80107218 <trap+0xd8>
80107209:	8b 43 3c             	mov    0x3c(%ebx),%eax
8010720c:	83 e0 03             	and    $0x3,%eax
8010720f:	83 f8 03             	cmp    $0x3,%eax
80107212:	0f 84 80 01 00 00    	je     80107398 <trap+0x258>
    exit(0);

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80107218:	e8 83 c7 ff ff       	call   801039a0 <myproc>
8010721d:	85 c0                	test   %eax,%eax
8010721f:	74 0d                	je     8010722e <trap+0xee>
80107221:	e8 7a c7 ff ff       	call   801039a0 <myproc>
80107226:	8b 40 0c             	mov    0xc(%eax),%eax
80107229:	83 f8 04             	cmp    $0x4,%eax
8010722c:	74 7a                	je     801072a8 <trap+0x168>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010722e:	e8 6d c7 ff ff       	call   801039a0 <myproc>
80107233:	85 c0                	test   %eax,%eax
80107235:	74 17                	je     8010724e <trap+0x10e>
80107237:	e8 64 c7 ff ff       	call   801039a0 <myproc>
8010723c:	8b 40 24             	mov    0x24(%eax),%eax
8010723f:	85 c0                	test   %eax,%eax
80107241:	74 0b                	je     8010724e <trap+0x10e>
80107243:	8b 43 3c             	mov    0x3c(%ebx),%eax
80107246:	83 e0 03             	and    $0x3,%eax
80107249:	83 f8 03             	cmp    $0x3,%eax
8010724c:	74 3b                	je     80107289 <trap+0x149>
    exit(0);
}
8010724e:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80107251:	8b 75 f8             	mov    -0x8(%ebp),%esi
80107254:	8b 7d fc             	mov    -0x4(%ebp),%edi
80107257:	89 ec                	mov    %ebp,%esp
80107259:	5d                   	pop    %ebp
8010725a:	c3                   	ret    
8010725b:	90                   	nop
...
8010726a:	0f 85 10 01 00 00    	jne    80107380 <trap+0x240>
    myproc()->tf = tf;
80107270:	e8 2b c7 ff ff       	call   801039a0 <myproc>
80107275:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80107278:	e8 b3 ee ff ff       	call   80106130 <syscall>
    if(myproc()->killed)
8010727d:	e8 1e c7 ff ff       	call   801039a0 <myproc>
80107282:	8b 48 24             	mov    0x24(%eax),%ecx
80107285:	85 c9                	test   %ecx,%ecx
80107287:	74 c5                	je     8010724e <trap+0x10e>
      exit(0);
80107289:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
80107290:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80107293:	8b 75 f8             	mov    -0x8(%ebp),%esi
80107296:	8b 7d fc             	mov    -0x4(%ebp),%edi
80107299:	89 ec                	mov    %ebp,%esp
8010729b:	5d                   	pop    %ebp
      exit(0);
8010729c:	e9 4f d0 ff ff       	jmp    801042f0 <exit>
801072a1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
801072a8:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801072ac:	75 80                	jne    8010722e <trap+0xee>
    yield();
801072ae:	e8 5d d1 ff ff       	call   80104410 <yield>
801072b3:	e9 76 ff ff ff       	jmp    8010722e <trap+0xee>
801072b8:	90                   	nop
801072b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801072c0:	e8 bb c6 ff ff       	call   80103980 <cpuid>
801072c5:	85 c0                	test   %eax,%eax
801072c7:	0f 84 e3 00 00 00    	je     801073b0 <trap+0x270>
801072cd:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
801072d0:	e8 7b b5 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801072d5:	e8 c6 c6 ff ff       	call   801039a0 <myproc>
801072da:	85 c0                	test   %eax,%eax
801072dc:	0f 85 1b ff ff ff    	jne    801071fd <trap+0xbd>
801072e2:	e9 31 ff ff ff       	jmp    80107218 <trap+0xd8>
801072e7:	89 f6                	mov    %esi,%esi
801072e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    kbdintr();
801072f0:	e8 1b b4 ff ff       	call   80102710 <kbdintr>
    lapiceoi();
801072f5:	e8 56 b5 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801072fa:	e8 a1 c6 ff ff       	call   801039a0 <myproc>
801072ff:	85 c0                	test   %eax,%eax
80107301:	0f 85 f6 fe ff ff    	jne    801071fd <trap+0xbd>
80107307:	e9 0c ff ff ff       	jmp    80107218 <trap+0xd8>
8010730c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80107310:	e8 6b 02 00 00       	call   80107580 <uartintr>
    lapiceoi();
80107315:	e8 36 b5 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010731a:	e8 81 c6 ff ff       	call   801039a0 <myproc>
8010731f:	85 c0                	test   %eax,%eax
80107321:	0f 85 d6 fe ff ff    	jne    801071fd <trap+0xbd>
80107327:	e9 ec fe ff ff       	jmp    80107218 <trap+0xd8>
8010732c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107330:	8b 7b 38             	mov    0x38(%ebx),%edi
80107333:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80107337:	e8 44 c6 ff ff       	call   80103980 <cpuid>
8010733c:	c7 04 24 94 91 10 80 	movl   $0x80109194,(%esp)
80107343:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80107347:	89 74 24 08          	mov    %esi,0x8(%esp)
8010734b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010734f:	e8 fc 92 ff ff       	call   80100650 <cprintf>
    lapiceoi();
80107354:	e8 f7 b4 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107359:	e8 42 c6 ff ff       	call   801039a0 <myproc>
8010735e:	85 c0                	test   %eax,%eax
80107360:	0f 85 97 fe ff ff    	jne    801071fd <trap+0xbd>
80107366:	e9 ad fe ff ff       	jmp    80107218 <trap+0xd8>
8010736b:	90                   	nop
8010736c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80107370:	e8 eb ad ff ff       	call   80102160 <ideintr>
80107375:	e9 53 ff ff ff       	jmp    801072cd <trap+0x18d>
8010737a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit(0);
80107380:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80107387:	e8 64 cf ff ff       	call   801042f0 <exit>
8010738c:	e9 df fe ff ff       	jmp    80107270 <trap+0x130>
80107391:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit(0);
80107398:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010739f:	e8 4c cf ff ff       	call   801042f0 <exit>
801073a4:	e9 6f fe ff ff       	jmp    80107218 <trap+0xd8>
801073a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      acquire(&tickslock);
801073b0:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
801073b7:	e8 a4 e8 ff ff       	call   80105c60 <acquire>
      ticks++;
801073bc:	ff 05 20 80 11 80    	incl   0x80118020
      updatePerformance();
801073c2:	e8 89 d8 ff ff       	call   80104c50 <updatePerformance>
      wakeup(&ticks);
801073c7:	c7 04 24 20 80 11 80 	movl   $0x80118020,(%esp)
801073ce:	e8 3d d3 ff ff       	call   80104710 <wakeup>
      release(&tickslock);
801073d3:	c7 04 24 e0 77 11 80 	movl   $0x801177e0,(%esp)
801073da:	e8 21 e9 ff ff       	call   80105d00 <release>
801073df:	e9 e9 fe ff ff       	jmp    801072cd <trap+0x18d>
801073e4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801073e7:	e8 94 c5 ff ff       	call   80103980 <cpuid>
801073ec:	89 74 24 10          	mov    %esi,0x10(%esp)
801073f0:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801073f4:	89 44 24 08          	mov    %eax,0x8(%esp)
801073f8:	8b 43 30             	mov    0x30(%ebx),%eax
801073fb:	c7 04 24 b8 91 10 80 	movl   $0x801091b8,(%esp)
80107402:	89 44 24 04          	mov    %eax,0x4(%esp)
80107406:	e8 45 92 ff ff       	call   80100650 <cprintf>
      panic("trap");
8010740b:	c7 04 24 8e 91 10 80 	movl   $0x8010918e,(%esp)
...
{
  if(!uart)
80107420:	a1 20 c6 10 80       	mov    0x8010c620,%eax
{
80107425:	55                   	push   %ebp
80107426:	89 e5                	mov    %esp,%ebp
  if(!uart)
80107428:	85 c0                	test   %eax,%eax
8010742a:	74 1c                	je     80107448 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010742c:	ba fd 03 00 00       	mov    $0x3fd,%edx
80107431:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80107432:	24 01                	and    $0x1,%al
80107434:	84 c0                	test   %al,%al
80107436:	74 10                	je     80107448 <uartgetc+0x28>
80107438:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010743d:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
...
8010745a:	bb 80 00 00 00       	mov    $0x80,%ebx
8010745f:	83 ec 20             	sub    $0x20,%esp
80107462:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107465:	eb 18                	jmp    8010747f <uartputc.part.0+0x2f>
80107467:	89 f6                	mov    %esi,%esi
80107469:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    microdelay(10);
80107470:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80107477:	e8 f4 b3 ff ff       	call   80102870 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010747c:	4b                   	dec    %ebx
8010747d:	74 09                	je     80107488 <uartputc.part.0+0x38>
8010747f:	89 f2                	mov    %esi,%edx
80107481:	ec                   	in     (%dx),%al
80107482:	24 20                	and    $0x20,%al
80107484:	84 c0                	test   %al,%al
80107486:	74 e8                	je     80107470 <uartputc.part.0+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107488:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010748d:	0f b6 45 f4          	movzbl -0xc(%ebp),%eax
80107491:	ee                   	out    %al,(%dx)
}
80107492:	83 c4 20             	add    $0x20,%esp
80107495:	5b                   	pop    %ebx
80107496:	5e                   	pop    %esi
80107497:	5d                   	pop    %ebp
80107498:	c3                   	ret    
...
801074a5:	88 c8                	mov    %cl,%al
801074a7:	57                   	push   %edi
801074a8:	56                   	push   %esi
801074a9:	53                   	push   %ebx
801074aa:	bb fa 03 00 00       	mov    $0x3fa,%ebx
801074af:	83 ec 1c             	sub    $0x1c,%esp
801074b2:	89 da                	mov    %ebx,%edx
801074b4:	ee                   	out    %al,(%dx)
801074b5:	bf fb 03 00 00       	mov    $0x3fb,%edi
801074ba:	b0 80                	mov    $0x80,%al
801074bc:	89 fa                	mov    %edi,%edx
801074be:	ee                   	out    %al,(%dx)
801074bf:	b0 0c                	mov    $0xc,%al
801074c1:	ba f8 03 00 00       	mov    $0x3f8,%edx
801074c6:	ee                   	out    %al,(%dx)
801074c7:	be f9 03 00 00       	mov    $0x3f9,%esi
801074cc:	88 c8                	mov    %cl,%al
801074ce:	89 f2                	mov    %esi,%edx
801074d0:	ee                   	out    %al,(%dx)
801074d1:	b0 03                	mov    $0x3,%al
801074d3:	89 fa                	mov    %edi,%edx
801074d5:	ee                   	out    %al,(%dx)
801074d6:	ba fc 03 00 00       	mov    $0x3fc,%edx
801074db:	88 c8                	mov    %cl,%al
801074dd:	ee                   	out    %al,(%dx)
801074de:	b0 01                	mov    $0x1,%al
801074e0:	89 f2                	mov    %esi,%edx
801074e2:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801074e3:	ba fd 03 00 00       	mov    $0x3fd,%edx
801074e8:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801074e9:	fe c0                	inc    %al
801074eb:	74 52                	je     8010753f <uartinit+0x9f>
  uart = 1;
801074ed:	b9 01 00 00 00       	mov    $0x1,%ecx
801074f2:	89 da                	mov    %ebx,%edx
801074f4:	89 0d 20 c6 10 80    	mov    %ecx,0x8010c620
801074fa:	ec                   	in     (%dx),%al
801074fb:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107500:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80107501:	31 db                	xor    %ebx,%ebx
80107503:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  for(p="xv6...\n"; *p; p++)
80107507:	bb b0 92 10 80       	mov    $0x801092b0,%ebx
  ioapicenable(IRQ_COM1, 0);
8010750c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107513:	e8 88 ae ff ff       	call   801023a0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80107518:	b8 78 00 00 00       	mov    $0x78,%eax
8010751d:	eb 09                	jmp    80107528 <uartinit+0x88>
8010751f:	90                   	nop
80107520:	43                   	inc    %ebx
80107521:	0f be 03             	movsbl (%ebx),%eax
80107524:	84 c0                	test   %al,%al
80107526:	74 17                	je     8010753f <uartinit+0x9f>
  if(!uart)
80107528:	8b 15 20 c6 10 80    	mov    0x8010c620,%edx
8010752e:	85 d2                	test   %edx,%edx
80107530:	74 ee                	je     80107520 <uartinit+0x80>
  for(p="xv6...\n"; *p; p++)
80107532:	43                   	inc    %ebx
80107533:	e8 18 ff ff ff       	call   80107450 <uartputc.part.0>
80107538:	0f be 03             	movsbl (%ebx),%eax
8010753b:	84 c0                	test   %al,%al
8010753d:	75 e9                	jne    80107528 <uartinit+0x88>
}
8010753f:	83 c4 1c             	add    $0x1c,%esp
80107542:	5b                   	pop    %ebx
80107543:	5e                   	pop    %esi
80107544:	5f                   	pop    %edi
80107545:	5d                   	pop    %ebp
...
80107550 <uartputc>:
  if(!uart)
80107550:	8b 15 20 c6 10 80    	mov    0x8010c620,%edx
{
80107556:	55                   	push   %ebp
80107557:	89 e5                	mov    %esp,%ebp
80107559:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
8010755c:	85 d2                	test   %edx,%edx
8010755e:	74 10                	je     80107570 <uartputc+0x20>
}
80107560:	5d                   	pop    %ebp
80107561:	e9 ea fe ff ff       	jmp    80107450 <uartputc.part.0>
...
80107586:	c7 04 24 20 74 10 80 	movl   $0x80107420,(%esp)
8010758d:	e8 3e 92 ff ff       	call   801007d0 <consoleintr>
}
80107592:	c9                   	leave  
80107593:	c3                   	ret    
...
80107596:	6a 00                	push   $0x0
  jmp alltraps
80107598:	e9 ca fa ff ff       	jmp    80107067 <alltraps>
...
8010759d:	6a 00                	push   $0x0
  pushl $1
8010759f:	6a 01                	push   $0x1
  jmp alltraps
801075a1:	e9 c1 fa ff ff       	jmp    80107067 <alltraps>
...
801075a6:	6a 00                	push   $0x0
  pushl $2
801075a8:	6a 02                	push   $0x2
  jmp alltraps
801075aa:	e9 b8 fa ff ff       	jmp    80107067 <alltraps>
...
801075af:	6a 00                	push   $0x0
  pushl $3
801075b1:	6a 03                	push   $0x3
  jmp alltraps
801075b3:	e9 af fa ff ff       	jmp    80107067 <alltraps>
...
801075b8:	6a 00                	push   $0x0
  pushl $4
801075ba:	6a 04                	push   $0x4
  jmp alltraps
801075bc:	e9 a6 fa ff ff       	jmp    80107067 <alltraps>
...
801075c1:	6a 00                	push   $0x0
  pushl $5
801075c3:	6a 05                	push   $0x5
  jmp alltraps
801075c5:	e9 9d fa ff ff       	jmp    80107067 <alltraps>
...
801075ca:	6a 00                	push   $0x0
  pushl $6
801075cc:	6a 06                	push   $0x6
  jmp alltraps
801075ce:	e9 94 fa ff ff       	jmp    80107067 <alltraps>
...
801075d3:	6a 00                	push   $0x0
  pushl $7
801075d5:	6a 07                	push   $0x7
  jmp alltraps
801075d7:	e9 8b fa ff ff       	jmp    80107067 <alltraps>

801075dc <vector8>:
.globl vector8
vector8:
  pushl $8
801075dc:	6a 08                	push   $0x8
  jmp alltraps
801075de:	e9 84 fa ff ff       	jmp    80107067 <alltraps>
...
801075e3:	6a 00                	push   $0x0
  pushl $9
801075e5:	6a 09                	push   $0x9
  jmp alltraps
801075e7:	e9 7b fa ff ff       	jmp    80107067 <alltraps>

801075ec <vector10>:
.globl vector10
vector10:
  pushl $10
801075ec:	6a 0a                	push   $0xa
  jmp alltraps
801075ee:	e9 74 fa ff ff       	jmp    80107067 <alltraps>

801075f3 <vector11>:
.globl vector11
vector11:
  pushl $11
801075f3:	6a 0b                	push   $0xb
  jmp alltraps
801075f5:	e9 6d fa ff ff       	jmp    80107067 <alltraps>

801075fa <vector12>:
.globl vector12
vector12:
  pushl $12
801075fa:	6a 0c                	push   $0xc
  jmp alltraps
801075fc:	e9 66 fa ff ff       	jmp    80107067 <alltraps>

80107601 <vector13>:
.globl vector13
vector13:
  pushl $13
80107601:	6a 0d                	push   $0xd
  jmp alltraps
80107603:	e9 5f fa ff ff       	jmp    80107067 <alltraps>

80107608 <vector14>:
.globl vector14
vector14:
  pushl $14
80107608:	6a 0e                	push   $0xe
  jmp alltraps
8010760a:	e9 58 fa ff ff       	jmp    80107067 <alltraps>
...
8010760f:	6a 00                	push   $0x0
  pushl $15
80107611:	6a 0f                	push   $0xf
  jmp alltraps
80107613:	e9 4f fa ff ff       	jmp    80107067 <alltraps>
...
80107618:	6a 00                	push   $0x0
  pushl $16
8010761a:	6a 10                	push   $0x10
  jmp alltraps
8010761c:	e9 46 fa ff ff       	jmp    80107067 <alltraps>

80107621 <vector17>:
.globl vector17
vector17:
  pushl $17
80107621:	6a 11                	push   $0x11
  jmp alltraps
80107623:	e9 3f fa ff ff       	jmp    80107067 <alltraps>
...
80107628:	6a 00                	push   $0x0
  pushl $18
8010762a:	6a 12                	push   $0x12
  jmp alltraps
8010762c:	e9 36 fa ff ff       	jmp    80107067 <alltraps>
...
80107631:	6a 00                	push   $0x0
  pushl $19
80107633:	6a 13                	push   $0x13
  jmp alltraps
80107635:	e9 2d fa ff ff       	jmp    80107067 <alltraps>
...
8010763a:	6a 00                	push   $0x0
  pushl $20
8010763c:	6a 14                	push   $0x14
  jmp alltraps
8010763e:	e9 24 fa ff ff       	jmp    80107067 <alltraps>
...
80107643:	6a 00                	push   $0x0
  pushl $21
80107645:	6a 15                	push   $0x15
  jmp alltraps
80107647:	e9 1b fa ff ff       	jmp    80107067 <alltraps>
...
8010764c:	6a 00                	push   $0x0
  pushl $22
8010764e:	6a 16                	push   $0x16
  jmp alltraps
80107650:	e9 12 fa ff ff       	jmp    80107067 <alltraps>
...
80107655:	6a 00                	push   $0x0
  pushl $23
80107657:	6a 17                	push   $0x17
  jmp alltraps
80107659:	e9 09 fa ff ff       	jmp    80107067 <alltraps>
...
8010765e:	6a 00                	push   $0x0
  pushl $24
80107660:	6a 18                	push   $0x18
  jmp alltraps
80107662:	e9 00 fa ff ff       	jmp    80107067 <alltraps>
...
80107667:	6a 00                	push   $0x0
  pushl $25
80107669:	6a 19                	push   $0x19
  jmp alltraps
8010766b:	e9 f7 f9 ff ff       	jmp    80107067 <alltraps>
...
80107670:	6a 00                	push   $0x0
  pushl $26
80107672:	6a 1a                	push   $0x1a
  jmp alltraps
80107674:	e9 ee f9 ff ff       	jmp    80107067 <alltraps>
...
80107679:	6a 00                	push   $0x0
  pushl $27
8010767b:	6a 1b                	push   $0x1b
  jmp alltraps
8010767d:	e9 e5 f9 ff ff       	jmp    80107067 <alltraps>
...
80107682:	6a 00                	push   $0x0
  pushl $28
80107684:	6a 1c                	push   $0x1c
  jmp alltraps
80107686:	e9 dc f9 ff ff       	jmp    80107067 <alltraps>
...
8010768b:	6a 00                	push   $0x0
  pushl $29
8010768d:	6a 1d                	push   $0x1d
  jmp alltraps
8010768f:	e9 d3 f9 ff ff       	jmp    80107067 <alltraps>
...
80107694:	6a 00                	push   $0x0
  pushl $30
80107696:	6a 1e                	push   $0x1e
  jmp alltraps
80107698:	e9 ca f9 ff ff       	jmp    80107067 <alltraps>
...
8010769d:	6a 00                	push   $0x0
  pushl $31
8010769f:	6a 1f                	push   $0x1f
  jmp alltraps
801076a1:	e9 c1 f9 ff ff       	jmp    80107067 <alltraps>
...
801076a6:	6a 00                	push   $0x0
  pushl $32
801076a8:	6a 20                	push   $0x20
  jmp alltraps
801076aa:	e9 b8 f9 ff ff       	jmp    80107067 <alltraps>
...
801076af:	6a 00                	push   $0x0
  pushl $33
801076b1:	6a 21                	push   $0x21
  jmp alltraps
801076b3:	e9 af f9 ff ff       	jmp    80107067 <alltraps>
...
801076b8:	6a 00                	push   $0x0
  pushl $34
801076ba:	6a 22                	push   $0x22
  jmp alltraps
801076bc:	e9 a6 f9 ff ff       	jmp    80107067 <alltraps>
...
801076c1:	6a 00                	push   $0x0
  pushl $35
801076c3:	6a 23                	push   $0x23
  jmp alltraps
801076c5:	e9 9d f9 ff ff       	jmp    80107067 <alltraps>
...
801076ca:	6a 00                	push   $0x0
  pushl $36
801076cc:	6a 24                	push   $0x24
  jmp alltraps
801076ce:	e9 94 f9 ff ff       	jmp    80107067 <alltraps>
...
801076d3:	6a 00                	push   $0x0
  pushl $37
801076d5:	6a 25                	push   $0x25
  jmp alltraps
801076d7:	e9 8b f9 ff ff       	jmp    80107067 <alltraps>
...
801076dc:	6a 00                	push   $0x0
  pushl $38
801076de:	6a 26                	push   $0x26
  jmp alltraps
801076e0:	e9 82 f9 ff ff       	jmp    80107067 <alltraps>
...
801076e5:	6a 00                	push   $0x0
  pushl $39
801076e7:	6a 27                	push   $0x27
  jmp alltraps
801076e9:	e9 79 f9 ff ff       	jmp    80107067 <alltraps>
...
801076f0:	6a 28                	push   $0x28
  jmp alltraps
801076f2:	e9 70 f9 ff ff       	jmp    80107067 <alltraps>
...
801076f7:	6a 00                	push   $0x0
  pushl $41
801076f9:	6a 29                	push   $0x29
  jmp alltraps
801076fb:	e9 67 f9 ff ff       	jmp    80107067 <alltraps>
...
80107700:	6a 00                	push   $0x0
  pushl $42
80107702:	6a 2a                	push   $0x2a
  jmp alltraps
80107704:	e9 5e f9 ff ff       	jmp    80107067 <alltraps>
...
80107709:	6a 00                	push   $0x0
  pushl $43
8010770b:	6a 2b                	push   $0x2b
  jmp alltraps
8010770d:	e9 55 f9 ff ff       	jmp    80107067 <alltraps>
...
80107712:	6a 00                	push   $0x0
  pushl $44
80107714:	6a 2c                	push   $0x2c
  jmp alltraps
80107716:	e9 4c f9 ff ff       	jmp    80107067 <alltraps>
...
8010771b:	6a 00                	push   $0x0
  pushl $45
8010771d:	6a 2d                	push   $0x2d
  jmp alltraps
8010771f:	e9 43 f9 ff ff       	jmp    80107067 <alltraps>
...
80107724:	6a 00                	push   $0x0
  pushl $46
80107726:	6a 2e                	push   $0x2e
  jmp alltraps
80107728:	e9 3a f9 ff ff       	jmp    80107067 <alltraps>
...
8010772d:	6a 00                	push   $0x0
  pushl $47
8010772f:	6a 2f                	push   $0x2f
  jmp alltraps
80107731:	e9 31 f9 ff ff       	jmp    80107067 <alltraps>
...
80107736:	6a 00                	push   $0x0
  pushl $48
80107738:	6a 30                	push   $0x30
  jmp alltraps
8010773a:	e9 28 f9 ff ff       	jmp    80107067 <alltraps>
...
8010773f:	6a 00                	push   $0x0
  pushl $49
80107741:	6a 31                	push   $0x31
  jmp alltraps
80107743:	e9 1f f9 ff ff       	jmp    80107067 <alltraps>
...
80107748:	6a 00                	push   $0x0
  pushl $50
8010774a:	6a 32                	push   $0x32
  jmp alltraps
8010774c:	e9 16 f9 ff ff       	jmp    80107067 <alltraps>
...
80107751:	6a 00                	push   $0x0
  pushl $51
80107753:	6a 33                	push   $0x33
  jmp alltraps
80107755:	e9 0d f9 ff ff       	jmp    80107067 <alltraps>
...
8010775a:	6a 00                	push   $0x0
  pushl $52
8010775c:	6a 34                	push   $0x34
  jmp alltraps
8010775e:	e9 04 f9 ff ff       	jmp    80107067 <alltraps>
...
80107763:	6a 00                	push   $0x0
  pushl $53
80107765:	6a 35                	push   $0x35
  jmp alltraps
80107767:	e9 fb f8 ff ff       	jmp    80107067 <alltraps>
...
8010776c:	6a 00                	push   $0x0
  pushl $54
8010776e:	6a 36                	push   $0x36
  jmp alltraps
80107770:	e9 f2 f8 ff ff       	jmp    80107067 <alltraps>
...
80107775:	6a 00                	push   $0x0
  pushl $55
80107777:	6a 37                	push   $0x37
  jmp alltraps
80107779:	e9 e9 f8 ff ff       	jmp    80107067 <alltraps>
...
8010777e:	6a 00                	push   $0x0
  pushl $56
80107780:	6a 38                	push   $0x38
  jmp alltraps
80107782:	e9 e0 f8 ff ff       	jmp    80107067 <alltraps>
...
80107787:	6a 00                	push   $0x0
  pushl $57
80107789:	6a 39                	push   $0x39
  jmp alltraps
8010778b:	e9 d7 f8 ff ff       	jmp    80107067 <alltraps>
...
80107790:	6a 00                	push   $0x0
  pushl $58
80107792:	6a 3a                	push   $0x3a
  jmp alltraps
80107794:	e9 ce f8 ff ff       	jmp    80107067 <alltraps>
...
80107799:	6a 00                	push   $0x0
  pushl $59
8010779b:	6a 3b                	push   $0x3b
  jmp alltraps
8010779d:	e9 c5 f8 ff ff       	jmp    80107067 <alltraps>
...
801077a2:	6a 00                	push   $0x0
  pushl $60
801077a4:	6a 3c                	push   $0x3c
  jmp alltraps
801077a6:	e9 bc f8 ff ff       	jmp    80107067 <alltraps>
...
801077ab:	6a 00                	push   $0x0
  pushl $61
801077ad:	6a 3d                	push   $0x3d
  jmp alltraps
801077af:	e9 b3 f8 ff ff       	jmp    80107067 <alltraps>
...
801077b4:	6a 00                	push   $0x0
  pushl $62
801077b6:	6a 3e                	push   $0x3e
  jmp alltraps
801077b8:	e9 aa f8 ff ff       	jmp    80107067 <alltraps>
...
801077bd:	6a 00                	push   $0x0
  pushl $63
801077bf:	6a 3f                	push   $0x3f
  jmp alltraps
801077c1:	e9 a1 f8 ff ff       	jmp    80107067 <alltraps>
...
801077c6:	6a 00                	push   $0x0
  pushl $64
801077c8:	6a 40                	push   $0x40
  jmp alltraps
801077ca:	e9 98 f8 ff ff       	jmp    80107067 <alltraps>
...
801077cf:	6a 00                	push   $0x0
  pushl $65
801077d1:	6a 41                	push   $0x41
  jmp alltraps
801077d3:	e9 8f f8 ff ff       	jmp    80107067 <alltraps>
...
801077d8:	6a 00                	push   $0x0
  pushl $66
801077da:	6a 42                	push   $0x42
  jmp alltraps
801077dc:	e9 86 f8 ff ff       	jmp    80107067 <alltraps>
...
801077e1:	6a 00                	push   $0x0
  pushl $67
801077e3:	6a 43                	push   $0x43
  jmp alltraps
801077e5:	e9 7d f8 ff ff       	jmp    80107067 <alltraps>
...
801077ea:	6a 00                	push   $0x0
  pushl $68
801077ec:	6a 44                	push   $0x44
  jmp alltraps
801077ee:	e9 74 f8 ff ff       	jmp    80107067 <alltraps>
...
801077f3:	6a 00                	push   $0x0
  pushl $69
801077f5:	6a 45                	push   $0x45
  jmp alltraps
801077f7:	e9 6b f8 ff ff       	jmp    80107067 <alltraps>
...
801077fc:	6a 00                	push   $0x0
  pushl $70
801077fe:	6a 46                	push   $0x46
  jmp alltraps
80107800:	e9 62 f8 ff ff       	jmp    80107067 <alltraps>
...
80107805:	6a 00                	push   $0x0
  pushl $71
80107807:	6a 47                	push   $0x47
  jmp alltraps
80107809:	e9 59 f8 ff ff       	jmp    80107067 <alltraps>
...
8010780e:	6a 00                	push   $0x0
  pushl $72
80107810:	6a 48                	push   $0x48
  jmp alltraps
80107812:	e9 50 f8 ff ff       	jmp    80107067 <alltraps>
...
80107817:	6a 00                	push   $0x0
  pushl $73
80107819:	6a 49                	push   $0x49
  jmp alltraps
8010781b:	e9 47 f8 ff ff       	jmp    80107067 <alltraps>
...
80107820:	6a 00                	push   $0x0
  pushl $74
80107822:	6a 4a                	push   $0x4a
  jmp alltraps
80107824:	e9 3e f8 ff ff       	jmp    80107067 <alltraps>
...
80107829:	6a 00                	push   $0x0
  pushl $75
8010782b:	6a 4b                	push   $0x4b
  jmp alltraps
8010782d:	e9 35 f8 ff ff       	jmp    80107067 <alltraps>
...
80107832:	6a 00                	push   $0x0
  pushl $76
80107834:	6a 4c                	push   $0x4c
  jmp alltraps
80107836:	e9 2c f8 ff ff       	jmp    80107067 <alltraps>
...
8010783b:	6a 00                	push   $0x0
  pushl $77
8010783d:	6a 4d                	push   $0x4d
  jmp alltraps
8010783f:	e9 23 f8 ff ff       	jmp    80107067 <alltraps>
...
80107844:	6a 00                	push   $0x0
  pushl $78
80107846:	6a 4e                	push   $0x4e
  jmp alltraps
80107848:	e9 1a f8 ff ff       	jmp    80107067 <alltraps>
...
8010784d:	6a 00                	push   $0x0
  pushl $79
8010784f:	6a 4f                	push   $0x4f
  jmp alltraps
80107851:	e9 11 f8 ff ff       	jmp    80107067 <alltraps>
...
80107856:	6a 00                	push   $0x0
  pushl $80
80107858:	6a 50                	push   $0x50
  jmp alltraps
8010785a:	e9 08 f8 ff ff       	jmp    80107067 <alltraps>
...
8010785f:	6a 00                	push   $0x0
  pushl $81
80107861:	6a 51                	push   $0x51
  jmp alltraps
80107863:	e9 ff f7 ff ff       	jmp    80107067 <alltraps>
...
80107868:	6a 00                	push   $0x0
  pushl $82
8010786a:	6a 52                	push   $0x52
  jmp alltraps
8010786c:	e9 f6 f7 ff ff       	jmp    80107067 <alltraps>
...
80107871:	6a 00                	push   $0x0
  pushl $83
80107873:	6a 53                	push   $0x53
  jmp alltraps
80107875:	e9 ed f7 ff ff       	jmp    80107067 <alltraps>
...
8010787a:	6a 00                	push   $0x0
  pushl $84
8010787c:	6a 54                	push   $0x54
  jmp alltraps
8010787e:	e9 e4 f7 ff ff       	jmp    80107067 <alltraps>
...
80107883:	6a 00                	push   $0x0
  pushl $85
80107885:	6a 55                	push   $0x55
  jmp alltraps
80107887:	e9 db f7 ff ff       	jmp    80107067 <alltraps>
...
8010788c:	6a 00                	push   $0x0
  pushl $86
8010788e:	6a 56                	push   $0x56
  jmp alltraps
80107890:	e9 d2 f7 ff ff       	jmp    80107067 <alltraps>
...
80107895:	6a 00                	push   $0x0
  pushl $87
80107897:	6a 57                	push   $0x57
  jmp alltraps
80107899:	e9 c9 f7 ff ff       	jmp    80107067 <alltraps>
...
8010789e:	6a 00                	push   $0x0
  pushl $88
801078a0:	6a 58                	push   $0x58
  jmp alltraps
801078a2:	e9 c0 f7 ff ff       	jmp    80107067 <alltraps>
...
801078a7:	6a 00                	push   $0x0
  pushl $89
801078a9:	6a 59                	push   $0x59
  jmp alltraps
801078ab:	e9 b7 f7 ff ff       	jmp    80107067 <alltraps>
...
801078b0:	6a 00                	push   $0x0
  pushl $90
801078b2:	6a 5a                	push   $0x5a
  jmp alltraps
801078b4:	e9 ae f7 ff ff       	jmp    80107067 <alltraps>
...
801078b9:	6a 00                	push   $0x0
  pushl $91
801078bb:	6a 5b                	push   $0x5b
  jmp alltraps
801078bd:	e9 a5 f7 ff ff       	jmp    80107067 <alltraps>
...
801078c2:	6a 00                	push   $0x0
  pushl $92
801078c4:	6a 5c                	push   $0x5c
  jmp alltraps
801078c6:	e9 9c f7 ff ff       	jmp    80107067 <alltraps>
...
801078cb:	6a 00                	push   $0x0
  pushl $93
801078cd:	6a 5d                	push   $0x5d
  jmp alltraps
801078cf:	e9 93 f7 ff ff       	jmp    80107067 <alltraps>
...
801078d4:	6a 00                	push   $0x0
  pushl $94
801078d6:	6a 5e                	push   $0x5e
  jmp alltraps
801078d8:	e9 8a f7 ff ff       	jmp    80107067 <alltraps>
...
801078dd:	6a 00                	push   $0x0
  pushl $95
801078df:	6a 5f                	push   $0x5f
  jmp alltraps
801078e1:	e9 81 f7 ff ff       	jmp    80107067 <alltraps>
...
801078e6:	6a 00                	push   $0x0
  pushl $96
801078e8:	6a 60                	push   $0x60
  jmp alltraps
801078ea:	e9 78 f7 ff ff       	jmp    80107067 <alltraps>
...
801078ef:	6a 00                	push   $0x0
  pushl $97
801078f1:	6a 61                	push   $0x61
  jmp alltraps
801078f3:	e9 6f f7 ff ff       	jmp    80107067 <alltraps>
...
801078f8:	6a 00                	push   $0x0
  pushl $98
801078fa:	6a 62                	push   $0x62
  jmp alltraps
801078fc:	e9 66 f7 ff ff       	jmp    80107067 <alltraps>
...
80107901:	6a 00                	push   $0x0
  pushl $99
80107903:	6a 63                	push   $0x63
  jmp alltraps
80107905:	e9 5d f7 ff ff       	jmp    80107067 <alltraps>
...
8010790a:	6a 00                	push   $0x0
  pushl $100
8010790c:	6a 64                	push   $0x64
  jmp alltraps
8010790e:	e9 54 f7 ff ff       	jmp    80107067 <alltraps>
...
80107913:	6a 00                	push   $0x0
  pushl $101
80107915:	6a 65                	push   $0x65
  jmp alltraps
80107917:	e9 4b f7 ff ff       	jmp    80107067 <alltraps>
...
8010791c:	6a 00                	push   $0x0
  pushl $102
8010791e:	6a 66                	push   $0x66
  jmp alltraps
80107920:	e9 42 f7 ff ff       	jmp    80107067 <alltraps>
...
80107925:	6a 00                	push   $0x0
  pushl $103
80107927:	6a 67                	push   $0x67
  jmp alltraps
80107929:	e9 39 f7 ff ff       	jmp    80107067 <alltraps>
...
8010792e:	6a 00                	push   $0x0
  pushl $104
80107930:	6a 68                	push   $0x68
  jmp alltraps
80107932:	e9 30 f7 ff ff       	jmp    80107067 <alltraps>
...
80107937:	6a 00                	push   $0x0
  pushl $105
80107939:	6a 69                	push   $0x69
  jmp alltraps
8010793b:	e9 27 f7 ff ff       	jmp    80107067 <alltraps>
...
80107940:	6a 00                	push   $0x0
  pushl $106
80107942:	6a 6a                	push   $0x6a
  jmp alltraps
80107944:	e9 1e f7 ff ff       	jmp    80107067 <alltraps>
...
80107949:	6a 00                	push   $0x0
  pushl $107
8010794b:	6a 6b                	push   $0x6b
  jmp alltraps
8010794d:	e9 15 f7 ff ff       	jmp    80107067 <alltraps>
...
80107952:	6a 00                	push   $0x0
  pushl $108
80107954:	6a 6c                	push   $0x6c
  jmp alltraps
80107956:	e9 0c f7 ff ff       	jmp    80107067 <alltraps>
...
8010795b:	6a 00                	push   $0x0
  pushl $109
8010795d:	6a 6d                	push   $0x6d
  jmp alltraps
8010795f:	e9 03 f7 ff ff       	jmp    80107067 <alltraps>
...
80107964:	6a 00                	push   $0x0
  pushl $110
80107966:	6a 6e                	push   $0x6e
  jmp alltraps
80107968:	e9 fa f6 ff ff       	jmp    80107067 <alltraps>
...
8010796d:	6a 00                	push   $0x0
  pushl $111
8010796f:	6a 6f                	push   $0x6f
  jmp alltraps
80107971:	e9 f1 f6 ff ff       	jmp    80107067 <alltraps>
...
80107976:	6a 00                	push   $0x0
  pushl $112
80107978:	6a 70                	push   $0x70
  jmp alltraps
8010797a:	e9 e8 f6 ff ff       	jmp    80107067 <alltraps>
...
8010797f:	6a 00                	push   $0x0
  pushl $113
80107981:	6a 71                	push   $0x71
  jmp alltraps
80107983:	e9 df f6 ff ff       	jmp    80107067 <alltraps>
...
80107988:	6a 00                	push   $0x0
  pushl $114
8010798a:	6a 72                	push   $0x72
  jmp alltraps
8010798c:	e9 d6 f6 ff ff       	jmp    80107067 <alltraps>
...
80107991:	6a 00                	push   $0x0
  pushl $115
80107993:	6a 73                	push   $0x73
  jmp alltraps
80107995:	e9 cd f6 ff ff       	jmp    80107067 <alltraps>
...
8010799a:	6a 00                	push   $0x0
  pushl $116
8010799c:	6a 74                	push   $0x74
  jmp alltraps
8010799e:	e9 c4 f6 ff ff       	jmp    80107067 <alltraps>
...
801079a3:	6a 00                	push   $0x0
  pushl $117
801079a5:	6a 75                	push   $0x75
  jmp alltraps
801079a7:	e9 bb f6 ff ff       	jmp    80107067 <alltraps>
...
801079ac:	6a 00                	push   $0x0
  pushl $118
801079ae:	6a 76                	push   $0x76
  jmp alltraps
801079b0:	e9 b2 f6 ff ff       	jmp    80107067 <alltraps>
...
801079b5:	6a 00                	push   $0x0
  pushl $119
801079b7:	6a 77                	push   $0x77
  jmp alltraps
801079b9:	e9 a9 f6 ff ff       	jmp    80107067 <alltraps>
...
801079be:	6a 00                	push   $0x0
  pushl $120
801079c0:	6a 78                	push   $0x78
  jmp alltraps
801079c2:	e9 a0 f6 ff ff       	jmp    80107067 <alltraps>
...
801079c7:	6a 00                	push   $0x0
  pushl $121
801079c9:	6a 79                	push   $0x79
  jmp alltraps
801079cb:	e9 97 f6 ff ff       	jmp    80107067 <alltraps>
...
801079d0:	6a 00                	push   $0x0
  pushl $122
801079d2:	6a 7a                	push   $0x7a
  jmp alltraps
801079d4:	e9 8e f6 ff ff       	jmp    80107067 <alltraps>
...
801079d9:	6a 00                	push   $0x0
  pushl $123
801079db:	6a 7b                	push   $0x7b
  jmp alltraps
801079dd:	e9 85 f6 ff ff       	jmp    80107067 <alltraps>
...
801079e2:	6a 00                	push   $0x0
  pushl $124
801079e4:	6a 7c                	push   $0x7c
  jmp alltraps
801079e6:	e9 7c f6 ff ff       	jmp    80107067 <alltraps>
...
801079eb:	6a 00                	push   $0x0
  pushl $125
801079ed:	6a 7d                	push   $0x7d
  jmp alltraps
801079ef:	e9 73 f6 ff ff       	jmp    80107067 <alltraps>
...
801079f4:	6a 00                	push   $0x0
  pushl $126
801079f6:	6a 7e                	push   $0x7e
  jmp alltraps
801079f8:	e9 6a f6 ff ff       	jmp    80107067 <alltraps>
...
801079fd:	6a 00                	push   $0x0
  pushl $127
801079ff:	6a 7f                	push   $0x7f
  jmp alltraps
80107a01:	e9 61 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a06:	6a 00                	push   $0x0
  pushl $128
80107a08:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80107a0d:	e9 55 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a12:	6a 00                	push   $0x0
  pushl $129
80107a14:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107a19:	e9 49 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a1e:	6a 00                	push   $0x0
  pushl $130
80107a20:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107a25:	e9 3d f6 ff ff       	jmp    80107067 <alltraps>
...
80107a2a:	6a 00                	push   $0x0
  pushl $131
80107a2c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107a31:	e9 31 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a36:	6a 00                	push   $0x0
  pushl $132
80107a38:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80107a3d:	e9 25 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a42:	6a 00                	push   $0x0
  pushl $133
80107a44:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80107a49:	e9 19 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a4e:	6a 00                	push   $0x0
  pushl $134
80107a50:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80107a55:	e9 0d f6 ff ff       	jmp    80107067 <alltraps>
...
80107a5a:	6a 00                	push   $0x0
  pushl $135
80107a5c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80107a61:	e9 01 f6 ff ff       	jmp    80107067 <alltraps>
...
80107a66:	6a 00                	push   $0x0
  pushl $136
80107a68:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80107a6d:	e9 f5 f5 ff ff       	jmp    80107067 <alltraps>
...
80107a72:	6a 00                	push   $0x0
  pushl $137
80107a74:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80107a79:	e9 e9 f5 ff ff       	jmp    80107067 <alltraps>
...
80107a7e:	6a 00                	push   $0x0
  pushl $138
80107a80:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80107a85:	e9 dd f5 ff ff       	jmp    80107067 <alltraps>
...
80107a8a:	6a 00                	push   $0x0
  pushl $139
80107a8c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80107a91:	e9 d1 f5 ff ff       	jmp    80107067 <alltraps>
...
80107a96:	6a 00                	push   $0x0
  pushl $140
80107a98:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80107a9d:	e9 c5 f5 ff ff       	jmp    80107067 <alltraps>
...
80107aa2:	6a 00                	push   $0x0
  pushl $141
80107aa4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107aa9:	e9 b9 f5 ff ff       	jmp    80107067 <alltraps>
...
80107aae:	6a 00                	push   $0x0
  pushl $142
80107ab0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107ab5:	e9 ad f5 ff ff       	jmp    80107067 <alltraps>
...
80107aba:	6a 00                	push   $0x0
  pushl $143
80107abc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107ac1:	e9 a1 f5 ff ff       	jmp    80107067 <alltraps>
...
80107ac6:	6a 00                	push   $0x0
  pushl $144
80107ac8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107acd:	e9 95 f5 ff ff       	jmp    80107067 <alltraps>
...
80107ad2:	6a 00                	push   $0x0
  pushl $145
80107ad4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107ad9:	e9 89 f5 ff ff       	jmp    80107067 <alltraps>
...
80107ade:	6a 00                	push   $0x0
  pushl $146
80107ae0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107ae5:	e9 7d f5 ff ff       	jmp    80107067 <alltraps>
...
80107aea:	6a 00                	push   $0x0
  pushl $147
80107aec:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107af1:	e9 71 f5 ff ff       	jmp    80107067 <alltraps>
...
80107af6:	6a 00                	push   $0x0
  pushl $148
80107af8:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107afd:	e9 65 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b02:	6a 00                	push   $0x0
  pushl $149
80107b04:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107b09:	e9 59 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b0e:	6a 00                	push   $0x0
  pushl $150
80107b10:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107b15:	e9 4d f5 ff ff       	jmp    80107067 <alltraps>
...
80107b1a:	6a 00                	push   $0x0
  pushl $151
80107b1c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107b21:	e9 41 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b26:	6a 00                	push   $0x0
  pushl $152
80107b28:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107b2d:	e9 35 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b32:	6a 00                	push   $0x0
  pushl $153
80107b34:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107b39:	e9 29 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b3e:	6a 00                	push   $0x0
  pushl $154
80107b40:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107b45:	e9 1d f5 ff ff       	jmp    80107067 <alltraps>
...
80107b4a:	6a 00                	push   $0x0
  pushl $155
80107b4c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107b51:	e9 11 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b56:	6a 00                	push   $0x0
  pushl $156
80107b58:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80107b5d:	e9 05 f5 ff ff       	jmp    80107067 <alltraps>
...
80107b62:	6a 00                	push   $0x0
  pushl $157
80107b64:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80107b69:	e9 f9 f4 ff ff       	jmp    80107067 <alltraps>
...
80107b6e:	6a 00                	push   $0x0
  pushl $158
80107b70:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80107b75:	e9 ed f4 ff ff       	jmp    80107067 <alltraps>
...
80107b7a:	6a 00                	push   $0x0
  pushl $159
80107b7c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80107b81:	e9 e1 f4 ff ff       	jmp    80107067 <alltraps>
...
80107b86:	6a 00                	push   $0x0
  pushl $160
80107b88:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80107b8d:	e9 d5 f4 ff ff       	jmp    80107067 <alltraps>
...
80107b92:	6a 00                	push   $0x0
  pushl $161
80107b94:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80107b99:	e9 c9 f4 ff ff       	jmp    80107067 <alltraps>
...
80107b9e:	6a 00                	push   $0x0
  pushl $162
80107ba0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107ba5:	e9 bd f4 ff ff       	jmp    80107067 <alltraps>
...
80107baa:	6a 00                	push   $0x0
  pushl $163
80107bac:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107bb1:	e9 b1 f4 ff ff       	jmp    80107067 <alltraps>
...
80107bb6:	6a 00                	push   $0x0
  pushl $164
80107bb8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107bbd:	e9 a5 f4 ff ff       	jmp    80107067 <alltraps>
...
80107bc2:	6a 00                	push   $0x0
  pushl $165
80107bc4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107bc9:	e9 99 f4 ff ff       	jmp    80107067 <alltraps>
...
80107bce:	6a 00                	push   $0x0
  pushl $166
80107bd0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107bd5:	e9 8d f4 ff ff       	jmp    80107067 <alltraps>
...
80107bda:	6a 00                	push   $0x0
  pushl $167
80107bdc:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107be1:	e9 81 f4 ff ff       	jmp    80107067 <alltraps>
...
80107be6:	6a 00                	push   $0x0
  pushl $168
80107be8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107bed:	e9 75 f4 ff ff       	jmp    80107067 <alltraps>
...
80107bf2:	6a 00                	push   $0x0
  pushl $169
80107bf4:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107bf9:	e9 69 f4 ff ff       	jmp    80107067 <alltraps>
...
80107bfe:	6a 00                	push   $0x0
  pushl $170
80107c00:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107c05:	e9 5d f4 ff ff       	jmp    80107067 <alltraps>
...
80107c0a:	6a 00                	push   $0x0
  pushl $171
80107c0c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107c11:	e9 51 f4 ff ff       	jmp    80107067 <alltraps>
...
80107c16:	6a 00                	push   $0x0
  pushl $172
80107c18:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107c1d:	e9 45 f4 ff ff       	jmp    80107067 <alltraps>
...
80107c22:	6a 00                	push   $0x0
  pushl $173
80107c24:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107c29:	e9 39 f4 ff ff       	jmp    80107067 <alltraps>
...
80107c2e:	6a 00                	push   $0x0
  pushl $174
80107c30:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107c35:	e9 2d f4 ff ff       	jmp    80107067 <alltraps>
...
80107c3a:	6a 00                	push   $0x0
  pushl $175
80107c3c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107c41:	e9 21 f4 ff ff       	jmp    80107067 <alltraps>
...
80107c46:	6a 00                	push   $0x0
  pushl $176
80107c48:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107c4d:	e9 15 f4 ff ff       	jmp    80107067 <alltraps>
...
80107c52:	6a 00                	push   $0x0
  pushl $177
80107c54:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107c59:	e9 09 f4 ff ff       	jmp    80107067 <alltraps>
...
80107c5e:	6a 00                	push   $0x0
  pushl $178
80107c60:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107c65:	e9 fd f3 ff ff       	jmp    80107067 <alltraps>
...
80107c6a:	6a 00                	push   $0x0
  pushl $179
80107c6c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107c71:	e9 f1 f3 ff ff       	jmp    80107067 <alltraps>
...
80107c76:	6a 00                	push   $0x0
  pushl $180
80107c78:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107c7d:	e9 e5 f3 ff ff       	jmp    80107067 <alltraps>
...
80107c82:	6a 00                	push   $0x0
  pushl $181
80107c84:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107c89:	e9 d9 f3 ff ff       	jmp    80107067 <alltraps>
...
80107c8e:	6a 00                	push   $0x0
  pushl $182
80107c90:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107c95:	e9 cd f3 ff ff       	jmp    80107067 <alltraps>
...
80107c9a:	6a 00                	push   $0x0
  pushl $183
80107c9c:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107ca1:	e9 c1 f3 ff ff       	jmp    80107067 <alltraps>
...
80107ca6:	6a 00                	push   $0x0
  pushl $184
80107ca8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107cad:	e9 b5 f3 ff ff       	jmp    80107067 <alltraps>
...
80107cb2:	6a 00                	push   $0x0
  pushl $185
80107cb4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107cb9:	e9 a9 f3 ff ff       	jmp    80107067 <alltraps>
...
80107cbe:	6a 00                	push   $0x0
  pushl $186
80107cc0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107cc5:	e9 9d f3 ff ff       	jmp    80107067 <alltraps>
...
80107cca:	6a 00                	push   $0x0
  pushl $187
80107ccc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107cd1:	e9 91 f3 ff ff       	jmp    80107067 <alltraps>
...
80107cd6:	6a 00                	push   $0x0
  pushl $188
80107cd8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107cdd:	e9 85 f3 ff ff       	jmp    80107067 <alltraps>
...
80107ce2:	6a 00                	push   $0x0
  pushl $189
80107ce4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107ce9:	e9 79 f3 ff ff       	jmp    80107067 <alltraps>
...
80107cee:	6a 00                	push   $0x0
  pushl $190
80107cf0:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107cf5:	e9 6d f3 ff ff       	jmp    80107067 <alltraps>
...
80107cfa:	6a 00                	push   $0x0
  pushl $191
80107cfc:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107d01:	e9 61 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d06:	6a 00                	push   $0x0
  pushl $192
80107d08:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107d0d:	e9 55 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d12:	6a 00                	push   $0x0
  pushl $193
80107d14:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107d19:	e9 49 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d1e:	6a 00                	push   $0x0
  pushl $194
80107d20:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107d25:	e9 3d f3 ff ff       	jmp    80107067 <alltraps>
...
80107d2a:	6a 00                	push   $0x0
  pushl $195
80107d2c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107d31:	e9 31 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d36:	6a 00                	push   $0x0
  pushl $196
80107d38:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107d3d:	e9 25 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d42:	6a 00                	push   $0x0
  pushl $197
80107d44:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107d49:	e9 19 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d4e:	6a 00                	push   $0x0
  pushl $198
80107d50:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107d55:	e9 0d f3 ff ff       	jmp    80107067 <alltraps>
...
80107d5a:	6a 00                	push   $0x0
  pushl $199
80107d5c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107d61:	e9 01 f3 ff ff       	jmp    80107067 <alltraps>
...
80107d66:	6a 00                	push   $0x0
  pushl $200
80107d68:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107d6d:	e9 f5 f2 ff ff       	jmp    80107067 <alltraps>
...
80107d72:	6a 00                	push   $0x0
  pushl $201
80107d74:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107d79:	e9 e9 f2 ff ff       	jmp    80107067 <alltraps>
...
80107d7e:	6a 00                	push   $0x0
  pushl $202
80107d80:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107d85:	e9 dd f2 ff ff       	jmp    80107067 <alltraps>
...
80107d8a:	6a 00                	push   $0x0
  pushl $203
80107d8c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107d91:	e9 d1 f2 ff ff       	jmp    80107067 <alltraps>
...
80107d96:	6a 00                	push   $0x0
  pushl $204
80107d98:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107d9d:	e9 c5 f2 ff ff       	jmp    80107067 <alltraps>
...
80107da2:	6a 00                	push   $0x0
  pushl $205
80107da4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107da9:	e9 b9 f2 ff ff       	jmp    80107067 <alltraps>
...
80107dae:	6a 00                	push   $0x0
  pushl $206
80107db0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107db5:	e9 ad f2 ff ff       	jmp    80107067 <alltraps>
...
80107dba:	6a 00                	push   $0x0
  pushl $207
80107dbc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107dc1:	e9 a1 f2 ff ff       	jmp    80107067 <alltraps>
...
80107dc6:	6a 00                	push   $0x0
  pushl $208
80107dc8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107dcd:	e9 95 f2 ff ff       	jmp    80107067 <alltraps>
...
80107dd2:	6a 00                	push   $0x0
  pushl $209
80107dd4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107dd9:	e9 89 f2 ff ff       	jmp    80107067 <alltraps>
...
80107dde:	6a 00                	push   $0x0
  pushl $210
80107de0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107de5:	e9 7d f2 ff ff       	jmp    80107067 <alltraps>
...
80107dea:	6a 00                	push   $0x0
  pushl $211
80107dec:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107df1:	e9 71 f2 ff ff       	jmp    80107067 <alltraps>
...
80107df6:	6a 00                	push   $0x0
  pushl $212
80107df8:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107dfd:	e9 65 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e02:	6a 00                	push   $0x0
  pushl $213
80107e04:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107e09:	e9 59 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e0e:	6a 00                	push   $0x0
  pushl $214
80107e10:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107e15:	e9 4d f2 ff ff       	jmp    80107067 <alltraps>
...
80107e1a:	6a 00                	push   $0x0
  pushl $215
80107e1c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107e21:	e9 41 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e26:	6a 00                	push   $0x0
  pushl $216
80107e28:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107e2d:	e9 35 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e32:	6a 00                	push   $0x0
  pushl $217
80107e34:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107e39:	e9 29 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e3e:	6a 00                	push   $0x0
  pushl $218
80107e40:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107e45:	e9 1d f2 ff ff       	jmp    80107067 <alltraps>
...
80107e4a:	6a 00                	push   $0x0
  pushl $219
80107e4c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107e51:	e9 11 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e56:	6a 00                	push   $0x0
  pushl $220
80107e58:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107e5d:	e9 05 f2 ff ff       	jmp    80107067 <alltraps>
...
80107e62:	6a 00                	push   $0x0
  pushl $221
80107e64:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107e69:	e9 f9 f1 ff ff       	jmp    80107067 <alltraps>
...
80107e6e:	6a 00                	push   $0x0
  pushl $222
80107e70:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107e75:	e9 ed f1 ff ff       	jmp    80107067 <alltraps>
...
80107e7a:	6a 00                	push   $0x0
  pushl $223
80107e7c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107e81:	e9 e1 f1 ff ff       	jmp    80107067 <alltraps>
...
80107e86:	6a 00                	push   $0x0
  pushl $224
80107e88:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107e8d:	e9 d5 f1 ff ff       	jmp    80107067 <alltraps>
...
80107e92:	6a 00                	push   $0x0
  pushl $225
80107e94:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107e99:	e9 c9 f1 ff ff       	jmp    80107067 <alltraps>
...
80107e9e:	6a 00                	push   $0x0
  pushl $226
80107ea0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107ea5:	e9 bd f1 ff ff       	jmp    80107067 <alltraps>
...
80107eaa:	6a 00                	push   $0x0
  pushl $227
80107eac:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107eb1:	e9 b1 f1 ff ff       	jmp    80107067 <alltraps>
...
80107eb6:	6a 00                	push   $0x0
  pushl $228
80107eb8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107ebd:	e9 a5 f1 ff ff       	jmp    80107067 <alltraps>
...
80107ec2:	6a 00                	push   $0x0
  pushl $229
80107ec4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107ec9:	e9 99 f1 ff ff       	jmp    80107067 <alltraps>
...
80107ece:	6a 00                	push   $0x0
  pushl $230
80107ed0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107ed5:	e9 8d f1 ff ff       	jmp    80107067 <alltraps>
...
80107eda:	6a 00                	push   $0x0
  pushl $231
80107edc:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107ee1:	e9 81 f1 ff ff       	jmp    80107067 <alltraps>
...
80107ee6:	6a 00                	push   $0x0
  pushl $232
80107ee8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107eed:	e9 75 f1 ff ff       	jmp    80107067 <alltraps>
...
80107ef2:	6a 00                	push   $0x0
  pushl $233
80107ef4:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107ef9:	e9 69 f1 ff ff       	jmp    80107067 <alltraps>
...
80107efe:	6a 00                	push   $0x0
  pushl $234
80107f00:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107f05:	e9 5d f1 ff ff       	jmp    80107067 <alltraps>
...
80107f0a:	6a 00                	push   $0x0
  pushl $235
80107f0c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107f11:	e9 51 f1 ff ff       	jmp    80107067 <alltraps>
...
80107f16:	6a 00                	push   $0x0
  pushl $236
80107f18:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107f1d:	e9 45 f1 ff ff       	jmp    80107067 <alltraps>
...
80107f22:	6a 00                	push   $0x0
  pushl $237
80107f24:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107f29:	e9 39 f1 ff ff       	jmp    80107067 <alltraps>
...
80107f2e:	6a 00                	push   $0x0
  pushl $238
80107f30:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107f35:	e9 2d f1 ff ff       	jmp    80107067 <alltraps>
...
80107f3a:	6a 00                	push   $0x0
  pushl $239
80107f3c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107f41:	e9 21 f1 ff ff       	jmp    80107067 <alltraps>
...
80107f46:	6a 00                	push   $0x0
  pushl $240
80107f48:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107f4d:	e9 15 f1 ff ff       	jmp    80107067 <alltraps>
...
80107f52:	6a 00                	push   $0x0
  pushl $241
80107f54:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107f59:	e9 09 f1 ff ff       	jmp    80107067 <alltraps>
...
80107f5e:	6a 00                	push   $0x0
  pushl $242
80107f60:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107f65:	e9 fd f0 ff ff       	jmp    80107067 <alltraps>
...
80107f6a:	6a 00                	push   $0x0
  pushl $243
80107f6c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107f71:	e9 f1 f0 ff ff       	jmp    80107067 <alltraps>
...
80107f76:	6a 00                	push   $0x0
  pushl $244
80107f78:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107f7d:	e9 e5 f0 ff ff       	jmp    80107067 <alltraps>
...
80107f82:	6a 00                	push   $0x0
  pushl $245
80107f84:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107f89:	e9 d9 f0 ff ff       	jmp    80107067 <alltraps>
...
80107f8e:	6a 00                	push   $0x0
  pushl $246
80107f90:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107f95:	e9 cd f0 ff ff       	jmp    80107067 <alltraps>
...
80107f9a:	6a 00                	push   $0x0
  pushl $247
80107f9c:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107fa1:	e9 c1 f0 ff ff       	jmp    80107067 <alltraps>
...
80107fa6:	6a 00                	push   $0x0
  pushl $248
80107fa8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107fad:	e9 b5 f0 ff ff       	jmp    80107067 <alltraps>
...
80107fb2:	6a 00                	push   $0x0
  pushl $249
80107fb4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107fb9:	e9 a9 f0 ff ff       	jmp    80107067 <alltraps>
...
80107fbe:	6a 00                	push   $0x0
  pushl $250
80107fc0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107fc5:	e9 9d f0 ff ff       	jmp    80107067 <alltraps>
...
80107fca:	6a 00                	push   $0x0
  pushl $251
80107fcc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107fd1:	e9 91 f0 ff ff       	jmp    80107067 <alltraps>
...
80107fd6:	6a 00                	push   $0x0
  pushl $252
80107fd8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107fdd:	e9 85 f0 ff ff       	jmp    80107067 <alltraps>
...
80107fe2:	6a 00                	push   $0x0
  pushl $253
80107fe4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107fe9:	e9 79 f0 ff ff       	jmp    80107067 <alltraps>
...
80107fee:	6a 00                	push   $0x0
  pushl $254
80107ff0:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107ff5:	e9 6d f0 ff ff       	jmp    80107067 <alltraps>
...
80107ffa:	6a 00                	push   $0x0
  pushl $255
80107ffc:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80108001:	e9 61 f0 ff ff       	jmp    80107067 <alltraps>
80108006:	66 90                	xchg   %ax,%ax
80108008:	66 90                	xchg   %ax,%ax
8010800a:	66 90                	xchg   %ax,%ax
8010800c:	66 90                	xchg   %ax,%ax
...
80108013:	83 ec 28             	sub    $0x28,%esp
80108016:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80108019:	89 d3                	mov    %edx,%ebx
8010801b:	c1 eb 16             	shr    $0x16,%ebx
{
8010801e:	89 75 f8             	mov    %esi,-0x8(%ebp)
  pde = &pgdir[PDX(va)];
80108021:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80108024:	89 7d fc             	mov    %edi,-0x4(%ebp)
80108027:	89 d7                	mov    %edx,%edi
  if(*pde & PTE_P){
80108029:	8b 06                	mov    (%esi),%eax
8010802b:	a8 01                	test   $0x1,%al
8010802d:	74 29                	je     80108058 <walkpgdir+0x48>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010802f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108034:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
8010803a:	c1 ef 0a             	shr    $0xa,%edi
}
8010803d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  return &pgtab[PTX(va)];
80108040:	89 fa                	mov    %edi,%edx
}
80108042:	8b 7d fc             	mov    -0x4(%ebp),%edi
  return &pgtab[PTX(va)];
80108045:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
8010804b:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
8010804e:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80108051:	89 ec                	mov    %ebp,%esp
80108053:	5d                   	pop    %ebp
80108054:	c3                   	ret    
80108055:	8d 76 00             	lea    0x0(%esi),%esi
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80108058:	85 c9                	test   %ecx,%ecx
8010805a:	74 34                	je     80108090 <walkpgdir+0x80>
8010805c:	e8 4f a5 ff ff       	call   801025b0 <kalloc>
80108061:	85 c0                	test   %eax,%eax
80108063:	89 c3                	mov    %eax,%ebx
80108065:	74 29                	je     80108090 <walkpgdir+0x80>
    memset(pgtab, 0, PGSIZE);
80108067:	b8 00 10 00 00       	mov    $0x1000,%eax
8010806c:	31 d2                	xor    %edx,%edx
8010806e:	89 44 24 08          	mov    %eax,0x8(%esp)
80108072:	89 54 24 04          	mov    %edx,0x4(%esp)
80108076:	89 1c 24             	mov    %ebx,(%esp)
80108079:	e8 d2 dc ff ff       	call   80105d50 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010807e:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80108084:	83 c8 07             	or     $0x7,%eax
80108087:	89 06                	mov    %eax,(%esi)
80108089:	eb af                	jmp    8010803a <walkpgdir+0x2a>
8010808b:	90                   	nop
8010808c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
}
80108090:	8b 5d f4             	mov    -0xc(%ebp),%ebx
      return 0;
80108093:	31 c0                	xor    %eax,%eax
}
80108095:	8b 75 f8             	mov    -0x8(%ebp),%esi
80108098:	8b 7d fc             	mov    -0x4(%ebp),%edi
8010809b:	89 ec                	mov    %ebp,%esp
8010809d:	5d                   	pop    %ebp
8010809e:	c3                   	ret    
8010809f:	90                   	nop
...
801080a6:	89 d3                	mov    %edx,%ebx
{
801080a8:	83 ec 2c             	sub    $0x2c,%esp
  a = (char*)PGROUNDDOWN((uint)va);
801080ab:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
801080b1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801080b4:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
801080b8:	8b 7d 08             	mov    0x8(%ebp),%edi
...
801080c6:	29 df                	sub    %ebx,%edi
801080c8:	83 c8 01             	or     $0x1,%eax
801080cb:	89 45 dc             	mov    %eax,-0x24(%ebp)
801080ce:	eb 17                	jmp    801080e7 <mappages+0x47>
    if(*pte & PTE_P)
801080d0:	f6 00 01             	testb  $0x1,(%eax)
801080d3:	75 45                	jne    8010811a <mappages+0x7a>
    *pte = pa | perm | PTE_P;
801080d5:	8b 55 dc             	mov    -0x24(%ebp),%edx
801080d8:	09 d6                	or     %edx,%esi
    if(a == last)
801080da:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
    *pte = pa | perm | PTE_P;
801080dd:	89 30                	mov    %esi,(%eax)
    if(a == last)
801080df:	74 2f                	je     80108110 <mappages+0x70>
      break;
    a += PGSIZE;
801080e1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
801080e7:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801080ea:	b9 01 00 00 00       	mov    $0x1,%ecx
801080ef:	89 da                	mov    %ebx,%edx
801080f1:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
801080f4:	e8 17 ff ff ff       	call   80108010 <walkpgdir>
801080f9:	85 c0                	test   %eax,%eax
801080fb:	75 d3                	jne    801080d0 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
801080fd:	83 c4 2c             	add    $0x2c,%esp
      return -1;
...
80108110:	83 c4 2c             	add    $0x2c,%esp
  return 0;
80108113:	31 c0                	xor    %eax,%eax
}
80108115:	5b                   	pop    %ebx
80108116:	5e                   	pop    %esi
80108117:	5f                   	pop    %edi
...
80108119:	c3                   	ret    
      panic("remap");
8010811a:	c7 04 24 b8 92 10 80 	movl   $0x801092b8,(%esp)
80108121:	e8 4a 82 ff ff       	call   80100370 <panic>
80108126:	8d 76 00             	lea    0x0(%esi),%esi
80108129:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80108130 <deallocuvm.part.0>:
...
80108134:	89 c7                	mov    %eax,%edi
80108136:	56                   	push   %esi
80108137:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80108138:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010813e:	83 ec 2c             	sub    $0x2c,%esp
  a = PGROUNDUP(newsz);
80108141:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80108147:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80108149:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010814c:	73 62                	jae    801081b0 <deallocuvm.part.0+0x80>
8010814e:	89 d6                	mov    %edx,%esi
80108150:	eb 39                	jmp    8010818b <deallocuvm.part.0+0x5b>
80108152:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80108158:	8b 10                	mov    (%eax),%edx
8010815a:	f6 c2 01             	test   $0x1,%dl
8010815d:	74 22                	je     80108181 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010815f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80108165:	74 54                	je     801081bb <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80108167:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010816d:	89 14 24             	mov    %edx,(%esp)
80108170:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108173:	e8 68 a2 ff ff       	call   801023e0 <kfree>
      *pte = 0;
80108178:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010817b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80108181:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80108187:	39 f3                	cmp    %esi,%ebx
80108189:	73 25                	jae    801081b0 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010818b:	31 c9                	xor    %ecx,%ecx
8010818d:	89 da                	mov    %ebx,%edx
8010818f:	89 f8                	mov    %edi,%eax
80108191:	e8 7a fe ff ff       	call   80108010 <walkpgdir>
    if(!pte)
80108196:	85 c0                	test   %eax,%eax
80108198:	75 be                	jne    80108158 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010819a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801081a0:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801081a6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801081ac:	39 f3                	cmp    %esi,%ebx
801081ae:	72 db                	jb     8010818b <deallocuvm.part.0+0x5b>
    }
  }
  return newsz;
}
801081b0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801081b3:	83 c4 2c             	add    $0x2c,%esp
801081b6:	5b                   	pop    %ebx
801081b7:	5e                   	pop    %esi
801081b8:	5f                   	pop    %edi
801081b9:	5d                   	pop    %ebp
801081ba:	c3                   	ret    
        panic("kfree");
801081bb:	c7 04 24 c6 8b 10 80 	movl   $0x80108bc6,(%esp)
801081c2:	e8 a9 81 ff ff       	call   80100370 <panic>
...
801081d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801081d6:	e8 a5 b7 ff ff       	call   80103980 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801081db:	b9 00 9a cf 00       	mov    $0xcf9a00,%ecx
  pd[0] = size-1;
801081e0:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
801081e6:	8d 14 80             	lea    (%eax,%eax,4),%edx
801081e9:	8d 04 50             	lea    (%eax,%edx,2),%eax
801081ec:	ba ff ff 00 00       	mov    $0xffff,%edx
801081f1:	c1 e0 04             	shl    $0x4,%eax
801081f4:	89 90 78 48 11 80    	mov    %edx,-0x7feeb788(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801081fa:	ba ff ff 00 00       	mov    $0xffff,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801081ff:	89 88 7c 48 11 80    	mov    %ecx,-0x7feeb784(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108205:	b9 00 92 cf 00       	mov    $0xcf9200,%ecx
8010820a:	89 90 80 48 11 80    	mov    %edx,-0x7feeb780(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108210:	ba ff ff 00 00       	mov    $0xffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108215:	89 88 84 48 11 80    	mov    %ecx,-0x7feeb77c(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010821b:	b9 00 fa cf 00       	mov    $0xcffa00,%ecx
80108220:	89 90 88 48 11 80    	mov    %edx,-0x7feeb778(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108226:	ba ff ff 00 00       	mov    $0xffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010822b:	89 88 8c 48 11 80    	mov    %ecx,-0x7feeb774(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108231:	b9 00 f2 cf 00       	mov    $0xcff200,%ecx
80108236:	89 90 90 48 11 80    	mov    %edx,-0x7feeb770(%eax)
8010823c:	89 88 94 48 11 80    	mov    %ecx,-0x7feeb76c(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80108242:	05 70 48 11 80       	add    $0x80114870,%eax
  pd[1] = (uint)p;
80108247:	0f b7 d0             	movzwl %ax,%edx
  pd[2] = (uint)p >> 16;
8010824a:	c1 e8 10             	shr    $0x10,%eax
  pd[1] = (uint)p;
8010824d:	66 89 55 f4          	mov    %dx,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80108251:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80108255:	8d 45 f2             	lea    -0xe(%ebp),%eax
80108258:	0f 01 10             	lgdtl  (%eax)
}
8010825b:	c9                   	leave  
8010825c:	c3                   	ret    
...
80108260:	a1 24 80 11 80       	mov    0x80118024,%eax
{
80108265:	55                   	push   %ebp
80108266:	89 e5                	mov    %esp,%ebp
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80108268:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80108286:	83 ec 2c             	sub    $0x2c,%esp
80108289:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
8010828c:	85 db                	test   %ebx,%ebx
8010828e:	0f 84 c5 00 00 00    	je     80108359 <switchuvm+0xd9>
  if(p->kstack == 0)
80108294:	8b 7b 08             	mov    0x8(%ebx),%edi
80108297:	85 ff                	test   %edi,%edi
80108299:	0f 84 d2 00 00 00    	je     80108371 <switchuvm+0xf1>
  if(p->pgdir == 0)
8010829f:	8b 73 04             	mov    0x4(%ebx),%esi
801082a2:	85 f6                	test   %esi,%esi
801082a4:	0f 84 bb 00 00 00    	je     80108365 <switchuvm+0xe5>
  pushcli();
801082aa:	e8 d1 d8 ff ff       	call   80105b80 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801082af:	e8 4c b6 ff ff       	call   80103900 <mycpu>
801082b4:	89 c6                	mov    %eax,%esi
801082b6:	e8 45 b6 ff ff       	call   80103900 <mycpu>
801082bb:	89 c7                	mov    %eax,%edi
801082bd:	e8 3e b6 ff ff       	call   80103900 <mycpu>
801082c2:	83 c7 08             	add    $0x8,%edi
801082c5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801082c8:	e8 33 b6 ff ff       	call   80103900 <mycpu>
801082cd:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801082d0:	ba 67 00 00 00       	mov    $0x67,%edx
801082d5:	66 89 96 98 00 00 00 	mov    %dx,0x98(%esi)
801082dc:	66 89 be 9a 00 00 00 	mov    %di,0x9a(%esi)
801082e3:	83 c1 08             	add    $0x8,%ecx
801082e6:	c1 e9 10             	shr    $0x10,%ecx
801082e9:	83 c0 08             	add    $0x8,%eax
801082ec:	88 8e 9c 00 00 00    	mov    %cl,0x9c(%esi)
801082f2:	c1 e8 18             	shr    $0x18,%eax
801082f5:	b9 99 40 00 00       	mov    $0x4099,%ecx
801082fa:	66 89 8e 9d 00 00 00 	mov    %cx,0x9d(%esi)
80108301:	88 86 9f 00 00 00    	mov    %al,0x9f(%esi)
  mycpu()->gdt[SEG_TSS].s = 0;
80108307:	e8 f4 b5 ff ff       	call   80103900 <mycpu>
8010830c:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80108313:	e8 e8 b5 ff ff       	call   80103900 <mycpu>
80108318:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
8010831e:	8b 73 08             	mov    0x8(%ebx),%esi
80108321:	e8 da b5 ff ff       	call   80103900 <mycpu>
80108326:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010832c:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
8010832f:	e8 cc b5 ff ff       	call   80103900 <mycpu>
80108334:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
8010833a:	b8 28 00 00 00       	mov    $0x28,%eax
8010833f:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80108342:	8b 43 04             	mov    0x4(%ebx),%eax
80108345:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010834a:	0f 22 d8             	mov    %eax,%cr3
}
8010834d:	83 c4 2c             	add    $0x2c,%esp
80108350:	5b                   	pop    %ebx
80108351:	5e                   	pop    %esi
80108352:	5f                   	pop    %edi
80108353:	5d                   	pop    %ebp
  popcli();
80108354:	e9 67 d8 ff ff       	jmp    80105bc0 <popcli>
    panic("switchuvm: no process");
80108359:	c7 04 24 be 92 10 80 	movl   $0x801092be,(%esp)
80108360:	e8 0b 80 ff ff       	call   80100370 <panic>
    panic("switchuvm: no pgdir");
80108365:	c7 04 24 e9 92 10 80 	movl   $0x801092e9,(%esp)
8010836c:	e8 ff 7f ff ff       	call   80100370 <panic>
    panic("switchuvm: no kstack");
80108371:	c7 04 24 d4 92 10 80 	movl   $0x801092d4,(%esp)
80108378:	e8 f3 7f ff ff       	call   80100370 <panic>
...
80108383:	83 ec 38             	sub    $0x38,%esp
80108386:	89 75 f8             	mov    %esi,-0x8(%ebp)
80108389:	8b 75 10             	mov    0x10(%ebp),%esi
8010838c:	8b 45 08             	mov    0x8(%ebp),%eax
8010838f:	89 7d fc             	mov    %edi,-0x4(%ebp)
80108392:	8b 7d 0c             	mov    0xc(%ebp),%edi
80108395:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  if(sz >= PGSIZE)
80108398:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
{
8010839e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
801083a1:	77 59                	ja     801083fc <inituvm+0x7c>
  mem = kalloc();
801083a3:	e8 08 a2 ff ff       	call   801025b0 <kalloc>
  memset(mem, 0, PGSIZE);
801083a8:	31 d2                	xor    %edx,%edx
801083aa:	89 54 24 04          	mov    %edx,0x4(%esp)
  mem = kalloc();
801083ae:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801083b0:	b8 00 10 00 00       	mov    $0x1000,%eax
801083b5:	89 1c 24             	mov    %ebx,(%esp)
801083b8:	89 44 24 08          	mov    %eax,0x8(%esp)
801083bc:	e8 8f d9 ff ff       	call   80105d50 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801083c1:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801083c7:	b9 06 00 00 00       	mov    $0x6,%ecx
801083cc:	89 04 24             	mov    %eax,(%esp)
801083cf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801083d2:	31 d2                	xor    %edx,%edx
801083d4:	89 4c 24 04          	mov    %ecx,0x4(%esp)
801083d8:	b9 00 10 00 00       	mov    $0x1000,%ecx
801083dd:	e8 be fc ff ff       	call   801080a0 <mappages>
  memmove(mem, init, sz);
801083e2:	89 75 10             	mov    %esi,0x10(%ebp)
}
801083e5:	8b 75 f8             	mov    -0x8(%ebp),%esi
  memmove(mem, init, sz);
801083e8:	89 7d 0c             	mov    %edi,0xc(%ebp)
}
801083eb:	8b 7d fc             	mov    -0x4(%ebp),%edi
  memmove(mem, init, sz);
801083ee:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
801083f1:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801083f4:	89 ec                	mov    %ebp,%esp
801083f6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801083f7:	e9 14 da ff ff       	jmp    80105e10 <memmove>
    panic("inituvm: more than a page");
801083fc:	c7 04 24 fd 92 10 80 	movl   $0x801092fd,(%esp)
80108403:	e8 68 7f ff ff       	call   80100370 <panic>
80108408:	90                   	nop
...
80108419:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
80108420:	0f 85 98 00 00 00    	jne    801084be <loaduvm+0xae>
  for(i = 0; i < sz; i += PGSIZE){
80108426:	8b 75 18             	mov    0x18(%ebp),%esi
80108429:	31 db                	xor    %ebx,%ebx
8010842b:	85 f6                	test   %esi,%esi
8010842d:	75 1a                	jne    80108449 <loaduvm+0x39>
8010842f:	eb 77                	jmp    801084a8 <loaduvm+0x98>
80108431:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108438:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010843e:	81 ee 00 10 00 00    	sub    $0x1000,%esi
80108444:	39 5d 18             	cmp    %ebx,0x18(%ebp)
80108447:	76 5f                	jbe    801084a8 <loaduvm+0x98>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80108449:	8b 55 0c             	mov    0xc(%ebp),%edx
8010844c:	31 c9                	xor    %ecx,%ecx
8010844e:	8b 45 08             	mov    0x8(%ebp),%eax
80108451:	01 da                	add    %ebx,%edx
80108453:	e8 b8 fb ff ff       	call   80108010 <walkpgdir>
80108458:	85 c0                	test   %eax,%eax
8010845a:	74 56                	je     801084b2 <loaduvm+0xa2>
    pa = PTE_ADDR(*pte);
8010845c:	8b 00                	mov    (%eax),%eax
    if(sz - i < PGSIZE)
8010845e:	bf 00 10 00 00       	mov    $0x1000,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80108463:	8b 4d 14             	mov    0x14(%ebp),%ecx
    pa = PTE_ADDR(*pte);
80108466:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
8010846b:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80108471:	0f 46 fe             	cmovbe %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80108474:	05 00 00 00 80       	add    $0x80000000,%eax
80108479:	89 44 24 04          	mov    %eax,0x4(%esp)
8010847d:	8b 45 10             	mov    0x10(%ebp),%eax
80108480:	01 d9                	add    %ebx,%ecx
80108482:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80108486:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010848a:	89 04 24             	mov    %eax,(%esp)
8010848d:	e8 3e 95 ff ff       	call   801019d0 <readi>
80108492:	39 f8                	cmp    %edi,%eax
80108494:	74 a2                	je     80108438 <loaduvm+0x28>
}
80108496:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
801084a8:	83 c4 1c             	add    $0x1c,%esp
  return 0;
...
801084b2:	c7 04 24 17 93 10 80 	movl   $0x80109317,(%esp)
801084b9:	e8 b2 7e ff ff       	call   80100370 <panic>
    panic("loaduvm: addr must be page aligned");
801084be:	c7 04 24 b8 93 10 80 	movl   $0x801093b8,(%esp)
801084c5:	e8 a6 7e ff ff       	call   80100370 <panic>
801084ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
801084d6:	83 ec 2c             	sub    $0x2c,%esp
  if(newsz >= KERNBASE)
801084d9:	8b 7d 10             	mov    0x10(%ebp),%edi
801084dc:	85 ff                	test   %edi,%edi
801084de:	0f 88 91 00 00 00    	js     80108575 <allocuvm+0xa5>
  if(newsz < oldsz)
801084e4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801084e7:	0f 82 9b 00 00 00    	jb     80108588 <allocuvm+0xb8>
  a = PGROUNDUP(oldsz);
801084ed:	8b 45 0c             	mov    0xc(%ebp),%eax
801084f0:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801084f6:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
801084fc:	39 5d 10             	cmp    %ebx,0x10(%ebp)
801084ff:	0f 86 86 00 00 00    	jbe    8010858b <allocuvm+0xbb>
80108505:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80108508:	8b 7d 08             	mov    0x8(%ebp),%edi
8010850b:	eb 49                	jmp    80108556 <allocuvm+0x86>
8010850d:	8d 76 00             	lea    0x0(%esi),%esi
    memset(mem, 0, PGSIZE);
80108510:	31 d2                	xor    %edx,%edx
80108512:	b8 00 10 00 00       	mov    $0x1000,%eax
80108517:	89 54 24 04          	mov    %edx,0x4(%esp)
8010851b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010851f:	89 34 24             	mov    %esi,(%esp)
80108522:	e8 29 d8 ff ff       	call   80105d50 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80108527:	b9 06 00 00 00       	mov    $0x6,%ecx
8010852c:	89 da                	mov    %ebx,%edx
8010852e:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80108534:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80108538:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010853d:	89 04 24             	mov    %eax,(%esp)
80108540:	89 f8                	mov    %edi,%eax
80108542:	e8 59 fb ff ff       	call   801080a0 <mappages>
80108547:	85 c0                	test   %eax,%eax
80108549:	78 4d                	js     80108598 <allocuvm+0xc8>
  for(; a < newsz; a += PGSIZE){
8010854b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80108551:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80108554:	76 7a                	jbe    801085d0 <allocuvm+0x100>
    mem = kalloc();
80108556:	e8 55 a0 ff ff       	call   801025b0 <kalloc>
    if(mem == 0){
8010855b:	85 c0                	test   %eax,%eax
    mem = kalloc();
8010855d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
8010855f:	75 af                	jne    80108510 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80108561:	c7 04 24 35 93 10 80 	movl   $0x80109335,(%esp)
80108568:	e8 e3 80 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
8010856d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108570:	39 45 10             	cmp    %eax,0x10(%ebp)
80108573:	77 6b                	ja     801085e0 <allocuvm+0x110>
}
80108575:	83 c4 2c             	add    $0x2c,%esp
    return 0;
80108578:	31 ff                	xor    %edi,%edi
}
8010857a:	5b                   	pop    %ebx
8010857b:	89 f8                	mov    %edi,%eax
8010857d:	5e                   	pop    %esi
8010857e:	5f                   	pop    %edi
8010857f:	5d                   	pop    %ebp
80108580:	c3                   	ret    
80108581:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return oldsz;
80108588:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
8010858b:	83 c4 2c             	add    $0x2c,%esp
8010858e:	89 f8                	mov    %edi,%eax
80108590:	5b                   	pop    %ebx
80108591:	5e                   	pop    %esi
80108592:	5f                   	pop    %edi
80108593:	5d                   	pop    %ebp
80108594:	c3                   	ret    
80108595:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("allocuvm out of memory (2)\n");
80108598:	c7 04 24 4d 93 10 80 	movl   $0x8010934d,(%esp)
8010859f:	e8 ac 80 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
801085a4:	8b 45 0c             	mov    0xc(%ebp),%eax
801085a7:	39 45 10             	cmp    %eax,0x10(%ebp)
801085aa:	76 0d                	jbe    801085b9 <allocuvm+0xe9>
801085ac:	89 c1                	mov    %eax,%ecx
801085ae:	8b 55 10             	mov    0x10(%ebp),%edx
801085b1:	8b 45 08             	mov    0x8(%ebp),%eax
801085b4:	e8 77 fb ff ff       	call   80108130 <deallocuvm.part.0>
      kfree(mem);
801085b9:	89 34 24             	mov    %esi,(%esp)
      return 0;
801085bc:	31 ff                	xor    %edi,%edi
      kfree(mem);
801085be:	e8 1d 9e ff ff       	call   801023e0 <kfree>
}
801085c3:	83 c4 2c             	add    $0x2c,%esp
801085c6:	89 f8                	mov    %edi,%eax
801085c8:	5b                   	pop    %ebx
801085c9:	5e                   	pop    %esi
801085ca:	5f                   	pop    %edi
801085cb:	5d                   	pop    %ebp
...
801085d0:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801085d3:	83 c4 2c             	add    $0x2c,%esp
801085d6:	5b                   	pop    %ebx
801085d7:	5e                   	pop    %esi
801085d8:	89 f8                	mov    %edi,%eax
801085da:	5f                   	pop    %edi
801085db:	5d                   	pop    %ebp
801085dc:	c3                   	ret    
801085dd:	8d 76 00             	lea    0x0(%esi),%esi
801085e0:	89 c1                	mov    %eax,%ecx
801085e2:	8b 55 10             	mov    0x10(%ebp),%edx
      return 0;
801085e5:	31 ff                	xor    %edi,%edi
801085e7:	8b 45 08             	mov    0x8(%ebp),%eax
801085ea:	e8 41 fb ff ff       	call   80108130 <deallocuvm.part.0>
801085ef:	eb 9a                	jmp    8010858b <allocuvm+0xbb>
801085f1:	eb 0d                	jmp    80108600 <deallocuvm>
801085f3:	90                   	nop
801085f4:	90                   	nop
801085f5:	90                   	nop
801085f6:	90                   	nop
...
80108603:	8b 55 0c             	mov    0xc(%ebp),%edx
80108606:	8b 4d 10             	mov    0x10(%ebp),%ecx
80108609:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
8010860c:	39 d1                	cmp    %edx,%ecx
8010860e:	73 10                	jae    80108620 <deallocuvm+0x20>
}
80108610:	5d                   	pop    %ebp
80108611:	e9 1a fb ff ff       	jmp    80108130 <deallocuvm.part.0>
80108616:	8d 76 00             	lea    0x0(%esi),%esi
80108619:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
...
80108639:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010863c:	85 f6                	test   %esi,%esi
8010863e:	74 55                	je     80108695 <freevm+0x65>
80108640:	31 c9                	xor    %ecx,%ecx
80108642:	ba 00 00 00 80       	mov    $0x80000000,%edx
80108647:	89 f0                	mov    %esi,%eax
80108649:	89 f3                	mov    %esi,%ebx
8010864b:	e8 e0 fa ff ff       	call   80108130 <deallocuvm.part.0>
80108650:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80108656:	eb 0f                	jmp    80108667 <freevm+0x37>
80108658:	90                   	nop
80108659:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108660:	83 c3 04             	add    $0x4,%ebx
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80108663:	39 fb                	cmp    %edi,%ebx
80108665:	74 1f                	je     80108686 <freevm+0x56>
    if(pgdir[i] & PTE_P){
80108667:	8b 03                	mov    (%ebx),%eax
80108669:	a8 01                	test   $0x1,%al
8010866b:	74 f3                	je     80108660 <freevm+0x30>
      char * v = P2V(PTE_ADDR(pgdir[i]));
8010866d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108672:	83 c3 04             	add    $0x4,%ebx
80108675:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010867a:	89 04 24             	mov    %eax,(%esp)
8010867d:	e8 5e 9d ff ff       	call   801023e0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80108682:	39 fb                	cmp    %edi,%ebx
80108684:	75 e1                	jne    80108667 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
80108686:	89 75 08             	mov    %esi,0x8(%ebp)
}
80108689:	83 c4 1c             	add    $0x1c,%esp
8010868c:	5b                   	pop    %ebx
8010868d:	5e                   	pop    %esi
8010868e:	5f                   	pop    %edi
8010868f:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80108690:	e9 4b 9d ff ff       	jmp    801023e0 <kfree>
    panic("freevm: no pgdir");
80108695:	c7 04 24 69 93 10 80 	movl   $0x80109369,(%esp)
8010869c:	e8 cf 7c ff ff       	call   80100370 <panic>
801086a1:	eb 0d                	jmp    801086b0 <setupkvm>
801086a3:	90                   	nop
801086a4:	90                   	nop
801086a5:	90                   	nop
801086a6:	90                   	nop
...
801086b5:	83 ec 10             	sub    $0x10,%esp
  if((pgdir = (pde_t*)kalloc()) == 0)
801086b8:	e8 f3 9e ff ff       	call   801025b0 <kalloc>
801086bd:	85 c0                	test   %eax,%eax
801086bf:	89 c6                	mov    %eax,%esi
801086c1:	74 46                	je     80108709 <setupkvm+0x59>
  memset(pgdir, 0, PGSIZE);
801086c3:	b8 00 10 00 00       	mov    $0x1000,%eax
801086c8:	31 d2                	xor    %edx,%edx
801086ca:	89 44 24 08          	mov    %eax,0x8(%esp)
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801086ce:	bb 20 c4 10 80       	mov    $0x8010c420,%ebx
  memset(pgdir, 0, PGSIZE);
801086d3:	89 54 24 04          	mov    %edx,0x4(%esp)
801086d7:	89 34 24             	mov    %esi,(%esp)
801086da:	e8 71 d6 ff ff       	call   80105d50 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801086df:	8b 53 0c             	mov    0xc(%ebx),%edx
                (uint)k->phys_start, k->perm) < 0) {
801086e2:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801086e5:	8b 4b 08             	mov    0x8(%ebx),%ecx
801086e8:	89 54 24 04          	mov    %edx,0x4(%esp)
801086ec:	8b 13                	mov    (%ebx),%edx
801086ee:	89 04 24             	mov    %eax,(%esp)
801086f1:	29 c1                	sub    %eax,%ecx
801086f3:	89 f0                	mov    %esi,%eax
801086f5:	e8 a6 f9 ff ff       	call   801080a0 <mappages>
801086fa:	85 c0                	test   %eax,%eax
801086fc:	78 1a                	js     80108718 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801086fe:	83 c3 10             	add    $0x10,%ebx
80108701:	81 fb 60 c4 10 80    	cmp    $0x8010c460,%ebx
80108707:	75 d6                	jne    801086df <setupkvm+0x2f>
}
80108709:	83 c4 10             	add    $0x10,%esp
8010870c:	89 f0                	mov    %esi,%eax
8010870e:	5b                   	pop    %ebx
8010870f:	5e                   	pop    %esi
80108710:	5d                   	pop    %ebp
80108711:	c3                   	ret    
80108712:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      freevm(pgdir);
80108718:	89 34 24             	mov    %esi,(%esp)
      return 0;
8010871b:	31 f6                	xor    %esi,%esi
      freevm(pgdir);
8010871d:	e8 0e ff ff ff       	call   80108630 <freevm>
}
80108722:	83 c4 10             	add    $0x10,%esp
80108725:	89 f0                	mov    %esi,%eax
80108727:	5b                   	pop    %ebx
80108728:	5e                   	pop    %esi
80108729:	5d                   	pop    %ebp
8010872a:	c3                   	ret    
...
80108733:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108736:	e8 75 ff ff ff       	call   801086b0 <setupkvm>
8010873b:	a3 24 80 11 80       	mov    %eax,0x80118024
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80108740:	05 00 00 00 80       	add    $0x80000000,%eax
80108745:	0f 22 d8             	mov    %eax,%cr3
}
80108748:	c9                   	leave  
80108749:	c3                   	ret    
...
80108755:	83 ec 18             	sub    $0x18,%esp
  pte = walkpgdir(pgdir, uva, 0);
80108758:	8b 55 0c             	mov    0xc(%ebp),%edx
8010875b:	8b 45 08             	mov    0x8(%ebp),%eax
8010875e:	e8 ad f8 ff ff       	call   80108010 <walkpgdir>
  if(pte == 0)
80108763:	85 c0                	test   %eax,%eax
80108765:	74 05                	je     8010876c <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
80108767:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010876a:	c9                   	leave  
8010876b:	c3                   	ret    
    panic("clearpteu");
8010876c:	c7 04 24 7a 93 10 80 	movl   $0x8010937a,(%esp)
80108773:	e8 f8 7b ff ff       	call   80100370 <panic>
80108778:	90                   	nop
...
80108786:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80108789:	e8 22 ff ff ff       	call   801086b0 <setupkvm>
8010878e:	85 c0                	test   %eax,%eax
80108790:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108793:	0f 84 a3 00 00 00    	je     8010883c <copyuvm+0xbc>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108799:	8b 55 0c             	mov    0xc(%ebp),%edx
8010879c:	85 d2                	test   %edx,%edx
8010879e:	0f 84 98 00 00 00    	je     8010883c <copyuvm+0xbc>
801087a4:	31 ff                	xor    %edi,%edi
801087a6:	eb 50                	jmp    801087f8 <copyuvm+0x78>
801087a8:	90                   	nop
...
801087b0:	b8 00 10 00 00       	mov    $0x1000,%eax
801087b5:	89 44 24 08          	mov    %eax,0x8(%esp)
801087b9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801087bc:	89 34 24             	mov    %esi,(%esp)
801087bf:	05 00 00 00 80       	add    $0x80000000,%eax
801087c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801087c8:	e8 43 d6 ff ff       	call   80105e10 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801087cd:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801087d3:	b9 00 10 00 00       	mov    $0x1000,%ecx
801087d8:	89 04 24             	mov    %eax,(%esp)
801087db:	8b 45 e0             	mov    -0x20(%ebp),%eax
801087de:	89 fa                	mov    %edi,%edx
801087e0:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801087e4:	e8 b7 f8 ff ff       	call   801080a0 <mappages>
801087e9:	85 c0                	test   %eax,%eax
801087eb:	78 63                	js     80108850 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
801087ed:	81 c7 00 10 00 00    	add    $0x1000,%edi
801087f3:	39 7d 0c             	cmp    %edi,0xc(%ebp)
801087f6:	76 44                	jbe    8010883c <copyuvm+0xbc>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801087f8:	8b 45 08             	mov    0x8(%ebp),%eax
801087fb:	31 c9                	xor    %ecx,%ecx
801087fd:	89 fa                	mov    %edi,%edx
801087ff:	e8 0c f8 ff ff       	call   80108010 <walkpgdir>
80108804:	85 c0                	test   %eax,%eax
80108806:	74 5e                	je     80108866 <copyuvm+0xe6>
    if(!(*pte & PTE_P))
80108808:	8b 18                	mov    (%eax),%ebx
8010880a:	f6 c3 01             	test   $0x1,%bl
8010880d:	74 4b                	je     8010885a <copyuvm+0xda>
    pa = PTE_ADDR(*pte);
8010880f:	89 d8                	mov    %ebx,%eax
    flags = PTE_FLAGS(*pte);
80108811:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
80108817:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010881c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010881f:	e8 8c 9d ff ff       	call   801025b0 <kalloc>
80108824:	85 c0                	test   %eax,%eax
80108826:	89 c6                	mov    %eax,%esi
80108828:	75 86                	jne    801087b0 <copyuvm+0x30>
    }
  }
  return d;
...
80108830:	e8 fb fd ff ff       	call   80108630 <freevm>
  return 0;
80108835:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
8010883c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010883f:	83 c4 2c             	add    $0x2c,%esp
80108842:	5b                   	pop    %ebx
80108843:	5e                   	pop    %esi
80108844:	5f                   	pop    %edi
80108845:	5d                   	pop    %ebp
80108846:	c3                   	ret    
80108847:	89 f6                	mov    %esi,%esi
80108849:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      kfree(mem);
80108850:	89 34 24             	mov    %esi,(%esp)
80108853:	e8 88 9b ff ff       	call   801023e0 <kfree>
      goto bad;
80108858:	eb d0                	jmp    8010882a <copyuvm+0xaa>
      panic("copyuvm: page not present");
8010885a:	c7 04 24 9e 93 10 80 	movl   $0x8010939e,(%esp)
80108861:	e8 0a 7b ff ff       	call   80100370 <panic>
      panic("copyuvm: pte should exist");
80108866:	c7 04 24 84 93 10 80 	movl   $0x80109384,(%esp)
8010886d:	e8 fe 7a ff ff       	call   80100370 <panic>
...
8010888e:	e8 7d f7 ff ff       	call   80108010 <walkpgdir>
  if((*pte & PTE_P) == 0)
80108893:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
80108895:	89 c2                	mov    %eax,%edx
80108897:	83 e2 05             	and    $0x5,%edx
8010889a:	83 fa 05             	cmp    $0x5,%edx
8010889d:	75 11                	jne    801088b0 <uva2ka+0x30>
    return 0;
...
801088aa:	c3                   	ret    
801088ab:	90                   	nop
801088ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return 0;
801088b0:	31 c0                	xor    %eax,%eax
}
801088b2:	c9                   	leave  
801088b3:	c3                   	ret    
801088b4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801088ba:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
801088c6:	83 ec 2c             	sub    $0x2c,%esp
801088c9:	8b 75 14             	mov    0x14(%ebp),%esi
801088cc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
801088cf:	85 f6                	test   %esi,%esi
801088d1:	74 75                	je     80108948 <copyout+0x88>
801088d3:	89 da                	mov    %ebx,%edx
801088d5:	eb 3f                	jmp    80108916 <copyout+0x56>
...
801088d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
801088e0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801088e3:	89 df                	mov    %ebx,%edi
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801088e5:	8b 4d 10             	mov    0x10(%ebp),%ecx
    n = PGSIZE - (va - va0);
801088e8:	29 d7                	sub    %edx,%edi
801088ea:	81 c7 00 10 00 00    	add    $0x1000,%edi
801088f0:	39 f7                	cmp    %esi,%edi
801088f2:	0f 47 fe             	cmova  %esi,%edi
    memmove(pa0 + (va - va0), buf, n);
801088f5:	29 da                	sub    %ebx,%edx
801088f7:	01 c2                	add    %eax,%edx
801088f9:	89 14 24             	mov    %edx,(%esp)
801088fc:	89 7c 24 08          	mov    %edi,0x8(%esp)
80108900:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80108904:	e8 07 d5 ff ff       	call   80105e10 <memmove>
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
80108909:	8d 93 00 10 00 00    	lea    0x1000(%ebx),%edx
    buf += n;
8010890f:	01 7d 10             	add    %edi,0x10(%ebp)
  while(len > 0){
80108912:	29 fe                	sub    %edi,%esi
80108914:	74 32                	je     80108948 <copyout+0x88>
    pa0 = uva2ka(pgdir, (char*)va0);
80108916:	8b 45 08             	mov    0x8(%ebp),%eax
    va0 = (uint)PGROUNDDOWN(va);
80108919:	89 d3                	mov    %edx,%ebx
8010891b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    pa0 = uva2ka(pgdir, (char*)va0);
80108921:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    va0 = (uint)PGROUNDDOWN(va);
80108925:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108928:	89 04 24             	mov    %eax,(%esp)
8010892b:	e8 50 ff ff ff       	call   80108880 <uva2ka>
    if(pa0 == 0)
80108930:	85 c0                	test   %eax,%eax
80108932:	75 ac                	jne    801088e0 <copyout+0x20>
  }
  return 0;
}
80108934:	83 c4 2c             	add    $0x2c,%esp
      return -1;
...
8010893f:	5d                   	pop    %ebp
80108940:	c3                   	ret    
80108941:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108948:	83 c4 2c             	add    $0x2c,%esp
  return 0;
