...
8010005c:	e8 0f 59 00 00       	call   80105970 <initlock>
  bcache.head.prev = &bcache.head;
...
8010009b:	e8 a0 57 00 00       	call   80105840 <initsleeplock>
...
801000e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000e6:	e8 d5 59 00 00       	call   80105ac0 <acquire>
...
80100161:	e8 fa 59 00 00       	call   80105b60 <release>
      acquiresleep(&b->lock);
80100166:	8d 43 0c             	lea    0xc(%ebx),%eax
80100169:	89 04 24             	mov    %eax,(%esp)
8010016c:	e8 0f 57 00 00       	call   80105880 <acquiresleep>
  struct buf *b;
...
801001b0:	e8 6b 57 00 00       	call   80105920 <holdingsleep>
...
801001f1:	e8 2a 57 00 00       	call   80105920 <holdingsleep>
...
801001fd:	e8 de 56 00 00       	call   801058e0 <releasesleep>

  acquire(&bcache.lock);
80100202:	c7 04 24 40 d6 10 80 	movl   $0x8010d640,(%esp)
80100209:	e8 b2 58 00 00       	call   80105ac0 <acquire>
  b->refcnt--;
  if (b->refcnt == 0) {
...
8010024e:	5d                   	pop    %ebp
  release(&bcache.lock);
8010024f:	e9 0c 59 00 00       	jmp    80105b60 <release>
    panic("brelse");
...
8010027e:	e8 3d 58 00 00       	call   80105ac0 <acquire>
  while(n > 0){
...
801002b8:	e8 b3 41 00 00       	call   80104470 <sleep>
    while(input.r == input.w){
...
801002de:	e8 7d 58 00 00       	call   80105b60 <release>
        ilock(ip);
...
8010033a:	e8 21 58 00 00       	call   80105b60 <release>
  ilock(ip);
...
80100429:	e8 82 6f 00 00       	call   801073b0 <uartputc>
...
801004cc:	e8 df 6e 00 00       	call   801073b0 <uartputc>
801004d1:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004d8:	e8 d3 6e 00 00       	call   801073b0 <uartputc>
801004dd:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004e4:	e8 c7 6e 00 00       	call   801073b0 <uartputc>
...
80100508:	e8 63 57 00 00       	call   80105c70 <memmove>
    pos -= 80;
...
80100536:	e8 75 56 00 00       	call   80105bb0 <memset>
...
8010060e:	e8 ad 54 00 00       	call   80105ac0 <acquire>
  for(i = 0; i < n; i++)
...
80100634:	e8 27 55 00 00       	call   80105b60 <release>
  ilock(ip);
...
8010070e:	e8 4d 54 00 00       	call   80105b60 <release>
}
...
801007b7:	e8 04 53 00 00       	call   80105ac0 <acquire>
...
801007e1:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&cons.lock);
801007e4:	e8 d7 52 00 00       	call   80105ac0 <acquire>
...
80100847:	e8 14 53 00 00       	call   80105b60 <release>
  if(doprocdump) {
...
801008d4:	a3 24 20 11 80       	mov    %eax,0x80112024
          wakeup(&input.r);
801008d9:	e8 92 3d 00 00       	call   80104670 <wakeup>
...
8010094e:	e9 0d 40 00 00       	jmp    80104960 <procdump>
80100953:	90                   	nop
...
80100996:	e8 d5 4f 00 00       	call   80105970 <initlock>
...
80100a5a:	75 d3                	jne    80100a2f <exec+0x5f>
  if((pgdir = setupkvm()) == 0)
80100a5c:	e8 af 7a 00 00       	call   80108510 <setupkvm>
...
80100ac8:	e8 63 78 00 00       	call   80108330 <allocuvm>
...
80100b05:	e8 66 77 00 00       	call   80108270 <loaduvm>
...
80100b58:	e8 33 79 00 00       	call   80108490 <freevm>
...
80100b92:	e8 99 77 00 00       	call   80108330 <allocuvm>
...
80100ba6:	e8 e5 78 00 00       	call   80108490 <freevm>
  return -1;
...
80100be7:	e8 c4 79 00 00       	call   801085b0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c18:	e8 b3 51 00 00       	call   80105dd0 <strlen>
...
80100c2d:	e8 9e 51 00 00       	call   80105dd0 <strlen>
80100c32:	40                   	inc    %eax
...
80100c48:	e8 d3 7a 00 00       	call   80108720 <copyout>
...
80100cb2:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cb8:	e8 63 7a 00 00       	call   80108720 <copyout>
...
80100d01:	e8 8a 50 00 00       	call   80105d90 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d2b:	e8 b0 73 00 00       	call   801080e0 <switchuvm>
  freevm(oldpgdir);
80100d30:	89 3c 24             	mov    %edi,(%esp)
80100d33:	e8 58 77 00 00       	call   80108490 <freevm>
  return 0;
...
80100d66:	e8 05 4c 00 00       	call   80105970 <initlock>
}
80100d6b:	c9                   	leave  
80100d6c:	c3                   	ret    
...
80100d83:	e8 38 4d 00 00       	call   80105ac0 <acquire>
...
80100db0:	e8 ab 4d 00 00       	call   80105b60 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dc7:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100dc9:	e8 92 4d 00 00       	call   80105b60 <release>
}
...
80100df1:	e8 ca 4c 00 00       	call   80105ac0 <acquire>
  if(f->ref < 1)
...
80100e08:	e8 53 4d 00 00       	call   80105b60 <release>
  return f;
}
...
80100e46:	89 7d fc             	mov    %edi,-0x4(%ebp)
  acquire(&ftable.lock);
80100e49:	e8 72 4c 00 00       	call   80105ac0 <acquire>
  if(f->ref < 1)
...
80100e73:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e74:	e9 e7 4c 00 00       	jmp    80105b60 <release>
...
80100e9c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100e9f:	e8 bc 4c 00 00       	call   80105b60 <release>
  if(ff.type == FD_PIPE)
...
80101218:	e8 93 49 00 00       	call   80105bb0 <memset>
  log_write(bp);
...
80101259:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
8010125c:	e8 5f 48 00 00       	call   80105ac0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801012be:	e8 9d 48 00 00       	call   80105b60 <release>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 79 48 00 00       	call   80105b60 <release>
}
...
80101408:	e8 63 48 00 00       	call   80105c70 <memmove>
}
...
801014cc:	e8 9f 44 00 00       	call   80105970 <initlock>
...
801014f2:	e8 49 43 00 00       	call   80105840 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015f3:	e8 b8 45 00 00       	call   80105bb0 <memset>
      dip->type = type;
...
801016a2:	e8 c9 45 00 00       	call   80105c70 <memmove>
  log_write(bp);
...
801016d1:	e8 ea 43 00 00       	call   80105ac0 <acquire>
  ip->ref++;
801016d6:	ff 43 08             	incl   0x8(%ebx)
  release(&icache.lock);
801016d9:	c7 04 24 60 2a 11 80 	movl   $0x80112a60,(%esp)
801016e0:	e8 7b 44 00 00       	call   80105b60 <release>
}
...
80101714:	e8 67 41 00 00       	call   80105880 <acquiresleep>
  if(ip->valid == 0){
...
80101796:	e8 d5 44 00 00       	call   80105c70 <memmove>
    brelse(bp);
...
801017e9:	e8 32 41 00 00       	call   80105920 <holdingsleep>
...
80101804:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101805:	e9 d6 40 00 00       	jmp    801058e0 <releasesleep>
    panic("iunlock");
...
80101838:	e8 43 40 00 00       	call   80105880 <acquiresleep>
...
8010184e:	e8 8d 40 00 00       	call   801058e0 <releasesleep>
  acquire(&icache.lock);
80101853:	c7 04 24 60 2a 11 80 	movl   $0x80112a60,(%esp)
8010185a:	e8 61 42 00 00       	call   80105ac0 <acquire>
  ip->ref--;
...
80101a83:	e8 e8 41 00 00       	call   80105c70 <memmove>
    brelse(bp);
...
80101baf:	e8 bc 40 00 00       	call   80105c70 <memmove>
    log_write(bp);
...
80101c5c:	e8 6f 40 00 00       	call   80105cd0 <strncmp>
}
80101c61:	c9                   	leave  
80101c62:	c3                   	ret    
...
80101cdb:	e8 f0 3f 00 00       	call   80105cd0 <strncmp>
      continue;
...
80101d68:	e8 53 3d 00 00       	call   80105ac0 <acquire>
  ip->ref++;
80101d6d:	ff 46 08             	incl   0x8(%esi)
  release(&icache.lock);
80101d70:	c7 04 24 60 2a 11 80 	movl   $0x80112a60,(%esp)
80101d77:	e8 e4 3d 00 00       	call   80105b60 <release>
...
80101ddc:	e8 8f 3e 00 00       	call   80105c70 <memmove>
    path++;
...
80101e65:	e8 06 3e 00 00       	call   80105c70 <memmove>
    name[len] = 0;
...
80101f73:	e8 b8 3d 00 00       	call   80105d30 <strncpy>
  de.inum = inum;
...
80101fbd:	e8 ae e3 ff ff       	call   80100370 <panic>
    panic("dirlink");
80101fc2:	c7 04 24 ae 8f 10 80 	movl   $0x80108fae,(%esp)
...
801020f6:	e8 75 38 00 00       	call   80105970 <initlock>
...
80102173:	89 7d fc             	mov    %edi,-0x4(%ebp)
  acquire(&idelock);
80102176:	e8 45 39 00 00       	call   80105ac0 <acquire>
...
801021ce:	e8 9d 24 00 00       	call   80104670 <wakeup>
...
801021e8:	e8 73 39 00 00       	call   80105b60 <release>
...
80102210:	e8 0b 37 00 00       	call   80105920 <holdingsleep>
...
80102247:	e8 74 38 00 00       	call   80105ac0 <acquire>
...
8010228c:	e8 df 21 00 00       	call   80104470 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801022a6:	5d                   	pop    %ebp
  release(&idelock);
801022a7:	e9 b4 38 00 00       	jmp    80105b60 <release>
...
80102420:	e8 8b 37 00 00       	call   80105bb0 <memset>
...
801024fb:	e8 70 34 00 00       	call   80105970 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801025e5:	e8 d6 34 00 00       	call   80105ac0 <acquire>
  r = kmem.freelist;
...
8010260f:	e8 4c 35 00 00       	call   80105b60 <release>
  return (char*)r;
...
80102a20:	e8 eb 31 00 00       	call   80105c10 <memcmp>
...
80102b3c:	e8 2f 31 00 00       	call   80105c70 <memmove>
...
80102c0a:	e8 61 2d 00 00       	call   80105970 <initlock>
  readsb(dev, &sb);
...
80102c9d:	e8 1e 2e 00 00       	call   80105ac0 <acquire>
...
80102cb8:	e8 b3 17 00 00       	call   80104470 <sleep>
    if(log.committing){
...
80102ce5:	a3 3c 47 11 80       	mov    %eax,0x8011473c
      release(&log.lock);
80102cea:	e8 71 2e 00 00       	call   80105b60 <release>
      break;
    }
  }
}
...
80102d10:	e8 ab 2d 00 00       	call   80105ac0 <acquire>
  log.outstanding -= 1;
...
80102d44:	89 35 40 47 11 80    	mov    %esi,0x80114740
  release(&log.lock);
80102d4a:	e8 11 2e 00 00       	call   80105b60 <release>
}
...
80102da9:	e8 c2 2e 00 00       	call   80105c70 <memmove>
...
80102e6b:	e8 50 2c 00 00       	call   80105ac0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102eb9:	5d                   	pop    %ebp
  release(&log.lock);
80102eba:	e9 a1 2c 00 00       	jmp    80105b60 <release>
80102ebf:	90                   	nop
  log.lh.block[i] = b->blockno;
...
80102f04:	83 ec 14             	sub    $0x14,%esp
  switchkvm();
80102f07:	e8 b4 51 00 00       	call   801080c0 <switchkvm>
  seginit();
80102f0c:	e8 1f 51 00 00       	call   80108030 <seginit>
  lapicinit();
...
80102f32:	e8 39 40 00 00       	call   80106f70 <idtinit>
...
80102f7a:	e8 91 11 00 00       	call   80104110 <scheduler>
80102f7f:	90                   	nop
...
80102f9f:	e8 ec 55 00 00       	call   80108590 <kvmalloc>
...
80102fb0:	e8 7b 50 00 00       	call   80108030 <seginit>
  picinit();       // disable pic
...
80102fc5:	e8 36 43 00 00       	call   80107300 <uartinit>
  pinit();         // process table
80102fca:	e8 11 09 00 00       	call   801038e0 <pinit>
80102fcf:	90                   	nop
  tvinit();        // trap vectors
80102fd0:	e8 1b 3f 00 00       	call   80106ef0 <tvinit>
  binit();         // buffer cache
...
80102ffe:	e8 6d 2c 00 00       	call   80105c70 <memmove>
...
801030bc:	e8 1f 1d 00 00       	call   80104de0 <initSchedDS>
	__sync_synchronize();
...
80103123:	e8 28 d5 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80103128:	e8 43 3e 00 00       	call   80106f70 <idtinit>
  scheduler();     // start running processes
8010312d:	e8 de 0f 00 00       	call   80104110 <scheduler>
...
8010317b:	e8 90 2a 00 00       	call   80105c10 <memcmp>
...
8010323a:	e8 d1 29 00 00       	call   80105c10 <memcmp>
...
80103475:	e8 f6 24 00 00       	call   80105970 <initlock>
  (*f0)->type = FD_PIPE;
...
801034d5:	e8 e6 25 00 00       	call   80105ac0 <acquire>
  if(writable){
...
801034ef:	e8 7c 11 00 00       	call   80104670 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
80103513:	5d                   	pop    %ebp
    release(&p->lock);
80103514:	e9 47 26 00 00       	jmp    80105b60 <release>
...
80103531:	e8 3a 11 00 00       	call   80104670 <wakeup>
80103536:	eb bc                	jmp    801034f4 <pipeclose+0x34>
80103538:	90                   	nop
80103539:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103540:	89 1c 24             	mov    %ebx,(%esp)
80103543:	e8 18 26 00 00       	call   80105b60 <release>
}
...
8010356f:	e8 4c 25 00 00       	call   80105ac0 <acquire>
  for(i = 0; i < n; i++){
...
801035c3:	e8 a8 10 00 00       	call   80104670 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801035c8:	89 7c 24 04          	mov    %edi,0x4(%esp)
801035cc:	89 1c 24             	mov    %ebx,(%esp)
801035cf:	e8 9c 0e 00 00       	call   80104470 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103602:	e8 59 25 00 00       	call   80105b60 <release>
        return -1;
...
8010364f:	e8 1c 10 00 00       	call   80104670 <wakeup>
  release(&p->lock);
80103654:	89 3c 24             	mov    %edi,(%esp)
80103657:	e8 04 25 00 00       	call   80105b60 <release>
  return n;
...
80103682:	e8 39 24 00 00       	call   80105ac0 <acquire>
...
801036b7:	e8 b4 0d 00 00       	call   80104470 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801036e7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
      release(&p->lock);
801036ec:	e8 6f 24 00 00       	call   80105b60 <release>
...
80103744:	e8 27 0f 00 00       	call   80104670 <wakeup>
  release(&p->lock);
80103749:	89 34 24             	mov    %esi,(%esp)
8010374c:	e8 0f 24 00 00       	call   80105b60 <release>
}
...
80103783:	e8 38 23 00 00       	call   80105ac0 <acquire>
...
801037c2:	89 15 04 c0 10 80    	mov    %edx,0x8010c004
  release(&ptable.lock);
801037c8:	e8 93 23 00 00       	call   80105b60 <release>
  
  acquire(&tickslock);
801037cd:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
801037d4:	e8 e7 22 00 00       	call   80105ac0 <acquire>
...
801037eb:	e8 70 23 00 00       	call   80105b60 <release>
...
80103807:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010380a:	ba df 6e 10 80       	mov    $0x80106edf,%edx
  sp -= sizeof *p->context;
...
80103827:	e8 84 23 00 00       	call   80105bb0 <memset>
...
80103847:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103849:	e8 12 23 00 00       	call   80105b60 <release>
}
...
8010387d:	e8 de 22 00 00       	call   80105b60 <release>
...
801038e1:	b8 65 8d 10 80       	mov    $0x80108d65,%eax
{
...
801038f6:	e8 75 20 00 00       	call   80105970 <initlock>
}
801038fb:	c9                   	leave  
801038fc:	c3                   	ret    
...
8010395e:	c7 04 24 6c 8d 10 80 	movl   $0x80108d6c,(%esp)
80103965:	e8 06 ca ff ff       	call   80100370 <panic>
    panic("mycpu called with interrupts enabled\n");
8010396a:	c7 04 24 5c 8e 10 80 	movl   $0x80108e5c,(%esp)
...
801039a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039a7:	e8 34 20 00 00       	call   801059e0 <pushcli>
  c = mycpu();
801039ac:	e8 4f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
801039b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b7:	e8 64 20 00 00       	call   80105a20 <popcli>
}
801039bc:	5a                   	pop    %edx
...
801039dc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039de:	a3 c8 c5 10 80       	mov    %eax,0x8010c5c8
  if((p->pgdir = setupkvm()) == 0)
801039e3:	e8 28 4b 00 00       	call   80108510 <setupkvm>
801039e8:	85 c0                	test   %eax,%eax
801039ea:	89 43 04             	mov    %eax,0x4(%ebx)
801039ed:	0f 84 ed 00 00 00    	je     80103ae0 <userinit+0x110>
...
80103a08:	e8 d3 47 00 00       	call   801081e0 <inituvm>
...
80103a28:	e8 83 21 00 00       	call   80105bb0 <memset>
...
80103a7a:	b8 95 8d 10 80       	mov    $0x80108d95,%eax
80103a7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a83:	8d 43 6c             	lea    0x6c(%ebx),%eax
80103a86:	89 04 24             	mov    %eax,(%esp)
80103a89:	e8 02 23 00 00       	call   80105d90 <safestrcpy>
  p->cwd = namei("/");
80103a8e:	c7 04 24 9e 8d 10 80 	movl   $0x80108d9e,(%esp)
80103a95:	e8 36 e5 ff ff       	call   80101fd0 <namei>
80103a9a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a9d:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103aa4:	e8 17 20 00 00       	call   80105ac0 <acquire>
  if(POLICY == 1)
80103aa9:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
  p->state = RUNNABLE;
80103ab0:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
      rrq.enqueue(p);
80103ab7:	89 1c 24             	mov    %ebx,(%esp)
  if(POLICY == 1)
80103aba:	74 1c                	je     80103ad8 <userinit+0x108>
      pq.put(p);
80103abc:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
  release(&ptable.lock);
80103ac2:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103ac9:	e8 92 20 00 00       	call   80105b60 <release>
}
80103ace:	83 c4 14             	add    $0x14,%esp
80103ad1:	5b                   	pop    %ebx
80103ad2:	5d                   	pop    %ebp
80103ad3:	c3                   	ret    
80103ad4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      rrq.enqueue(p);
80103ad8:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80103ade:	eb e2                	jmp    80103ac2 <userinit+0xf2>
    panic("userinit: out of memory?");
80103ae0:	c7 04 24 7c 8d 10 80 	movl   $0x80108d7c,(%esp)
80103ae7:	e8 84 c8 ff ff       	call   80100370 <panic>
...
80103af8:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103afb:	e8 e0 1e 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80103b00:	e8 fb fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b05:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b0b:	e8 10 1f 00 00       	call   80105a20 <popcli>
  if(n > 0){
80103b10:	83 fe 00             	cmp    $0x0,%esi
  sz = curproc->sz;
80103b13:	8b 03                	mov    (%ebx),%eax
  if(n > 0){
80103b15:	7f 19                	jg     80103b30 <growproc+0x40>
  } else if(n < 0){
80103b17:	75 37                	jne    80103b50 <growproc+0x60>
  curproc->sz = sz;
80103b19:	89 03                	mov    %eax,(%ebx)
  switchuvm(curproc);
80103b1b:	89 1c 24             	mov    %ebx,(%esp)
80103b1e:	e8 bd 45 00 00       	call   801080e0 <switchuvm>
  return 0;
...
80103b30:	01 c6                	add    %eax,%esi
80103b32:	89 74 24 08          	mov    %esi,0x8(%esp)
80103b36:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b3a:	8b 43 04             	mov    0x4(%ebx),%eax
80103b3d:	89 04 24             	mov    %eax,(%esp)
80103b40:	e8 eb 47 00 00       	call   80108330 <allocuvm>
80103b45:	85 c0                	test   %eax,%eax
80103b47:	75 d0                	jne    80103b19 <growproc+0x29>
      return -1;
80103b49:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b4e:	eb d5                	jmp    80103b25 <growproc+0x35>
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)
80103b50:	01 c6                	add    %eax,%esi
80103b52:	89 74 24 08          	mov    %esi,0x8(%esp)
80103b56:	89 44 24 04          	mov    %eax,0x4(%esp)
80103b5a:	8b 43 04             	mov    0x4(%ebx),%eax
80103b5d:	89 04 24             	mov    %eax,(%esp)
80103b60:	e8 fb 48 00 00       	call   80108460 <deallocuvm>
80103b65:	85 c0                	test   %eax,%eax
80103b67:	75 b0                	jne    80103b19 <growproc+0x29>
80103b69:	eb de                	jmp    80103b49 <growproc+0x59>
80103b6b:	90                   	nop
80103b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80103b70 <setAccumulator>:
void setAccumulator(struct proc *p){
80103b70:	55                   	push   %ebp
80103b71:	89 e5                	mov    %esp,%ebp
80103b73:	83 ec 28             	sub    $0x28,%esp
  if (pq.getMinAccumulator(&acc1)){
80103b76:	8d 45 e8             	lea    -0x18(%ebp),%eax
void setAccumulator(struct proc *p){
80103b79:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80103b7c:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103b7f:	89 75 fc             	mov    %esi,-0x4(%ebp)
  if (pq.getMinAccumulator(&acc1)){
80103b82:	89 04 24             	mov    %eax,(%esp)
80103b85:	ff 15 f4 c5 10 80    	call   *0x8010c5f4
80103b8b:	85 c0                	test   %eax,%eax
      if (rpholder.getMinAccumulator(&acc2))
80103b8d:	8d 45 f0             	lea    -0x10(%ebp),%eax
80103b90:	89 04 24             	mov    %eax,(%esp)
  if (pq.getMinAccumulator(&acc1)){
80103b93:	74 3b                	je     80103bd0 <setAccumulator+0x60>
      if (rpholder.getMinAccumulator(&acc2))
80103b95:	ff 15 d8 c5 10 80    	call   *0x8010c5d8
80103b9b:	85 c0                	test   %eax,%eax
80103b9d:	74 79                	je     80103c18 <setAccumulator+0xa8>
            if (acc1<acc2)
80103b9f:	8b 55 ec             	mov    -0x14(%ebp),%edx
80103ba2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103ba5:	8b 75 e8             	mov    -0x18(%ebp),%esi
80103ba8:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80103bab:	39 c2                	cmp    %eax,%edx
80103bad:	7f 0a                	jg     80103bb9 <setAccumulator+0x49>
80103baf:	0f 8c 83 00 00 00    	jl     80103c38 <setAccumulator+0xc8>
80103bb5:	39 ce                	cmp    %ecx,%esi
80103bb7:	72 7f                	jb     80103c38 <setAccumulator+0xc8>
                   p->accumulator = acc2;
80103bb9:	89 8b 84 00 00 00    	mov    %ecx,0x84(%ebx)
80103bbf:	89 83 88 00 00 00    	mov    %eax,0x88(%ebx)
}
80103bc5:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80103bc8:	8b 75 fc             	mov    -0x4(%ebp),%esi
80103bcb:	89 ec                	mov    %ebp,%esp
80103bcd:	5d                   	pop    %ebp
80103bce:	c3                   	ret    
80103bcf:	90                   	nop
  else if (rpholder.getMinAccumulator(&acc2)){
80103bd0:	ff 15 d8 c5 10 80    	call   *0x8010c5d8
80103bd6:	85 c0                	test   %eax,%eax
80103bd8:	75 1e                	jne    80103bf8 <setAccumulator+0x88>
       p->accumulator = 0;
80103bda:	31 c0                	xor    %eax,%eax
80103bdc:	31 d2                	xor    %edx,%edx
80103bde:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
80103be4:	89 93 88 00 00 00    	mov    %edx,0x88(%ebx)
}
80103bea:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80103bed:	8b 75 fc             	mov    -0x4(%ebp),%esi
80103bf0:	89 ec                	mov    %ebp,%esp
80103bf2:	5d                   	pop    %ebp
80103bf3:	c3                   	ret    
80103bf4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        p->accumulator = acc2;
80103bf8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103bfb:	8b 55 f4             	mov    -0xc(%ebp),%edx
80103bfe:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
80103c04:	89 93 88 00 00 00    	mov    %edx,0x88(%ebx)
}
80103c0a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80103c0d:	8b 75 fc             	mov    -0x4(%ebp),%esi
80103c10:	89 ec                	mov    %ebp,%esp
80103c12:	5d                   	pop    %ebp
80103c13:	c3                   	ret    
80103c14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
             p->accumulator = acc1;
80103c18:	8b 45 e8             	mov    -0x18(%ebp),%eax
80103c1b:	8b 55 ec             	mov    -0x14(%ebp),%edx
80103c1e:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
80103c24:	89 93 88 00 00 00    	mov    %edx,0x88(%ebx)
}
80103c2a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80103c2d:	8b 75 fc             	mov    -0x4(%ebp),%esi
80103c30:	89 ec                	mov    %ebp,%esp
80103c32:	5d                   	pop    %ebp
80103c33:	c3                   	ret    
80103c34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
                   p->accumulator = acc1;
80103c38:	89 b3 84 00 00 00    	mov    %esi,0x84(%ebx)
80103c3e:	89 93 88 00 00 00    	mov    %edx,0x88(%ebx)
}
80103c44:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80103c47:	8b 75 fc             	mov    -0x4(%ebp),%esi
80103c4a:	89 ec                	mov    %ebp,%esp
80103c4c:	5d                   	pop    %ebp
80103c4d:	c3                   	ret    
...
80103c56:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c59:	e8 82 1d 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80103c5e:	e8 9d fc ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103c63:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c69:	e8 b2 1d 00 00       	call   80105a20 <popcli>
  if((np = allocproc()) == 0){
80103c6e:	e8 fd fa ff ff       	call   80103770 <allocproc>
80103c73:	85 c0                	test   %eax,%eax
80103c75:	0f 84 1d 01 00 00    	je     80103d98 <fork+0x148>
80103c7b:	89 c7                	mov    %eax,%edi
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103c7d:	8b 06                	mov    (%esi),%eax
80103c7f:	89 44 24 04          	mov    %eax,0x4(%esp)
80103c83:	8b 46 04             	mov    0x4(%esi),%eax
80103c86:	89 04 24             	mov    %eax,(%esp)
80103c89:	e8 52 49 00 00       	call   801085e0 <copyuvm>
80103c8e:	85 c0                	test   %eax,%eax
80103c90:	89 47 04             	mov    %eax,0x4(%edi)
80103c93:	0f 84 09 01 00 00    	je     80103da2 <fork+0x152>
  np->sz = curproc->sz;
80103c99:	8b 06                	mov    (%esi),%eax
  np->parent = curproc;
80103c9b:	89 77 14             	mov    %esi,0x14(%edi)
  *np->tf = *curproc->tf;
80103c9e:	8b 57 18             	mov    0x18(%edi),%edx
  np->sz = curproc->sz;
80103ca1:	89 07                	mov    %eax,(%edi)
  *np->tf = *curproc->tf;
80103ca3:	31 c0                	xor    %eax,%eax
80103ca5:	8b 4e 18             	mov    0x18(%esi),%ecx
...
80103cb4:	72 f2                	jb     80103ca8 <fork+0x58>
  np->tf->eax = 0;
80103cb6:	8b 47 18             	mov    0x18(%edi),%eax
  for(i = 0; i < NOFILE; i++)
...
80103cc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(curproc->ofile[i])
80103cd0:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
...
80103ce0:	89 44 9f 28          	mov    %eax,0x28(%edi,%ebx,4)
  for(i = 0; i < NOFILE; i++)
80103ce4:	43                   	inc    %ebx
80103ce5:	83 fb 10             	cmp    $0x10,%ebx
80103ce8:	75 e6                	jne    80103cd0 <fork+0x80>
  np->cwd = idup(curproc->cwd);
80103cea:	8b 46 68             	mov    0x68(%esi),%eax
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ced:	83 c6 6c             	add    $0x6c,%esi
  np->cwd = idup(curproc->cwd);
80103cf0:	89 04 24             	mov    %eax,(%esp)
80103cf3:	e8 c8 d9 ff ff       	call   801016c0 <idup>
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cf8:	ba 10 00 00 00       	mov    $0x10,%edx
  np->cwd = idup(curproc->cwd);
80103cfd:	89 47 68             	mov    %eax,0x68(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103d00:	8d 47 6c             	lea    0x6c(%edi),%eax
80103d03:	89 54 24 08          	mov    %edx,0x8(%esp)
80103d07:	89 74 24 04          	mov    %esi,0x4(%esp)
80103d0b:	89 04 24             	mov    %eax,(%esp)
80103d0e:	e8 7d 20 00 00       	call   80105d90 <safestrcpy>
  pid = np->pid;
80103d13:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&tickslock);
80103d16:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80103d1d:	e8 9e 1d 00 00       	call   80105ac0 <acquire>
  np->performance.ctime = ticks;
80103d22:	a1 20 83 11 80       	mov    0x80118320,%eax
80103d27:	89 87 94 00 00 00    	mov    %eax,0x94(%edi)
  release(&tickslock);
80103d2d:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80103d34:	e8 27 1e 00 00       	call   80105b60 <release>
  acquire(&ptable.lock);
80103d39:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103d40:	e8 7b 1d 00 00       	call   80105ac0 <acquire>
  if(POLICY == 1)
80103d45:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
  np->state = RUNNABLE;
80103d4c:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
      rrq.enqueue(np);
80103d53:	89 3c 24             	mov    %edi,(%esp)
  if(POLICY == 1)
80103d56:	74 38                	je     80103d90 <fork+0x140>
      pq.put(np);
80103d58:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
  np->priority = 5; // Set the priority of new process to 5
80103d5e:	b8 05 00 00 00       	mov    $0x5,%eax
80103d63:	89 87 80 00 00 00    	mov    %eax,0x80(%edi)
  setAccumulator(np);
80103d69:	89 3c 24             	mov    %edi,(%esp)
80103d6c:	e8 ff fd ff ff       	call   80103b70 <setAccumulator>
  release(&ptable.lock);
80103d71:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103d78:	e8 e3 1d 00 00       	call   80105b60 <release>
}
80103d7d:	83 c4 1c             	add    $0x1c,%esp
...
80103d89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      rrq.enqueue(np);
80103d90:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80103d96:	eb c6                	jmp    80103d5e <fork+0x10e>
    return -1;
80103d98:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103d9d:	8d 76 00             	lea    0x0(%esi),%esi
80103da0:	eb db                	jmp    80103d7d <fork+0x12d>
    kfree(np->kstack);
80103da2:	8b 47 08             	mov    0x8(%edi),%eax
    return -1;
...
80103dad:	e8 2e e6 ff ff       	call   801023e0 <kfree>
    np->kstack = 0;
80103db2:	c7 47 08 00 00 00 00 	movl   $0x0,0x8(%edi)
    np->state = UNUSED;
80103db9:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
80103dc0:	eb bb                	jmp    80103d7d <fork+0x12d>
...
80103dd4:	89 c6                	mov    %eax,%esi
80103dd6:	53                   	push   %ebx
  struct proc *p;

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103dd7:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
{
80103ddc:	83 ec 10             	sub    $0x10,%esp
80103ddf:	eb 15                	jmp    80103df6 <wakeup1+0x26>
80103de1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103de8:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80103dee:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80103df4:	73 3c                	jae    80103e32 <wakeup1+0x62>
    if(p->state == SLEEPING && p->chan == chan){ 
80103df6:	8b 43 0c             	mov    0xc(%ebx),%eax
80103df9:	83 f8 02             	cmp    $0x2,%eax
80103dfc:	75 ea                	jne    80103de8 <wakeup1+0x18>
80103dfe:	39 73 20             	cmp    %esi,0x20(%ebx)
80103e01:	75 e5                	jne    80103de8 <wakeup1+0x18>
      p->state = RUNNABLE;
      setAccumulator(p);  
80103e03:	89 1c 24             	mov    %ebx,(%esp)
      p->state = RUNNABLE;
80103e06:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
      setAccumulator(p);  
80103e0d:	e8 5e fd ff ff       	call   80103b70 <setAccumulator>
      if(POLICY == 1)
80103e12:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
        rrq.enqueue(p);
80103e19:	89 1c 24             	mov    %ebx,(%esp)
      if(POLICY == 1)
80103e1c:	74 22                	je     80103e40 <wakeup1+0x70>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e1e:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
      else
        pq.put(p);
80103e24:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e2a:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80103e30:	72 c4                	jb     80103df6 <wakeup1+0x26>
    }
}
...
80103e39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        rrq.enqueue(p);
80103e40:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80103e46:	eb a0                	jmp    80103de8 <wakeup1+0x18>
80103e48:	90                   	nop
80103e49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80103e50 <originalScheduler>:
{
...
80103e59:	8b 7d 0c             	mov    0xc(%ebp),%edi
  asm volatile("sti");
80103e5c:	fb                   	sti    
    acquire(&ptable.lock);
80103e5d:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e64:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
    acquire(&ptable.lock);
80103e69:	e8 52 1c 00 00       	call   80105ac0 <acquire>
      swtch(&(c->scheduler), p->context);
80103e6e:	8d 77 04             	lea    0x4(%edi),%esi
80103e71:	eb 0d                	jmp    80103e80 <originalScheduler+0x30>
80103e73:	90                   	nop
80103e74:	90                   	nop
80103e75:	90                   	nop
80103e76:	90                   	nop
...
80103e86:	75 31                	jne    80103eb9 <originalScheduler+0x69>
      c->proc = p;
80103e88:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
      switchuvm(p);
80103e8e:	89 1c 24             	mov    %ebx,(%esp)
80103e91:	e8 4a 42 00 00       	call   801080e0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103e96:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103e99:	89 34 24             	mov    %esi,(%esp)
      p->state = RUNNING;
80103e9c:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ea3:	89 44 24 04          	mov    %eax,0x4(%esp)
80103ea7:	e8 3d 1f 00 00       	call   80105de9 <swtch>
      switchkvm();
80103eac:	e8 0f 42 00 00       	call   801080c0 <switchkvm>
      c->proc = 0;
80103eb1:	31 c0                	xor    %eax,%eax
80103eb3:	89 87 ac 00 00 00    	mov    %eax,0xac(%edi)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eb9:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80103ebf:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80103ec5:	72 b9                	jb     80103e80 <originalScheduler+0x30>
    release(&ptable.lock);
80103ec7:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
80103ece:	83 c4 1c             	add    $0x1c,%esp
80103ed1:	5b                   	pop    %ebx
80103ed2:	5e                   	pop    %esi
80103ed3:	5f                   	pop    %edi
80103ed4:	5d                   	pop    %ebp
    release(&ptable.lock);
80103ed5:	e9 86 1c 00 00       	jmp    80105b60 <release>
80103eda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80103ee0 <roundRobinScheduler>:
{
...
80103ee8:	8b 75 0c             	mov    0xc(%ebp),%esi
80103eeb:	fb                   	sti    
    acquire(&ptable.lock);
80103eec:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80103ef3:	e8 c8 1b 00 00       	call   80105ac0 <acquire>
    if(!rrq.isEmpty()){
80103ef8:	ff 15 dc c5 10 80    	call   *0x8010c5dc
80103efe:	85 c0                	test   %eax,%eax
80103f00:	75 4e                	jne    80103f50 <roundRobinScheduler+0x70>
            p = rrq.dequeue();
80103f02:	ff 15 e4 c5 10 80    	call   *0x8010c5e4
80103f08:	89 c3                	mov    %eax,%ebx
            c->proc = p;
80103f0a:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
            switchuvm(p);
80103f10:	89 04 24             	mov    %eax,(%esp)
80103f13:	e8 c8 41 00 00       	call   801080e0 <switchuvm>
            swtch(&(c->scheduler), p->context);
80103f18:	8b 43 1c             	mov    0x1c(%ebx),%eax
            p->state = RUNNING;
80103f1b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
            swtch(&(c->scheduler), p->context);
80103f22:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f26:	8d 46 04             	lea    0x4(%esi),%eax
80103f29:	89 04 24             	mov    %eax,(%esp)
80103f2c:	e8 b8 1e 00 00       	call   80105de9 <swtch>
            switchkvm();
80103f31:	e8 8a 41 00 00       	call   801080c0 <switchkvm>
            rpholder.remove(p);
80103f36:	89 1c 24             	mov    %ebx,(%esp)
80103f39:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
            rpholder.add(p);
80103f3f:	89 1c 24             	mov    %ebx,(%esp)
80103f42:	ff 15 d0 c5 10 80    	call   *0x8010c5d0
            c->proc = 0;
80103f48:	31 c0                	xor    %eax,%eax
80103f4a:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
    release(&ptable.lock);
80103f50:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
...
80103f83:	e8 38 1b 00 00       	call   80105ac0 <acquire>
    if(!pq.isEmpty()){
80103f88:	ff 15 ec c5 10 80    	call   *0x8010c5ec
80103f8e:	85 c0                	test   %eax,%eax
80103f90:	75 4e                	jne    80103fe0 <priorityScheduler+0x70>
        p = pq.extractMin();
80103f92:	ff 15 f8 c5 10 80    	call   *0x8010c5f8
80103f98:	89 c3                	mov    %eax,%ebx
        c->proc = p;
80103f9a:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
        switchuvm(p);
80103fa0:	89 04 24             	mov    %eax,(%esp)
80103fa3:	e8 38 41 00 00       	call   801080e0 <switchuvm>
        p->state = RUNNING; 
80103fa8:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
        rpholder.remove(p);
80103faf:	89 1c 24             	mov    %ebx,(%esp)
80103fb2:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
        rpholder.add(p);
80103fb8:	89 1c 24             	mov    %ebx,(%esp)
80103fbb:	ff 15 d0 c5 10 80    	call   *0x8010c5d0
        swtch(&(c->scheduler), p->context);
80103fc1:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103fc4:	89 44 24 04          	mov    %eax,0x4(%esp)
80103fc8:	8d 46 04             	lea    0x4(%esi),%eax
80103fcb:	89 04 24             	mov    %eax,(%esp)
80103fce:	e8 16 1e 00 00       	call   80105de9 <swtch>
        switchkvm();
80103fd3:	e8 e8 40 00 00       	call   801080c0 <switchkvm>
        c->proc = 0;
80103fd8:	31 c0                	xor    %eax,%eax
80103fda:	89 86 ac 00 00 00    	mov    %eax,0xac(%esi)
    release(&ptable.lock);
80103fe0:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
...
80103fec:	5d                   	pop    %ebp
    release(&ptable.lock);
80103fed:	e9 6e 1b 00 00       	jmp    80105b60 <release>
...
80104006:	83 ec 3c             	sub    $0x3c,%esp
80104009:	8b 45 0c             	mov    0xc(%ebp),%eax
8010400c:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010400f:	89 45 d4             	mov    %eax,-0x2c(%ebp)
80104012:	fb                   	sti    
    acquire(&ptable.lock);
80104013:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010401a:	e8 a1 1a 00 00       	call   80105ac0 <acquire>
    if(!pq.isEmpty()){
8010401f:	ff 15 ec c5 10 80    	call   *0x8010c5ec
80104025:	85 c0                	test   %eax,%eax
80104027:	75 5b                	jne    80104084 <extendedPriorityScheduler+0x84>
            if (avoidStarv){
80104029:	8b 0d b8 c5 10 80    	mov    0x8010c5b8,%ecx
8010402f:	85 c9                	test   %ecx,%ecx
80104031:	75 6d                	jne    801040a0 <extendedPriorityScheduler+0xa0>
                np = pq.extractMin();
80104033:	ff 15 f8 c5 10 80    	call   *0x8010c5f8
80104039:	89 c3                	mov    %eax,%ebx
            c->proc = np;
8010403b:	8b 7d d4             	mov    -0x2c(%ebp),%edi
8010403e:	89 9f ac 00 00 00    	mov    %ebx,0xac(%edi)
            switchuvm(np);
80104044:	89 1c 24             	mov    %ebx,(%esp)
80104047:	e8 94 40 00 00       	call   801080e0 <switchuvm>
            np->state = RUNNING;
8010404c:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
            rpholder.remove(np);
80104053:	89 1c 24             	mov    %ebx,(%esp)
80104056:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
            rpholder.add(np);
8010405c:	89 1c 24             	mov    %ebx,(%esp)
8010405f:	ff 15 d0 c5 10 80    	call   *0x8010c5d0
            swtch(&(c->scheduler), np->context);
80104065:	8b 43 1c             	mov    0x1c(%ebx),%eax
80104068:	89 44 24 04          	mov    %eax,0x4(%esp)
8010406c:	8d 47 04             	lea    0x4(%edi),%eax
8010406f:	89 04 24             	mov    %eax,(%esp)
80104072:	e8 72 1d 00 00       	call   80105de9 <swtch>
            switchkvm();
80104077:	e8 44 40 00 00       	call   801080c0 <switchkvm>
            c->proc = 0;
8010407c:	31 c0                	xor    %eax,%eax
8010407e:	89 87 ac 00 00 00    	mov    %eax,0xac(%edi)
                        release(&ptable.lock);
80104084:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
8010408b:	83 c4 3c             	add    $0x3c,%esp
8010408e:	5b                   	pop    %ebx
8010408f:	5e                   	pop    %esi
80104090:	5f                   	pop    %edi
80104091:	5d                   	pop    %ebp
                        release(&ptable.lock);
80104092:	e9 c9 1a 00 00       	jmp    80105b60 <release>
80104097:	89 f6                	mov    %esi,%esi
80104099:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
                        if (tqCounter - p->timeStamp > max){
801040a0:	8b 35 c0 c5 10 80    	mov    0x8010c5c0,%esi
...
801040a6:	b8 d4 4d 11 80       	mov    $0x80114dd4,%eax
                        if (tqCounter - p->timeStamp > max){
801040ab:	8b 3d c4 c5 10 80    	mov    0x8010c5c4,%edi
801040b1:	eb 0d                	jmp    801040c0 <extendedPriorityScheduler+0xc0>
801040b3:	90                   	nop
801040b4:	90                   	nop
801040b5:	90                   	nop
801040b6:	90                   	nop
...
801040c2:	89 f9                	mov    %edi,%ecx
801040c4:	2b 90 8c 00 00 00    	sub    0x8c(%eax),%edx
801040ca:	1b 88 90 00 00 00    	sbb    0x90(%eax),%ecx
801040d0:	89 55 d8             	mov    %edx,-0x28(%ebp)
801040d3:	89 4d dc             	mov    %ecx,-0x24(%ebp)
801040d6:	df 6d d8             	fildll -0x28(%ebp)
801040d9:	d9 ee                	fldz   
801040db:	d9 c9                	fxch   %st(1)
801040dd:	df e9                	fucomip %st(1),%st
801040df:	dd d8                	fstp   %st(0)
801040e1:	0f 47 d8             	cmova  %eax,%ebx
                for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){  // Run over all the ptable and look for the process which didn't work for the lonest time.
801040e4:	05 b4 00 00 00       	add    $0xb4,%eax
801040e9:	3d d4 7a 11 80       	cmp    $0x80117ad4,%eax
801040ee:	72 d0                	jb     801040c0 <extendedPriorityScheduler+0xc0>
                avoidStarv = 0;
801040f0:	31 d2                	xor    %edx,%edx
801040f2:	89 15 b8 c5 10 80    	mov    %edx,0x8010c5b8
                if (!pq.extractProc(np)){
801040f8:	89 1c 24             	mov    %ebx,(%esp)
801040fb:	ff 15 00 c6 10 80    	call   *0x8010c600
80104101:	85 c0                	test   %eax,%eax
80104103:	0f 85 32 ff ff ff    	jne    8010403b <extendedPriorityScheduler+0x3b>
80104109:	e9 76 ff ff ff       	jmp    80104084 <extendedPriorityScheduler+0x84>
...
80104114:	83 ec 14             	sub    $0x14,%esp
  struct cpu *c = mycpu();
80104117:	e8 e4 f7 ff ff       	call   80103900 <mycpu>
8010411c:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
8010411e:	31 c0                	xor    %eax,%eax
80104120:	89 83 ac 00 00 00    	mov    %eax,0xac(%ebx)
80104126:	8d 76 00             	lea    0x0(%esi),%esi
80104129:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    switch(POLICY){
80104130:	a1 08 c0 10 80       	mov    0x8010c008,%eax
80104135:	83 f8 01             	cmp    $0x1,%eax
80104138:	74 26                	je     80104160 <scheduler+0x50>
8010413a:	7e 3c                	jle    80104178 <scheduler+0x68>
8010413c:	83 f8 02             	cmp    $0x2,%eax
8010413f:	74 4f                	je     80104190 <scheduler+0x80>
80104141:	83 f8 03             	cmp    $0x3,%eax
80104144:	75 ef                	jne    80104135 <scheduler+0x25>
            extendedPriorityScheduler(p, c);
80104146:	89 5c 24 04          	mov    %ebx,0x4(%esp)
8010414a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104151:	e8 aa fe ff ff       	call   80104000 <extendedPriorityScheduler>
    switch(POLICY){
80104156:	a1 08 c0 10 80       	mov    0x8010c008,%eax
8010415b:	83 f8 01             	cmp    $0x1,%eax
8010415e:	75 da                	jne    8010413a <scheduler+0x2a>
            roundRobinScheduler(p, c);
80104160:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104164:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010416b:	e8 70 fd ff ff       	call   80103ee0 <roundRobinScheduler>
            break;
80104170:	eb be                	jmp    80104130 <scheduler+0x20>
80104172:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    switch(POLICY){
80104178:	85 c0                	test   %eax,%eax
8010417a:	75 b9                	jne    80104135 <scheduler+0x25>
            originalScheduler(p, c);
8010417c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104180:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104187:	e8 c4 fc ff ff       	call   80103e50 <originalScheduler>
            break;
8010418c:	eb a2                	jmp    80104130 <scheduler+0x20>
8010418e:	66 90                	xchg   %ax,%ax
            priorityScheduler(p, c);
80104190:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104194:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010419b:	e8 d0 fd ff ff       	call   80103f70 <priorityScheduler>
            break;
801041a0:	eb 8e                	jmp    80104130 <scheduler+0x20>
...
801041b5:	83 ec 10             	sub    $0x10,%esp
  pushcli();
801041b8:	e8 23 18 00 00       	call   801059e0 <pushcli>
  c = mycpu();
801041bd:	e8 3e f7 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801041c2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041c8:	e8 53 18 00 00       	call   80105a20 <popcli>
  if(!holding(&ptable.lock))
801041cd:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801041d4:	e8 a7 18 00 00       	call   80105a80 <holding>
801041d9:	85 c0                	test   %eax,%eax
801041db:	74 51                	je     8010422e <sched+0x7e>
  if(mycpu()->ncli != 1)
801041dd:	e8 1e f7 ff ff       	call   80103900 <mycpu>
801041e2:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
801041e9:	75 67                	jne    80104252 <sched+0xa2>
  if(p->state == RUNNING)
801041eb:	8b 43 0c             	mov    0xc(%ebx),%eax
801041ee:	83 f8 04             	cmp    $0x4,%eax
801041f1:	74 53                	je     80104246 <sched+0x96>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
801041f3:	9c                   	pushf  
801041f4:	58                   	pop    %eax
  if(readeflags()&FL_IF)
801041f5:	f6 c4 02             	test   $0x2,%ah
801041f8:	75 40                	jne    8010423a <sched+0x8a>
  intena = mycpu()->intena;
801041fa:	e8 01 f7 ff ff       	call   80103900 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
801041ff:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80104202:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80104208:	e8 f3 f6 ff ff       	call   80103900 <mycpu>
8010420d:	8b 40 04             	mov    0x4(%eax),%eax
80104210:	89 1c 24             	mov    %ebx,(%esp)
80104213:	89 44 24 04          	mov    %eax,0x4(%esp)
80104217:	e8 cd 1b 00 00       	call   80105de9 <swtch>
  mycpu()->intena = intena;
8010421c:	e8 df f6 ff ff       	call   80103900 <mycpu>
80104221:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
...
8010422e:	c7 04 24 a0 8d 10 80 	movl   $0x80108da0,(%esp)
80104235:	e8 36 c1 ff ff       	call   80100370 <panic>
    panic("sched interruptible");
8010423a:	c7 04 24 cc 8d 10 80 	movl   $0x80108dcc,(%esp)
80104241:	e8 2a c1 ff ff       	call   80100370 <panic>
    panic("sched running");
80104246:	c7 04 24 be 8d 10 80 	movl   $0x80108dbe,(%esp)
8010424d:	e8 1e c1 ff ff       	call   80100370 <panic>
    panic("sched locks");
80104252:	c7 04 24 b2 8d 10 80 	movl   $0x80108db2,(%esp)
...
80104266:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80104269:	e8 72 17 00 00       	call   801059e0 <pushcli>
  c = mycpu();
8010426e:	e8 8d f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104273:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104279:	e8 a2 17 00 00       	call   80105a20 <popcli>
  if(curproc == initproc)
8010427e:	39 35 c8 c5 10 80    	cmp    %esi,0x8010c5c8
80104284:	0f 84 d6 00 00 00    	je     80104360 <exit+0x100>
8010428a:	8d 5e 28             	lea    0x28(%esi),%ebx
8010428d:	8d 7e 68             	lea    0x68(%esi),%edi
    if(curproc->ofile[fd]){
80104290:	8b 03                	mov    (%ebx),%eax
80104292:	85 c0                	test   %eax,%eax
80104294:	74 0e                	je     801042a4 <exit+0x44>
...
801042c5:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
801042cc:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801042d3:	e8 e8 17 00 00       	call   80105ac0 <acquire>
  wakeup1(curproc->parent);
801042d8:	8b 46 14             	mov    0x14(%esi),%eax
801042db:	e8 f0 fa ff ff       	call   80103dd0 <wakeup1>
801042e0:	eb 14                	jmp    801042f6 <exit+0x96>
801042e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042e8:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
801042ee:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
801042f4:	73 2a                	jae    80104320 <exit+0xc0>
    if(p->parent == curproc){
801042f6:	39 73 14             	cmp    %esi,0x14(%ebx)
801042f9:	75 ed                	jne    801042e8 <exit+0x88>
      if(p->state == ZOMBIE)
801042fb:	8b 53 0c             	mov    0xc(%ebx),%edx
      p->parent = initproc;
801042fe:	a1 c8 c5 10 80       	mov    0x8010c5c8,%eax
      if(p->state == ZOMBIE)
80104303:	83 fa 05             	cmp    $0x5,%edx
      p->parent = initproc;
80104306:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
80104309:	75 dd                	jne    801042e8 <exit+0x88>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010430b:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
        wakeup1(initproc);
80104311:	e8 ba fa ff ff       	call   80103dd0 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104316:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
8010431c:	72 d8                	jb     801042f6 <exit+0x96>
8010431e:	66 90                	xchg   %ax,%ax
  if (p->state == RUNNING)
80104320:	8b 43 0c             	mov    0xc(%ebx),%eax
80104323:	83 f8 04             	cmp    $0x4,%eax
80104326:	75 09                	jne    80104331 <exit+0xd1>
      rpholder.remove(p);
80104328:	89 1c 24             	mov    %ebx,(%esp)
8010432b:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
  curproc->exitStatus = status;
80104331:	8b 45 08             	mov    0x8(%ebp),%eax
80104334:	89 46 7c             	mov    %eax,0x7c(%esi)
  if(p->state == RUNNING)
80104337:	8b 43 0c             	mov    0xc(%ebx),%eax
8010433a:	83 f8 04             	cmp    $0x4,%eax
8010433d:	75 09                	jne    80104348 <exit+0xe8>
      rpholder.remove(p);
8010433f:	89 1c 24             	mov    %ebx,(%esp)
80104342:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
  curproc->state = ZOMBIE;
80104348:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
8010434f:	e8 5c fe ff ff       	call   801041b0 <sched>
  panic("zombie exit");
80104354:	c7 04 24 ed 8d 10 80 	movl   $0x80108ded,(%esp)
8010435b:	e8 10 c0 ff ff       	call   80100370 <panic>
    panic("init exiting");
80104360:	c7 04 24 e0 8d 10 80 	movl   $0x80108de0,(%esp)
...
80104377:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010437e:	e8 3d 17 00 00       	call   80105ac0 <acquire>
  pushcli();
80104383:	e8 58 16 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80104388:	e8 73 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010438d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104393:	e8 88 16 00 00       	call   80105a20 <popcli>
  if(p->state == RUNNING){
80104398:	8b 43 0c             	mov    0xc(%ebx),%eax
8010439b:	83 f8 04             	cmp    $0x4,%eax
8010439e:	75 20                	jne    801043c0 <yield+0x50>
    p->timeStamp = tqCounter;   
801043a0:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
801043a5:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
801043ab:	89 83 8c 00 00 00    	mov    %eax,0x8c(%ebx)
801043b1:	89 93 90 00 00 00    	mov    %edx,0x90(%ebx)
    rpholder.remove(p);
801043b7:	89 1c 24             	mov    %ebx,(%esp)
801043ba:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
  tqCounter++;
801043c0:	83 05 c0 c5 10 80 01 	addl   $0x1,0x8010c5c0
  p->state = RUNNABLE;
801043c7:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  tqCounter++;
801043ce:	83 15 c4 c5 10 80 00 	adcl   $0x0,0x8010c5c4
  if(POLICY == 1){
801043d5:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
      rrq.enqueue(p);
801043dc:	89 1c 24             	mov    %ebx,(%esp)
  if(POLICY == 1){
801043df:	74 7f                	je     80104460 <yield+0xf0>
      pq.put(p);
801043e1:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
      p->accumulator += p->priority;
801043e7:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
801043ed:	99                   	cltd   
801043ee:	01 83 84 00 00 00    	add    %eax,0x84(%ebx)
801043f4:	11 93 88 00 00 00    	adc    %edx,0x88(%ebx)
      if (POLICY == 3 && (tqCounter % 100 == 0)){
801043fa:	83 3d 08 c0 10 80 03 	cmpl   $0x3,0x8010c008
80104401:	74 1d                	je     80104420 <yield+0xb0>
  sched();
80104403:	e8 a8 fd ff ff       	call   801041b0 <sched>
  release(&ptable.lock);
80104408:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010440f:	e8 4c 17 00 00       	call   80105b60 <release>
}
...
8010441a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if (POLICY == 3 && (tqCounter % 100 == 0)){
80104420:	ba 64 00 00 00       	mov    $0x64,%edx
80104425:	a1 c0 c5 10 80       	mov    0x8010c5c0,%eax
8010442a:	31 c9                	xor    %ecx,%ecx
8010442c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104430:	8b 15 c4 c5 10 80    	mov    0x8010c5c4,%edx
80104436:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
8010443a:	89 04 24             	mov    %eax,(%esp)
8010443d:	89 54 24 04          	mov    %edx,0x4(%esp)
80104441:	e8 2a 13 00 00       	call   80105770 <__moddi3>
80104446:	09 c2                	or     %eax,%edx
80104448:	75 b9                	jne    80104403 <yield+0x93>
         avoidStarv = 1;
8010444a:	b8 01 00 00 00       	mov    $0x1,%eax
8010444f:	a3 b8 c5 10 80       	mov    %eax,0x8010c5b8
80104454:	eb ad                	jmp    80104403 <yield+0x93>
80104456:	8d 76 00             	lea    0x0(%esi),%esi
80104459:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      rrq.enqueue(p);
80104460:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80104466:	eb 9b                	jmp    80104403 <yield+0x93>
80104468:	90                   	nop
...
80104473:	83 ec 28             	sub    $0x28,%esp
80104476:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80104479:	89 75 f8             	mov    %esi,-0x8(%ebp)
8010447c:	8b 75 0c             	mov    0xc(%ebp),%esi
8010447f:	89 7d fc             	mov    %edi,-0x4(%ebp)
80104482:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
80104485:	e8 56 15 00 00       	call   801059e0 <pushcli>
  c = mycpu();
8010448a:	e8 71 f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010448f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104495:	e8 86 15 00 00       	call   80105a20 <popcli>
  if(p == 0)
8010449a:	85 db                	test   %ebx,%ebx
8010449c:	0f 84 ae 00 00 00    	je     80104550 <sleep+0xe0>
  if(lk == 0)
801044a2:	85 f6                	test   %esi,%esi
801044a4:	0f 84 9a 00 00 00    	je     80104544 <sleep+0xd4>
  if(lk != &ptable.lock){  //DOC: sleeplock0
801044aa:	81 fe a0 4d 11 80    	cmp    $0x80114da0,%esi
801044b0:	74 5e                	je     80104510 <sleep+0xa0>
    acquire(&ptable.lock);  //DOC: sleeplock1
801044b2:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801044b9:	e8 02 16 00 00       	call   80105ac0 <acquire>
    release(lk); 
801044be:	89 34 24             	mov    %esi,(%esp)
801044c1:	e8 9a 16 00 00       	call   80105b60 <release>
  if(p->state == RUNNING)
801044c6:	8b 43 0c             	mov    0xc(%ebx),%eax
  p->chan = chan;
801044c9:	89 7b 20             	mov    %edi,0x20(%ebx)
  if(p->state == RUNNING)
801044cc:	83 f8 04             	cmp    $0x4,%eax
801044cf:	75 09                	jne    801044da <sleep+0x6a>
      rpholder.remove(p);
801044d1:	89 1c 24             	mov    %ebx,(%esp)
801044d4:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
  p->state = SLEEPING;
801044da:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801044e1:	e8 ca fc ff ff       	call   801041b0 <sched>
  p->chan = 0;
801044e6:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801044ed:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801044f4:	e8 67 16 00 00       	call   80105b60 <release>
}
801044f9:	8b 5d f4             	mov    -0xc(%ebp),%ebx
    acquire(lk);
801044fc:	89 75 08             	mov    %esi,0x8(%ebp)
}
801044ff:	8b 7d fc             	mov    -0x4(%ebp),%edi
80104502:	8b 75 f8             	mov    -0x8(%ebp),%esi
80104505:	89 ec                	mov    %ebp,%esp
80104507:	5d                   	pop    %ebp
    acquire(lk);
80104508:	e9 b3 15 00 00       	jmp    80105ac0 <acquire>
8010450d:	8d 76 00             	lea    0x0(%esi),%esi
  if(p->state == RUNNING)
80104510:	8b 43 0c             	mov    0xc(%ebx),%eax
  p->chan = chan;
80104513:	89 7b 20             	mov    %edi,0x20(%ebx)
  if(p->state == RUNNING)
80104516:	83 f8 04             	cmp    $0x4,%eax
80104519:	75 09                	jne    80104524 <sleep+0xb4>
      rpholder.remove(p);
8010451b:	89 1c 24             	mov    %ebx,(%esp)
8010451e:	ff 15 d4 c5 10 80    	call   *0x8010c5d4
  p->state = SLEEPING;
80104524:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010452b:	e8 80 fc ff ff       	call   801041b0 <sched>
  p->chan = 0;
80104530:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80104537:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010453a:	8b 75 f8             	mov    -0x8(%ebp),%esi
8010453d:	8b 7d fc             	mov    -0x4(%ebp),%edi
80104540:	89 ec                	mov    %ebp,%esp
80104542:	5d                   	pop    %ebp
80104543:	c3                   	ret    
    panic("sleep without lk");
80104544:	c7 04 24 ff 8d 10 80 	movl   $0x80108dff,(%esp)
8010454b:	e8 20 be ff ff       	call   80100370 <panic>
    panic("sleep");
80104550:	c7 04 24 f9 8d 10 80 	movl   $0x80108df9,(%esp)
...
80104569:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
8010456c:	e8 6f 14 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80104571:	e8 8a f3 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104576:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
8010457c:	e8 9f 14 00 00       	call   80105a20 <popcli>
  acquire(&ptable.lock);
80104581:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104588:	e8 33 15 00 00       	call   80105ac0 <acquire>
    havekids = 0;
8010458d:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010458f:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
80104594:	eb 18                	jmp    801045ae <wait+0x4e>
80104596:	8d 76 00             	lea    0x0(%esi),%esi
80104599:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
801045a0:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
801045a6:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
801045ac:	73 20                	jae    801045ce <wait+0x6e>
      if(p->parent != curproc)
801045ae:	39 73 14             	cmp    %esi,0x14(%ebx)
801045b1:	75 ed                	jne    801045a0 <wait+0x40>
      if(p->state == ZOMBIE){
801045b3:	8b 43 0c             	mov    0xc(%ebx),%eax
801045b6:	83 f8 05             	cmp    $0x5,%eax
801045b9:	74 35                	je     801045f0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045bb:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
      havekids = 1;
801045c1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801045c6:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
801045cc:	72 e0                	jb     801045ae <wait+0x4e>
    if(!havekids || curproc->killed){
801045ce:	85 c0                	test   %eax,%eax
801045d0:	74 7d                	je     8010464f <wait+0xef>
801045d2:	8b 56 24             	mov    0x24(%esi),%edx
801045d5:	85 d2                	test   %edx,%edx
801045d7:	75 76                	jne    8010464f <wait+0xef>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
801045d9:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
801045de:	89 44 24 04          	mov    %eax,0x4(%esp)
801045e2:	89 34 24             	mov    %esi,(%esp)
801045e5:	e8 86 fe ff ff       	call   80104470 <sleep>
    havekids = 0;
801045ea:	eb a1                	jmp    8010458d <wait+0x2d>
801045ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        kfree(p->kstack);
801045f0:	8b 43 08             	mov    0x8(%ebx),%eax
        pid = p->pid;
801045f3:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801045f6:	89 04 24             	mov    %eax,(%esp)
801045f9:	e8 e2 dd ff ff       	call   801023e0 <kfree>
        freevm(p->pgdir);
801045fe:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80104601:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104608:	89 04 24             	mov    %eax,(%esp)
8010460b:	e8 80 3e 00 00       	call   80108490 <freevm>
        if(status != null){ 
80104610:	85 ff                	test   %edi,%edi
        p->pid = 0;
80104612:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104619:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104620:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104624:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010462b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status != null){ 
80104632:	74 05                	je     80104639 <wait+0xd9>
            *status = p->exitStatus;
80104634:	8b 43 7c             	mov    0x7c(%ebx),%eax
80104637:	89 07                	mov    %eax,(%edi)
        release(&ptable.lock);
80104639:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104640:	e8 1b 15 00 00       	call   80105b60 <release>
}
80104645:	83 c4 1c             	add    $0x1c,%esp
80104648:	89 f0                	mov    %esi,%eax
8010464a:	5b                   	pop    %ebx
8010464b:	5e                   	pop    %esi
8010464c:	5f                   	pop    %edi
8010464d:	5d                   	pop    %ebp
8010464e:	c3                   	ret    
      release(&ptable.lock);
8010464f:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
      return -1;
80104656:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010465b:	e8 00 15 00 00       	call   80105b60 <release>
      return -1;
80104660:	eb e3                	jmp    80104645 <wait+0xe5>
...
80104674:	83 ec 14             	sub    $0x14,%esp
80104677:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010467a:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104681:	e8 3a 14 00 00       	call   80105ac0 <acquire>
  wakeup1(chan);
80104686:	89 d8                	mov    %ebx,%eax
80104688:	e8 43 f7 ff ff       	call   80103dd0 <wakeup1>
  release(&ptable.lock);
8010468d:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
80104694:	83 c4 14             	add    $0x14,%esp
80104697:	5b                   	pop    %ebx
80104698:	5d                   	pop    %ebp
  release(&ptable.lock);
80104699:	e9 c2 14 00 00       	jmp    80105b60 <release>
...
801046a4:	53                   	push   %ebx
  ...
  acquire(&ptable.lock);
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046a5:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
{
801046aa:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801046ad:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
{
801046b4:	8b 75 08             	mov    0x8(%ebp),%esi
  acquire(&ptable.lock);
801046b7:	e8 04 14 00 00       	call   80105ac0 <acquire>
801046bc:	eb 10                	jmp    801046ce <kill+0x2e>
801046be:	66 90                	xchg   %ax,%ax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801046c0:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
801046c6:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
801046cc:	73 5a                	jae    80104728 <kill+0x88>
    if(p->pid == pid){
801046ce:	39 73 10             	cmp    %esi,0x10(%ebx)
801046d1:	75 ed                	jne    801046c0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING){
801046d3:	8b 43 0c             	mov    0xc(%ebx),%eax
      p->killed = 1;
801046d6:	c7 43 24 01 00 00 00 	movl   $0x1,0x24(%ebx)
      if(p->state == SLEEPING){
801046dd:	83 f8 02             	cmp    $0x2,%eax
801046e0:	74 1e                	je     80104700 <kill+0x60>
        if(POLICY == 1)
            rrq.enqueue(p);
        else
            pq.put(p);
      ...
      release(&ptable.lock);
801046e2:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801046e9:	e8 72 14 00 00       	call   80105b60 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801046f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        setAccumulator(p);  
80104700:	89 1c 24             	mov    %ebx,(%esp)
        p->state = RUNNABLE;
80104703:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
        setAccumulator(p);  
8010470a:	e8 61 f4 ff ff       	call   80103b70 <setAccumulator>
        if(POLICY == 1)
8010470f:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
            rrq.enqueue(p);
80104716:	89 1c 24             	mov    %ebx,(%esp)
        if(POLICY == 1)
80104719:	74 25                	je     80104740 <kill+0xa0>
            pq.put(p);
8010471b:	ff 15 f0 c5 10 80    	call   *0x8010c5f0
80104721:	eb bf                	jmp    801046e2 <kill+0x42>
80104723:	90                   	nop
80104724:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&ptable.lock);
80104728:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
8010472f:	e8 2c 14 00 00       	call   80105b60 <release>
}
...
8010473f:	c3                   	ret    
            rrq.enqueue(p);
80104740:	ff 15 e0 c5 10 80    	call   *0x8010c5e0
80104746:	eb 9a                	jmp    801046e2 <kill+0x42>
80104748:	90                   	nop
...
80104756:	83 ec 2c             	sub    $0x2c,%esp
80104759:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
8010475c:	e8 7f 12 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80104761:	e8 9a f1 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104766:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
8010476c:	e8 af 12 00 00       	call   80105a20 <popcli>
  struct proc *curproc = myproc();
  struct proc *p;
  int procExist = -1;

  if(curproc == initproc)
80104771:	39 3d c8 c5 10 80    	cmp    %edi,0x8010c5c8
80104777:	74 7e                	je     801047f7 <detach+0xa7>
    panic("init called detach");

  acquire(&ptable.lock);
80104779:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104780:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
  acquire(&ptable.lock);
80104785:	e8 36 13 00 00       	call   80105ac0 <acquire>
  int procExist = -1;
8010478a:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010478f:	eb 15                	jmp    801047a6 <detach+0x56>
80104791:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104798:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
8010479e:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
801047a4:	73 35                	jae    801047db <detach+0x8b>
    if(p->pid == pid && p->parent == curproc){
801047a6:	39 73 10             	cmp    %esi,0x10(%ebx)
801047a9:	75 ed                	jne    80104798 <detach+0x48>
801047ab:	39 7b 14             	cmp    %edi,0x14(%ebx)
801047ae:	75 e8                	jne    80104798 <detach+0x48>
        procExist = 0;
        p->parent = initproc;
        if(p->state == ZOMBIE)
801047b0:	8b 4b 0c             	mov    0xc(%ebx),%ecx
        procExist = 0;
801047b3:	31 d2                	xor    %edx,%edx
        p->parent = initproc;
801047b5:	a1 c8 c5 10 80       	mov    0x8010c5c8,%eax
        if(p->state == ZOMBIE)
801047ba:	83 f9 05             	cmp    $0x5,%ecx
        p->parent = initproc;
801047bd:	89 43 14             	mov    %eax,0x14(%ebx)
        if(p->state == ZOMBIE)
801047c0:	75 d6                	jne    80104798 <detach+0x48>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047c2:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
801047c8:	89 55 e4             	mov    %edx,-0x1c(%ebp)
            wakeup1(initproc);
801047cb:	e8 00 f6 ff ff       	call   80103dd0 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047d0:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
            wakeup1(initproc);
801047d6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801047d9:	72 cb                	jb     801047a6 <detach+0x56>
    }
  }
  release(&ptable.lock);
801047db:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
801047e2:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801047e5:	e8 76 13 00 00       	call   80105b60 <release>
  return procExist;
}
801047ea:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801047ed:	83 c4 2c             	add    $0x2c,%esp
801047f0:	5b                   	pop    %ebx
801047f1:	5e                   	pop    %esi
801047f2:	89 d0                	mov    %edx,%eax
801047f4:	5f                   	pop    %edi
801047f5:	5d                   	pop    %ebp
801047f6:	c3                   	ret    
    panic("init called detach");
801047f7:	c7 04 24 10 8e 10 80 	movl   $0x80108e10,(%esp)
801047fe:	e8 6d bb ff ff       	call   80100370 <panic>
...
8010481c:	89 75 fc             	mov    %esi,-0x4(%ebp)
  pushcli();
8010481f:	e8 bc 11 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80104824:	e8 d7 f0 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104829:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
8010482f:	e8 ec 11 00 00       	call   80105a20 <popcli>
  struct proc *curproc = myproc();
  
  if(proc_priority <= 10 && proc_priority >= 0){
80104834:	83 fb 0a             	cmp    $0xa,%ebx
80104837:	77 13                	ja     8010484c <priority+0x3c>
      if(POLICY == 3 || (POLICY == 2 && proc_priority >= 1)){
80104839:	a1 08 c0 10 80       	mov    0x8010c008,%eax
8010483e:	83 f8 03             	cmp    $0x3,%eax
80104841:	74 1d                	je     80104860 <priority+0x50>
80104843:	83 f8 02             	cmp    $0x2,%eax
80104846:	75 04                	jne    8010484c <priority+0x3c>
80104848:	85 db                	test   %ebx,%ebx
8010484a:	75 14                	jne    80104860 <priority+0x50>
        acquire(&ptable.lock);
...
8010484c:	8b 5d f8             	mov    -0x8(%ebp),%ebx
8010484f:	8b 75 fc             	mov    -0x4(%ebp),%esi
80104852:	89 ec                	mov    %ebp,%esp
80104854:	5d                   	pop    %ebp
80104855:	c3                   	ret    
80104856:	8d 76 00             	lea    0x0(%esi),%esi
80104859:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
        acquire(&ptable.lock);
80104860:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104867:	e8 54 12 00 00       	call   80105ac0 <acquire>
        curproc->priority = proc_priority;
8010486c:	89 9e 80 00 00 00    	mov    %ebx,0x80(%esi)
}
80104872:	8b 5d f8             	mov    -0x8(%ebp),%ebx
        release(&ptable.lock); 
80104875:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
8010487c:	8b 75 fc             	mov    -0x4(%ebp),%esi
8010487f:	89 ec                	mov    %ebp,%esp
80104881:	5d                   	pop    %ebp
        release(&ptable.lock); 
80104882:	e9 d9 12 00 00       	jmp    80105b60 <release>
...
80104894:	53                   	push   %ebx
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104895:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
{
8010489a:	83 ec 10             	sub    $0x10,%esp
    acquire(&ptable.lock);
8010489d:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
{
801048a4:	8b 75 08             	mov    0x8(%ebp),%esi
    acquire(&ptable.lock);
801048a7:	e8 14 12 00 00       	call   80105ac0 <acquire>
801048ac:	eb 2f                	jmp    801048dd <policy+0x4d>
801048ae:	66 90                	xchg   %ax,%ax
        ...
        if(policy_id == 2){ 
801048b0:	83 fe 02             	cmp    $0x2,%esi
801048b3:	74 5b                	je     80104910 <policy+0x80>
            }
...
801048b5:	83 fe 03             	cmp    $0x3,%esi
801048b8:	75 0f                	jne    801048c9 <policy+0x39>
801048ba:	83 3d 08 c0 10 80 01 	cmpl   $0x1,0x8010c008
801048c1:	75 06                	jne    801048c9 <policy+0x39>
            pq.switchToRoundRobinPolicy();
801048c3:	ff 15 fc c5 10 80    	call   *0x8010c5fc
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048c9:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
801048cf:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
        }
        POLICY = policy_id;
801048d5:	89 35 08 c0 10 80    	mov    %esi,0x8010c008
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048db:	73 63                	jae    80104940 <policy+0xb0>
        if(policy_id == 1 && (POLICY == 2 || POLICY == 3)){ /*change from Priority to Round Robin policy*/
801048dd:	83 fe 01             	cmp    $0x1,%esi
801048e0:	75 ce                	jne    801048b0 <policy+0x20>
801048e2:	a1 08 c0 10 80       	mov    0x8010c008,%eax
801048e7:	83 e8 02             	sub    $0x2,%eax
801048ea:	83 f8 01             	cmp    $0x1,%eax
801048ed:	77 da                	ja     801048c9 <policy+0x39>
            pq.switchToRoundRobinPolicy();
801048ef:	ff 15 fc c5 10 80    	call   *0x8010c5fc
            p->accumulator = 0;
801048f5:	31 c9                	xor    %ecx,%ecx
801048f7:	31 c0                	xor    %eax,%eax
801048f9:	89 8b 84 00 00 00    	mov    %ecx,0x84(%ebx)
801048ff:	89 83 88 00 00 00    	mov    %eax,0x88(%ebx)
80104905:	eb c2                	jmp    801048c9 <policy+0x39>
80104907:	89 f6                	mov    %esi,%esi
80104909:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
            if(POLICY == 3){ /*change from Extended Priority to Priority scheduling policy*/
80104910:	a1 08 c0 10 80       	mov    0x8010c008,%eax
80104915:	83 f8 03             	cmp    $0x3,%eax
80104918:	74 0e                	je     80104928 <policy+0x98>
            if(POLICY == 1){ /*change from Round Robin to Priority scheduling policy*/
8010491a:	48                   	dec    %eax
8010491b:	75 ac                	jne    801048c9 <policy+0x39>
                rrq.switchToPriorityQueuePolicy();
8010491d:	ff 15 e8 c5 10 80    	call   *0x8010c5e8
80104923:	eb a4                	jmp    801048c9 <policy+0x39>
80104925:	8d 76 00             	lea    0x0(%esi),%esi
                if(p->priority == 0) 
80104928:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
8010492e:	85 d2                	test   %edx,%edx
80104930:	75 97                	jne    801048c9 <policy+0x39>
                    p->priority = 1;
80104932:	b8 01 00 00 00       	mov    $0x1,%eax
80104937:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
8010493d:	eb 8a                	jmp    801048c9 <policy+0x39>
8010493f:	90                   	nop
    }
    //cprintf("update POLICY to %d\n", POLICY);
    release(&ptable.lock);
80104940:	c7 45 08 a0 4d 11 80 	movl   $0x80114da0,0x8(%ebp)
}
...
8010494c:	5d                   	pop    %ebp
    release(&ptable.lock);
8010494d:	e9 0e 12 00 00       	jmp    80105b60 <release>
...
80104965:	53                   	push   %ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104966:	bb d4 4d 11 80       	mov    $0x80114dd4,%ebx
{
8010496b:	83 ec 4c             	sub    $0x4c,%esp
8010496e:	eb 1e                	jmp    8010498e <procdump+0x2e>
    if(p->state == SLEEPING){
    ...
    cprintf("\n");
80104970:	c7 04 24 ad 8e 10 80 	movl   $0x80108ead,(%esp)
80104977:	e8 d4 bc ff ff       	call   80100650 <cprintf>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010497c:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80104982:	81 fb d4 7a 11 80    	cmp    $0x80117ad4,%ebx
80104988:	0f 83 b2 00 00 00    	jae    80104a40 <procdump+0xe0>
    if(p->state == UNUSED)
8010498e:	8b 43 0c             	mov    0xc(%ebx),%eax
80104991:	85 c0                	test   %eax,%eax
80104993:	74 e7                	je     8010497c <procdump+0x1c>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104995:	8b 43 0c             	mov    0xc(%ebx),%eax
      state = "???";
80104998:	b8 23 8e 10 80       	mov    $0x80108e23,%eax
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010499d:	8b 53 0c             	mov    0xc(%ebx),%edx
801049a0:	83 fa 05             	cmp    $0x5,%edx
801049a3:	77 18                	ja     801049bd <procdump+0x5d>
801049a5:	8b 53 0c             	mov    0xc(%ebx),%edx
801049a8:	8b 14 95 84 8e 10 80 	mov    -0x7fef717c(,%edx,4),%edx
801049af:	85 d2                	test   %edx,%edx
801049b1:	74 0a                	je     801049bd <procdump+0x5d>
      state = states[p->state];
801049b3:	8b 43 0c             	mov    0xc(%ebx),%eax
801049b6:	8b 04 85 84 8e 10 80 	mov    -0x7fef717c(,%eax,4),%eax
    cprintf("%d %s %s", p->pid, state, p->name);
801049bd:	89 44 24 08          	mov    %eax,0x8(%esp)
801049c1:	8b 43 10             	mov    0x10(%ebx),%eax
801049c4:	8d 53 6c             	lea    0x6c(%ebx),%edx
801049c7:	89 54 24 0c          	mov    %edx,0xc(%esp)
801049cb:	c7 04 24 27 8e 10 80 	movl   $0x80108e27,(%esp)
801049d2:	89 44 24 04          	mov    %eax,0x4(%esp)
801049d6:	e8 75 bc ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
801049db:	8b 43 0c             	mov    0xc(%ebx),%eax
801049de:	83 f8 02             	cmp    $0x2,%eax
801049e1:	75 8d                	jne    80104970 <procdump+0x10>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801049e3:	8d 45 c0             	lea    -0x40(%ebp),%eax
801049e6:	89 44 24 04          	mov    %eax,0x4(%esp)
801049ea:	8b 43 1c             	mov    0x1c(%ebx),%eax
801049ed:	8d 75 c0             	lea    -0x40(%ebp),%esi
801049f0:	8d 7d e8             	lea    -0x18(%ebp),%edi
801049f3:	8b 40 0c             	mov    0xc(%eax),%eax
801049f6:	83 c0 08             	add    $0x8,%eax
801049f9:	89 04 24             	mov    %eax,(%esp)
801049fc:	e8 8f 0f 00 00       	call   80105990 <getcallerpcs>
80104a01:	eb 0d                	jmp    80104a10 <procdump+0xb0>
80104a03:	90                   	nop
80104a04:	90                   	nop
80104a05:	90                   	nop
80104a06:	90                   	nop
...
80104a14:	0f 84 56 ff ff ff    	je     80104970 <procdump+0x10>
        cprintf(" %p", pc[i]);
80104a1a:	89 54 24 04          	mov    %edx,0x4(%esp)
80104a1e:	83 c6 04             	add    $0x4,%esi
80104a21:	c7 04 24 01 88 10 80 	movl   $0x80108801,(%esp)
80104a28:	e8 23 bc ff ff       	call   80100650 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104a2d:	39 f7                	cmp    %esi,%edi
80104a2f:	75 df                	jne    80104a10 <procdump+0xb0>
80104a31:	e9 3a ff ff ff       	jmp    80104970 <procdump+0x10>
...
80104a54:	8b 75 0c             	mov    0xc(%ebp),%esi
80104a57:	53                   	push   %ebx
  pushcli();
80104a58:	e8 83 0f 00 00       	call   801059e0 <pushcli>
  c = mycpu();
80104a5d:	e8 9e ee ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104a62:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104a68:	e8 b3 0f 00 00       	call   80105a20 <popcli>
      struct proc *curproc = myproc();
      
      if (!curproc)
80104a6d:	85 db                	test   %ebx,%ebx
80104a6f:	74 3b                	je     80104aac <wait_stat+0x5c>
          return -1;
      
      *performance = curproc->performance;
80104a71:	8b 83 94 00 00 00    	mov    0x94(%ebx),%eax
80104a77:	89 06                	mov    %eax,(%esi)
80104a79:	8b 83 98 00 00 00    	mov    0x98(%ebx),%eax
80104a7f:	89 46 04             	mov    %eax,0x4(%esi)
80104a82:	8b 83 9c 00 00 00    	mov    0x9c(%ebx),%eax
80104a88:	89 46 08             	mov    %eax,0x8(%esi)
80104a8b:	8b 83 a0 00 00 00    	mov    0xa0(%ebx),%eax
80104a91:	89 46 0c             	mov    %eax,0xc(%esi)
80104a94:	8b 83 a4 00 00 00    	mov    0xa4(%ebx),%eax
80104a9a:	89 46 10             	mov    %eax,0x10(%esi)
      *status = curproc->exitStatus;
80104a9d:	8b 45 08             	mov    0x8(%ebp),%eax
80104aa0:	8b 53 7c             	mov    0x7c(%ebx),%edx
80104aa3:	89 10                	mov    %edx,(%eax)
      
      return curproc->pid;
80104aa5:	8b 43 10             	mov    0x10(%ebx),%eax
}
80104aa8:	5b                   	pop    %ebx
80104aa9:	5e                   	pop    %esi
80104aaa:	5d                   	pop    %ebp
...
80104ab1:	eb f5                	jmp    80104aa8 <wait_stat+0x58>
80104ab3:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104ab9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80104ac0 <updatePerformance>:

// increments performence to all proccesses that are running or sleeping
void updatePerformance(){
80104ac0:	55                   	push   %ebp
80104ac1:	89 e5                	mov    %esp,%ebp
80104ac3:	83 ec 18             	sub    $0x18,%esp
  struct proc *p;
  acquire(&ptable.lock);
80104ac6:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104acd:	e8 ee 0f 00 00       	call   80105ac0 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ad2:	b8 d4 4d 11 80       	mov    $0x80114dd4,%eax
80104ad7:	89 f6                	mov    %esi,%esi
80104ad9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(p->state == RUNNABLE){
80104ae0:	8b 50 0c             	mov    0xc(%eax),%edx
80104ae3:	83 fa 03             	cmp    $0x3,%edx
80104ae6:	75 06                	jne    80104aee <updatePerformance+0x2e>
        p->performance.retime++;
80104ae8:	ff 80 a0 00 00 00    	incl   0xa0(%eax)
    }
    if(p->state == RUNNING){
80104aee:	8b 50 0c             	mov    0xc(%eax),%edx
80104af1:	83 fa 04             	cmp    $0x4,%edx
80104af4:	75 06                	jne    80104afc <updatePerformance+0x3c>
      p->performance.rutime++;
80104af6:	ff 80 a4 00 00 00    	incl   0xa4(%eax)
    }
    if(p->state == SLEEPING){
80104afc:	8b 50 0c             	mov    0xc(%eax),%edx
80104aff:	83 fa 02             	cmp    $0x2,%edx
80104b02:	75 06                	jne    80104b0a <updatePerformance+0x4a>
      p->performance.stime++;
80104b04:	ff 80 9c 00 00 00    	incl   0x9c(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104b0a:	05 b4 00 00 00       	add    $0xb4,%eax
80104b0f:	3d d4 7a 11 80       	cmp    $0x80117ad4,%eax
80104b14:	72 ca                	jb     80104ae0 <updatePerformance+0x20>
    }
  }
  release(&ptable.lock);
80104b16:	c7 04 24 a0 4d 11 80 	movl   $0x80114da0,(%esp)
80104b1d:	e8 3e 10 00 00       	call   80105b60 <release>
}
80104b22:	c9                   	leave  
80104b23:	c3                   	ret    
...
bool Map::isEmpty() {
	return !root;
80104b30:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
...
80104b50 <getMinAccumulatorPriorityQueue>:
	return !root;
80104b50:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
80104b55:	8b 10                	mov    (%eax),%edx
...
bool Map::getMinKey(long long *pkey) {
	if(isEmpty())
80104b57:	85 d2                	test   %edx,%edx
80104b59:	74 35                	je     80104b90 <getMinAccumulatorPriorityQueue+0x40>
...
80104b5f:	eb 09                	jmp    80104b6a <getMinAccumulatorPriorityQueue+0x1a>
...
80104b6f:	75 f7                	jne    80104b68 <getMinAccumulatorPriorityQueue+0x18>
	*pkey = getMinNode()->key;
80104b71:	8b 45 08             	mov    0x8(%ebp),%eax
80104b74:	8b 5a 04             	mov    0x4(%edx),%ebx
80104b77:	8b 0a                	mov    (%edx),%ecx
80104b79:	89 58 04             	mov    %ebx,0x4(%eax)
80104b7c:	89 08                	mov    %ecx,(%eax)
80104b7e:	b8 01 00 00 00       	mov    $0x1,%eax
}
80104b83:	5b                   	pop    %ebx
80104b84:	5d                   	pop    %ebp
80104b85:	c3                   	ret    
...
80104ba0 <isEmptyRoundRobinQueue>:
	return !first;
80104ba0:	a1 18 c6 10 80       	mov    0x8010c618,%eax
...
80104bc0 <enqueueRoundRobinQueue>:
	if(!freeLinks)
80104bc0:	a1 10 c6 10 80       	mov    0x8010c610,%eax
80104bc5:	85 c0                	test   %eax,%eax
80104bc7:	74 47                	je     80104c10 <enqueueRoundRobinQueue+0x50>
static boolean enqueueRoundRobinQueue(Proc *p) {
80104bc9:	55                   	push   %ebp
	return roundRobinQ->enqueue(p);
80104bca:	8b 0d 18 c6 10 80    	mov    0x8010c618,%ecx
	freeLinks = freeLinks->next;
80104bd0:	8b 50 04             	mov    0x4(%eax),%edx
static boolean enqueueRoundRobinQueue(Proc *p) {
80104bd3:	89 e5                	mov    %esp,%ebp
	ans->next = null;
80104bd5:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = freeLinks->next;
80104bdc:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	ans->p = p;
80104be2:	8b 55 08             	mov    0x8(%ebp),%edx
80104be5:	89 10                	mov    %edx,(%eax)
	if(isEmpty()) first = link;
80104be7:	8b 11                	mov    (%ecx),%edx
80104be9:	85 d2                	test   %edx,%edx
80104beb:	74 2b                	je     80104c18 <enqueueRoundRobinQueue+0x58>
	else last->next = link;
80104bed:	8b 51 04             	mov    0x4(%ecx),%edx
80104bf0:	89 42 04             	mov    %eax,0x4(%edx)
80104bf3:	eb 05                	jmp    80104bfa <enqueueRoundRobinQueue+0x3a>
80104bf5:	8d 76 00             	lea    0x0(%esi),%esi
	while(ans->next)
80104bf8:	89 d0                	mov    %edx,%eax
80104bfa:	8b 50 04             	mov    0x4(%eax),%edx
80104bfd:	85 d2                	test   %edx,%edx
80104bff:	75 f7                	jne    80104bf8 <enqueueRoundRobinQueue+0x38>
	last = link->getLast();
80104c01:	89 41 04             	mov    %eax,0x4(%ecx)
...
80104c14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(isEmpty()) first = link;
80104c18:	89 01                	mov    %eax,(%ecx)
80104c1a:	eb de                	jmp    80104bfa <enqueueRoundRobinQueue+0x3a>
80104c1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104c20 <dequeueRoundRobinQueue>:
	return roundRobinQ->dequeue();
80104c20:	8b 0d 18 c6 10 80    	mov    0x8010c618,%ecx
	return !first;
80104c26:	8b 11                	mov    (%ecx),%edx
	if(isEmpty())
80104c28:	85 d2                	test   %edx,%edx
80104c2a:	74 3c                	je     80104c68 <dequeueRoundRobinQueue+0x48>
static Proc* dequeueRoundRobinQueue() {
80104c2c:	55                   	push   %ebp
80104c2d:	89 e5                	mov    %esp,%ebp
80104c2f:	83 ec 08             	sub    $0x8,%esp
80104c32:	89 75 fc             	mov    %esi,-0x4(%ebp)
	link->next = freeLinks;
80104c35:	8b 35 10 c6 10 80    	mov    0x8010c610,%esi
static Proc* dequeueRoundRobinQueue() {
80104c3b:	89 5d f8             	mov    %ebx,-0x8(%ebp)
	Link *next = first->next;
80104c3e:	8b 5a 04             	mov    0x4(%edx),%ebx
	Proc *p = first->p;
80104c41:	8b 02                	mov    (%edx),%eax
	link->next = freeLinks;
80104c43:	89 72 04             	mov    %esi,0x4(%edx)
	freeLinks = link;
80104c46:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty())
80104c4c:	85 db                	test   %ebx,%ebx
	first = next;
80104c4e:	89 19                	mov    %ebx,(%ecx)
	if(isEmpty())
80104c50:	75 07                	jne    80104c59 <dequeueRoundRobinQueue+0x39>
		last = null;
80104c52:	c7 41 04 00 00 00 00 	movl   $0x0,0x4(%ecx)
}
80104c59:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80104c5c:	8b 75 fc             	mov    -0x4(%ebp),%esi
80104c5f:	89 ec                	mov    %ebp,%esp
80104c61:	5d                   	pop    %ebp
80104c62:	c3                   	ret    
80104c63:	90                   	nop
...
80104c70 <isEmptyRunningProcessHolder>:
	return !first;
80104c70:	a1 14 c6 10 80       	mov    0x8010c614,%eax
...
80104c7d:	0f 94 c0             	sete   %al
80104c80:	0f b6 c0             	movzbl %al,%eax
}
80104c83:	c3                   	ret    
80104c84:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104c8a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80104c90 <addRunningProcessHolder>:
	if(!freeLinks)
80104c90:	a1 10 c6 10 80       	mov    0x8010c610,%eax
80104c95:	85 c0                	test   %eax,%eax
80104c97:	74 47                	je     80104ce0 <addRunningProcessHolder+0x50>
static boolean addRunningProcessHolder(Proc* p) {
80104c99:	55                   	push   %ebp
	return runningProcHolder->enqueue(p);
80104c9a:	8b 0d 14 c6 10 80    	mov    0x8010c614,%ecx
	freeLinks = freeLinks->next;
80104ca0:	8b 50 04             	mov    0x4(%eax),%edx
static boolean addRunningProcessHolder(Proc* p) {
80104ca3:	89 e5                	mov    %esp,%ebp
	ans->next = null;
80104ca5:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = freeLinks->next;
80104cac:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	ans->p = p;
80104cb2:	8b 55 08             	mov    0x8(%ebp),%edx
80104cb5:	89 10                	mov    %edx,(%eax)
	if(isEmpty()) first = link;
80104cb7:	8b 11                	mov    (%ecx),%edx
80104cb9:	85 d2                	test   %edx,%edx
80104cbb:	74 2b                	je     80104ce8 <addRunningProcessHolder+0x58>
	else last->next = link;
80104cbd:	8b 51 04             	mov    0x4(%ecx),%edx
80104cc0:	89 42 04             	mov    %eax,0x4(%edx)
80104cc3:	eb 05                	jmp    80104cca <addRunningProcessHolder+0x3a>
80104cc5:	8d 76 00             	lea    0x0(%esi),%esi
	while(ans->next)
80104cc8:	89 d0                	mov    %edx,%eax
80104cca:	8b 50 04             	mov    0x4(%eax),%edx
80104ccd:	85 d2                	test   %edx,%edx
80104ccf:	75 f7                	jne    80104cc8 <addRunningProcessHolder+0x38>
	last = link->getLast();
80104cd1:	89 41 04             	mov    %eax,0x4(%ecx)
80104cd4:	b8 01 00 00 00       	mov    $0x1,%eax
}
80104cd9:	5d                   	pop    %ebp
80104cda:	c3                   	ret    
80104cdb:	90                   	nop
...
80104cea:	eb de                	jmp    80104cca <addRunningProcessHolder+0x3a>
80104cec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80104cf0 <_ZL9allocNodeP4procx>:
...
80104cf4:	53                   	push   %ebx
	if(!freeNodes)
80104cf5:	8b 1d 0c c6 10 80    	mov    0x8010c60c,%ebx
80104cfb:	85 db                	test   %ebx,%ebx
80104cfd:	74 4d                	je     80104d4c <_ZL9allocNodeP4procx+0x5c>
	ans->key = key;
80104cff:	89 13                	mov    %edx,(%ebx)
	if(!freeLinks)
80104d01:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
	freeNodes = freeNodes->next;
80104d07:	8b 73 10             	mov    0x10(%ebx),%esi
	ans->key = key;
80104d0a:	89 4b 04             	mov    %ecx,0x4(%ebx)
	ans->next = null;
80104d0d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	if(!freeLinks)
80104d14:	85 d2                	test   %edx,%edx
	freeNodes = freeNodes->next;
80104d16:	89 35 0c c6 10 80    	mov    %esi,0x8010c60c
	if(!freeLinks)
80104d1c:	74 3f                	je     80104d5d <_ZL9allocNodeP4procx+0x6d>
	freeLinks = freeLinks->next;
80104d1e:	8b 4a 04             	mov    0x4(%edx),%ecx
	ans->p = p;
80104d21:	89 02                	mov    %eax,(%edx)
	ans->next = null;
80104d23:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
	if(isEmpty()) first = link;
80104d2a:	8b 43 08             	mov    0x8(%ebx),%eax
	freeLinks = freeLinks->next;
80104d2d:	89 0d 10 c6 10 80    	mov    %ecx,0x8010c610
	if(isEmpty()) first = link;
80104d33:	85 c0                	test   %eax,%eax
80104d35:	74 21                	je     80104d58 <_ZL9allocNodeP4procx+0x68>
	else last->next = link;
80104d37:	8b 43 0c             	mov    0xc(%ebx),%eax
80104d3a:	89 50 04             	mov    %edx,0x4(%eax)
80104d3d:	eb 03                	jmp    80104d42 <_ZL9allocNodeP4procx+0x52>
80104d3f:	90                   	nop
	while(ans->next)
80104d40:	89 ca                	mov    %ecx,%edx
80104d42:	8b 4a 04             	mov    0x4(%edx),%ecx
80104d45:	85 c9                	test   %ecx,%ecx
80104d47:	75 f7                	jne    80104d40 <_ZL9allocNodeP4procx+0x50>
	last = link->getLast();
80104d49:	89 53 0c             	mov    %edx,0xc(%ebx)
}
...
80104d52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	if(isEmpty()) first = link;
80104d58:	89 53 08             	mov    %edx,0x8(%ebx)
80104d5b:	eb e5                	jmp    80104d42 <_ZL9allocNodeP4procx+0x52>
	node->parent = node->left = node->right = null;
80104d5d:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
80104d64:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
80104d6b:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
	node->next = freeNodes;
80104d72:	89 73 10             	mov    %esi,0x10(%ebx)
	freeNodes = node;
80104d75:	89 1d 0c c6 10 80    	mov    %ebx,0x8010c60c
		return null;
80104d7b:	31 db                	xor    %ebx,%ebx
80104d7d:	eb cd                	jmp    80104d4c <_ZL9allocNodeP4procx+0x5c>
80104d7f:	90                   	nop

80104d80 <_ZL8mymallocj>:
static char* mymalloc(uint size) {
80104d80:	55                   	push   %ebp
80104d81:	89 e5                	mov    %esp,%ebp
80104d83:	53                   	push   %ebx
80104d84:	89 c3                	mov    %eax,%ebx
80104d86:	83 ec 14             	sub    $0x14,%esp
	if(spaceLeft < size) {
80104d89:	8b 15 04 c6 10 80    	mov    0x8010c604,%edx
80104d8f:	39 c2                	cmp    %eax,%edx
80104d91:	73 26                	jae    80104db9 <_ZL8mymallocj+0x39>
		data = kalloc();
80104d93:	e8 18 d8 ff ff       	call   801025b0 <kalloc>
		memset(data, 0, PGSIZE);
80104d98:	ba 00 10 00 00       	mov    $0x1000,%edx
80104d9d:	31 c9                	xor    %ecx,%ecx
80104d9f:	89 54 24 08          	mov    %edx,0x8(%esp)
80104da3:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80104da7:	89 04 24             	mov    %eax,(%esp)
		data = kalloc();
80104daa:	a3 08 c6 10 80       	mov    %eax,0x8010c608
		memset(data, 0, PGSIZE);
80104daf:	e8 fc 0d 00 00       	call   80105bb0 <memset>
80104db4:	ba 00 10 00 00       	mov    $0x1000,%edx
	char* ans = data;
80104db9:	a1 08 c6 10 80       	mov    0x8010c608,%eax
	spaceLeft -= size;
80104dbe:	29 da                	sub    %ebx,%edx
80104dc0:	89 15 04 c6 10 80    	mov    %edx,0x8010c604
	data += size;
80104dc6:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
80104dc9:	89 0d 08 c6 10 80    	mov    %ecx,0x8010c608
}
80104dcf:	83 c4 14             	add    $0x14,%esp
80104dd2:	5b                   	pop    %ebx
80104dd3:	5d                   	pop    %ebp
80104dd4:	c3                   	ret    
...
80104de5:	53                   	push   %ebx
	freeLinks = null;
80104de6:	bb 80 00 00 00       	mov    $0x80,%ebx
void initSchedDS() { //called once by the "pioneer" cpu from the main function in main.c
80104deb:	83 ec 04             	sub    $0x4,%esp
	data               = null;
80104dee:	a3 08 c6 10 80       	mov    %eax,0x8010c608
	spaceLeft          = 0u;
80104df3:	31 c0                	xor    %eax,%eax
80104df5:	a3 04 c6 10 80       	mov    %eax,0x8010c604
	priorityQ          = (Map*)mymalloc(sizeof(Map));
80104dfa:	b8 04 00 00 00       	mov    $0x4,%eax
80104dff:	e8 7c ff ff ff       	call   80104d80 <_ZL8mymallocj>
80104e04:	a3 1c c6 10 80       	mov    %eax,0x8010c61c
	*priorityQ         = Map();
80104e09:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
	roundRobinQ        = (LinkedList*)mymalloc(sizeof(LinkedList));
80104e0f:	b8 08 00 00 00       	mov    $0x8,%eax
80104e14:	e8 67 ff ff ff       	call   80104d80 <_ZL8mymallocj>
80104e19:	a3 18 c6 10 80       	mov    %eax,0x8010c618
	*roundRobinQ       = LinkedList();
80104e1e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80104e24:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	runningProcHolder  = (LinkedList*)mymalloc(sizeof(LinkedList));
80104e2b:	b8 08 00 00 00       	mov    $0x8,%eax
80104e30:	e8 4b ff ff ff       	call   80104d80 <_ZL8mymallocj>
80104e35:	a3 14 c6 10 80       	mov    %eax,0x8010c614
	*runningProcHolder = LinkedList();
80104e3a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80104e40:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = null;
80104e47:	31 c0                	xor    %eax,%eax
80104e49:	a3 10 c6 10 80       	mov    %eax,0x8010c610
80104e4e:	66 90                	xchg   %ax,%ax
		Link *link = (Link*)mymalloc(sizeof(Link));
80104e50:	b8 08 00 00 00       	mov    $0x8,%eax
80104e55:	e8 26 ff ff ff       	call   80104d80 <_ZL8mymallocj>
		link->next = freeLinks;
80104e5a:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
	for(int i = 0; i < NPROCLIST; ++i) {
80104e60:	4b                   	dec    %ebx
		*link = Link();
80104e61:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		link->next = freeLinks;
80104e67:	89 50 04             	mov    %edx,0x4(%eax)
		freeLinks = link;
80104e6a:	a3 10 c6 10 80       	mov    %eax,0x8010c610
	for(int i = 0; i < NPROCLIST; ++i) {
80104e6f:	75 df                	jne    80104e50 <initSchedDS+0x70>
	freeNodes = null;
80104e71:	31 c0                	xor    %eax,%eax
80104e73:	bb 80 00 00 00       	mov    $0x80,%ebx
80104e78:	a3 0c c6 10 80       	mov    %eax,0x8010c60c
80104e7d:	8d 76 00             	lea    0x0(%esi),%esi
		MapNode *node = (MapNode*)mymalloc(sizeof(MapNode));
80104e80:	b8 20 00 00 00       	mov    $0x20,%eax
80104e85:	e8 f6 fe ff ff       	call   80104d80 <_ZL8mymallocj>
		node->next = freeNodes;
80104e8a:	8b 15 0c c6 10 80    	mov    0x8010c60c,%edx
	for(int i = 0; i < NPROCMAP; ++i) {
80104e90:	4b                   	dec    %ebx
		*node = MapNode();
80104e91:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
80104e98:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
80104e9f:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
80104ea6:	c7 40 18 00 00 00 00 	movl   $0x0,0x18(%eax)
80104ead:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
		node->next = freeNodes;
80104eb4:	89 50 10             	mov    %edx,0x10(%eax)
		freeNodes = node;
80104eb7:	a3 0c c6 10 80       	mov    %eax,0x8010c60c
	for(int i = 0; i < NPROCMAP; ++i) {
80104ebc:	75 c2                	jne    80104e80 <initSchedDS+0xa0>
	pq.isEmpty                      = isEmptyPriorityQueue;
80104ebe:	b8 30 4b 10 80       	mov    $0x80104b30,%eax
	pq.put                          = putPriorityQueue;
80104ec3:	ba b0 54 10 80       	mov    $0x801054b0,%edx
	pq.isEmpty                      = isEmptyPriorityQueue;
80104ec8:	a3 ec c5 10 80       	mov    %eax,0x8010c5ec
	pq.switchToRoundRobinPolicy     = switchToRoundRobinPolicyPriorityQueue;
80104ecd:	b8 70 56 10 80       	mov    $0x80105670,%eax
	pq.getMinAccumulator            = getMinAccumulatorPriorityQueue;
80104ed2:	b9 50 4b 10 80       	mov    $0x80104b50,%ecx
	pq.switchToRoundRobinPolicy     = switchToRoundRobinPolicyPriorityQueue;
80104ed7:	a3 fc c5 10 80       	mov    %eax,0x8010c5fc
	pq.extractProc                  = extractProcPriorityQueue;
80104edc:	b8 50 57 10 80       	mov    $0x80105750,%eax
	pq.extractMin                   = extractMinPriorityQueue;
80104ee1:	bb d0 55 10 80       	mov    $0x801055d0,%ebx
	pq.extractProc                  = extractProcPriorityQueue;
80104ee6:	a3 00 c6 10 80       	mov    %eax,0x8010c600
	rrq.isEmpty                     = isEmptyRoundRobinQueue;
80104eeb:	b8 a0 4b 10 80       	mov    $0x80104ba0,%eax
80104ef0:	a3 dc c5 10 80       	mov    %eax,0x8010c5dc
	rrq.enqueue                     = enqueueRoundRobinQueue;
80104ef5:	b8 c0 4b 10 80       	mov    $0x80104bc0,%eax
80104efa:	a3 e0 c5 10 80       	mov    %eax,0x8010c5e0
	rrq.dequeue                     = dequeueRoundRobinQueue;
80104eff:	b8 20 4c 10 80       	mov    $0x80104c20,%eax
80104f04:	a3 e4 c5 10 80       	mov    %eax,0x8010c5e4
	rrq.switchToPriorityQueuePolicy = switchToPriorityQueuePolicyRoundRobinQueue;
80104f09:	b8 e0 51 10 80       	mov    $0x801051e0,%eax
	pq.put                          = putPriorityQueue;
80104f0e:	89 15 f0 c5 10 80    	mov    %edx,0x8010c5f0
	rpholder.isEmpty                = isEmptyRunningProcessHolder;
80104f14:	ba 70 4c 10 80       	mov    $0x80104c70,%edx
	pq.getMinAccumulator            = getMinAccumulatorPriorityQueue;
80104f19:	89 0d f4 c5 10 80    	mov    %ecx,0x8010c5f4
	rpholder.add                    = addRunningProcessHolder;
80104f1f:	b9 90 4c 10 80       	mov    $0x80104c90,%ecx
	pq.extractMin                   = extractMinPriorityQueue;
80104f24:	89 1d f8 c5 10 80    	mov    %ebx,0x8010c5f8
	rpholder.remove                 = removeRunningProcessHolder;
80104f2a:	bb 40 51 10 80       	mov    $0x80105140,%ebx
	rrq.switchToPriorityQueuePolicy = switchToPriorityQueuePolicyRoundRobinQueue;
80104f2f:	a3 e8 c5 10 80       	mov    %eax,0x8010c5e8
	rpholder.getMinAccumulator      = getMinAccumulatorRunningProcessHolder;
80104f34:	b8 70 52 10 80       	mov    $0x80105270,%eax
	rpholder.remove                 = removeRunningProcessHolder;
80104f39:	89 1d d4 c5 10 80    	mov    %ebx,0x8010c5d4
	rpholder.isEmpty                = isEmptyRunningProcessHolder;
80104f3f:	89 15 cc c5 10 80    	mov    %edx,0x8010c5cc
	rpholder.add                    = addRunningProcessHolder;
80104f45:	89 0d d0 c5 10 80    	mov    %ecx,0x8010c5d0
	rpholder.getMinAccumulator      = getMinAccumulatorRunningProcessHolder;
80104f4b:	a3 d8 c5 10 80       	mov    %eax,0x8010c5d8
}
80104f50:	58                   	pop    %eax
80104f51:	5b                   	pop    %ebx
80104f52:	5d                   	pop    %ebp
...
80104f60 <_ZN4Link7getLastEv>:
Link* Link::getLast() {
80104f60:	55                   	push   %ebp
80104f61:	89 e5                	mov    %esp,%ebp
80104f63:	8b 45 08             	mov    0x8(%ebp),%eax
80104f66:	eb 0a                	jmp    80104f72 <_ZN4Link7getLastEv+0x12>
80104f68:	90                   	nop
80104f69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104f70:	89 d0                	mov    %edx,%eax
	while(ans->next)
80104f72:	8b 50 04             	mov    0x4(%eax),%edx
80104f75:	85 d2                	test   %edx,%edx
80104f77:	75 f7                	jne    80104f70 <_ZN4Link7getLastEv+0x10>
}
80104f79:	5d                   	pop    %ebp
80104f7a:	c3                   	ret    
80104f7b:	90                   	nop
...
80104f80 <_ZN10LinkedList7isEmptyEv>:
...
80104f8b:	0f 94 c0             	sete   %al
}
80104f8e:	c3                   	ret    
80104f8f:	90                   	nop

80104f90 <_ZN10LinkedList6appendEP4Link>:
...
80104f9b:	74 1f                	je     80104fbc <_ZN10LinkedList6appendEP4Link+0x2c>
	if(isEmpty()) first = link;
80104f9d:	8b 01                	mov    (%ecx),%eax
80104f9f:	85 c0                	test   %eax,%eax
80104fa1:	74 1d                	je     80104fc0 <_ZN10LinkedList6appendEP4Link+0x30>
	else last->next = link;
80104fa3:	8b 41 04             	mov    0x4(%ecx),%eax
80104fa6:	89 50 04             	mov    %edx,0x4(%eax)
80104fa9:	eb 07                	jmp    80104fb2 <_ZN10LinkedList6appendEP4Link+0x22>
80104fab:	90                   	nop
80104fac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	while(ans->next)
80104fb0:	89 c2                	mov    %eax,%edx
80104fb2:	8b 42 04             	mov    0x4(%edx),%eax
80104fb5:	85 c0                	test   %eax,%eax
80104fb7:	75 f7                	jne    80104fb0 <_ZN10LinkedList6appendEP4Link+0x20>
	last = link->getLast();
80104fb9:	89 51 04             	mov    %edx,0x4(%ecx)
}
80104fbc:	5d                   	pop    %ebp
80104fbd:	c3                   	ret    
80104fbe:	66 90                	xchg   %ax,%ax
	if(isEmpty()) first = link;
80104fc0:	89 11                	mov    %edx,(%ecx)
80104fc2:	eb ee                	jmp    80104fb2 <_ZN10LinkedList6appendEP4Link+0x22>
80104fc4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104fca:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80104fd0 <_ZN10LinkedList7enqueueEP4proc>:
	if(!freeLinks)
80104fd0:	a1 10 c6 10 80       	mov    0x8010c610,%eax
bool LinkedList::enqueue(Proc *p) {
80104fd5:	55                   	push   %ebp
80104fd6:	89 e5                	mov    %esp,%ebp
80104fd8:	8b 4d 08             	mov    0x8(%ebp),%ecx
	if(!freeLinks)
80104fdb:	85 c0                	test   %eax,%eax
80104fdd:	74 41                	je     80105020 <_ZN10LinkedList7enqueueEP4proc+0x50>
	freeLinks = freeLinks->next;
80104fdf:	8b 50 04             	mov    0x4(%eax),%edx
	ans->next = null;
80104fe2:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	freeLinks = freeLinks->next;
80104fe9:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	ans->p = p;
80104fef:	8b 55 0c             	mov    0xc(%ebp),%edx
80104ff2:	89 10                	mov    %edx,(%eax)
	if(isEmpty()) first = link;
80104ff4:	8b 11                	mov    (%ecx),%edx
80104ff6:	85 d2                	test   %edx,%edx
80104ff8:	74 2e                	je     80105028 <_ZN10LinkedList7enqueueEP4proc+0x58>
	else last->next = link;
80104ffa:	8b 51 04             	mov    0x4(%ecx),%edx
80104ffd:	89 42 04             	mov    %eax,0x4(%edx)
80105000:	eb 08                	jmp    8010500a <_ZN10LinkedList7enqueueEP4proc+0x3a>
80105002:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	while(ans->next)
80105008:	89 d0                	mov    %edx,%eax
8010500a:	8b 50 04             	mov    0x4(%eax),%edx
8010500d:	85 d2                	test   %edx,%edx
8010500f:	75 f7                	jne    80105008 <_ZN10LinkedList7enqueueEP4proc+0x38>
	last = link->getLast();
80105011:	89 41 04             	mov    %eax,0x4(%ecx)
	return true;
80105014:	b0 01                	mov    $0x1,%al
}
80105016:	5d                   	pop    %ebp
80105017:	c3                   	ret    
80105018:	90                   	nop
...
80105024:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	if(isEmpty()) first = link;
80105028:	89 01                	mov    %eax,(%ecx)
8010502a:	eb de                	jmp    8010500a <_ZN10LinkedList7enqueueEP4proc+0x3a>
8010502c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105030 <_ZN10LinkedList7dequeueEv>:
...
8010503c:	89 75 fc             	mov    %esi,-0x4(%ebp)
	return !first;
8010503f:	8b 11                	mov    (%ecx),%edx
	if(isEmpty())
80105041:	85 d2                	test   %edx,%edx
80105043:	74 2b                	je     80105070 <_ZN10LinkedList7dequeueEv+0x40>
	Link *next = first->next;
80105045:	8b 5a 04             	mov    0x4(%edx),%ebx
	link->next = freeLinks;
80105048:	8b 35 10 c6 10 80    	mov    0x8010c610,%esi
	Proc *p = first->p;
8010504e:	8b 02                	mov    (%edx),%eax
	freeLinks = link;
80105050:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty())
80105056:	85 db                	test   %ebx,%ebx
	link->next = freeLinks;
80105058:	89 72 04             	mov    %esi,0x4(%edx)
	first = next;
8010505b:	89 19                	mov    %ebx,(%ecx)
	if(isEmpty())
8010505d:	75 07                	jne    80105066 <_ZN10LinkedList7dequeueEv+0x36>
		last = null;
8010505f:	c7 41 04 00 00 00 00 	movl   $0x0,0x4(%ecx)
}
80105066:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105069:	8b 75 fc             	mov    -0x4(%ebp),%esi
8010506c:	89 ec                	mov    %ebp,%esp
8010506e:	5d                   	pop    %ebp
8010506f:	c3                   	ret    
		return null;
80105070:	31 c0                	xor    %eax,%eax
80105072:	eb f2                	jmp    80105066 <_ZN10LinkedList7dequeueEv+0x36>
80105074:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010507a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105080 <_ZN10LinkedList6removeEP4proc>:
bool LinkedList::remove(Proc *p) {
80105080:	55                   	push   %ebp
80105081:	89 e5                	mov    %esp,%ebp
80105083:	56                   	push   %esi
80105084:	8b 75 08             	mov    0x8(%ebp),%esi
80105087:	53                   	push   %ebx
80105088:	8b 4d 0c             	mov    0xc(%ebp),%ecx
	return !first;
8010508b:	8b 1e                	mov    (%esi),%ebx
	if(isEmpty())
8010508d:	85 db                	test   %ebx,%ebx
8010508f:	74 2f                	je     801050c0 <_ZN10LinkedList6removeEP4proc+0x40>
	if(first->p == p) {
80105091:	39 0b                	cmp    %ecx,(%ebx)
80105093:	8b 53 04             	mov    0x4(%ebx),%edx
80105096:	74 70                	je     80105108 <_ZN10LinkedList6removeEP4proc+0x88>
	while(cur) {
80105098:	85 d2                	test   %edx,%edx
8010509a:	74 24                	je     801050c0 <_ZN10LinkedList6removeEP4proc+0x40>
		if(cur->p == p) {
8010509c:	3b 0a                	cmp    (%edx),%ecx
8010509e:	66 90                	xchg   %ax,%ax
801050a0:	75 0c                	jne    801050ae <_ZN10LinkedList6removeEP4proc+0x2e>
801050a2:	eb 2c                	jmp    801050d0 <_ZN10LinkedList6removeEP4proc+0x50>
801050a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801050a8:	39 08                	cmp    %ecx,(%eax)
801050aa:	74 34                	je     801050e0 <_ZN10LinkedList6removeEP4proc+0x60>
801050ac:	89 c2                	mov    %eax,%edx
		cur = cur->next;
801050ae:	8b 42 04             	mov    0x4(%edx),%eax
	while(cur) {
801050b1:	85 c0                	test   %eax,%eax
801050b3:	75 f3                	jne    801050a8 <_ZN10LinkedList6removeEP4proc+0x28>
}
801050b5:	5b                   	pop    %ebx
801050b6:	5e                   	pop    %esi
801050b7:	5d                   	pop    %ebp
...
801050d2:	89 da                	mov    %ebx,%edx
801050d4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801050da:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
			prev->next = cur->next;
801050e0:	8b 48 04             	mov    0x4(%eax),%ecx
801050e3:	89 4a 04             	mov    %ecx,0x4(%edx)
			if(!(cur->next)) //removes the last link
801050e6:	8b 48 04             	mov    0x4(%eax),%ecx
801050e9:	85 c9                	test   %ecx,%ecx
801050eb:	74 43                	je     80105130 <_ZN10LinkedList6removeEP4proc+0xb0>
	link->next = freeLinks;
801050ed:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
	freeLinks = link;
801050f3:	a3 10 c6 10 80       	mov    %eax,0x8010c610
	link->next = freeLinks;
801050f8:	89 50 04             	mov    %edx,0x4(%eax)
			return true;
801050fb:	b0 01                	mov    $0x1,%al
}
801050fd:	5b                   	pop    %ebx
801050fe:	5e                   	pop    %esi
801050ff:	5d                   	pop    %ebp
...
80105101:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	link->next = freeLinks;
80105108:	a1 10 c6 10 80       	mov    0x8010c610,%eax
	if(isEmpty())
8010510d:	85 d2                	test   %edx,%edx
	freeLinks = link;
8010510f:	89 1d 10 c6 10 80    	mov    %ebx,0x8010c610
	link->next = freeLinks;
80105115:	89 43 04             	mov    %eax,0x4(%ebx)
		return true;
80105118:	b0 01                	mov    $0x1,%al
	first = next;
8010511a:	89 16                	mov    %edx,(%esi)
	if(isEmpty())
8010511c:	75 97                	jne    801050b5 <_ZN10LinkedList6removeEP4proc+0x35>
		last = null;
8010511e:	c7 46 04 00 00 00 00 	movl   $0x0,0x4(%esi)
80105125:	eb 8e                	jmp    801050b5 <_ZN10LinkedList6removeEP4proc+0x35>
80105127:	89 f6                	mov    %esi,%esi
80105129:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
				last = prev;
80105130:	89 56 04             	mov    %edx,0x4(%esi)
80105133:	eb b8                	jmp    801050ed <_ZN10LinkedList6removeEP4proc+0x6d>
80105135:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105139:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105140 <removeRunningProcessHolder>:
...
8010514d:	a1 14 c6 10 80       	mov    0x8010c614,%eax
80105152:	89 04 24             	mov    %eax,(%esp)
80105155:	e8 26 ff ff ff       	call   80105080 <_ZN10LinkedList6removeEP4proc>
}
8010515a:	c9                   	leave  
	return runningProcHolder->remove(p);
...
80105160 <_ZN10LinkedList8transferEv>:
	if(!priorityQ->isEmpty())
80105160:	8b 15 1c c6 10 80    	mov    0x8010c61c,%edx
		return false;
80105166:	31 c0                	xor    %eax,%eax
bool LinkedList::transfer() {
80105168:	55                   	push   %ebp
80105169:	89 e5                	mov    %esp,%ebp
8010516b:	53                   	push   %ebx
8010516c:	8b 4d 08             	mov    0x8(%ebp),%ecx
	if(!priorityQ->isEmpty())
8010516f:	8b 1a                	mov    (%edx),%ebx
80105171:	85 db                	test   %ebx,%ebx
80105173:	74 0b                	je     80105180 <_ZN10LinkedList8transferEv+0x20>
}
80105175:	5b                   	pop    %ebx
80105176:	5d                   	pop    %ebp
80105177:	c3                   	ret    
...
80105179:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	if(!isEmpty()) {
80105180:	8b 19                	mov    (%ecx),%ebx
80105182:	85 db                	test   %ebx,%ebx
80105184:	74 4a                	je     801051d0 <_ZN10LinkedList8transferEv+0x70>
	if(!freeNodes)
80105186:	8b 1d 0c c6 10 80    	mov    0x8010c60c,%ebx
8010518c:	85 db                	test   %ebx,%ebx
8010518e:	74 e5                	je     80105175 <_ZN10LinkedList8transferEv+0x15>
	freeNodes = freeNodes->next;
80105190:	8b 43 10             	mov    0x10(%ebx),%eax
	ans->key = key;
80105193:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	ans->next = null;
80105199:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	ans->key = key;
801051a0:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
	freeNodes = freeNodes->next;
801051a7:	a3 0c c6 10 80       	mov    %eax,0x8010c60c
		node->listOfProcs.first = first;
801051ac:	8b 01                	mov    (%ecx),%eax
801051ae:	89 43 08             	mov    %eax,0x8(%ebx)
		node->listOfProcs.last = last;
801051b1:	8b 41 04             	mov    0x4(%ecx),%eax
801051b4:	89 43 0c             	mov    %eax,0xc(%ebx)
	return true;
801051b7:	b0 01                	mov    $0x1,%al
		first = last = null;
801051b9:	c7 41 04 00 00 00 00 	movl   $0x0,0x4(%ecx)
801051c0:	c7 01 00 00 00 00    	movl   $0x0,(%ecx)
		priorityQ->root = node;
801051c6:	89 1a                	mov    %ebx,(%edx)
}
801051c8:	5b                   	pop    %ebx
801051c9:	5d                   	pop    %ebp
801051ca:	c3                   	ret    
...
801051cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	return true;
801051d0:	b0 01                	mov    $0x1,%al
801051d2:	eb a1                	jmp    80105175 <_ZN10LinkedList8transferEv+0x15>
801051d4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801051da:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

801051e0 <switchToPriorityQueuePolicyRoundRobinQueue>:
static boolean switchToPriorityQueuePolicyRoundRobinQueue() {
801051e0:	55                   	push   %ebp
801051e1:	89 e5                	mov    %esp,%ebp
801051e3:	83 ec 04             	sub    $0x4,%esp
	return roundRobinQ->transfer();
801051e6:	a1 18 c6 10 80       	mov    0x8010c618,%eax
801051eb:	89 04 24             	mov    %eax,(%esp)
801051ee:	e8 6d ff ff ff       	call   80105160 <_ZN10LinkedList8transferEv>
}
801051f3:	c9                   	leave  
	return roundRobinQ->transfer();
801051f4:	0f b6 c0             	movzbl %al,%eax
}
801051f7:	c3                   	ret    
801051f8:	90                   	nop
801051f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105200 <_ZN10LinkedList9getMinKeyEPx>:
...
80105208:	83 ec 1c             	sub    $0x1c,%esp
8010520b:	8b 7d 08             	mov    0x8(%ebp),%edi
	return !first;
8010520e:	8b 17                	mov    (%edi),%edx
	if(isEmpty())
80105210:	85 d2                	test   %edx,%edx
80105212:	74 41                	je     80105255 <_ZN10LinkedList9getMinKeyEPx+0x55>
	long long minKey = getAccumulator(first->p);
80105214:	8b 02                	mov    (%edx),%eax
80105216:	89 04 24             	mov    %eax,(%esp)
80105219:	e8 a2 e6 ff ff       	call   801038c0 <getAccumulator>
	forEach([&](Proc *p) {
8010521e:	8b 3f                	mov    (%edi),%edi
...
80105224:	89 d3                	mov    %edx,%ebx
80105226:	74 23                	je     8010524b <_ZN10LinkedList9getMinKeyEPx+0x4b>
80105228:	90                   	nop
...
80105235:	e8 86 e6 ff ff       	call   801038c0 <getAccumulator>
8010523a:	39 d3                	cmp    %edx,%ebx
8010523c:	7c 06                	jl     80105244 <_ZN10LinkedList9getMinKeyEPx+0x44>
8010523e:	7f 20                	jg     80105260 <_ZN10LinkedList9getMinKeyEPx+0x60>
80105240:	39 c6                	cmp    %eax,%esi
80105242:	77 1c                	ja     80105260 <_ZN10LinkedList9getMinKeyEPx+0x60>
			accept(link->p);
			link = link->next;
80105244:	8b 7f 04             	mov    0x4(%edi),%edi
		while(link) {
80105247:	85 ff                	test   %edi,%edi
80105249:	75 e5                	jne    80105230 <_ZN10LinkedList9getMinKeyEPx+0x30>
	*pkey = minKey;
8010524b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010524e:	89 30                	mov    %esi,(%eax)
80105250:	89 58 04             	mov    %ebx,0x4(%eax)
	return true;
80105253:	b0 01                	mov    $0x1,%al
}
80105255:	83 c4 1c             	add    $0x1c,%esp
80105258:	5b                   	pop    %ebx
80105259:	5e                   	pop    %esi
8010525a:	5f                   	pop    %edi
8010525b:	5d                   	pop    %ebp
...
8010525d:	8d 76 00             	lea    0x0(%esi),%esi
			link = link->next;
80105260:	8b 7f 04             	mov    0x4(%edi),%edi
80105263:	89 c6                	mov    %eax,%esi
80105265:	89 d3                	mov    %edx,%ebx
		while(link) {
80105267:	85 ff                	test   %edi,%edi
80105269:	75 c5                	jne    80105230 <_ZN10LinkedList9getMinKeyEPx+0x30>
8010526b:	eb de                	jmp    8010524b <_ZN10LinkedList9getMinKeyEPx+0x4b>
8010526d:	8d 76 00             	lea    0x0(%esi),%esi

80105270 <getMinAccumulatorRunningProcessHolder>:
...
8010527d:	a1 14 c6 10 80       	mov    0x8010c614,%eax
80105282:	89 04 24             	mov    %eax,(%esp)
80105285:	e8 76 ff ff ff       	call   80105200 <_ZN10LinkedList9getMinKeyEPx>
}
8010528a:	c9                   	leave  
	return runningProcHolder->getMinKey(pkey);
8010528b:	0f b6 c0             	movzbl %al,%eax
}
8010528e:	c3                   	ret    
8010528f:	90                   	nop

80105290 <_ZN7MapNode7isEmptyEv>:
...
80105296:	5d                   	pop    %ebp
	return !first;
80105297:	8b 40 08             	mov    0x8(%eax),%eax
8010529a:	85 c0                	test   %eax,%eax
8010529c:	0f 94 c0             	sete   %al
}
8010529f:	c3                   	ret    

801052a0 <_ZN7MapNode3putEP4proc>:
...
801052a6:	83 ec 2c             	sub    $0x2c,%esp
	long long key = getAccumulator(p);
801052a9:	8b 45 0c             	mov    0xc(%ebp),%eax
bool MapNode::put(Proc *p) { //we can not use recursion, since the stack of xv6 is too small....
801052ac:	8b 5d 08             	mov    0x8(%ebp),%ebx
	long long key = getAccumulator(p);
801052af:	89 04 24             	mov    %eax,(%esp)
801052b2:	e8 09 e6 ff ff       	call   801038c0 <getAccumulator>
801052b7:	89 d1                	mov    %edx,%ecx
801052b9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801052bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		if(key == node->key)
801052c0:	8b 13                	mov    (%ebx),%edx
801052c2:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801052c5:	8b 43 04             	mov    0x4(%ebx),%eax
801052c8:	31 d7                	xor    %edx,%edi
801052ca:	89 fe                	mov    %edi,%esi
801052cc:	89 c7                	mov    %eax,%edi
801052ce:	31 cf                	xor    %ecx,%edi
801052d0:	09 fe                	or     %edi,%esi
801052d2:	74 4c                	je     80105320 <_ZN7MapNode3putEP4proc+0x80>
		else if(key < node->key) { //left
801052d4:	39 c8                	cmp    %ecx,%eax
801052d6:	7c 20                	jl     801052f8 <_ZN7MapNode3putEP4proc+0x58>
801052d8:	7f 08                	jg     801052e2 <_ZN7MapNode3putEP4proc+0x42>
801052da:	3b 55 e4             	cmp    -0x1c(%ebp),%edx
801052dd:	8d 76 00             	lea    0x0(%esi),%esi
801052e0:	76 16                	jbe    801052f8 <_ZN7MapNode3putEP4proc+0x58>
			if(node->left)
801052e2:	8b 43 18             	mov    0x18(%ebx),%eax
801052e5:	85 c0                	test   %eax,%eax
801052e7:	0f 84 83 00 00 00    	je     80105370 <_ZN7MapNode3putEP4proc+0xd0>
bool MapNode::put(Proc *p) { //we can not use recursion, since the stack of xv6 is too small....
801052ed:	89 c3                	mov    %eax,%ebx
801052ef:	eb cf                	jmp    801052c0 <_ZN7MapNode3putEP4proc+0x20>
801052f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
			if(node->right)
801052f8:	8b 43 1c             	mov    0x1c(%ebx),%eax
801052fb:	85 c0                	test   %eax,%eax
801052fd:	75 ee                	jne    801052ed <_ZN7MapNode3putEP4proc+0x4d>
801052ff:	8b 75 e4             	mov    -0x1c(%ebp),%esi
				node->right = allocNode(p, key);
80105302:	8b 45 0c             	mov    0xc(%ebp),%eax
80105305:	89 f2                	mov    %esi,%edx
80105307:	e8 e4 f9 ff ff       	call   80104cf0 <_ZL9allocNodeP4procx>
				if(node->right) {
8010530c:	85 c0                	test   %eax,%eax
				node->right = allocNode(p, key);
8010530e:	89 43 1c             	mov    %eax,0x1c(%ebx)
				if(node->right) {
80105311:	74 71                	je     80105384 <_ZN7MapNode3putEP4proc+0xe4>
					node->right->parent = node;
80105313:	89 58 14             	mov    %ebx,0x14(%eax)
}
80105316:	83 c4 2c             	add    $0x2c,%esp
					return true;
80105319:	b0 01                	mov    $0x1,%al
}
8010531b:	5b                   	pop    %ebx
8010531c:	5e                   	pop    %esi
8010531d:	5f                   	pop    %edi
...
8010531f:	c3                   	ret    
	if(!freeLinks)
80105320:	a1 10 c6 10 80       	mov    0x8010c610,%eax
80105325:	85 c0                	test   %eax,%eax
80105327:	74 5b                	je     80105384 <_ZN7MapNode3putEP4proc+0xe4>
	ans->p = p;
80105329:	8b 75 0c             	mov    0xc(%ebp),%esi
	freeLinks = freeLinks->next;
8010532c:	8b 50 04             	mov    0x4(%eax),%edx
	ans->next = null;
8010532f:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	ans->p = p;
80105336:	89 30                	mov    %esi,(%eax)
	freeLinks = freeLinks->next;
80105338:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty()) first = link;
8010533e:	8b 53 08             	mov    0x8(%ebx),%edx
80105341:	85 d2                	test   %edx,%edx
80105343:	74 4b                	je     80105390 <_ZN7MapNode3putEP4proc+0xf0>
	else last->next = link;
80105345:	8b 53 0c             	mov    0xc(%ebx),%edx
80105348:	89 42 04             	mov    %eax,0x4(%edx)
8010534b:	eb 05                	jmp    80105352 <_ZN7MapNode3putEP4proc+0xb2>
8010534d:	8d 76 00             	lea    0x0(%esi),%esi
	while(ans->next)
80105350:	89 d0                	mov    %edx,%eax
80105352:	8b 50 04             	mov    0x4(%eax),%edx
80105355:	85 d2                	test   %edx,%edx
80105357:	75 f7                	jne    80105350 <_ZN7MapNode3putEP4proc+0xb0>
	last = link->getLast();
80105359:	89 43 0c             	mov    %eax,0xc(%ebx)
}
8010535c:	83 c4 2c             	add    $0x2c,%esp
	return true;
8010535f:	b0 01                	mov    $0x1,%al
}
80105361:	5b                   	pop    %ebx
80105362:	5e                   	pop    %esi
80105363:	5f                   	pop    %edi
...
80105370:	8b 75 e4             	mov    -0x1c(%ebp),%esi
				node->left = allocNode(p, key);
80105373:	8b 45 0c             	mov    0xc(%ebp),%eax
80105376:	89 f2                	mov    %esi,%edx
80105378:	e8 73 f9 ff ff       	call   80104cf0 <_ZL9allocNodeP4procx>
				if(node->left) {
8010537d:	85 c0                	test   %eax,%eax
				node->left = allocNode(p, key);
8010537f:	89 43 18             	mov    %eax,0x18(%ebx)
				if(node->left) {
80105382:	75 8f                	jne    80105313 <_ZN7MapNode3putEP4proc+0x73>
}
80105384:	83 c4 2c             	add    $0x2c,%esp
		return false;
...
8010538e:	66 90                	xchg   %ax,%ax
	if(isEmpty()) first = link;
80105390:	89 43 08             	mov    %eax,0x8(%ebx)
80105393:	eb bd                	jmp    80105352 <_ZN7MapNode3putEP4proc+0xb2>
80105395:	90                   	nop
80105396:	8d 76 00             	lea    0x0(%esi),%esi
80105399:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801053a0 <_ZN7MapNode10getMinNodeEv>:
MapNode* MapNode::getMinNode() { //no recursion.
801053a0:	55                   	push   %ebp
801053a1:	89 e5                	mov    %esp,%ebp
801053a3:	8b 45 08             	mov    0x8(%ebp),%eax
801053a6:	eb 0a                	jmp    801053b2 <_ZN7MapNode10getMinNodeEv+0x12>
801053a8:	90                   	nop
801053a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801053b0:	89 d0                	mov    %edx,%eax
	while(minNode->left)
801053b2:	8b 50 18             	mov    0x18(%eax),%edx
801053b5:	85 d2                	test   %edx,%edx
801053b7:	75 f7                	jne    801053b0 <_ZN7MapNode10getMinNodeEv+0x10>
}
801053b9:	5d                   	pop    %ebp
801053ba:	c3                   	ret    
801053bb:	90                   	nop
...
801053d7:	75 f7                	jne    801053d0 <_ZN7MapNode9getMinKeyEPx+0x10>
	*pkey = getMinNode()->key;
801053d9:	8b 5a 04             	mov    0x4(%edx),%ebx
...
801053f0 <_ZN7MapNode7dequeueEv>:
Proc* MapNode::dequeue() {
801053f0:	55                   	push   %ebp
801053f1:	89 e5                	mov    %esp,%ebp
801053f3:	83 ec 08             	sub    $0x8,%esp
801053f6:	8b 4d 08             	mov    0x8(%ebp),%ecx
801053f9:	89 5d f8             	mov    %ebx,-0x8(%ebp)
801053fc:	89 75 fc             	mov    %esi,-0x4(%ebp)
	return !first;
801053ff:	8b 51 08             	mov    0x8(%ecx),%edx
	if(isEmpty())
80105402:	85 d2                	test   %edx,%edx
80105404:	74 32                	je     80105438 <_ZN7MapNode7dequeueEv+0x48>
	Link *next = first->next;
80105406:	8b 5a 04             	mov    0x4(%edx),%ebx
	link->next = freeLinks;
80105409:	8b 35 10 c6 10 80    	mov    0x8010c610,%esi
	Proc *p = first->p;
8010540f:	8b 02                	mov    (%edx),%eax
	freeLinks = link;
80105411:	89 15 10 c6 10 80    	mov    %edx,0x8010c610
	if(isEmpty())
80105417:	85 db                	test   %ebx,%ebx
	link->next = freeLinks;
80105419:	89 72 04             	mov    %esi,0x4(%edx)
	first = next;
8010541c:	89 59 08             	mov    %ebx,0x8(%ecx)
	if(isEmpty())
8010541f:	75 07                	jne    80105428 <_ZN7MapNode7dequeueEv+0x38>
		last = null;
80105421:	c7 41 0c 00 00 00 00 	movl   $0x0,0xc(%ecx)
}
80105428:	8b 5d f8             	mov    -0x8(%ebp),%ebx
8010542b:	8b 75 fc             	mov    -0x4(%ebp),%esi
8010542e:	89 ec                	mov    %ebp,%esp
80105430:	5d                   	pop    %ebp
80105431:	c3                   	ret    
...
80105438:	31 c0                	xor    %eax,%eax
	return listOfProcs.dequeue();
8010543a:	eb ec                	jmp    80105428 <_ZN7MapNode7dequeueEv+0x38>
8010543c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105440 <_ZN3Map7isEmptyEv>:
bool Map::isEmpty() {
...
8010544b:	0f 94 c0             	sete   %al
}
8010544e:	c3                   	ret    
8010544f:	90                   	nop

80105450 <_ZN3Map3putEP4proc>:
bool Map::put(Proc *p) {
80105450:	55                   	push   %ebp
80105451:	89 e5                	mov    %esp,%ebp
80105453:	83 ec 18             	sub    $0x18,%esp
80105456:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80105459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010545c:	89 75 fc             	mov    %esi,-0x4(%ebp)
8010545f:	8b 75 08             	mov    0x8(%ebp),%esi
	long long key = getAccumulator(p);
80105462:	89 1c 24             	mov    %ebx,(%esp)
80105465:	e8 56 e4 ff ff       	call   801038c0 <getAccumulator>
	return !root;
8010546a:	8b 0e                	mov    (%esi),%ecx
	if(isEmpty()) {
8010546c:	85 c9                	test   %ecx,%ecx
8010546e:	74 18                	je     80105488 <_ZN3Map3putEP4proc+0x38>
	return root->put(p);
80105470:	89 5d 0c             	mov    %ebx,0xc(%ebp)
}
80105473:	8b 75 fc             	mov    -0x4(%ebp),%esi
	return root->put(p);
80105476:	89 4d 08             	mov    %ecx,0x8(%ebp)
}
80105479:	8b 5d f8             	mov    -0x8(%ebp),%ebx
8010547c:	89 ec                	mov    %ebp,%esp
8010547e:	5d                   	pop    %ebp
	return root->put(p);
8010547f:	e9 1c fe ff ff       	jmp    801052a0 <_ZN7MapNode3putEP4proc>
80105484:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		root = allocNode(p, key);
80105488:	89 d1                	mov    %edx,%ecx
8010548a:	89 c2                	mov    %eax,%edx
8010548c:	89 d8                	mov    %ebx,%eax
8010548e:	e8 5d f8 ff ff       	call   80104cf0 <_ZL9allocNodeP4procx>
80105493:	89 06                	mov    %eax,(%esi)
		return !isEmpty();
80105495:	85 c0                	test   %eax,%eax
80105497:	0f 95 c0             	setne  %al
}
8010549a:	8b 5d f8             	mov    -0x8(%ebp),%ebx
8010549d:	8b 75 fc             	mov    -0x4(%ebp),%esi
801054a0:	89 ec                	mov    %ebp,%esp
801054a2:	5d                   	pop    %ebp
801054a3:	c3                   	ret    
801054a4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801054aa:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

801054b0 <putPriorityQueue>:
...
801054bd:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
801054c2:	89 04 24             	mov    %eax,(%esp)
801054c5:	e8 86 ff ff ff       	call   80105450 <_ZN3Map3putEP4proc>
}
801054ca:	c9                   	leave  
	return priorityQ->put(p);
801054cb:	0f b6 c0             	movzbl %al,%eax
}
801054ce:	c3                   	ret    
801054cf:	90                   	nop

801054d0 <_ZN3Map9getMinKeyEPx>:
bool Map::getMinKey(long long *pkey) {
...
801054d7:	8b 10                	mov    (%eax),%edx
	if(isEmpty())
801054d9:	85 d2                	test   %edx,%edx
801054db:	75 05                	jne    801054e2 <_ZN3Map9getMinKeyEPx+0x12>
801054dd:	eb 21                	jmp    80105500 <_ZN3Map9getMinKeyEPx+0x30>
801054df:	90                   	nop
	while(minNode->left)
801054e0:	89 c2                	mov    %eax,%edx
801054e2:	8b 42 18             	mov    0x18(%edx),%eax
801054e5:	85 c0                	test   %eax,%eax
801054e7:	75 f7                	jne    801054e0 <_ZN3Map9getMinKeyEPx+0x10>
	*pkey = getMinNode()->key;
801054e9:	8b 45 0c             	mov    0xc(%ebp),%eax
801054ec:	8b 5a 04             	mov    0x4(%edx),%ebx
801054ef:	8b 0a                	mov    (%edx),%ecx
801054f1:	89 58 04             	mov    %ebx,0x4(%eax)
801054f4:	89 08                	mov    %ecx,(%eax)
		return false;

	root->getMinKey(pkey);
	return true;
801054f6:	b0 01                	mov    $0x1,%al
}
801054f8:	5b                   	pop    %ebx
801054f9:	5d                   	pop    %ebp
801054fa:	c3                   	ret    
...
80105510 <_ZN3Map10extractMinEv>:
...
80105518:	53                   	push   %ebx
	return !root;
80105519:	8b 1e                	mov    (%esi),%ebx
	if(isEmpty())
8010551b:	85 db                	test   %ebx,%ebx
8010551d:	0f 84 a5 00 00 00    	je     801055c8 <_ZN3Map10extractMinEv+0xb8>
80105523:	89 da                	mov    %ebx,%edx
80105525:	eb 0b                	jmp    80105532 <_ZN3Map10extractMinEv+0x22>
80105527:	89 f6                	mov    %esi,%esi
80105529:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
	while(minNode->left)
80105530:	89 c2                	mov    %eax,%edx
80105532:	8b 42 18             	mov    0x18(%edx),%eax
80105535:	85 c0                	test   %eax,%eax
80105537:	75 f7                	jne    80105530 <_ZN3Map10extractMinEv+0x20>
	return !first;
80105539:	8b 4a 08             	mov    0x8(%edx),%ecx
	if(isEmpty())
8010553c:	85 c9                	test   %ecx,%ecx
8010553e:	74 70                	je     801055b0 <_ZN3Map10extractMinEv+0xa0>
	Link *next = first->next;
80105540:	8b 59 04             	mov    0x4(%ecx),%ebx
	link->next = freeLinks;
80105543:	8b 3d 10 c6 10 80    	mov    0x8010c610,%edi
	Proc *p = first->p;
80105549:	8b 01                	mov    (%ecx),%eax
	freeLinks = link;
8010554b:	89 0d 10 c6 10 80    	mov    %ecx,0x8010c610
	if(isEmpty())
80105551:	85 db                	test   %ebx,%ebx
	link->next = freeLinks;
80105553:	89 79 04             	mov    %edi,0x4(%ecx)
	first = next;
80105556:	89 5a 08             	mov    %ebx,0x8(%edx)
	if(isEmpty())
80105559:	74 05                	je     80105560 <_ZN3Map10extractMinEv+0x50>
		}
		deallocNode(minNode);
	}
...
8010555f:	c3                   	ret    
		last = null;
80105560:	c7 42 0c 00 00 00 00 	movl   $0x0,0xc(%edx)
80105567:	8b 4a 1c             	mov    0x1c(%edx),%ecx
8010556a:	8b 1e                	mov    (%esi),%ebx
		if(minNode == root) {
8010556c:	39 da                	cmp    %ebx,%edx
8010556e:	74 49                	je     801055b9 <_ZN3Map10extractMinEv+0xa9>
			MapNode *parent = minNode->parent;
80105570:	8b 5a 14             	mov    0x14(%edx),%ebx
			parent->left = minNode->right;
80105573:	89 4b 18             	mov    %ecx,0x18(%ebx)
			if(minNode->right)
80105576:	8b 4a 1c             	mov    0x1c(%edx),%ecx
80105579:	85 c9                	test   %ecx,%ecx
8010557b:	74 03                	je     80105580 <_ZN3Map10extractMinEv+0x70>
				minNode->right->parent = parent;
8010557d:	89 59 14             	mov    %ebx,0x14(%ecx)
	node->next = freeNodes;
80105580:	8b 0d 0c c6 10 80    	mov    0x8010c60c,%ecx
	node->parent = node->left = node->right = null;
80105586:	c7 42 1c 00 00 00 00 	movl   $0x0,0x1c(%edx)
8010558d:	c7 42 18 00 00 00 00 	movl   $0x0,0x18(%edx)
80105594:	c7 42 14 00 00 00 00 	movl   $0x0,0x14(%edx)
	node->next = freeNodes;
8010559b:	89 4a 10             	mov    %ecx,0x10(%edx)
}
8010559e:	5b                   	pop    %ebx
	freeNodes = node;
8010559f:	89 15 0c c6 10 80    	mov    %edx,0x8010c60c
}
801055a5:	5e                   	pop    %esi
801055a6:	5f                   	pop    %edi
801055a7:	5d                   	pop    %ebp
...
801055b0:	31 c0                	xor    %eax,%eax
		if(minNode == root) {
801055b2:	39 da                	cmp    %ebx,%edx
801055b4:	8b 4a 1c             	mov    0x1c(%edx),%ecx
801055b7:	75 b7                	jne    80105570 <_ZN3Map10extractMinEv+0x60>
			if(!isEmpty())
801055b9:	85 c9                	test   %ecx,%ecx
			root = minNode->right;
801055bb:	89 0e                	mov    %ecx,(%esi)
			if(!isEmpty())
801055bd:	74 c1                	je     80105580 <_ZN3Map10extractMinEv+0x70>
				root->parent = null;
801055bf:	c7 41 14 00 00 00 00 	movl   $0x0,0x14(%ecx)
801055c6:	eb b8                	jmp    80105580 <_ZN3Map10extractMinEv+0x70>
		return null;
801055c8:	31 c0                	xor    %eax,%eax
801055ca:	eb 8f                	jmp    8010555b <_ZN3Map10extractMinEv+0x4b>
801055cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801055d0 <extractMinPriorityQueue>:
static Proc* extractMinPriorityQueue() {
801055d0:	55                   	push   %ebp
801055d1:	89 e5                	mov    %esp,%ebp
801055d3:	83 ec 04             	sub    $0x4,%esp
	return priorityQ->extractMin();
801055d6:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
801055db:	89 04 24             	mov    %eax,(%esp)
801055de:	e8 2d ff ff ff       	call   80105510 <_ZN3Map10extractMinEv>
}
801055e3:	c9                   	leave  
801055e4:	c3                   	ret    
801055e5:	90                   	nop
...
801055f0 <_ZN3Map8transferEv.part.1>:
...
801055f5:	89 c3                	mov    %eax,%ebx
801055f7:	83 ec 04             	sub    $0x4,%esp
801055fa:	eb 16                	jmp    80105612 <_ZN3Map8transferEv.part.1+0x22>
...
80105603:	e8 08 ff ff ff       	call   80105510 <_ZN3Map10extractMinEv>
	if(!freeLinks)
80105608:	8b 15 10 c6 10 80    	mov    0x8010c610,%edx
8010560e:	85 d2                	test   %edx,%edx
80105610:	75 0e                	jne    80105620 <_ZN3Map8transferEv.part.1+0x30>
	while(!isEmpty()) {
80105612:	8b 03                	mov    (%ebx),%eax
80105614:	85 c0                	test   %eax,%eax
80105616:	75 e8                	jne    80105600 <_ZN3Map8transferEv.part.1+0x10>
...
8010561f:	90                   	nop
	freeLinks = freeLinks->next;
80105620:	8b 72 04             	mov    0x4(%edx),%esi
		roundRobinQ->enqueue(p); //should succeed.
80105623:	8b 0d 18 c6 10 80    	mov    0x8010c618,%ecx
	ans->next = null;
80105629:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
	ans->p = p;
80105630:	89 02                	mov    %eax,(%edx)
	freeLinks = freeLinks->next;
80105632:	89 35 10 c6 10 80    	mov    %esi,0x8010c610
	if(isEmpty()) first = link;
80105638:	8b 31                	mov    (%ecx),%esi
8010563a:	85 f6                	test   %esi,%esi
8010563c:	74 22                	je     80105660 <_ZN3Map8transferEv.part.1+0x70>
	else last->next = link;
8010563e:	8b 41 04             	mov    0x4(%ecx),%eax
80105641:	89 50 04             	mov    %edx,0x4(%eax)
80105644:	eb 0c                	jmp    80105652 <_ZN3Map8transferEv.part.1+0x62>
80105646:	8d 76 00             	lea    0x0(%esi),%esi
80105649:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
	while(ans->next)
80105650:	89 c2                	mov    %eax,%edx
80105652:	8b 42 04             	mov    0x4(%edx),%eax
80105655:	85 c0                	test   %eax,%eax
80105657:	75 f7                	jne    80105650 <_ZN3Map8transferEv.part.1+0x60>
	last = link->getLast();
80105659:	89 51 04             	mov    %edx,0x4(%ecx)
8010565c:	eb b4                	jmp    80105612 <_ZN3Map8transferEv.part.1+0x22>
8010565e:	66 90                	xchg   %ax,%ax
	if(isEmpty()) first = link;
80105660:	89 11                	mov    %edx,(%ecx)
80105662:	eb ee                	jmp    80105652 <_ZN3Map8transferEv.part.1+0x62>
80105664:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010566a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80105670 <switchToRoundRobinPolicyPriorityQueue>:
	if(!roundRobinQ->isEmpty())
80105670:	8b 15 18 c6 10 80    	mov    0x8010c618,%edx
80105676:	8b 02                	mov    (%edx),%eax
80105678:	85 c0                	test   %eax,%eax
8010567a:	74 04                	je     80105680 <switchToRoundRobinPolicyPriorityQueue+0x10>
8010567c:	31 c0                	xor    %eax,%eax
}
8010567e:	c3                   	ret    
8010567f:	90                   	nop
80105680:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
static boolean switchToRoundRobinPolicyPriorityQueue() {
80105685:	55                   	push   %ebp
80105686:	89 e5                	mov    %esp,%ebp
80105688:	e8 63 ff ff ff       	call   801055f0 <_ZN3Map8transferEv.part.1>
}
8010568d:	5d                   	pop    %ebp
8010568e:	0f b6 c0             	movzbl %al,%eax
80105691:	c3                   	ret    
80105692:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105699:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801056a0 <_ZN3Map8transferEv>:
	return !first;
...
801056a9:	8b 45 08             	mov    0x8(%ebp),%eax
	if(!roundRobinQ->isEmpty())
801056ac:	8b 12                	mov    (%edx),%edx
801056ae:	85 d2                	test   %edx,%edx
801056b0:	74 0e                	je     801056c0 <_ZN3Map8transferEv+0x20>
}
...
801056c0:	5d                   	pop    %ebp
801056c1:	e9 2a ff ff ff       	jmp    801055f0 <_ZN3Map8transferEv.part.1>
801056c6:	8d 76 00             	lea    0x0(%esi),%esi
801056c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801056d0 <_ZN3Map11extractProcEP4proc>:
...
801056d5:	83 ec 30             	sub    $0x30,%esp
	if(!freeNodes)
801056d8:	8b 15 0c c6 10 80    	mov    0x8010c60c,%edx
bool Map::extractProc(Proc *p) {
801056de:	8b 5d 08             	mov    0x8(%ebp),%ebx
801056e1:	8b 75 0c             	mov    0xc(%ebp),%esi
	if(!freeNodes)
801056e4:	85 d2                	test   %edx,%edx
801056e6:	74 50                	je     80105738 <_ZN3Map11extractProcEP4proc+0x68>
...
801056e8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	...
	bool ans = false;
801056ef:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
801056f3:	eb 13                	jmp    80105708 <_ZN3Map11extractProcEP4proc+0x38>
801056f5:	8d 76 00             	lea    0x0(%esi),%esi
	Map tempMap;
	while(!isEmpty()) {
		Proc *otherP = extractMin();
801056f8:	89 1c 24             	mov    %ebx,(%esp)
801056fb:	e8 10 fe ff ff       	call   80105510 <_ZN3Map10extractMinEv>
		if(otherP != p)
80105700:	39 f0                	cmp    %esi,%eax
80105702:	75 1c                	jne    80105720 <_ZN3Map11extractProcEP4proc+0x50>
			tempMap.put(otherP); //should scucceed.
		else ans = true;
80105704:	c6 45 e7 01          	movb   $0x1,-0x19(%ebp)
	while(!isEmpty()) {
80105708:	8b 03                	mov    (%ebx),%eax
8010570a:	85 c0                	test   %eax,%eax
8010570c:	75 ea                	jne    801056f8 <_ZN3Map11extractProcEP4proc+0x28>
	}
	root = tempMap.root;
8010570e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105711:	89 03                	mov    %eax,(%ebx)
	return ans;
}
80105713:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105717:	83 c4 30             	add    $0x30,%esp
8010571a:	5b                   	pop    %ebx
8010571b:	5e                   	pop    %esi
8010571c:	5d                   	pop    %ebp
8010571d:	c3                   	ret    
...
8010572a:	e8 21 fd ff ff       	call   80105450 <_ZN3Map3putEP4proc>
8010572f:	eb d7                	jmp    80105708 <_ZN3Map11extractProcEP4proc+0x38>
80105731:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		return false;
80105738:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
}
8010573c:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105740:	83 c4 30             	add    $0x30,%esp
80105743:	5b                   	pop    %ebx
80105744:	5e                   	pop    %esi
80105745:	5d                   	pop    %ebp
80105746:	c3                   	ret    
...
80105750 <extractProcPriorityQueue>:
...
8010575d:	a1 1c c6 10 80       	mov    0x8010c61c,%eax
80105762:	89 04 24             	mov    %eax,(%esp)
80105765:	e8 66 ff ff ff       	call   801056d0 <_ZN3Map11extractProcEP4proc>
}
8010576a:	c9                   	leave  
	return priorityQ->extractProc(p);
...
80105776:	83 ec 2c             	sub    $0x2c,%esp
80105779:	8b 45 08             	mov    0x8(%ebp),%eax
8010577c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010577f:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105782:	8b 45 10             	mov    0x10(%ebp),%eax
80105785:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80105788:	8b 55 14             	mov    0x14(%ebp),%edx
8010578b:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010578e:	89 d7                	mov    %edx,%edi
	if(divisor == 0)
80105790:	09 c2                	or     %eax,%edx
80105792:	0f 84 9a 00 00 00    	je     80105832 <__moddi3+0xc2>
		panic((char*)"divide by zero!!!\n");

	bool isNumberNegative = false;
	if(number < 0) {
80105798:	8b 45 e4             	mov    -0x1c(%ebp),%eax
	bool isNumberNegative = false;
8010579b:	c6 45 df 00          	movb   $0x0,-0x21(%ebp)
	if(number < 0) {
8010579f:	85 c0                	test   %eax,%eax
801057a1:	79 0e                	jns    801057b1 <__moddi3+0x41>
		number = -number;
801057a3:	f7 5d e0             	negl   -0x20(%ebp)
		isNumberNegative = true;
801057a6:	c6 45 df 01          	movb   $0x1,-0x21(%ebp)
		number = -number;
801057aa:	83 55 e4 00          	adcl   $0x0,-0x1c(%ebp)
801057ae:	f7 5d e4             	negl   -0x1c(%ebp)
801057b1:	8b 55 d8             	mov    -0x28(%ebp),%edx
801057b4:	89 f8                	mov    %edi,%eax
801057b6:	c1 ff 1f             	sar    $0x1f,%edi
801057b9:	31 f8                	xor    %edi,%eax
801057bb:	89 f9                	mov    %edi,%ecx
801057bd:	31 fa                	xor    %edi,%edx
801057bf:	89 c7                	mov    %eax,%edi
801057c1:	8b 45 e0             	mov    -0x20(%ebp),%eax
801057c4:	89 d6                	mov    %edx,%esi
801057c6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801057c9:	29 ce                	sub    %ecx,%esi
801057cb:	19 cf                	sbb    %ecx,%edi
	if(divisor < 0)
		divisor = -divisor;
...
801057cd:	39 fa                	cmp    %edi,%edx
801057cf:	7d 1f                	jge    801057f0 <__moddi3+0x80>
...
801057d1:	80 7d df 00          	cmpb   $0x0,-0x21(%ebp)
801057d5:	74 07                	je     801057de <__moddi3+0x6e>
801057d7:	f7 d8                	neg    %eax
801057d9:	83 d2 00             	adc    $0x0,%edx
801057dc:	f7 da                	neg    %edx
	}
}
801057de:	83 c4 2c             	add    $0x2c,%esp
801057e1:	5b                   	pop    %ebx
801057e2:	5e                   	pop    %esi
801057e3:	5f                   	pop    %edi
801057e4:	5d                   	pop    %ebp
...
801057e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
		while(number >= divisor2) {
801057f0:	7f 04                	jg     801057f6 <__moddi3+0x86>
801057f2:	39 f0                	cmp    %esi,%eax
801057f4:	72 db                	jb     801057d1 <__moddi3+0x61>
801057f6:	89 f1                	mov    %esi,%ecx
801057f8:	89 fb                	mov    %edi,%ebx
801057fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
			number -= divisor2;
80105800:	29 c8                	sub    %ecx,%eax
80105802:	19 da                	sbb    %ebx,%edx
				divisor2 += divisor2;
80105804:	0f a4 cb 01          	shld   $0x1,%ecx,%ebx
80105808:	01 c9                	add    %ecx,%ecx
		while(number >= divisor2) {
8010580a:	39 da                	cmp    %ebx,%edx
8010580c:	7f f2                	jg     80105800 <__moddi3+0x90>
8010580e:	7d 18                	jge    80105828 <__moddi3+0xb8>
		if(number < divisor)
80105810:	39 d7                	cmp    %edx,%edi
80105812:	7c b9                	jl     801057cd <__moddi3+0x5d>
80105814:	7f bb                	jg     801057d1 <__moddi3+0x61>
80105816:	39 c6                	cmp    %eax,%esi
80105818:	76 b3                	jbe    801057cd <__moddi3+0x5d>
8010581a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105820:	eb af                	jmp    801057d1 <__moddi3+0x61>
80105822:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		while(number >= divisor2) {
80105828:	39 c8                	cmp    %ecx,%eax
8010582a:	73 d4                	jae    80105800 <__moddi3+0x90>
8010582c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105830:	eb de                	jmp    80105810 <__moddi3+0xa0>
		panic((char*)"divide by zero!!!\n");
80105832:	c7 04 24 9c 8e 10 80 	movl   $0x80108e9c,(%esp)
80105839:	e8 32 ab ff ff       	call   80100370 <panic>
8010583e:	66 90                	xchg   %ax,%ax

80105840 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80105841:	b8 af 8e 10 80       	mov    $0x80108eaf,%eax
{
80105846:	89 e5                	mov    %esp,%ebp
80105848:	53                   	push   %ebx
80105849:	83 ec 14             	sub    $0x14,%esp
8010584c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
8010584f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105853:	8d 43 04             	lea    0x4(%ebx),%eax
80105856:	89 04 24             	mov    %eax,(%esp)
80105859:	e8 12 01 00 00       	call   80105970 <initlock>
  lk->name = name;
8010585e:	8b 45 0c             	mov    0xc(%ebp),%eax
  lk->locked = 0;
80105861:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80105867:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
8010586e:	89 43 38             	mov    %eax,0x38(%ebx)
}
80105871:	83 c4 14             	add    $0x14,%esp
80105874:	5b                   	pop    %ebx
80105875:	5d                   	pop    %ebp
80105876:	c3                   	ret    
...
80105891:	e8 2a 02 00 00       	call   80105ac0 <acquire>
  while (lk->locked) {
80105896:	8b 13                	mov    (%ebx),%edx
80105898:	85 d2                	test   %edx,%edx
8010589a:	74 16                	je     801058b2 <acquiresleep+0x32>
8010589c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
801058a0:	89 74 24 04          	mov    %esi,0x4(%esp)
801058a4:	89 1c 24             	mov    %ebx,(%esp)
801058a7:	e8 c4 eb ff ff       	call   80104470 <sleep>
  while (lk->locked) {
801058ac:	8b 03                	mov    (%ebx),%eax
801058ae:	85 c0                	test   %eax,%eax
801058b0:	75 ee                	jne    801058a0 <acquiresleep+0x20>
  }
  lk->locked = 1;
801058b2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801058b8:	e8 e3 e0 ff ff       	call   801039a0 <myproc>
801058bd:	8b 40 10             	mov    0x10(%eax),%eax
801058c0:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
801058c3:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801058cb:	5d                   	pop    %ebp
  release(&lk->lk);
801058cc:	e9 8f 02 00 00       	jmp    80105b60 <release>
801058d1:	eb 0d                	jmp    801058e0 <releasesleep>
801058d3:	90                   	nop
801058d4:	90                   	nop
801058d5:	90                   	nop
801058d6:	90                   	nop
...
801058e6:	89 5d f8             	mov    %ebx,-0x8(%ebp)
801058e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
801058ec:	89 75 fc             	mov    %esi,-0x4(%ebp)
  acquire(&lk->lk);
801058ef:	8d 73 04             	lea    0x4(%ebx),%esi
801058f2:	89 34 24             	mov    %esi,(%esp)
801058f5:	e8 c6 01 00 00       	call   80105ac0 <acquire>
  lk->locked = 0;
801058fa:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80105900:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80105907:	89 1c 24             	mov    %ebx,(%esp)
8010590a:	e8 61 ed ff ff       	call   80104670 <wakeup>
  release(&lk->lk);
}
8010590f:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  release(&lk->lk);
80105912:	89 75 08             	mov    %esi,0x8(%ebp)
}
80105915:	8b 75 fc             	mov    -0x4(%ebp),%esi
80105918:	89 ec                	mov    %ebp,%esp
8010591a:	5d                   	pop    %ebp
  release(&lk->lk);
8010591b:	e9 40 02 00 00       	jmp    80105b60 <release>

80105920 <holdingsleep>:
...
80105926:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80105929:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010592c:	89 7d fc             	mov    %edi,-0x4(%ebp)
8010592f:	89 75 f8             	mov    %esi,-0x8(%ebp)
80105932:	31 f6                	xor    %esi,%esi
  int r;
  
  acquire(&lk->lk);
80105934:	8d 7b 04             	lea    0x4(%ebx),%edi
80105937:	89 3c 24             	mov    %edi,(%esp)
8010593a:	e8 81 01 00 00       	call   80105ac0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
8010593f:	8b 03                	mov    (%ebx),%eax
80105941:	85 c0                	test   %eax,%eax
80105943:	74 11                	je     80105956 <holdingsleep+0x36>
80105945:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80105948:	e8 53 e0 ff ff       	call   801039a0 <myproc>
8010594d:	39 58 10             	cmp    %ebx,0x10(%eax)
80105950:	0f 94 c0             	sete   %al
80105953:	0f b6 f0             	movzbl %al,%esi
  release(&lk->lk);
80105956:	89 3c 24             	mov    %edi,(%esp)
80105959:	e8 02 02 00 00       	call   80105b60 <release>
  return r;
}
8010595e:	89 f0                	mov    %esi,%eax
80105960:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105963:	8b 75 f8             	mov    -0x8(%ebp),%esi
80105966:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
80105973:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
80105976:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
80105979:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
8010597f:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80105982:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80105989:	5d                   	pop    %ebp
8010598a:	c3                   	ret    
8010598b:	90                   	nop
...
{
80105998:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010599b:	53                   	push   %ebx
  ebp = (uint*)v - 2;
8010599c:	83 e8 08             	sub    $0x8,%eax
8010599f:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801059a0:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
801059a6:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801059ac:	77 12                	ja     801059c0 <getcallerpcs+0x30>
      break;
    pcs[i] = ebp[1];     // saved %eip
801059ae:	8b 58 04             	mov    0x4(%eax),%ebx
801059b1:	89 1c 91             	mov    %ebx,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
801059b4:	42                   	inc    %edx
801059b5:	83 fa 0a             	cmp    $0xa,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
801059b8:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
801059ba:	75 e4                	jne    801059a0 <getcallerpcs+0x10>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
801059be:	c3                   	ret    
801059bf:	90                   	nop
801059c0:	8d 04 91             	lea    (%ecx,%edx,4),%eax
801059c3:	83 c1 28             	add    $0x28,%ecx
...
801059d6:	83 c0 04             	add    $0x4,%eax
  for(; i < 10; i++)
801059d9:	39 c1                	cmp    %eax,%ecx
801059db:	75 f3                	jne    801059d0 <getcallerpcs+0x40>
}
801059dd:	5b                   	pop    %ebx
801059de:	5d                   	pop    %ebp
801059df:	c3                   	ret    
...
801059e9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801059ea:	e8 11 df ff ff       	call   80103900 <mycpu>
801059ef:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
801059f5:	85 d2                	test   %edx,%edx
801059f7:	75 11                	jne    80105a0a <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
801059f9:	e8 02 df ff ff       	call   80103900 <mycpu>
801059fe:	81 e3 00 02 00 00    	and    $0x200,%ebx
80105a04:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
80105a0a:	e8 f1 de ff ff       	call   80103900 <mycpu>
80105a0f:	ff 80 a4 00 00 00    	incl   0xa4(%eax)
}
80105a15:	58                   	pop    %eax
80105a16:	5b                   	pop    %ebx
80105a17:	5d                   	pop    %ebp
...
80105a27:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80105a28:	f6 c4 02             	test   $0x2,%ah
80105a2b:	75 35                	jne    80105a62 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80105a2d:	e8 ce de ff ff       	call   80103900 <mycpu>
80105a32:	ff 88 a4 00 00 00    	decl   0xa4(%eax)
80105a38:	78 34                	js     80105a6e <popcli+0x4e>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105a3a:	e8 c1 de ff ff       	call   80103900 <mycpu>
80105a3f:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
80105a45:	85 d2                	test   %edx,%edx
80105a47:	74 07                	je     80105a50 <popcli+0x30>
    sti();
}
80105a49:	c9                   	leave  
80105a4a:	c3                   	ret    
...
80105a4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80105a50:	e8 ab de ff ff       	call   80103900 <mycpu>
80105a55:	8b 80 a8 00 00 00    	mov    0xa8(%eax),%eax
80105a5b:	85 c0                	test   %eax,%eax
80105a5d:	74 ea                	je     80105a49 <popcli+0x29>
  asm volatile("sti");
80105a5f:	fb                   	sti    
}
80105a60:	c9                   	leave  
80105a61:	c3                   	ret    
    panic("popcli - interruptible");
80105a62:	c7 04 24 ba 8e 10 80 	movl   $0x80108eba,(%esp)
80105a69:	e8 02 a9 ff ff       	call   80100370 <panic>
    panic("popcli");
80105a6e:	c7 04 24 d1 8e 10 80 	movl   $0x80108ed1,(%esp)
80105a75:	e8 f6 a8 ff ff       	call   80100370 <panic>
...
80105a86:	89 75 fc             	mov    %esi,-0x4(%ebp)
80105a89:	8b 75 08             	mov    0x8(%ebp),%esi
80105a8c:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80105a8f:	31 db                	xor    %ebx,%ebx
  pushcli();
80105a91:	e8 4a ff ff ff       	call   801059e0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80105a96:	8b 06                	mov    (%esi),%eax
80105a98:	85 c0                	test   %eax,%eax
80105a9a:	74 10                	je     80105aac <holding+0x2c>
80105a9c:	8b 5e 08             	mov    0x8(%esi),%ebx
80105a9f:	e8 5c de ff ff       	call   80103900 <mycpu>
80105aa4:	39 c3                	cmp    %eax,%ebx
80105aa6:	0f 94 c3             	sete   %bl
80105aa9:	0f b6 db             	movzbl %bl,%ebx
  popcli();
80105aac:	e8 6f ff ff ff       	call   80105a20 <popcli>
}
80105ab1:	89 d8                	mov    %ebx,%eax
80105ab3:	8b 75 fc             	mov    -0x4(%ebp),%esi
80105ab6:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105ab9:	89 ec                	mov    %ebp,%esp
80105abb:	5d                   	pop    %ebp
80105abc:	c3                   	ret    
...
80105ac8:	e8 13 ff ff ff       	call   801059e0 <pushcli>
  if(holding(lk))
80105acd:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105ad0:	89 1c 24             	mov    %ebx,(%esp)
80105ad3:	e8 a8 ff ff ff       	call   80105a80 <holding>
80105ad8:	85 c0                	test   %eax,%eax
80105ada:	75 78                	jne    80105b54 <acquire+0x94>
80105adc:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80105ade:	ba 01 00 00 00       	mov    $0x1,%edx
80105ae3:	eb 06                	jmp    80105aeb <acquire+0x2b>
80105ae5:	8d 76 00             	lea    0x0(%esi),%esi
80105ae8:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105aeb:	89 d0                	mov    %edx,%eax
80105aed:	f0 87 03             	lock xchg %eax,(%ebx)
  while(xchg(&lk->locked, 1) != 0)
80105af0:	85 c0                	test   %eax,%eax
80105af2:	75 f4                	jne    80105ae8 <acquire+0x28>
  __sync_synchronize();
80105af4:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80105af9:	8b 5d 08             	mov    0x8(%ebp),%ebx
80105afc:	e8 ff dd ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80105b01:	8d 53 0c             	lea    0xc(%ebx),%edx
  lk->cpu = mycpu();
80105b04:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
80105b07:	89 e8                	mov    %ebp,%eax
80105b09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80105b10:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
80105b16:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80105b1c:	77 1a                	ja     80105b38 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
80105b1e:	8b 48 04             	mov    0x4(%eax),%ecx
80105b21:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
  for(i = 0; i < 10; i++){
80105b24:	46                   	inc    %esi
80105b25:	83 fe 0a             	cmp    $0xa,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80105b28:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80105b2a:	75 e4                	jne    80105b10 <acquire+0x50>
}
...
80105b38:	8d 04 b2             	lea    (%edx,%esi,4),%eax
80105b3b:	83 c2 28             	add    $0x28,%edx
80105b3e:	66 90                	xchg   %ax,%ax
    pcs[i] = 0;
80105b40:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80105b46:	83 c0 04             	add    $0x4,%eax
  for(; i < 10; i++)
80105b49:	39 d0                	cmp    %edx,%eax
80105b4b:	75 f3                	jne    80105b40 <acquire+0x80>
}
...
80105b53:	c3                   	ret    
    panic("acquire");
80105b54:	c7 04 24 d8 8e 10 80 	movl   $0x80108ed8,(%esp)
80105b5b:	e8 10 a8 ff ff       	call   80100370 <panic>
...
80105b67:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
80105b6a:	89 1c 24             	mov    %ebx,(%esp)
80105b6d:	e8 0e ff ff ff       	call   80105a80 <holding>
80105b72:	85 c0                	test   %eax,%eax
80105b74:	74 23                	je     80105b99 <release+0x39>
  lk->pcs[0] = 0;
80105b76:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80105b7d:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80105b84:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80105b89:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80105b8f:	83 c4 14             	add    $0x14,%esp
80105b92:	5b                   	pop    %ebx
80105b93:	5d                   	pop    %ebp
  popcli();
80105b94:	e9 87 fe ff ff       	jmp    80105a20 <popcli>
    panic("release");
80105b99:	c7 04 24 e0 8e 10 80 	movl   $0x80108ee0,(%esp)
80105ba0:	e8 cb a7 ff ff       	call   80100370 <panic>
...
80105bb6:	8b 55 08             	mov    0x8(%ebp),%edx
80105bb9:	89 5d f8             	mov    %ebx,-0x8(%ebp)
80105bbc:	8b 4d 10             	mov    0x10(%ebp),%ecx
80105bbf:	89 7d fc             	mov    %edi,-0x4(%ebp)
  if ((int)dst%4 == 0 && n%4 == 0){
80105bc2:	f6 c2 03             	test   $0x3,%dl
80105bc5:	75 05                	jne    80105bcc <memset+0x1c>
80105bc7:	f6 c1 03             	test   $0x3,%cl
80105bca:	74 14                	je     80105be0 <memset+0x30>
  asm volatile("cld; rep stosb" :
80105bcc:	89 d7                	mov    %edx,%edi
80105bce:	8b 45 0c             	mov    0xc(%ebp),%eax
80105bd1:	fc                   	cld    
80105bd2:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80105bd4:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105bd7:	89 d0                	mov    %edx,%eax
80105bd9:	8b 7d fc             	mov    -0x4(%ebp),%edi
80105bdc:	89 ec                	mov    %ebp,%esp
80105bde:	5d                   	pop    %ebp
80105bdf:	c3                   	ret    
    c &= 0xFF;
80105be0:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105be4:	c1 e9 02             	shr    $0x2,%ecx
80105be7:	89 f8                	mov    %edi,%eax
80105be9:	89 fb                	mov    %edi,%ebx
80105beb:	c1 e0 18             	shl    $0x18,%eax
80105bee:	c1 e3 10             	shl    $0x10,%ebx
80105bf1:	09 d8                	or     %ebx,%eax
80105bf3:	09 f8                	or     %edi,%eax
80105bf5:	c1 e7 08             	shl    $0x8,%edi
80105bf8:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80105bfa:	89 d7                	mov    %edx,%edi
80105bfc:	fc                   	cld    
80105bfd:	f3 ab                	rep stos %eax,%es:(%edi)
}
80105bff:	8b 5d f8             	mov    -0x8(%ebp),%ebx
80105c02:	89 d0                	mov    %edx,%eax
80105c04:	8b 7d fc             	mov    -0x4(%ebp),%edi
80105c07:	89 ec                	mov    %ebp,%esp
80105c09:	5d                   	pop    %ebp
80105c0a:	c3                   	ret    
80105c0b:	90                   	nop
...
80105c14:	8b 7d 0c             	mov    0xc(%ebp),%edi
80105c17:	56                   	push   %esi
80105c18:	8b 75 08             	mov    0x8(%ebp),%esi
...
80105c21:	74 27                	je     80105c4a <memcmp+0x3a>
    if(*s1 != *s2)
80105c23:	0f b6 16             	movzbl (%esi),%edx
80105c26:	0f b6 0f             	movzbl (%edi),%ecx
80105c29:	38 d1                	cmp    %dl,%cl
80105c2b:	75 2b                	jne    80105c58 <memcmp+0x48>
80105c2d:	b8 01 00 00 00       	mov    $0x1,%eax
80105c32:	eb 12                	jmp    80105c46 <memcmp+0x36>
80105c34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105c38:	0f b6 14 06          	movzbl (%esi,%eax,1),%edx
80105c3c:	40                   	inc    %eax
80105c3d:	0f b6 4c 07 ff       	movzbl -0x1(%edi,%eax,1),%ecx
80105c42:	38 ca                	cmp    %cl,%dl
80105c44:	75 12                	jne    80105c58 <memcmp+0x48>
  while(n-- > 0){
80105c46:	39 d8                	cmp    %ebx,%eax
80105c48:	75 ee                	jne    80105c38 <memcmp+0x28>
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105c58:	5b                   	pop    %ebx
      return *s1 - *s2;
80105c59:	0f b6 c2             	movzbl %dl,%eax
80105c5c:	29 c8                	sub    %ecx,%eax
}
80105c5e:	5e                   	pop    %esi
80105c5f:	5f                   	pop    %edi
80105c60:	5d                   	pop    %ebp
...
80105c78:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80105c7b:	8b 75 10             	mov    0x10(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105c7e:	39 c3                	cmp    %eax,%ebx
80105c80:	73 26                	jae    80105ca8 <memmove+0x38>
80105c82:	8d 0c 33             	lea    (%ebx,%esi,1),%ecx
80105c85:	39 c8                	cmp    %ecx,%eax
80105c87:	73 1f                	jae    80105ca8 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80105c89:	85 f6                	test   %esi,%esi
80105c8b:	8d 56 ff             	lea    -0x1(%esi),%edx
80105c8e:	74 0d                	je     80105c9d <memmove+0x2d>
      *--d = *--s;
80105c90:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
80105c94:	88 0c 10             	mov    %cl,(%eax,%edx,1)
    while(n-- > 0)
80105c97:	4a                   	dec    %edx
80105c98:	83 fa ff             	cmp    $0xffffffff,%edx
80105c9b:	75 f3                	jne    80105c90 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80105ca1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    while(n-- > 0)
80105ca8:	31 d2                	xor    %edx,%edx
80105caa:	85 f6                	test   %esi,%esi
80105cac:	74 ef                	je     80105c9d <memmove+0x2d>
80105cae:	66 90                	xchg   %ax,%ax
      *d++ = *s++;
80105cb0:	0f b6 0c 13          	movzbl (%ebx,%edx,1),%ecx
80105cb4:	88 0c 10             	mov    %cl,(%eax,%edx,1)
80105cb7:	42                   	inc    %edx
    while(n-- > 0)
80105cb8:	39 d6                	cmp    %edx,%esi
80105cba:	75 f4                	jne    80105cb0 <memmove+0x40>
}
80105cbc:	5b                   	pop    %ebx
80105cbd:	5e                   	pop    %esi
80105cbe:	5d                   	pop    %ebp
...
80105cc3:	5d                   	pop    %ebp
  return memmove(dst, src, n);
80105cc4:	eb aa                	jmp    80105c70 <memmove>
...
80105cd4:	8b 7d 10             	mov    0x10(%ebp),%edi
80105cd7:	56                   	push   %esi
80105cd8:	8b 75 0c             	mov    0xc(%ebp),%esi
80105cdb:	53                   	push   %ebx
80105cdc:	8b 5d 08             	mov    0x8(%ebp),%ebx
  while(n > 0 && *p && *p == *q)
80105cdf:	85 ff                	test   %edi,%edi
80105ce1:	74 2d                	je     80105d10 <strncmp+0x40>
80105ce3:	0f b6 03             	movzbl (%ebx),%eax
80105ce6:	0f b6 0e             	movzbl (%esi),%ecx
80105ce9:	84 c0                	test   %al,%al
80105ceb:	74 37                	je     80105d24 <strncmp+0x54>
80105ced:	38 c1                	cmp    %al,%cl
80105cef:	75 33                	jne    80105d24 <strncmp+0x54>
80105cf1:	01 f7                	add    %esi,%edi
80105cf3:	eb 13                	jmp    80105d08 <strncmp+0x38>
80105cf5:	8d 76 00             	lea    0x0(%esi),%esi
80105cf8:	0f b6 03             	movzbl (%ebx),%eax
80105cfb:	84 c0                	test   %al,%al
80105cfd:	74 21                	je     80105d20 <strncmp+0x50>
80105cff:	0f b6 0a             	movzbl (%edx),%ecx
80105d02:	89 d6                	mov    %edx,%esi
80105d04:	38 c8                	cmp    %cl,%al
80105d06:	75 1c                	jne    80105d24 <strncmp+0x54>
    n--, p++, q++;
80105d08:	8d 56 01             	lea    0x1(%esi),%edx
80105d0b:	43                   	inc    %ebx
  while(n > 0 && *p && *p == *q)
80105d0c:	39 fa                	cmp    %edi,%edx
80105d0e:	75 e8                	jne    80105cf8 <strncmp+0x28>
  if(n == 0)
    return 0;
...
80105d20:	0f b6 4e 01          	movzbl 0x1(%esi),%ecx
80105d24:	5b                   	pop    %ebx
  return (uchar)*p - (uchar)*q;
80105d25:	29 c8                	sub    %ecx,%eax
}
80105d27:	5e                   	pop    %esi
80105d28:	5f                   	pop    %edi
80105d29:	5d                   	pop    %ebp
...
80105d37:	8b 4d 10             	mov    0x10(%ebp),%ecx
80105d3a:	53                   	push   %ebx
80105d3b:	8b 75 0c             	mov    0xc(%ebp),%esi
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80105d3e:	89 c2                	mov    %eax,%edx
80105d40:	eb 15                	jmp    80105d57 <strncpy+0x27>
80105d42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105d48:	46                   	inc    %esi
80105d49:	0f b6 4e ff          	movzbl -0x1(%esi),%ecx
80105d4d:	42                   	inc    %edx
80105d4e:	84 c9                	test   %cl,%cl
80105d50:	88 4a ff             	mov    %cl,-0x1(%edx)
80105d53:	74 09                	je     80105d5e <strncpy+0x2e>
80105d55:	89 d9                	mov    %ebx,%ecx
80105d57:	85 c9                	test   %ecx,%ecx
80105d59:	8d 59 ff             	lea    -0x1(%ecx),%ebx
80105d5c:	7f ea                	jg     80105d48 <strncpy+0x18>
    ;
  while(n-- > 0)
80105d5e:	31 c9                	xor    %ecx,%ecx
80105d60:	85 db                	test   %ebx,%ebx
80105d62:	7e 19                	jle    80105d7d <strncpy+0x4d>
80105d64:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105d6a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
    *s++ = 0;
80105d70:	c6 04 0a 00          	movb   $0x0,(%edx,%ecx,1)
80105d74:	89 de                	mov    %ebx,%esi
80105d76:	41                   	inc    %ecx
80105d77:	29 ce                	sub    %ecx,%esi
  while(n-- > 0)
80105d79:	85 f6                	test   %esi,%esi
80105d7b:	7f f3                	jg     80105d70 <strncpy+0x40>
  return os;
}
80105d7d:	5b                   	pop    %ebx
80105d7e:	5e                   	pop    %esi
80105d7f:	5d                   	pop    %ebp
80105d80:	c3                   	ret    
80105d81:	eb 0d                	jmp    80105d90 <safestrcpy>
80105d83:	90                   	nop
80105d84:	90                   	nop
80105d85:	90                   	nop
80105d86:	90                   	nop
...
80105d93:	8b 4d 10             	mov    0x10(%ebp),%ecx
80105d96:	56                   	push   %esi
80105d97:	8b 45 08             	mov    0x8(%ebp),%eax
...
80105da0:	7e 22                	jle    80105dc4 <safestrcpy+0x34>
80105da2:	8d 74 0a ff          	lea    -0x1(%edx,%ecx,1),%esi
80105da6:	89 c1                	mov    %eax,%ecx
80105da8:	eb 13                	jmp    80105dbd <safestrcpy+0x2d>
80105daa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80105db0:	42                   	inc    %edx
80105db1:	0f b6 5a ff          	movzbl -0x1(%edx),%ebx
80105db5:	41                   	inc    %ecx
80105db6:	84 db                	test   %bl,%bl
80105db8:	88 59 ff             	mov    %bl,-0x1(%ecx)
80105dbb:	74 04                	je     80105dc1 <safestrcpy+0x31>
80105dbd:	39 f2                	cmp    %esi,%edx
80105dbf:	75 ef                	jne    80105db0 <safestrcpy+0x20>
    ;
  *s = 0;
80105dc1:	c6 01 00             	movb   $0x0,(%ecx)
  return os;
}
80105dc4:	5b                   	pop    %ebx
80105dc5:	5e                   	pop    %esi
...
80105ddb:	74 0a                	je     80105de7 <strlen+0x17>
80105ddd:	8d 76 00             	lea    0x0(%esi),%esi
80105de0:	40                   	inc    %eax
80105de1:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80105de5:	75 f9                	jne    80105de0 <strlen+0x10>
    ;
  return n;
}
80105de7:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80105de9:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105ded:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105df4:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105df5:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80105df7:	89 d4                	mov    %edx,%esp
...
80105e07:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80105e0a:	e8 91 db ff ff       	call   801039a0 <myproc>
...
80105e51:	76 27                	jbe    80105e7a <fetchstr+0x3a>
    return -1;
  *pp = (char*)addr;
80105e53:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105e56:	89 da                	mov    %ebx,%edx
80105e58:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80105e5a:	8b 00                	mov    (%eax),%eax
  for(s = *pp; s < ep; s++){
80105e5c:	39 c3                	cmp    %eax,%ebx
80105e5e:	73 1a                	jae    80105e7a <fetchstr+0x3a>
    if(*s == 0)
80105e60:	80 3b 00             	cmpb   $0x0,(%ebx)
80105e63:	75 10                	jne    80105e75 <fetchstr+0x35>
80105e65:	eb 29                	jmp    80105e90 <fetchstr+0x50>
80105e67:	89 f6                	mov    %esi,%esi
80105e69:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80105e70:	80 3a 00             	cmpb   $0x0,(%edx)
80105e73:	74 13                	je     80105e88 <fetchstr+0x48>
  for(s = *pp; s < ep; s++){
80105e75:	42                   	inc    %edx
80105e76:	39 d0                	cmp    %edx,%eax
80105e78:	77 f6                	ja     80105e70 <fetchstr+0x30>
    return -1;
...
80105e90:	31 c0                	xor    %eax,%eax
      return s - *pp;
80105e92:	eb eb                	jmp    80105e7f <fetchstr+0x3f>
80105e94:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105e9a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80105ea5:	e8 f6 da ff ff       	call   801039a0 <myproc>
80105eaa:	8b 55 08             	mov    0x8(%ebp),%edx
80105ead:	8b 40 18             	mov    0x18(%eax),%eax
80105eb0:	8b 40 44             	mov    0x44(%eax),%eax
80105eb3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105eb6:	e8 e5 da ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80105ebb:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80105ebe:	8b 00                	mov    (%eax),%eax
80105ec0:	39 c6                	cmp    %eax,%esi
80105ec2:	73 1c                	jae    80105ee0 <argint+0x40>
80105ec4:	8d 53 08             	lea    0x8(%ebx),%edx
80105ec7:	39 d0                	cmp    %edx,%eax
80105ec9:	72 15                	jb     80105ee0 <argint+0x40>
  *ip = *(int*)(addr);
80105ecb:	8b 45 0c             	mov    0xc(%ebp),%eax
80105ece:	8b 53 04             	mov    0x4(%ebx),%edx
80105ed1:	89 10                	mov    %edx,(%eax)
  return 0;
80105ed3:	31 c0                	xor    %eax,%eax
}
80105ed5:	5b                   	pop    %ebx
80105ed6:	5e                   	pop    %esi
80105ed7:	5d                   	pop    %ebp
...
80105ee0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80105ee5:	eb ee                	jmp    80105ed5 <argint+0x35>
...
80105ef5:	83 ec 20             	sub    $0x20,%esp
80105ef8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80105efb:	e8 a0 da ff ff       	call   801039a0 <myproc>
...
80105f0f:	e8 8c ff ff ff       	call   80105ea0 <argint>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80105f14:	c1 e8 1f             	shr    $0x1f,%eax
80105f17:	84 c0                	test   %al,%al
80105f19:	75 2d                	jne    80105f48 <argptr+0x58>
80105f1b:	89 d8                	mov    %ebx,%eax
80105f1d:	c1 e8 1f             	shr    $0x1f,%eax
80105f20:	84 c0                	test   %al,%al
80105f22:	75 24                	jne    80105f48 <argptr+0x58>
80105f24:	8b 16                	mov    (%esi),%edx
80105f26:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f29:	39 c2                	cmp    %eax,%edx
80105f2b:	76 1b                	jbe    80105f48 <argptr+0x58>
80105f2d:	01 c3                	add    %eax,%ebx
80105f2f:	39 da                	cmp    %ebx,%edx
80105f31:	72 15                	jb     80105f48 <argptr+0x58>
    return -1;
  *pp = (char*)i;
80105f33:	8b 55 0c             	mov    0xc(%ebp),%edx
80105f36:	89 02                	mov    %eax,(%edx)
  return 0;
80105f38:	31 c0                	xor    %eax,%eax
}
...
80105f4d:	eb eb                	jmp    80105f3a <argptr+0x4a>
80105f4f:	90                   	nop
...
80105f63:	e8 38 ff ff ff       	call   80105ea0 <argint>
80105f68:	85 c0                	test   %eax,%eax
80105f6a:	78 14                	js     80105f80 <argstr+0x30>
    return -1;
...
80105f79:	e8 c2 fe ff ff       	call   80105e40 <fetchstr>
}
80105f7e:	c9                   	leave  
80105f7f:	c3                   	ret    
    return -1;
...
80105f94:	83 ec 14             	sub    $0x14,%esp
  int num;
  struct proc *curproc = myproc();
80105f97:	e8 04 da ff ff       	call   801039a0 <myproc>
80105f9c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80105f9e:	8b 40 18             	mov    0x18(%eax),%eax
80105fa1:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105fa4:	8d 50 ff             	lea    -0x1(%eax),%edx
80105fa7:	83 fa 18             	cmp    $0x18,%edx
80105faa:	77 1c                	ja     80105fc8 <syscall+0x38>
80105fac:	8b 14 85 20 8f 10 80 	mov    -0x7fef70e0(,%eax,4),%edx
80105fb3:	85 d2                	test   %edx,%edx
80105fb5:	74 11                	je     80105fc8 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80105fb7:	ff d2                	call   *%edx
80105fb9:	8b 53 18             	mov    0x18(%ebx),%edx
80105fbc:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80105fc5:	8d 76 00             	lea    0x0(%esi),%esi
    cprintf("%d %s: unknown sys call %d\n",
80105fc8:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
80105fcc:	8d 43 6c             	lea    0x6c(%ebx),%eax
80105fcf:	89 44 24 08          	mov    %eax,0x8(%esp)
    cprintf("%d %s: unknown sys call %d\n",
80105fd3:	8b 43 10             	mov    0x10(%ebx),%eax
80105fd6:	c7 04 24 e8 8e 10 80 	movl   $0x80108ee8,(%esp)
80105fdd:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fe1:	e8 6a a6 ff ff       	call   80100650 <cprintf>
    curproc->tf->eax = -1;
80105fe6:	8b 43 18             	mov    0x18(%ebx),%eax
80105fe9:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80106001:	0f bf d2             	movswl %dx,%edx
80106004:	89 e5                	mov    %esp,%ebp
80106006:	83 ec 58             	sub    $0x58,%esp
80106009:	89 7d fc             	mov    %edi,-0x4(%ebp)
8010600c:	0f bf 7d 08          	movswl 0x8(%ebp),%edi
80106010:	0f bf c9             	movswl %cx,%ecx
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80106019:	89 75 f8             	mov    %esi,-0x8(%ebp)
8010601c:	89 7d bc             	mov    %edi,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010601f:	8d 7d da             	lea    -0x26(%ebp),%edi
80106022:	89 7c 24 04          	mov    %edi,0x4(%esp)
{
80106026:	89 55 c4             	mov    %edx,-0x3c(%ebp)
80106029:	89 4d c0             	mov    %ecx,-0x40(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010602c:	e8 bf bf ff ff       	call   80101ff0 <nameiparent>
80106031:	85 c0                	test   %eax,%eax
80106033:	0f 84 4f 01 00 00    	je     80106188 <create+0x188>
    return 0;
  ilock(dp);
80106039:	89 04 24             	mov    %eax,(%esp)
8010603c:	89 c3                	mov    %eax,%ebx
8010603e:	e8 ad b6 ff ff       	call   801016f0 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80106043:	8d 45 d4             	lea    -0x2c(%ebp),%eax
80106046:	89 44 24 08          	mov    %eax,0x8(%esp)
8010604a:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010604e:	89 1c 24             	mov    %ebx,(%esp)
80106051:	e8 1a bc ff ff       	call   80101c70 <dirlookup>
80106056:	85 c0                	test   %eax,%eax
80106058:	89 c6                	mov    %eax,%esi
8010605a:	74 34                	je     80106090 <create+0x90>
    iunlockput(dp);
8010605c:	89 1c 24             	mov    %ebx,(%esp)
8010605f:	e8 1c b9 ff ff       	call   80101980 <iunlockput>
    ilock(ip);
80106064:	89 34 24             	mov    %esi,(%esp)
80106067:	e8 84 b6 ff ff       	call   801016f0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010606c:	83 7d c4 02          	cmpl   $0x2,-0x3c(%ebp)
80106070:	0f 85 9a 00 00 00    	jne    80106110 <create+0x110>
80106076:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
8010607b:	0f 85 8f 00 00 00    	jne    80106110 <create+0x110>
...
80106081:	89 f0                	mov    %esi,%eax
80106083:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80106086:	8b 75 f8             	mov    -0x8(%ebp),%esi
80106089:	8b 7d fc             	mov    -0x4(%ebp),%edi
8010608c:	89 ec                	mov    %ebp,%esp
8010608e:	5d                   	pop    %ebp
8010608f:	c3                   	ret    
  if((ip = ialloc(dp->dev, type)) == 0)
80106090:	8b 45 c4             	mov    -0x3c(%ebp),%eax
80106093:	89 44 24 04          	mov    %eax,0x4(%esp)
80106097:	8b 03                	mov    (%ebx),%eax
80106099:	89 04 24             	mov    %eax,(%esp)
8010609c:	e8 cf b4 ff ff       	call   80101570 <ialloc>
801060a1:	85 c0                	test   %eax,%eax
801060a3:	89 c6                	mov    %eax,%esi
801060a5:	0f 84 f0 00 00 00    	je     8010619b <create+0x19b>
  ilock(ip);
801060ab:	89 04 24             	mov    %eax,(%esp)
801060ae:	e8 3d b6 ff ff       	call   801016f0 <ilock>
  ip->major = major;
801060b3:	8b 45 c0             	mov    -0x40(%ebp),%eax
  ip->nlink = 1;
801060b6:	66 c7 46 56 01 00    	movw   $0x1,0x56(%esi)
  ip->major = major;
801060bc:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801060c0:	8b 45 bc             	mov    -0x44(%ebp),%eax
801060c3:	66 89 46 54          	mov    %ax,0x54(%esi)
  iupdate(ip);
801060c7:	89 34 24             	mov    %esi,(%esp)
801060ca:	e8 61 b5 ff ff       	call   80101630 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801060cf:	83 7d c4 01          	cmpl   $0x1,-0x3c(%ebp)
801060d3:	74 5b                	je     80106130 <create+0x130>
  if(dirlink(dp, name, ip->inum) < 0)
801060d5:	8b 46 04             	mov    0x4(%esi),%eax
801060d8:	89 7c 24 04          	mov    %edi,0x4(%esp)
801060dc:	89 1c 24             	mov    %ebx,(%esp)
801060df:	89 44 24 08          	mov    %eax,0x8(%esp)
801060e3:	e8 08 be ff ff       	call   80101ef0 <dirlink>
801060e8:	85 c0                	test   %eax,%eax
801060ea:	0f 88 9f 00 00 00    	js     8010618f <create+0x18f>
  iunlockput(dp);
801060f0:	89 1c 24             	mov    %ebx,(%esp)
801060f3:	e8 88 b8 ff ff       	call   80101980 <iunlockput>
}
801060f8:	89 f0                	mov    %esi,%eax
801060fa:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801060fd:	8b 75 f8             	mov    -0x8(%ebp),%esi
80106100:	8b 7d fc             	mov    -0x4(%ebp),%edi
80106103:	89 ec                	mov    %ebp,%esp
80106105:	5d                   	pop    %ebp
80106106:	c3                   	ret    
...
80106110:	89 34 24             	mov    %esi,(%esp)
    return 0;
80106113:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80106115:	e8 66 b8 ff ff       	call   80101980 <iunlockput>
}
8010611a:	89 f0                	mov    %esi,%eax
8010611c:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010611f:	8b 75 f8             	mov    -0x8(%ebp),%esi
80106122:	8b 7d fc             	mov    -0x4(%ebp),%edi
80106125:	89 ec                	mov    %ebp,%esp
80106127:	5d                   	pop    %ebp
80106128:	c3                   	ret    
80106129:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink++;  // for ".."
80106130:	66 ff 43 56          	incw   0x56(%ebx)
    iupdate(dp);
80106134:	89 1c 24             	mov    %ebx,(%esp)
80106137:	e8 f4 b4 ff ff       	call   80101630 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010613c:	8b 46 04             	mov    0x4(%esi),%eax
8010613f:	ba a4 8f 10 80       	mov    $0x80108fa4,%edx
80106144:	89 54 24 04          	mov    %edx,0x4(%esp)
80106148:	89 34 24             	mov    %esi,(%esp)
8010614b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010614f:	e8 9c bd ff ff       	call   80101ef0 <dirlink>
80106154:	85 c0                	test   %eax,%eax
80106156:	78 20                	js     80106178 <create+0x178>
80106158:	8b 43 04             	mov    0x4(%ebx),%eax
8010615b:	89 34 24             	mov    %esi,(%esp)
8010615e:	89 44 24 08          	mov    %eax,0x8(%esp)
80106162:	b8 a3 8f 10 80       	mov    $0x80108fa3,%eax
80106167:	89 44 24 04          	mov    %eax,0x4(%esp)
8010616b:	e8 80 bd ff ff       	call   80101ef0 <dirlink>
80106170:	85 c0                	test   %eax,%eax
80106172:	0f 89 5d ff ff ff    	jns    801060d5 <create+0xd5>
      panic("create dots");
80106178:	c7 04 24 97 8f 10 80 	movl   $0x80108f97,(%esp)
8010617f:	e8 ec a1 ff ff       	call   80100370 <panic>
80106184:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return 0;
80106188:	31 f6                	xor    %esi,%esi
8010618a:	e9 f2 fe ff ff       	jmp    80106081 <create+0x81>
    panic("create: dirlink");
8010618f:	c7 04 24 a6 8f 10 80 	movl   $0x80108fa6,(%esp)
80106196:	e8 d5 a1 ff ff       	call   80100370 <panic>
    panic("create: ialloc");
8010619b:	c7 04 24 88 8f 10 80 	movl   $0x80108f88,(%esp)
801061a2:	e8 c9 a1 ff ff       	call   80100370 <panic>
801061a7:	89 f6                	mov    %esi,%esi
801061a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

801061b0 <argfd.constprop.0>:
argfd(int n, int *pfd, struct file **pf)
801061b0:	55                   	push   %ebp
801061b1:	89 e5                	mov    %esp,%ebp
801061b3:	56                   	push   %esi
801061b4:	89 d6                	mov    %edx,%esi
801061b6:	53                   	push   %ebx
801061b7:	89 c3                	mov    %eax,%ebx
...
801061ca:	e8 d1 fc ff ff       	call   80105ea0 <argint>
801061cf:	85 c0                	test   %eax,%eax
801061d1:	78 2d                	js     80106200 <argfd.constprop.0+0x50>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
801061d3:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
801061d7:	77 27                	ja     80106200 <argfd.constprop.0+0x50>
801061d9:	e8 c2 d7 ff ff       	call   801039a0 <myproc>
801061de:	8b 55 f4             	mov    -0xc(%ebp),%edx
801061e1:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
801061e5:	85 c0                	test   %eax,%eax
801061e7:	74 17                	je     80106200 <argfd.constprop.0+0x50>
  if(pfd)
801061e9:	85 db                	test   %ebx,%ebx
801061eb:	74 02                	je     801061ef <argfd.constprop.0+0x3f>
    *pfd = fd;
801061ed:	89 13                	mov    %edx,(%ebx)
    *pf = f;
801061ef:	89 06                	mov    %eax,(%esi)
  return 0;
801061f1:	31 c0                	xor    %eax,%eax
}
801061f3:	83 c4 20             	add    $0x20,%esp
801061f6:	5b                   	pop    %ebx
801061f7:	5e                   	pop    %esi
801061f8:	5d                   	pop    %ebp
801061f9:	c3                   	ret    
...
80106205:	eb ec                	jmp    801061f3 <argfd.constprop.0+0x43>
...
80106217:	83 ec 20             	sub    $0x20,%esp
  if(argfd(0, 0, &f) < 0)
8010621a:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010621d:	e8 8e ff ff ff       	call   801061b0 <argfd.constprop.0>
80106222:	85 c0                	test   %eax,%eax
80106224:	78 3a                	js     80106260 <sys_dup+0x50>
  if((fd=fdalloc(f)) < 0)
80106226:	8b 75 f4             	mov    -0xc(%ebp),%esi
  for(fd = 0; fd < NOFILE; fd++){
80106229:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010622b:	e8 70 d7 ff ff       	call   801039a0 <myproc>
80106230:	eb 0c                	jmp    8010623e <sys_dup+0x2e>
80106232:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80106238:	43                   	inc    %ebx
80106239:	83 fb 10             	cmp    $0x10,%ebx
8010623c:	74 22                	je     80106260 <sys_dup+0x50>
    if(curproc->ofile[fd] == 0){
8010623e:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
80106242:	85 d2                	test   %edx,%edx
80106244:	75 f2                	jne    80106238 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80106246:	89 74 98 28          	mov    %esi,0x28(%eax,%ebx,4)
  filedup(f);
8010624a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010624d:	89 04 24             	mov    %eax,(%esp)
80106250:	e8 8b ab ff ff       	call   80100de0 <filedup>
}
80106255:	83 c4 20             	add    $0x20,%esp
80106258:	89 d8                	mov    %ebx,%eax
8010625a:	5b                   	pop    %ebx
8010625b:	5e                   	pop    %esi
8010625c:	5d                   	pop    %ebp
8010625d:	c3                   	ret    
8010625e:	66 90                	xchg   %ax,%ax
80106260:	83 c4 20             	add    $0x20,%esp
    return -1;
80106263:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
...
80106275:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80106278:	8d 55 ec             	lea    -0x14(%ebp),%edx
8010627b:	e8 30 ff ff ff       	call   801061b0 <argfd.constprop.0>
80106280:	85 c0                	test   %eax,%eax
80106282:	78 54                	js     801062d8 <sys_read+0x68>
80106284:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106287:	89 44 24 04          	mov    %eax,0x4(%esp)
8010628b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106292:	e8 09 fc ff ff       	call   80105ea0 <argint>
80106297:	85 c0                	test   %eax,%eax
80106299:	78 3d                	js     801062d8 <sys_read+0x68>
8010629b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010629e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801062a5:	89 44 24 08          	mov    %eax,0x8(%esp)
801062a9:	8d 45 f4             	lea    -0xc(%ebp),%eax
801062ac:	89 44 24 04          	mov    %eax,0x4(%esp)
801062b0:	e8 3b fc ff ff       	call   80105ef0 <argptr>
801062b5:	85 c0                	test   %eax,%eax
801062b7:	78 1f                	js     801062d8 <sys_read+0x68>
...
801062c7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801062ca:	89 04 24             	mov    %eax,(%esp)
801062cd:	e8 8e ac ff ff       	call   80100f60 <fileread>
}
801062d2:	c9                   	leave  
801062d3:	c3                   	ret    
...
801062eb:	e8 c0 fe ff ff       	call   801061b0 <argfd.constprop.0>
801062f0:	85 c0                	test   %eax,%eax
801062f2:	78 54                	js     80106348 <sys_write+0x68>
801062f4:	8d 45 f0             	lea    -0x10(%ebp),%eax
801062f7:	89 44 24 04          	mov    %eax,0x4(%esp)
801062fb:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106302:	e8 99 fb ff ff       	call   80105ea0 <argint>
80106307:	85 c0                	test   %eax,%eax
80106309:	78 3d                	js     80106348 <sys_write+0x68>
...
80106320:	e8 cb fb ff ff       	call   80105ef0 <argptr>
80106325:	85 c0                	test   %eax,%eax
80106327:	78 1f                	js     80106348 <sys_write+0x68>
...
8010633d:	e8 ce ac ff ff       	call   80101010 <filewrite>
}
80106342:	c9                   	leave  
80106343:	c3                   	ret    
...
80106353:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, &fd, &f) < 0)
80106356:	8d 55 f4             	lea    -0xc(%ebp),%edx
80106359:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010635c:	e8 4f fe ff ff       	call   801061b0 <argfd.constprop.0>
80106361:	85 c0                	test   %eax,%eax
80106363:	78 23                	js     80106388 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80106365:	e8 36 d6 ff ff       	call   801039a0 <myproc>
8010636a:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010636d:	31 c9                	xor    %ecx,%ecx
8010636f:	89 4c 90 28          	mov    %ecx,0x28(%eax,%edx,4)
  fileclose(f);
80106373:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106376:	89 04 24             	mov    %eax,(%esp)
80106379:	e8 b2 aa ff ff       	call   80100e30 <fileclose>
  return 0;
8010637e:	31 c0                	xor    %eax,%eax
}
80106380:	c9                   	leave  
80106381:	c3                   	ret    
...
80106395:	83 ec 28             	sub    $0x28,%esp
  if(argfd(0, 0, &f) < 0 || argptr(1, (void*)&st, sizeof(*st)) < 0)
80106398:	8d 55 f0             	lea    -0x10(%ebp),%edx
8010639b:	e8 10 fe ff ff       	call   801061b0 <argfd.constprop.0>
801063a0:	85 c0                	test   %eax,%eax
801063a2:	78 3c                	js     801063e0 <sys_fstat+0x50>
801063a4:	b8 14 00 00 00       	mov    $0x14,%eax
801063a9:	89 44 24 08          	mov    %eax,0x8(%esp)
801063ad:	8d 45 f4             	lea    -0xc(%ebp),%eax
801063b0:	89 44 24 04          	mov    %eax,0x4(%esp)
801063b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801063bb:	e8 30 fb ff ff       	call   80105ef0 <argptr>
801063c0:	85 c0                	test   %eax,%eax
801063c2:	78 1c                	js     801063e0 <sys_fstat+0x50>
...
801063d1:	e8 3a ab ff ff       	call   80100f10 <filestat>
}
801063d6:	c9                   	leave  
801063d7:	c3                   	ret    
801063d8:	90                   	nop
...
801063f9:	8d 45 d4             	lea    -0x2c(%ebp),%eax
801063fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106400:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106407:	e8 44 fb ff ff       	call   80105f50 <argstr>
8010640c:	85 c0                	test   %eax,%eax
8010640e:	0f 88 e5 00 00 00    	js     801064f9 <sys_link+0x109>
80106414:	8d 45 d0             	lea    -0x30(%ebp),%eax
80106417:	89 44 24 04          	mov    %eax,0x4(%esp)
8010641b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106422:	e8 29 fb ff ff       	call   80105f50 <argstr>
80106427:	85 c0                	test   %eax,%eax
80106429:	0f 88 ca 00 00 00    	js     801064f9 <sys_link+0x109>
  begin_op();
8010642f:	e8 5c c8 ff ff       	call   80102c90 <begin_op>
  if((ip = namei(old)) == 0){
80106434:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80106437:	89 04 24             	mov    %eax,(%esp)
8010643a:	e8 91 bb ff ff       	call   80101fd0 <namei>
8010643f:	85 c0                	test   %eax,%eax
80106441:	89 c3                	mov    %eax,%ebx
80106443:	0f 84 ab 00 00 00    	je     801064f4 <sys_link+0x104>
  ilock(ip);
80106449:	89 04 24             	mov    %eax,(%esp)
8010644c:	e8 9f b2 ff ff       	call   801016f0 <ilock>
  if(ip->type == T_DIR){
80106451:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80106456:	0f 84 90 00 00 00    	je     801064ec <sys_link+0xfc>
  ip->nlink++;
8010645c:	66 ff 43 56          	incw   0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80106460:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80106463:	89 1c 24             	mov    %ebx,(%esp)
80106466:	e8 c5 b1 ff ff       	call   80101630 <iupdate>
  iunlock(ip);
8010646b:	89 1c 24             	mov    %ebx,(%esp)
8010646e:	e8 5d b3 ff ff       	call   801017d0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80106473:	8b 45 d0             	mov    -0x30(%ebp),%eax
80106476:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010647a:	89 04 24             	mov    %eax,(%esp)
8010647d:	e8 6e bb ff ff       	call   80101ff0 <nameiparent>
80106482:	85 c0                	test   %eax,%eax
80106484:	89 c6                	mov    %eax,%esi
80106486:	74 50                	je     801064d8 <sys_link+0xe8>
  ilock(dp);
80106488:	89 04 24             	mov    %eax,(%esp)
8010648b:	e8 60 b2 ff ff       	call   801016f0 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80106490:	8b 03                	mov    (%ebx),%eax
80106492:	39 06                	cmp    %eax,(%esi)
80106494:	75 3a                	jne    801064d0 <sys_link+0xe0>
80106496:	8b 43 04             	mov    0x4(%ebx),%eax
80106499:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010649d:	89 34 24             	mov    %esi,(%esp)
801064a0:	89 44 24 08          	mov    %eax,0x8(%esp)
801064a4:	e8 47 ba ff ff       	call   80101ef0 <dirlink>
801064a9:	85 c0                	test   %eax,%eax
801064ab:	78 23                	js     801064d0 <sys_link+0xe0>
  iunlockput(dp);
801064ad:	89 34 24             	mov    %esi,(%esp)
801064b0:	e8 cb b4 ff ff       	call   80101980 <iunlockput>
  iput(ip);
801064b5:	89 1c 24             	mov    %ebx,(%esp)
801064b8:	e8 63 b3 ff ff       	call   80101820 <iput>
  end_op();
801064bd:	e8 3e c8 ff ff       	call   80102d00 <end_op>
}
801064c2:	83 c4 3c             	add    $0x3c,%esp
  return 0;
801064c5:	31 c0                	xor    %eax,%eax
}
801064c7:	5b                   	pop    %ebx
801064c8:	5e                   	pop    %esi
801064c9:	5f                   	pop    %edi
...
801064cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    iunlockput(dp);
801064d0:	89 34 24             	mov    %esi,(%esp)
801064d3:	e8 a8 b4 ff ff       	call   80101980 <iunlockput>
  ilock(ip);
801064d8:	89 1c 24             	mov    %ebx,(%esp)
801064db:	e8 10 b2 ff ff       	call   801016f0 <ilock>
  ip->nlink--;
801064e0:	66 ff 4b 56          	decw   0x56(%ebx)
  iupdate(ip);
801064e4:	89 1c 24             	mov    %ebx,(%esp)
801064e7:	e8 44 b1 ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
801064ec:	89 1c 24             	mov    %ebx,(%esp)
801064ef:	e8 8c b4 ff ff       	call   80101980 <iunlockput>
  end_op();
801064f4:	e8 07 c8 ff ff       	call   80102d00 <end_op>
}
801064f9:	83 c4 3c             	add    $0x3c,%esp
  return -1;
...
80106516:	83 ec 5c             	sub    $0x5c,%esp
  if(argstr(0, &path) < 0)
80106519:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010651c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106520:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106527:	e8 24 fa ff ff       	call   80105f50 <argstr>
8010652c:	85 c0                	test   %eax,%eax
8010652e:	0f 88 68 01 00 00    	js     8010669c <sys_unlink+0x18c>
  begin_op();
80106534:	e8 57 c7 ff ff       	call   80102c90 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80106539:	8b 45 c0             	mov    -0x40(%ebp),%eax
8010653c:	8d 5d ca             	lea    -0x36(%ebp),%ebx
8010653f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106543:	89 04 24             	mov    %eax,(%esp)
80106546:	e8 a5 ba ff ff       	call   80101ff0 <nameiparent>
8010654b:	85 c0                	test   %eax,%eax
8010654d:	89 c6                	mov    %eax,%esi
8010654f:	0f 84 42 01 00 00    	je     80106697 <sys_unlink+0x187>
  ilock(dp);
80106555:	89 04 24             	mov    %eax,(%esp)
80106558:	e8 93 b1 ff ff       	call   801016f0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010655d:	b8 a4 8f 10 80       	mov    $0x80108fa4,%eax
80106562:	89 44 24 04          	mov    %eax,0x4(%esp)
80106566:	89 1c 24             	mov    %ebx,(%esp)
80106569:	e8 d2 b6 ff ff       	call   80101c40 <namecmp>
8010656e:	85 c0                	test   %eax,%eax
80106570:	0f 84 19 01 00 00    	je     8010668f <sys_unlink+0x17f>
80106576:	b8 a3 8f 10 80       	mov    $0x80108fa3,%eax
8010657b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010657f:	89 1c 24             	mov    %ebx,(%esp)
80106582:	e8 b9 b6 ff ff       	call   80101c40 <namecmp>
80106587:	85 c0                	test   %eax,%eax
80106589:	0f 84 00 01 00 00    	je     8010668f <sys_unlink+0x17f>
  if((ip = dirlookup(dp, name, &off)) == 0)
8010658f:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80106592:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106596:	89 44 24 08          	mov    %eax,0x8(%esp)
8010659a:	89 34 24             	mov    %esi,(%esp)
8010659d:	e8 ce b6 ff ff       	call   80101c70 <dirlookup>
801065a2:	85 c0                	test   %eax,%eax
801065a4:	89 c3                	mov    %eax,%ebx
801065a6:	0f 84 e3 00 00 00    	je     8010668f <sys_unlink+0x17f>
  ilock(ip);
801065ac:	89 04 24             	mov    %eax,(%esp)
801065af:	e8 3c b1 ff ff       	call   801016f0 <ilock>
  if(ip->nlink < 1)
801065b4:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801065b9:	0f 8e 0e 01 00 00    	jle    801066cd <sys_unlink+0x1bd>
  if(ip->type == T_DIR && !isdirempty(ip)){
801065bf:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801065c4:	8d 7d d8             	lea    -0x28(%ebp),%edi
801065c7:	74 77                	je     80106640 <sys_unlink+0x130>
  memset(&de, 0, sizeof(de));
801065c9:	31 d2                	xor    %edx,%edx
801065cb:	b8 10 00 00 00       	mov    $0x10,%eax
801065d0:	89 54 24 04          	mov    %edx,0x4(%esp)
801065d4:	89 44 24 08          	mov    %eax,0x8(%esp)
801065d8:	89 3c 24             	mov    %edi,(%esp)
801065db:	e8 d0 f5 ff ff       	call   80105bb0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801065e0:	8b 45 c4             	mov    -0x3c(%ebp),%eax
801065e3:	b9 10 00 00 00       	mov    $0x10,%ecx
801065e8:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801065ec:	89 7c 24 04          	mov    %edi,0x4(%esp)
801065f0:	89 34 24             	mov    %esi,(%esp)
801065f3:	89 44 24 08          	mov    %eax,0x8(%esp)
801065f7:	e8 f4 b4 ff ff       	call   80101af0 <writei>
801065fc:	83 f8 10             	cmp    $0x10,%eax
801065ff:	0f 85 d4 00 00 00    	jne    801066d9 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
80106605:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010660a:	0f 84 a0 00 00 00    	je     801066b0 <sys_unlink+0x1a0>
  iunlockput(dp);
80106610:	89 34 24             	mov    %esi,(%esp)
80106613:	e8 68 b3 ff ff       	call   80101980 <iunlockput>
  ip->nlink--;
80106618:	66 ff 4b 56          	decw   0x56(%ebx)
  iupdate(ip);
8010661c:	89 1c 24             	mov    %ebx,(%esp)
8010661f:	e8 0c b0 ff ff       	call   80101630 <iupdate>
  iunlockput(ip);
80106624:	89 1c 24             	mov    %ebx,(%esp)
80106627:	e8 54 b3 ff ff       	call   80101980 <iunlockput>
  end_op();
8010662c:	e8 cf c6 ff ff       	call   80102d00 <end_op>
}
80106631:	83 c4 5c             	add    $0x5c,%esp
  return 0;
80106634:	31 c0                	xor    %eax,%eax
}
80106636:	5b                   	pop    %ebx
80106637:	5e                   	pop    %esi
80106638:	5f                   	pop    %edi
...
80106640:	83 7b 58 20          	cmpl   $0x20,0x58(%ebx)
80106644:	76 83                	jbe    801065c9 <sys_unlink+0xb9>
80106646:	ba 20 00 00 00       	mov    $0x20,%edx
8010664b:	eb 0f                	jmp    8010665c <sys_unlink+0x14c>
8010664d:	8d 76 00             	lea    0x0(%esi),%esi
80106650:	83 c2 10             	add    $0x10,%edx
80106653:	3b 53 58             	cmp    0x58(%ebx),%edx
80106656:	0f 83 6d ff ff ff    	jae    801065c9 <sys_unlink+0xb9>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
8010665c:	b8 10 00 00 00       	mov    $0x10,%eax
80106661:	89 54 24 08          	mov    %edx,0x8(%esp)
80106665:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106669:	89 7c 24 04          	mov    %edi,0x4(%esp)
8010666d:	89 1c 24             	mov    %ebx,(%esp)
80106670:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80106673:	e8 58 b3 ff ff       	call   801019d0 <readi>
80106678:	8b 55 b4             	mov    -0x4c(%ebp),%edx
8010667b:	83 f8 10             	cmp    $0x10,%eax
8010667e:	75 41                	jne    801066c1 <sys_unlink+0x1b1>
    if(de.inum != 0)
80106680:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80106685:	74 c9                	je     80106650 <sys_unlink+0x140>
    iunlockput(ip);
80106687:	89 1c 24             	mov    %ebx,(%esp)
8010668a:	e8 f1 b2 ff ff       	call   80101980 <iunlockput>
  iunlockput(dp);
8010668f:	89 34 24             	mov    %esi,(%esp)
80106692:	e8 e9 b2 ff ff       	call   80101980 <iunlockput>
  end_op();
80106697:	e8 64 c6 ff ff       	call   80102d00 <end_op>
}
8010669c:	83 c4 5c             	add    $0x5c,%esp
  return -1;
...
801066a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink--;
801066b0:	66 ff 4e 56          	decw   0x56(%esi)
    iupdate(dp);
801066b4:	89 34 24             	mov    %esi,(%esp)
801066b7:	e8 74 af ff ff       	call   80101630 <iupdate>
801066bc:	e9 4f ff ff ff       	jmp    80106610 <sys_unlink+0x100>
      panic("isdirempty: readi");
801066c1:	c7 04 24 c8 8f 10 80 	movl   $0x80108fc8,(%esp)
801066c8:	e8 a3 9c ff ff       	call   80100370 <panic>
    panic("unlink: nlink < 1");
801066cd:	c7 04 24 b6 8f 10 80 	movl   $0x80108fb6,(%esp)
801066d4:	e8 97 9c ff ff       	call   80100370 <panic>
    panic("unlink: writei");
801066d9:	c7 04 24 da 8f 10 80 	movl   $0x80108fda,(%esp)
801066e0:	e8 8b 9c ff ff       	call   80100370 <panic>
...
801066f9:	8d 45 e0             	lea    -0x20(%ebp),%eax
801066fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80106700:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106707:	e8 44 f8 ff ff       	call   80105f50 <argstr>
8010670c:	85 c0                	test   %eax,%eax
8010670e:	0f 88 e9 00 00 00    	js     801067fd <sys_open+0x10d>
80106714:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106717:	89 44 24 04          	mov    %eax,0x4(%esp)
8010671b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106722:	e8 79 f7 ff ff       	call   80105ea0 <argint>
80106727:	85 c0                	test   %eax,%eax
80106729:	0f 88 ce 00 00 00    	js     801067fd <sys_open+0x10d>
    return -1;
...
8010672f:	e8 5c c5 ff ff       	call   80102c90 <begin_op>
  ...
  if(omode & O_CREATE){
80106734:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80106738:	0f 85 9a 00 00 00    	jne    801067d8 <sys_open+0xe8>
    if(ip == 0){
      end_op();
      return -1;
    }
    ...
    if((ip = namei(path)) == 0){
8010673e:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106741:	89 04 24             	mov    %eax,(%esp)
80106744:	e8 87 b8 ff ff       	call   80101fd0 <namei>
80106749:	85 c0                	test   %eax,%eax
8010674b:	89 c6                	mov    %eax,%esi
8010674d:	0f 84 a5 00 00 00    	je     801067f8 <sys_open+0x108>
      end_op();
      return -1;
    }
    ilock(ip);
80106753:	89 04 24             	mov    %eax,(%esp)
80106756:	e8 95 af ff ff       	call   801016f0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010675b:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80106760:	0f 84 a2 00 00 00    	je     80106808 <sys_open+0x118>
      end_op();
      return -1;
    }
  }
...
80106766:	e8 05 a6 ff ff       	call   80100d70 <filealloc>
8010676b:	85 c0                	test   %eax,%eax
8010676d:	89 c7                	mov    %eax,%edi
8010676f:	0f 84 9e 00 00 00    	je     80106813 <sys_open+0x123>
  struct proc *curproc = myproc();
80106775:	e8 26 d2 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010677a:	31 db                	xor    %ebx,%ebx
8010677c:	eb 0c                	jmp    8010678a <sys_open+0x9a>
8010677e:	66 90                	xchg   %ax,%ax
80106780:	43                   	inc    %ebx
80106781:	83 fb 10             	cmp    $0x10,%ebx
80106784:	0f 84 96 00 00 00    	je     80106820 <sys_open+0x130>
    if(curproc->ofile[fd] == 0){
8010678a:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
8010678e:	85 d2                	test   %edx,%edx
80106790:	75 ee                	jne    80106780 <sys_open+0x90>
      curproc->ofile[fd] = f;
80106792:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80106796:	89 34 24             	mov    %esi,(%esp)
80106799:	e8 32 b0 ff ff       	call   801017d0 <iunlock>
  end_op();
8010679e:	e8 5d c5 ff ff       	call   80102d00 <end_op>

  f->type = FD_INODE;
801067a3:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
801067a9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->ip = ip;
801067ac:	89 77 10             	mov    %esi,0x10(%edi)
  f->off = 0;
801067af:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
801067b6:	89 d0                	mov    %edx,%eax
801067b8:	f7 d0                	not    %eax
801067ba:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801067bd:	f6 c2 03             	test   $0x3,%dl
  f->readable = !(omode & O_WRONLY);
801067c0:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801067c3:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
801067c7:	83 c4 2c             	add    $0x2c,%esp
801067ca:	89 d8                	mov    %ebx,%eax
801067cc:	5b                   	pop    %ebx
801067cd:	5e                   	pop    %esi
801067ce:	5f                   	pop    %edi
801067cf:	5d                   	pop    %ebp
...
801067dd:	ba 02 00 00 00       	mov    $0x2,%edx
801067e2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801067e9:	e8 12 f8 ff ff       	call   80106000 <create>
    if(ip == 0){
801067ee:	85 c0                	test   %eax,%eax
    ip = create(path, T_FILE, 0, 0);
801067f0:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801067f2:	0f 85 6e ff ff ff    	jne    80106766 <sys_open+0x76>
    end_op();
801067f8:	e8 03 c5 ff ff       	call   80102d00 <end_op>
    return -1;
801067fd:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80106802:	eb c3                	jmp    801067c7 <sys_open+0xd7>
80106804:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ip->type == T_DIR && omode != O_RDONLY){
80106808:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010680b:	85 c9                	test   %ecx,%ecx
8010680d:	0f 84 53 ff ff ff    	je     80106766 <sys_open+0x76>
    iunlockput(ip);
80106813:	89 34 24             	mov    %esi,(%esp)
80106816:	e8 65 b1 ff ff       	call   80101980 <iunlockput>
8010681b:	eb db                	jmp    801067f8 <sys_open+0x108>
8010681d:	8d 76 00             	lea    0x0(%esi),%esi
      fileclose(f);
80106820:	89 3c 24             	mov    %edi,(%esp)
80106823:	e8 08 a6 ff ff       	call   80100e30 <fileclose>
80106828:	eb e9                	jmp    80106813 <sys_open+0x123>
...
80106893:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80106896:	e8 f5 c3 ff ff       	call   80102c90 <begin_op>
  if((argstr(0, &path)) < 0 ||
8010689b:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010689e:	89 44 24 04          	mov    %eax,0x4(%esp)
801068a2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801068a9:	e8 a2 f6 ff ff       	call   80105f50 <argstr>
801068ae:	85 c0                	test   %eax,%eax
801068b0:	78 5e                	js     80106910 <sys_mknod+0x80>
     argint(1, &major) < 0 ||
801068b2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801068b5:	89 44 24 04          	mov    %eax,0x4(%esp)
801068b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801068c0:	e8 db f5 ff ff       	call   80105ea0 <argint>
  if((argstr(0, &path)) < 0 ||
801068c5:	85 c0                	test   %eax,%eax
801068c7:	78 47                	js     80106910 <sys_mknod+0x80>
     argint(2, &minor) < 0 ||
801068c9:	8d 45 f4             	lea    -0xc(%ebp),%eax
801068cc:	89 44 24 04          	mov    %eax,0x4(%esp)
801068d0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801068d7:	e8 c4 f5 ff ff       	call   80105ea0 <argint>
     argint(1, &major) < 0 ||
801068dc:	85 c0                	test   %eax,%eax
801068de:	78 30                	js     80106910 <sys_mknod+0x80>
     (ip = create(path, T_DEV, major, minor)) == 0){
801068e0:	0f bf 45 f4          	movswl -0xc(%ebp),%eax
     argint(2, &minor) < 0 ||
801068e4:	ba 03 00 00 00       	mov    $0x3,%edx
     (ip = create(path, T_DEV, major, minor)) == 0){
801068e9:	0f bf 4d f0          	movswl -0x10(%ebp),%ecx
801068ed:	89 04 24             	mov    %eax,(%esp)
     argint(2, &minor) < 0 ||
801068f0:	8b 45 ec             	mov    -0x14(%ebp),%eax
801068f3:	e8 08 f7 ff ff       	call   80106000 <create>
801068f8:	85 c0                	test   %eax,%eax
801068fa:	74 14                	je     80106910 <sys_mknod+0x80>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80106925:	83 ec 20             	sub    $0x20,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80106928:	e8 73 d0 ff ff       	call   801039a0 <myproc>
8010692d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010692f:	e8 5c c3 ff ff       	call   80102c90 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80106934:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106937:	89 44 24 04          	mov    %eax,0x4(%esp)
8010693b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106942:	e8 09 f6 ff ff       	call   80105f50 <argstr>
80106947:	85 c0                	test   %eax,%eax
80106949:	78 4a                	js     80106995 <sys_chdir+0x75>
8010694b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010694e:	89 04 24             	mov    %eax,(%esp)
80106951:	e8 7a b6 ff ff       	call   80101fd0 <namei>
80106956:	85 c0                	test   %eax,%eax
80106958:	89 c3                	mov    %eax,%ebx
8010695a:	74 39                	je     80106995 <sys_chdir+0x75>
    end_op();
    return -1;
  }
  ilock(ip);
8010695c:	89 04 24             	mov    %eax,(%esp)
8010695f:	e8 8c ad ff ff       	call   801016f0 <ilock>
  if(ip->type != T_DIR){
80106964:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
    iunlockput(ip);
80106969:	89 1c 24             	mov    %ebx,(%esp)
  if(ip->type != T_DIR){
8010696c:	75 22                	jne    80106990 <sys_chdir+0x70>
    end_op();
    return -1;
  }
  iunlock(ip);
8010696e:	e8 5d ae ff ff       	call   801017d0 <iunlock>
  iput(curproc->cwd);
80106973:	8b 46 68             	mov    0x68(%esi),%eax
80106976:	89 04 24             	mov    %eax,(%esp)
80106979:	e8 a2 ae ff ff       	call   80101820 <iput>
  end_op();
8010697e:	e8 7d c3 ff ff       	call   80102d00 <end_op>
  curproc->cwd = ip;
  return 0;
80106983:	31 c0                	xor    %eax,%eax
  curproc->cwd = ip;
80106985:	89 5e 68             	mov    %ebx,0x68(%esi)
}
...
8010698f:	90                   	nop
    iunlockput(ip);
80106990:	e8 eb af ff ff       	call   80101980 <iunlockput>
    end_op();
80106995:	e8 66 c3 ff ff       	call   80102d00 <end_op>
    return -1;
8010699a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010699f:	eb e7                	jmp    80106988 <sys_chdir+0x68>
801069a1:	eb 0d                	jmp    801069b0 <sys_exec>
801069a3:	90                   	nop
801069a4:	90                   	nop
801069a5:	90                   	nop
801069a6:	90                   	nop
...
801069b6:	81 ec ac 00 00 00    	sub    $0xac,%esp
  char *path, *argv[MAXARG];
  int i;
  uint uargv, uarg;

  if(argstr(0, &path) < 0 || argint(1, (int*)&uargv) < 0){
801069bc:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
801069c2:	89 44 24 04          	mov    %eax,0x4(%esp)
801069c6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801069cd:	e8 7e f5 ff ff       	call   80105f50 <argstr>
801069d2:	85 c0                	test   %eax,%eax
801069d4:	0f 88 8e 00 00 00    	js     80106a68 <sys_exec+0xb8>
801069da:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
801069e0:	89 44 24 04          	mov    %eax,0x4(%esp)
801069e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801069eb:	e8 b0 f4 ff ff       	call   80105ea0 <argint>
801069f0:	85 c0                	test   %eax,%eax
801069f2:	78 74                	js     80106a68 <sys_exec+0xb8>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
801069f4:	ba 80 00 00 00       	mov    $0x80,%edx
801069f9:	31 c9                	xor    %ecx,%ecx
801069fb:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
  for(i=0;; i++){
80106a01:	31 db                	xor    %ebx,%ebx
  memset(argv, 0, sizeof(argv));
80106a03:	89 54 24 08          	mov    %edx,0x8(%esp)
80106a07:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80106a0d:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106a11:	89 04 24             	mov    %eax,(%esp)
80106a14:	e8 97 f1 ff ff       	call   80105bb0 <memset>
80106a19:	eb 2e                	jmp    80106a49 <sys_exec+0x99>
80106a1b:	90                   	nop
...
80106a28:	74 56                	je     80106a80 <sys_exec+0xd0>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80106a2a:	8d 8d 68 ff ff ff    	lea    -0x98(%ebp),%ecx
80106a30:	8d 14 31             	lea    (%ecx,%esi,1),%edx
80106a33:	89 54 24 04          	mov    %edx,0x4(%esp)
80106a37:	89 04 24             	mov    %eax,(%esp)
80106a3a:	e8 01 f4 ff ff       	call   80105e40 <fetchstr>
80106a3f:	85 c0                	test   %eax,%eax
80106a41:	78 25                	js     80106a68 <sys_exec+0xb8>
  for(i=0;; i++){
80106a43:	43                   	inc    %ebx
    if(i >= NELEM(argv))
80106a44:	83 fb 20             	cmp    $0x20,%ebx
80106a47:	74 1f                	je     80106a68 <sys_exec+0xb8>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106a49:	8b 85 60 ff ff ff    	mov    -0xa0(%ebp),%eax
80106a4f:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
80106a56:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106a5a:	01 f0                	add    %esi,%eax
80106a5c:	89 04 24             	mov    %eax,(%esp)
80106a5f:	e8 9c f3 ff ff       	call   80105e00 <fetchint>
80106a64:	85 c0                	test   %eax,%eax
80106a66:	79 b8                	jns    80106a20 <sys_exec+0x70>
      return -1;
  }
  return exec(path, argv);
}
80106a68:	81 c4 ac 00 00 00    	add    $0xac,%esp
    return -1;
...
80106a82:	89 84 9d 68 ff ff ff 	mov    %eax,-0x98(%ebp,%ebx,4)
  return exec(path, argv);
80106a89:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106a8f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a93:	8b 85 5c ff ff ff    	mov    -0xa4(%ebp),%eax
80106a99:	89 04 24             	mov    %eax,(%esp)
80106a9c:	e8 2f 9f ff ff       	call   801009d0 <exec>
}
80106aa1:	81 c4 ac 00 00 00    	add    $0xac,%esp
80106aa7:	5b                   	pop    %ebx
80106aa8:	5e                   	pop    %esi
80106aa9:	5f                   	pop    %edi
80106aaa:	5d                   	pop    %ebp
...
80106ab4:	bf 08 00 00 00       	mov    $0x8,%edi
{
80106ab9:	56                   	push   %esi
80106aba:	53                   	push   %ebx
80106abb:	83 ec 2c             	sub    $0x2c,%esp
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106abe:	8d 45 dc             	lea    -0x24(%ebp),%eax
80106ac1:	89 7c 24 08          	mov    %edi,0x8(%esp)
80106ac5:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ac9:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106ad0:	e8 1b f4 ff ff       	call   80105ef0 <argptr>
80106ad5:	85 c0                	test   %eax,%eax
80106ad7:	0f 88 a9 00 00 00    	js     80106b86 <sys_pipe+0xd6>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80106add:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106ae0:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ae4:	8d 45 e0             	lea    -0x20(%ebp),%eax
80106ae7:	89 04 24             	mov    %eax,(%esp)
80106aea:	e8 d1 c8 ff ff       	call   801033c0 <pipealloc>
80106aef:	85 c0                	test   %eax,%eax
80106af1:	0f 88 8f 00 00 00    	js     80106b86 <sys_pipe+0xd6>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106af7:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80106afa:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80106afc:	e8 9f ce ff ff       	call   801039a0 <myproc>
80106b01:	eb 0b                	jmp    80106b0e <sys_pipe+0x5e>
80106b03:	90                   	nop
80106b04:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(fd = 0; fd < NOFILE; fd++){
80106b08:	43                   	inc    %ebx
80106b09:	83 fb 10             	cmp    $0x10,%ebx
80106b0c:	74 62                	je     80106b70 <sys_pipe+0xc0>
    if(curproc->ofile[fd] == 0){
80106b0e:	8b 74 98 28          	mov    0x28(%eax,%ebx,4),%esi
80106b12:	85 f6                	test   %esi,%esi
80106b14:	75 f2                	jne    80106b08 <sys_pipe+0x58>
      curproc->ofile[fd] = f;
80106b16:	8d 73 08             	lea    0x8(%ebx),%esi
80106b19:	89 7c b0 08          	mov    %edi,0x8(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80106b1d:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80106b20:	e8 7b ce ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
80106b25:	31 d2                	xor    %edx,%edx
80106b27:	eb 0d                	jmp    80106b36 <sys_pipe+0x86>
80106b29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106b30:	42                   	inc    %edx
80106b31:	83 fa 10             	cmp    $0x10,%edx
80106b34:	74 2a                	je     80106b60 <sys_pipe+0xb0>
    if(curproc->ofile[fd] == 0){
80106b36:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
80106b3a:	85 c9                	test   %ecx,%ecx
80106b3c:	75 f2                	jne    80106b30 <sys_pipe+0x80>
      curproc->ofile[fd] = f;
80106b3e:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80106b42:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106b45:	89 18                	mov    %ebx,(%eax)
  fd[1] = fd1;
80106b47:	8b 45 dc             	mov    -0x24(%ebp),%eax
80106b4a:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
80106b4d:	31 c0                	xor    %eax,%eax
}
80106b4f:	83 c4 2c             	add    $0x2c,%esp
80106b52:	5b                   	pop    %ebx
80106b53:	5e                   	pop    %esi
80106b54:	5f                   	pop    %edi
80106b55:	5d                   	pop    %ebp
...
80106b59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      myproc()->ofile[fd0] = 0;
80106b60:	e8 3b ce ff ff       	call   801039a0 <myproc>
80106b65:	31 d2                	xor    %edx,%edx
80106b67:	89 54 b0 08          	mov    %edx,0x8(%eax,%esi,4)
80106b6b:	90                   	nop
80106b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    fileclose(rf);
80106b70:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106b73:	89 04 24             	mov    %eax,(%esp)
80106b76:	e8 b5 a2 ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
80106b7b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b7e:	89 04 24             	mov    %eax,(%esp)
80106b81:	e8 aa a2 ff ff       	call   80100e30 <fileclose>
    return -1;
80106b86:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106b8b:	eb c2                	jmp    80106b4f <sys_pipe+0x9f>
...
80106b93:	5d                   	pop    %ebp
  return fork();
80106b94:	e9 b7 d0 ff ff       	jmp    80103c50 <fork>
...
80106bb4:	e8 e7 f2 ff ff       	call   80105ea0 <argint>
80106bb9:	85 c0                	test   %eax,%eax
80106bbb:	78 13                	js     80106bd0 <sys_exit+0x30>
    return -1;
  exit(status);
80106bbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bc0:	89 04 24             	mov    %eax,(%esp)
80106bc3:	e8 98 d6 ff ff       	call   80104260 <exit>
...
80106c34:	e8 67 f2 ff ff       	call   80105ea0 <argint>
80106c39:	85 c0                	test   %eax,%eax
80106c3b:	78 13                	js     80106c50 <sys_kill+0x30>
    return -1;
  return kill(pid);
80106c3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c40:	89 04 24             	mov    %eax,(%esp)
80106c43:	e8 58 da ff ff       	call   801046a0 <kill>
}
80106c48:	c9                   	leave  
80106c49:	c3                   	ret    
...
80106c63:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80106c66:	e8 35 cd ff ff       	call   801039a0 <myproc>
80106c6b:	8b 40 10             	mov    0x10(%eax),%eax
}
80106c6e:	c9                   	leave  
80106c6f:	c3                   	ret    
...
80106c74:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;
...
80106c85:	e8 16 f2 ff ff       	call   80105ea0 <argint>
80106c8a:	85 c0                	test   %eax,%eax
80106c8c:	78 22                	js     80106cb0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80106c8e:	e8 0d cd ff ff       	call   801039a0 <myproc>
80106c93:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80106c95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106c98:	89 04 24             	mov    %eax,(%esp)
80106c9b:	e8 50 ce ff ff       	call   80103af0 <growproc>
80106ca0:	85 c0                	test   %eax,%eax
80106ca2:	78 0c                	js     80106cb0 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80106ca4:	83 c4 24             	add    $0x24,%esp
80106ca7:	89 d8                	mov    %ebx,%eax
80106ca9:	5b                   	pop    %ebx
80106caa:	5d                   	pop    %ebp
80106cab:	c3                   	ret    
80106cac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80106cb0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80106cb5:	eb ed                	jmp    80106ca4 <sys_sbrk+0x34>
...
80106cc4:	83 ec 24             	sub    $0x24,%esp
  int n;
  uint ticks0;
...
80106cd5:	e8 c6 f1 ff ff       	call   80105ea0 <argint>
80106cda:	85 c0                	test   %eax,%eax
80106cdc:	78 7e                	js     80106d5c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
80106cde:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80106ce5:	e8 d6 ed ff ff       	call   80105ac0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106cea:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  ticks0 = ticks;
80106ced:	8b 1d 20 83 11 80    	mov    0x80118320,%ebx
  while(ticks - ticks0 < n){
80106cf3:	85 c9                	test   %ecx,%ecx
80106cf5:	75 2a                	jne    80106d21 <sys_sleep+0x61>
80106cf7:	eb 4f                	jmp    80106d48 <sys_sleep+0x88>
...
80106d00:	b8 e0 7a 11 80       	mov    $0x80117ae0,%eax
80106d05:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d09:	c7 04 24 20 83 11 80 	movl   $0x80118320,(%esp)
80106d10:	e8 5b d7 ff ff       	call   80104470 <sleep>
  while(ticks - ticks0 < n){
80106d15:	a1 20 83 11 80       	mov    0x80118320,%eax
80106d1a:	29 d8                	sub    %ebx,%eax
80106d1c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80106d1f:	73 27                	jae    80106d48 <sys_sleep+0x88>
    if(myproc()->killed){
80106d21:	e8 7a cc ff ff       	call   801039a0 <myproc>
80106d26:	8b 50 24             	mov    0x24(%eax),%edx
80106d29:	85 d2                	test   %edx,%edx
80106d2b:	74 d3                	je     80106d00 <sys_sleep+0x40>
      release(&tickslock);
80106d2d:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80106d34:	e8 27 ee ff ff       	call   80105b60 <release>
  }
  release(&tickslock);
  return 0;
}
80106d39:	83 c4 24             	add    $0x24,%esp
      return -1;
80106d3c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80106d41:	5b                   	pop    %ebx
80106d42:	5d                   	pop    %ebp
80106d43:	c3                   	ret    
80106d44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80106d48:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80106d4f:	e8 0c ee ff ff       	call   80105b60 <release>
  return 0;
80106d54:	31 c0                	xor    %eax,%eax
}
80106d56:	83 c4 24             	add    $0x24,%esp
80106d59:	5b                   	pop    %ebx
80106d5a:	5d                   	pop    %ebp
80106d5b:	c3                   	ret    
    return -1;
80106d5c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106d61:	eb f3                	jmp    80106d56 <sys_sleep+0x96>
...
80106d74:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
80106d77:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80106d7e:	e8 3d ed ff ff       	call   80105ac0 <acquire>
  xticks = ticks;
80106d83:	8b 1d 20 83 11 80    	mov    0x80118320,%ebx
  release(&tickslock);
80106d89:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80106d90:	e8 cb ed ff ff       	call   80105b60 <release>
  return xticks;
}
80106d95:	83 c4 14             	add    $0x14,%esp
...
80106db4:	e8 e7 f0 ff ff       	call   80105ea0 <argint>
80106db9:	85 c0                	test   %eax,%eax
80106dbb:	78 13                	js     80106dd0 <sys_detach+0x30>
    return -1;
  return detach(pid);
80106dbd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106dc0:	89 04 24             	mov    %eax,(%esp)
80106dc3:	e8 88 d9 ff ff       	call   80104750 <detach>
}
80106dc8:	c9                   	leave  
80106dc9:	c3                   	ret    
...
80106de3:	83 ec 28             	sub    $0x28,%esp
  int proc_priority;

  if(argint(0, &proc_priority) < 0)
80106de6:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106de9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ded:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106df4:	e8 a7 f0 ff ff       	call   80105ea0 <argint>
80106df9:	85 c0                	test   %eax,%eax
80106dfb:	78 13                	js     80106e10 <sys_priority+0x30>
    return -1;
  priority(proc_priority);
80106dfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e00:	89 04 24             	mov    %eax,(%esp)
80106e03:	e8 08 da ff ff       	call   80104810 <priority>
  return 0;
...
80106e26:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106e29:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e2d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e34:	e8 67 f0 ff ff       	call   80105ea0 <argint>
80106e39:	85 c0                	test   %eax,%eax
80106e3b:	78 13                	js     80106e50 <sys_policy+0x30>
    return -1;
  policy(policy_id);
80106e3d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106e40:	89 04 24             	mov    %eax,(%esp)
80106e43:	e8 48 da ff ff       	call   80104890 <policy>
  return 0;
...
80106e61:	ba 04 00 00 00       	mov    $0x4,%edx
{
80106e66:	89 e5                	mov    %esp,%ebp
80106e68:	83 ec 28             	sub    $0x28,%esp
     if ((argptr(0, (char**)(&status), sizeof(int)) < 0) || (argptr(0, (void*)(&perform), sizeof(*perform)) < 0))
80106e6b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80106e6e:	89 54 24 08          	mov    %edx,0x8(%esp)
80106e72:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e76:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e7d:	e8 6e f0 ff ff       	call   80105ef0 <argptr>
80106e82:	85 c0                	test   %eax,%eax
80106e84:	78 3a                	js     80106ec0 <sys_wait_stat+0x60>
80106e86:	b8 14 00 00 00       	mov    $0x14,%eax
80106e8b:	89 44 24 08          	mov    %eax,0x8(%esp)
80106e8f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106e92:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e96:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106e9d:	e8 4e f0 ff ff       	call   80105ef0 <argptr>
80106ea2:	85 c0                	test   %eax,%eax
80106ea4:	78 1a                	js     80106ec0 <sys_wait_stat+0x60>
        return -1;
    return wait_stat(status,perform);
80106ea6:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106ea9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ead:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106eb0:	89 04 24             	mov    %eax,(%esp)
80106eb3:	e8 98 db ff ff       	call   80104a50 <wait_stat>
}
80106eb8:	c9                   	leave  
80106eb9:	c3                   	ret    
...
80106ec8:	06                   	push   %es
  pushl %fs
80106ec9:	0f a0                	push   %fs
  pushl %gs
80106ecb:	0f a8                	push   %gs
  pushal
80106ecd:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80106ece:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106ed2:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106ed4:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80106ed6:	54                   	push   %esp
  call trap
80106ed7:	e8 c4 00 00 00       	call   80106fa0 <trap>
  addl $4, %esp
...
80106edf:	61                   	popa   
  popl %gs
80106ee0:	0f a9                	pop    %gs
  popl %fs
80106ee2:	0f a1                	pop    %fs
  popl %es
80106ee4:	07                   	pop    %es
  popl %ds
80106ee5:	1f                   	pop    %ds
...
80106ee6:	83 c4 08             	add    $0x8,%esp
  iret
80106ee9:	cf                   	iret   
80106eea:	66 90                	xchg   %ax,%ax
80106eec:	66 90                	xchg   %ax,%ax
...
80106ef5:	83 ec 18             	sub    $0x18,%esp
80106ef8:	90                   	nop
80106ef9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80106f00:	8b 14 85 0c c0 10 80 	mov    -0x7fef3ff4(,%eax,4),%edx
80106f07:	b9 08 00 00 8e       	mov    $0x8e000008,%ecx
80106f0c:	89 0c c5 22 7b 11 80 	mov    %ecx,-0x7fee84de(,%eax,8)
80106f13:	66 89 14 c5 20 7b 11 	mov    %dx,-0x7fee84e0(,%eax,8)
80106f1a:	80 
80106f1b:	c1 ea 10             	shr    $0x10,%edx
80106f1e:	66 89 14 c5 26 7b 11 	mov    %dx,-0x7fee84da(,%eax,8)
80106f25:	80 
  for(i = 0; i < 256; i++)
80106f26:	40                   	inc    %eax
80106f27:	3d 00 01 00 00       	cmp    $0x100,%eax
80106f2c:	75 d2                	jne    80106f00 <tvinit+0x10>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f2e:	a1 0c c1 10 80       	mov    0x8010c10c,%eax

  initlock(&tickslock, "time");
80106f33:	b9 e9 8f 10 80       	mov    $0x80108fe9,%ecx
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f38:	ba 08 00 00 ef       	mov    $0xef000008,%edx
  initlock(&tickslock, "time");
80106f3d:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80106f41:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106f48:	89 15 22 7d 11 80    	mov    %edx,0x80117d22
80106f4e:	66 a3 20 7d 11 80    	mov    %ax,0x80117d20
80106f54:	c1 e8 10             	shr    $0x10,%eax
80106f57:	66 a3 26 7d 11 80    	mov    %ax,0x80117d26
  initlock(&tickslock, "time");
80106f5d:	e8 0e ea ff ff       	call   80105970 <initlock>
}
80106f62:	c9                   	leave  
80106f63:	c3                   	ret    
...
80106f70:	55                   	push   %ebp
  pd[1] = (uint)p;
80106f71:	b8 20 7b 11 80       	mov    $0x80117b20,%eax
80106f76:	89 e5                	mov    %esp,%ebp
80106f78:	0f b7 d0             	movzwl %ax,%edx
  pd[2] = (uint)p >> 16;
80106f7b:	c1 e8 10             	shr    $0x10,%eax
80106f7e:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80106f81:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80106f87:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80106f8b:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80106f8f:	8d 45 fa             	lea    -0x6(%ebp),%eax
80106f92:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80106f95:	c9                   	leave  
80106f96:	c3                   	ret    
...
80106fa3:	83 ec 48             	sub    $0x48,%esp
80106fa6:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80106fa9:	8b 5d 08             	mov    0x8(%ebp),%ebx
80106fac:	89 75 f8             	mov    %esi,-0x8(%ebp)
80106faf:	89 7d fc             	mov    %edi,-0x4(%ebp)
  if(tf->trapno == T_SYSCALL){
80106fb2:	8b 43 30             	mov    0x30(%ebx),%eax
80106fb5:	83 f8 40             	cmp    $0x40,%eax
80106fb8:	0f 84 02 01 00 00    	je     801070c0 <trap+0x120>
    if(myproc()->killed)
      exit(0);
    return;
  }
  ...
  switch(tf->trapno){
80106fbe:	83 e8 20             	sub    $0x20,%eax
80106fc1:	83 f8 1f             	cmp    $0x1f,%eax
80106fc4:	77 0a                	ja     80106fd0 <trap+0x30>
80106fc6:	ff 24 85 90 90 10 80 	jmp    *-0x7fef6f70(,%eax,4)
...
80106fd0:	e8 cb c9 ff ff       	call   801039a0 <myproc>
80106fd5:	8b 7b 38             	mov    0x38(%ebx),%edi
80106fd8:	85 c0                	test   %eax,%eax
80106fda:	0f 84 64 02 00 00    	je     80107244 <trap+0x2a4>
80106fe0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80106fe4:	0f 84 5a 02 00 00    	je     80107244 <trap+0x2a4>
...
80106fea:	0f 20 d1             	mov    %cr2,%ecx
80106fed:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80106ff0:	e8 8b c9 ff ff       	call   80103980 <cpuid>
80106ff5:	8b 73 30             	mov    0x30(%ebx),%esi
80106ff8:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106ffb:	8b 43 34             	mov    0x34(%ebx),%eax
80106ffe:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80107001:	e8 9a c9 ff ff       	call   801039a0 <myproc>
80107006:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107009:	e8 92 c9 ff ff       	call   801039a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010700e:	8b 55 dc             	mov    -0x24(%ebp),%edx
80107011:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
80107015:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107018:	8b 4d d8             	mov    -0x28(%ebp),%ecx
8010701b:	89 7c 24 18          	mov    %edi,0x18(%esp)
8010701f:	89 54 24 14          	mov    %edx,0x14(%esp)
80107023:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
80107026:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107029:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
8010702d:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80107031:	89 54 24 10          	mov    %edx,0x10(%esp)
80107035:	8b 40 10             	mov    0x10(%eax),%eax
80107038:	c7 04 24 4c 90 10 80 	movl   $0x8010904c,(%esp)
8010703f:	89 44 24 04          	mov    %eax,0x4(%esp)
80107043:	e8 08 96 ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80107048:	e8 53 c9 ff ff       	call   801039a0 <myproc>
8010704d:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80107054:	e8 47 c9 ff ff       	call   801039a0 <myproc>
80107059:	85 c0                	test   %eax,%eax
8010705b:	74 1b                	je     80107078 <trap+0xd8>
8010705d:	e8 3e c9 ff ff       	call   801039a0 <myproc>
80107062:	8b 50 24             	mov    0x24(%eax),%edx
80107065:	85 d2                	test   %edx,%edx
80107067:	74 0f                	je     80107078 <trap+0xd8>
80107069:	8b 43 3c             	mov    0x3c(%ebx),%eax
8010706c:	83 e0 03             	and    $0x3,%eax
8010706f:	83 f8 03             	cmp    $0x3,%eax
80107072:	0f 84 80 01 00 00    	je     801071f8 <trap+0x258>
    exit(0);
...
8010707f:	74 0d                	je     8010708e <trap+0xee>
80107081:	e8 1a c9 ff ff       	call   801039a0 <myproc>
80107086:	8b 40 0c             	mov    0xc(%eax),%eax
80107089:	83 f8 04             	cmp    $0x4,%eax
8010708c:	74 7a                	je     80107108 <trap+0x168>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010708e:	e8 0d c9 ff ff       	call   801039a0 <myproc>
80107093:	85 c0                	test   %eax,%eax
80107095:	74 17                	je     801070ae <trap+0x10e>
80107097:	e8 04 c9 ff ff       	call   801039a0 <myproc>
8010709c:	8b 40 24             	mov    0x24(%eax),%eax
8010709f:	85 c0                	test   %eax,%eax
801070a1:	74 0b                	je     801070ae <trap+0x10e>
801070a3:	8b 43 3c             	mov    0x3c(%ebx),%eax
801070a6:	83 e0 03             	and    $0x3,%eax
801070a9:	83 f8 03             	cmp    $0x3,%eax
801070ac:	74 3b                	je     801070e9 <trap+0x149>
    exit(0);
}
801070ae:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801070b1:	8b 75 f8             	mov    -0x8(%ebp),%esi
801070b4:	8b 7d fc             	mov    -0x4(%ebp),%edi
801070b7:	89 ec                	mov    %ebp,%esp
801070b9:	5d                   	pop    %ebp
801070ba:	c3                   	ret    
801070bb:	90                   	nop
801070bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
801070c0:	e8 db c8 ff ff       	call   801039a0 <myproc>
801070c5:	8b 70 24             	mov    0x24(%eax),%esi
801070c8:	85 f6                	test   %esi,%esi
801070ca:	0f 85 10 01 00 00    	jne    801071e0 <trap+0x240>
    myproc()->tf = tf;
801070d0:	e8 cb c8 ff ff       	call   801039a0 <myproc>
801070d5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801070d8:	e8 b3 ee ff ff       	call   80105f90 <syscall>
    if(myproc()->killed)
801070dd:	e8 be c8 ff ff       	call   801039a0 <myproc>
801070e2:	8b 48 24             	mov    0x24(%eax),%ecx
801070e5:	85 c9                	test   %ecx,%ecx
801070e7:	74 c5                	je     801070ae <trap+0x10e>
      exit(0);
801070e9:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
801070f0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801070f3:	8b 75 f8             	mov    -0x8(%ebp),%esi
801070f6:	8b 7d fc             	mov    -0x4(%ebp),%edi
801070f9:	89 ec                	mov    %ebp,%esp
801070fb:	5d                   	pop    %ebp
      exit(0);
801070fc:	e9 5f d1 ff ff       	jmp    80104260 <exit>
80107101:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
80107108:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010710c:	75 80                	jne    8010708e <trap+0xee>
    yield();
8010710e:	e8 5d d2 ff ff       	call   80104370 <yield>
80107113:	e9 76 ff ff ff       	jmp    8010708e <trap+0xee>
80107118:	90                   	nop
80107119:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80107120:	e8 5b c8 ff ff       	call   80103980 <cpuid>
80107125:	85 c0                	test   %eax,%eax
80107127:	0f 84 e3 00 00 00    	je     80107210 <trap+0x270>
8010712d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80107130:	e8 1b b7 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80107135:	e8 66 c8 ff ff       	call   801039a0 <myproc>
8010713a:	85 c0                	test   %eax,%eax
8010713c:	0f 85 1b ff ff ff    	jne    8010705d <trap+0xbd>
80107142:	e9 31 ff ff ff       	jmp    80107078 <trap+0xd8>
80107147:	89 f6                	mov    %esi,%esi
80107149:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    kbdintr();
80107150:	e8 bb b5 ff ff       	call   80102710 <kbdintr>
    lapiceoi();
80107155:	e8 f6 b6 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010715a:	e8 41 c8 ff ff       	call   801039a0 <myproc>
8010715f:	85 c0                	test   %eax,%eax
80107161:	0f 85 f6 fe ff ff    	jne    8010705d <trap+0xbd>
80107167:	e9 0c ff ff ff       	jmp    80107078 <trap+0xd8>
8010716c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80107170:	e8 6b 02 00 00       	call   801073e0 <uartintr>
    lapiceoi();
80107175:	e8 d6 b6 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010717a:	e8 21 c8 ff ff       	call   801039a0 <myproc>
8010717f:	85 c0                	test   %eax,%eax
80107181:	0f 85 d6 fe ff ff    	jne    8010705d <trap+0xbd>
80107187:	e9 ec fe ff ff       	jmp    80107078 <trap+0xd8>
8010718c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80107190:	8b 7b 38             	mov    0x38(%ebx),%edi
80107193:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80107197:	e8 e4 c7 ff ff       	call   80103980 <cpuid>
8010719c:	c7 04 24 f4 8f 10 80 	movl   $0x80108ff4,(%esp)
801071a3:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801071a7:	89 74 24 08          	mov    %esi,0x8(%esp)
801071ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801071af:	e8 9c 94 ff ff       	call   80100650 <cprintf>
    lapiceoi();
801071b4:	e8 97 b6 ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801071b9:	e8 e2 c7 ff ff       	call   801039a0 <myproc>
801071be:	85 c0                	test   %eax,%eax
801071c0:	0f 85 97 fe ff ff    	jne    8010705d <trap+0xbd>
801071c6:	e9 ad fe ff ff       	jmp    80107078 <trap+0xd8>
801071cb:	90                   	nop
801071cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
801071d0:	e8 8b af ff ff       	call   80102160 <ideintr>
801071d5:	e9 53 ff ff ff       	jmp    8010712d <trap+0x18d>
801071da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit(0);
801071e0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801071e7:	e8 74 d0 ff ff       	call   80104260 <exit>
801071ec:	e9 df fe ff ff       	jmp    801070d0 <trap+0x130>
801071f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit(0);
801071f8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801071ff:	e8 5c d0 ff ff       	call   80104260 <exit>
80107204:	e9 6f fe ff ff       	jmp    80107078 <trap+0xd8>
80107209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      acquire(&tickslock);
80107210:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
80107217:	e8 a4 e8 ff ff       	call   80105ac0 <acquire>
      ticks++;
8010721c:	ff 05 20 83 11 80    	incl   0x80118320
      updatePerformance();
80107222:	e8 99 d8 ff ff       	call   80104ac0 <updatePerformance>
      wakeup(&ticks);
80107227:	c7 04 24 20 83 11 80 	movl   $0x80118320,(%esp)
8010722e:	e8 3d d4 ff ff       	call   80104670 <wakeup>
      release(&tickslock);
80107233:	c7 04 24 e0 7a 11 80 	movl   $0x80117ae0,(%esp)
8010723a:	e8 21 e9 ff ff       	call   80105b60 <release>
8010723f:	e9 e9 fe ff ff       	jmp    8010712d <trap+0x18d>
80107244:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80107247:	e8 34 c7 ff ff       	call   80103980 <cpuid>
8010724c:	89 74 24 10          	mov    %esi,0x10(%esp)
80107250:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80107254:	89 44 24 08          	mov    %eax,0x8(%esp)
80107258:	8b 43 30             	mov    0x30(%ebx),%eax
8010725b:	c7 04 24 18 90 10 80 	movl   $0x80109018,(%esp)
80107262:	89 44 24 04          	mov    %eax,0x4(%esp)
80107266:	e8 e5 93 ff ff       	call   80100650 <cprintf>
      panic("trap");
8010726b:	c7 04 24 ee 8f 10 80 	movl   $0x80108fee,(%esp)
80107272:	e8 f9 90 ff ff       	call   80100370 <panic>
...
{
  if(!uart)
80107280:	a1 20 c6 10 80       	mov    0x8010c620,%eax
{
80107285:	55                   	push   %ebp
80107286:	89 e5                	mov    %esp,%ebp
  if(!uart)
80107288:	85 c0                	test   %eax,%eax
8010728a:	74 1c                	je     801072a8 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010728c:	ba fd 03 00 00       	mov    $0x3fd,%edx
80107291:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80107292:	24 01                	and    $0x1,%al
80107294:	84 c0                	test   %al,%al
80107296:	74 10                	je     801072a8 <uartgetc+0x28>
80107298:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010729d:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
8010729e:	0f b6 c0             	movzbl %al,%eax
}
801072a1:	5d                   	pop    %ebp
801072a2:	c3                   	ret    
801072a3:	90                   	nop
...
801072b0 <uartputc.part.0>:
uartputc(int c)
801072b0:	55                   	push   %ebp
801072b1:	89 e5                	mov    %esp,%ebp
801072b3:	56                   	push   %esi
801072b4:	be fd 03 00 00       	mov    $0x3fd,%esi
801072b9:	53                   	push   %ebx
801072ba:	bb 80 00 00 00       	mov    $0x80,%ebx
801072bf:	83 ec 20             	sub    $0x20,%esp
801072c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
801072c5:	eb 18                	jmp    801072df <uartputc.part.0+0x2f>
801072c7:	89 f6                	mov    %esi,%esi
801072c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    microdelay(10);
801072d0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
801072d7:	e8 94 b5 ff ff       	call   80102870 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801072dc:	4b                   	dec    %ebx
801072dd:	74 09                	je     801072e8 <uartputc.part.0+0x38>
801072df:	89 f2                	mov    %esi,%edx
801072e1:	ec                   	in     (%dx),%al
801072e2:	24 20                	and    $0x20,%al
801072e4:	84 c0                	test   %al,%al
801072e6:	74 e8                	je     801072d0 <uartputc.part.0+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801072e8:	ba f8 03 00 00       	mov    $0x3f8,%edx
801072ed:	0f b6 45 f4          	movzbl -0xc(%ebp),%eax
801072f1:	ee                   	out    %al,(%dx)
}
801072f2:	83 c4 20             	add    $0x20,%esp
801072f5:	5b                   	pop    %ebx
801072f6:	5e                   	pop    %esi
801072f7:	5d                   	pop    %ebp
801072f8:	c3                   	ret    
...
80107305:	88 c8                	mov    %cl,%al
80107307:	57                   	push   %edi
80107308:	56                   	push   %esi
80107309:	53                   	push   %ebx
8010730a:	bb fa 03 00 00       	mov    $0x3fa,%ebx
8010730f:	83 ec 1c             	sub    $0x1c,%esp
80107312:	89 da                	mov    %ebx,%edx
80107314:	ee                   	out    %al,(%dx)
80107315:	bf fb 03 00 00       	mov    $0x3fb,%edi
8010731a:	b0 80                	mov    $0x80,%al
8010731c:	89 fa                	mov    %edi,%edx
8010731e:	ee                   	out    %al,(%dx)
8010731f:	b0 0c                	mov    $0xc,%al
80107321:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107326:	ee                   	out    %al,(%dx)
80107327:	be f9 03 00 00       	mov    $0x3f9,%esi
8010732c:	88 c8                	mov    %cl,%al
8010732e:	89 f2                	mov    %esi,%edx
80107330:	ee                   	out    %al,(%dx)
80107331:	b0 03                	mov    $0x3,%al
80107333:	89 fa                	mov    %edi,%edx
80107335:	ee                   	out    %al,(%dx)
80107336:	ba fc 03 00 00       	mov    $0x3fc,%edx
8010733b:	88 c8                	mov    %cl,%al
8010733d:	ee                   	out    %al,(%dx)
8010733e:	b0 01                	mov    $0x1,%al
80107340:	89 f2                	mov    %esi,%edx
80107342:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107343:	ba fd 03 00 00       	mov    $0x3fd,%edx
80107348:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80107349:	fe c0                	inc    %al
8010734b:	74 52                	je     8010739f <uartinit+0x9f>
  uart = 1;
8010734d:	b9 01 00 00 00       	mov    $0x1,%ecx
80107352:	89 da                	mov    %ebx,%edx
80107354:	89 0d 20 c6 10 80    	mov    %ecx,0x8010c620
8010735a:	ec                   	in     (%dx),%al
8010735b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80107360:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80107361:	31 db                	xor    %ebx,%ebx
80107363:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  for(p="xv6...\n"; *p; p++)
80107367:	bb 10 91 10 80       	mov    $0x80109110,%ebx
  ioapicenable(IRQ_COM1, 0);
8010736c:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80107373:	e8 28 b0 ff ff       	call   801023a0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80107378:	b8 78 00 00 00       	mov    $0x78,%eax
8010737d:	eb 09                	jmp    80107388 <uartinit+0x88>
8010737f:	90                   	nop
80107380:	43                   	inc    %ebx
80107381:	0f be 03             	movsbl (%ebx),%eax
80107384:	84 c0                	test   %al,%al
80107386:	74 17                	je     8010739f <uartinit+0x9f>
  if(!uart)
80107388:	8b 15 20 c6 10 80    	mov    0x8010c620,%edx
8010738e:	85 d2                	test   %edx,%edx
80107390:	74 ee                	je     80107380 <uartinit+0x80>
  for(p="xv6...\n"; *p; p++)
80107392:	43                   	inc    %ebx
80107393:	e8 18 ff ff ff       	call   801072b0 <uartputc.part.0>
80107398:	0f be 03             	movsbl (%ebx),%eax
8010739b:	84 c0                	test   %al,%al
8010739d:	75 e9                	jne    80107388 <uartinit+0x88>
}
8010739f:	83 c4 1c             	add    $0x1c,%esp
801073a2:	5b                   	pop    %ebx
801073a3:	5e                   	pop    %esi
801073a4:	5f                   	pop    %edi
801073a5:	5d                   	pop    %ebp
...
801073b0 <uartputc>:
  if(!uart)
801073b0:	8b 15 20 c6 10 80    	mov    0x8010c620,%edx
{
801073b6:	55                   	push   %ebp
801073b7:	89 e5                	mov    %esp,%ebp
801073b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
801073bc:	85 d2                	test   %edx,%edx
801073be:	74 10                	je     801073d0 <uartputc+0x20>
}
801073c0:	5d                   	pop    %ebp
801073c1:	e9 ea fe ff ff       	jmp    801072b0 <uartputc.part.0>
...
801073e3:	83 ec 18             	sub    $0x18,%esp
  consoleintr(uartgetc);
801073e6:	c7 04 24 80 72 10 80 	movl   $0x80107280,(%esp)
801073ed:	e8 de 93 ff ff       	call   801007d0 <consoleintr>
}
801073f2:	c9                   	leave  
801073f3:	c3                   	ret    
...
801073f6:	6a 00                	push   $0x0
  jmp alltraps
801073f8:	e9 ca fa ff ff       	jmp    80106ec7 <alltraps>
...
801073ff:	6a 01                	push   $0x1
  jmp alltraps
80107401:	e9 c1 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107408:	6a 02                	push   $0x2
  jmp alltraps
8010740a:	e9 b8 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107411:	6a 03                	push   $0x3
  jmp alltraps
80107413:	e9 af fa ff ff       	jmp    80106ec7 <alltraps>
...
8010741a:	6a 04                	push   $0x4
  jmp alltraps
8010741c:	e9 a6 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107423:	6a 05                	push   $0x5
  jmp alltraps
80107425:	e9 9d fa ff ff       	jmp    80106ec7 <alltraps>
...
8010742c:	6a 06                	push   $0x6
  jmp alltraps
8010742e:	e9 94 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107435:	6a 07                	push   $0x7
  jmp alltraps
80107437:	e9 8b fa ff ff       	jmp    80106ec7 <alltraps>
...
8010743c:	6a 08                	push   $0x8
  jmp alltraps
8010743e:	e9 84 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107445:	6a 09                	push   $0x9
  jmp alltraps
80107447:	e9 7b fa ff ff       	jmp    80106ec7 <alltraps>
...
8010744c:	6a 0a                	push   $0xa
  jmp alltraps
8010744e:	e9 74 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107453:	6a 0b                	push   $0xb
  jmp alltraps
80107455:	e9 6d fa ff ff       	jmp    80106ec7 <alltraps>
...
8010745a:	6a 0c                	push   $0xc
  jmp alltraps
8010745c:	e9 66 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107461:	6a 0d                	push   $0xd
  jmp alltraps
80107463:	e9 5f fa ff ff       	jmp    80106ec7 <alltraps>
...
80107468:	6a 0e                	push   $0xe
  jmp alltraps
8010746a:	e9 58 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107471:	6a 0f                	push   $0xf
  jmp alltraps
80107473:	e9 4f fa ff ff       	jmp    80106ec7 <alltraps>
...
8010747a:	6a 10                	push   $0x10
  jmp alltraps
8010747c:	e9 46 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107481:	6a 11                	push   $0x11
  jmp alltraps
80107483:	e9 3f fa ff ff       	jmp    80106ec7 <alltraps>
...
8010748a:	6a 12                	push   $0x12
  jmp alltraps
8010748c:	e9 36 fa ff ff       	jmp    80106ec7 <alltraps>
...
80107493:	6a 13                	push   $0x13
  jmp alltraps
80107495:	e9 2d fa ff ff       	jmp    80106ec7 <alltraps>
...
8010749c:	6a 14                	push   $0x14
  jmp alltraps
8010749e:	e9 24 fa ff ff       	jmp    80106ec7 <alltraps>
...
801074a5:	6a 15                	push   $0x15
  jmp alltraps
801074a7:	e9 1b fa ff ff       	jmp    80106ec7 <alltraps>
...
801074ae:	6a 16                	push   $0x16
  jmp alltraps
801074b0:	e9 12 fa ff ff       	jmp    80106ec7 <alltraps>
...
801074b7:	6a 17                	push   $0x17
  jmp alltraps
801074b9:	e9 09 fa ff ff       	jmp    80106ec7 <alltraps>
...
801074c0:	6a 18                	push   $0x18
  jmp alltraps
801074c2:	e9 00 fa ff ff       	jmp    80106ec7 <alltraps>
...
801074c9:	6a 19                	push   $0x19
  jmp alltraps
801074cb:	e9 f7 f9 ff ff       	jmp    80106ec7 <alltraps>
...
801074d2:	6a 1a                	push   $0x1a
  jmp alltraps
801074d4:	e9 ee f9 ff ff       	jmp    80106ec7 <alltraps>
...
801074db:	6a 1b                	push   $0x1b
  jmp alltraps
801074dd:	e9 e5 f9 ff ff       	jmp    80106ec7 <alltraps>
...
801074e4:	6a 1c                	push   $0x1c
  jmp alltraps
801074e6:	e9 dc f9 ff ff       	jmp    80106ec7 <alltraps>
...
801074ed:	6a 1d                	push   $0x1d
  jmp alltraps
801074ef:	e9 d3 f9 ff ff       	jmp    80106ec7 <alltraps>
...
801074f6:	6a 1e                	push   $0x1e
  jmp alltraps
801074f8:	e9 ca f9 ff ff       	jmp    80106ec7 <alltraps>
...
801074ff:	6a 1f                	push   $0x1f
  jmp alltraps
80107501:	e9 c1 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107508:	6a 20                	push   $0x20
  jmp alltraps
8010750a:	e9 b8 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107511:	6a 21                	push   $0x21
  jmp alltraps
80107513:	e9 af f9 ff ff       	jmp    80106ec7 <alltraps>
...
8010751a:	6a 22                	push   $0x22
  jmp alltraps
8010751c:	e9 a6 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107523:	6a 23                	push   $0x23
  jmp alltraps
80107525:	e9 9d f9 ff ff       	jmp    80106ec7 <alltraps>
...
8010752c:	6a 24                	push   $0x24
  jmp alltraps
8010752e:	e9 94 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107535:	6a 25                	push   $0x25
  jmp alltraps
80107537:	e9 8b f9 ff ff       	jmp    80106ec7 <alltraps>
...
8010753e:	6a 26                	push   $0x26
  jmp alltraps
80107540:	e9 82 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107547:	6a 27                	push   $0x27
  jmp alltraps
80107549:	e9 79 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107550:	6a 28                	push   $0x28
  jmp alltraps
80107552:	e9 70 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107559:	6a 29                	push   $0x29
  jmp alltraps
8010755b:	e9 67 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107562:	6a 2a                	push   $0x2a
  jmp alltraps
80107564:	e9 5e f9 ff ff       	jmp    80106ec7 <alltraps>
...
8010756b:	6a 2b                	push   $0x2b
  jmp alltraps
8010756d:	e9 55 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107574:	6a 2c                	push   $0x2c
  jmp alltraps
80107576:	e9 4c f9 ff ff       	jmp    80106ec7 <alltraps>
...
8010757d:	6a 2d                	push   $0x2d
  jmp alltraps
8010757f:	e9 43 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107586:	6a 2e                	push   $0x2e
  jmp alltraps
80107588:	e9 3a f9 ff ff       	jmp    80106ec7 <alltraps>
...
8010758f:	6a 2f                	push   $0x2f
  jmp alltraps
80107591:	e9 31 f9 ff ff       	jmp    80106ec7 <alltraps>
...
80107598:	6a 30                	push   $0x30
  jmp alltraps
8010759a:	e9 28 f9 ff ff       	jmp    80106ec7 <alltraps>
...
801075a1:	6a 31                	push   $0x31
  jmp alltraps
801075a3:	e9 1f f9 ff ff       	jmp    80106ec7 <alltraps>
...
801075aa:	6a 32                	push   $0x32
  jmp alltraps
801075ac:	e9 16 f9 ff ff       	jmp    80106ec7 <alltraps>
...
801075b3:	6a 33                	push   $0x33
  jmp alltraps
801075b5:	e9 0d f9 ff ff       	jmp    80106ec7 <alltraps>
...
801075bc:	6a 34                	push   $0x34
  jmp alltraps
801075be:	e9 04 f9 ff ff       	jmp    80106ec7 <alltraps>
...
801075c5:	6a 35                	push   $0x35
  jmp alltraps
801075c7:	e9 fb f8 ff ff       	jmp    80106ec7 <alltraps>
...
801075ce:	6a 36                	push   $0x36
  jmp alltraps
801075d0:	e9 f2 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801075d7:	6a 37                	push   $0x37
  jmp alltraps
801075d9:	e9 e9 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801075e0:	6a 38                	push   $0x38
  jmp alltraps
801075e2:	e9 e0 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801075e9:	6a 39                	push   $0x39
  jmp alltraps
801075eb:	e9 d7 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801075f2:	6a 3a                	push   $0x3a
  jmp alltraps
801075f4:	e9 ce f8 ff ff       	jmp    80106ec7 <alltraps>
...
801075fb:	6a 3b                	push   $0x3b
  jmp alltraps
801075fd:	e9 c5 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107604:	6a 3c                	push   $0x3c
  jmp alltraps
80107606:	e9 bc f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010760d:	6a 3d                	push   $0x3d
  jmp alltraps
8010760f:	e9 b3 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107616:	6a 3e                	push   $0x3e
  jmp alltraps
80107618:	e9 aa f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010761f:	6a 3f                	push   $0x3f
  jmp alltraps
80107621:	e9 a1 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107628:	6a 40                	push   $0x40
  jmp alltraps
8010762a:	e9 98 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107631:	6a 41                	push   $0x41
  jmp alltraps
80107633:	e9 8f f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010763a:	6a 42                	push   $0x42
  jmp alltraps
8010763c:	e9 86 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107643:	6a 43                	push   $0x43
  jmp alltraps
80107645:	e9 7d f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010764c:	6a 44                	push   $0x44
  jmp alltraps
8010764e:	e9 74 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107655:	6a 45                	push   $0x45
  jmp alltraps
80107657:	e9 6b f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010765e:	6a 46                	push   $0x46
  jmp alltraps
80107660:	e9 62 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107667:	6a 47                	push   $0x47
  jmp alltraps
80107669:	e9 59 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107670:	6a 48                	push   $0x48
  jmp alltraps
80107672:	e9 50 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107679:	6a 49                	push   $0x49
  jmp alltraps
8010767b:	e9 47 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107682:	6a 4a                	push   $0x4a
  jmp alltraps
80107684:	e9 3e f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010768b:	6a 4b                	push   $0x4b
  jmp alltraps
8010768d:	e9 35 f8 ff ff       	jmp    80106ec7 <alltraps>
...
80107694:	6a 4c                	push   $0x4c
  jmp alltraps
80107696:	e9 2c f8 ff ff       	jmp    80106ec7 <alltraps>
...
8010769d:	6a 4d                	push   $0x4d
  jmp alltraps
8010769f:	e9 23 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801076a6:	6a 4e                	push   $0x4e
  jmp alltraps
801076a8:	e9 1a f8 ff ff       	jmp    80106ec7 <alltraps>
...
801076af:	6a 4f                	push   $0x4f
  jmp alltraps
801076b1:	e9 11 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801076b8:	6a 50                	push   $0x50
  jmp alltraps
801076ba:	e9 08 f8 ff ff       	jmp    80106ec7 <alltraps>
...
801076c1:	6a 51                	push   $0x51
  jmp alltraps
801076c3:	e9 ff f7 ff ff       	jmp    80106ec7 <alltraps>
...
801076ca:	6a 52                	push   $0x52
  jmp alltraps
801076cc:	e9 f6 f7 ff ff       	jmp    80106ec7 <alltraps>
...
801076d3:	6a 53                	push   $0x53
  jmp alltraps
801076d5:	e9 ed f7 ff ff       	jmp    80106ec7 <alltraps>
...
801076dc:	6a 54                	push   $0x54
  jmp alltraps
801076de:	e9 e4 f7 ff ff       	jmp    80106ec7 <alltraps>
...
801076e5:	6a 55                	push   $0x55
  jmp alltraps
801076e7:	e9 db f7 ff ff       	jmp    80106ec7 <alltraps>
...
801076ee:	6a 56                	push   $0x56
  jmp alltraps
801076f0:	e9 d2 f7 ff ff       	jmp    80106ec7 <alltraps>
...
801076f7:	6a 57                	push   $0x57
  jmp alltraps
801076f9:	e9 c9 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107700:	6a 58                	push   $0x58
  jmp alltraps
80107702:	e9 c0 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107709:	6a 59                	push   $0x59
  jmp alltraps
8010770b:	e9 b7 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107712:	6a 5a                	push   $0x5a
  jmp alltraps
80107714:	e9 ae f7 ff ff       	jmp    80106ec7 <alltraps>
...
8010771b:	6a 5b                	push   $0x5b
  jmp alltraps
8010771d:	e9 a5 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107724:	6a 5c                	push   $0x5c
  jmp alltraps
80107726:	e9 9c f7 ff ff       	jmp    80106ec7 <alltraps>
...
8010772d:	6a 5d                	push   $0x5d
  jmp alltraps
8010772f:	e9 93 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107736:	6a 5e                	push   $0x5e
  jmp alltraps
80107738:	e9 8a f7 ff ff       	jmp    80106ec7 <alltraps>
...
8010773f:	6a 5f                	push   $0x5f
  jmp alltraps
80107741:	e9 81 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107748:	6a 60                	push   $0x60
  jmp alltraps
8010774a:	e9 78 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107751:	6a 61                	push   $0x61
  jmp alltraps
80107753:	e9 6f f7 ff ff       	jmp    80106ec7 <alltraps>
...
8010775a:	6a 62                	push   $0x62
  jmp alltraps
8010775c:	e9 66 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107763:	6a 63                	push   $0x63
  jmp alltraps
80107765:	e9 5d f7 ff ff       	jmp    80106ec7 <alltraps>
...
8010776c:	6a 64                	push   $0x64
  jmp alltraps
8010776e:	e9 54 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107775:	6a 65                	push   $0x65
  jmp alltraps
80107777:	e9 4b f7 ff ff       	jmp    80106ec7 <alltraps>
...
8010777e:	6a 66                	push   $0x66
  jmp alltraps
80107780:	e9 42 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107787:	6a 67                	push   $0x67
  jmp alltraps
80107789:	e9 39 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107790:	6a 68                	push   $0x68
  jmp alltraps
80107792:	e9 30 f7 ff ff       	jmp    80106ec7 <alltraps>
...
80107799:	6a 69                	push   $0x69
  jmp alltraps
8010779b:	e9 27 f7 ff ff       	jmp    80106ec7 <alltraps>
...
801077a2:	6a 6a                	push   $0x6a
  jmp alltraps
801077a4:	e9 1e f7 ff ff       	jmp    80106ec7 <alltraps>
...
801077ab:	6a 6b                	push   $0x6b
  jmp alltraps
801077ad:	e9 15 f7 ff ff       	jmp    80106ec7 <alltraps>
...
801077b4:	6a 6c                	push   $0x6c
  jmp alltraps
801077b6:	e9 0c f7 ff ff       	jmp    80106ec7 <alltraps>
...
801077bd:	6a 6d                	push   $0x6d
  jmp alltraps
801077bf:	e9 03 f7 ff ff       	jmp    80106ec7 <alltraps>
...
801077c6:	6a 6e                	push   $0x6e
  jmp alltraps
801077c8:	e9 fa f6 ff ff       	jmp    80106ec7 <alltraps>
...
801077cf:	6a 6f                	push   $0x6f
  jmp alltraps
801077d1:	e9 f1 f6 ff ff       	jmp    80106ec7 <alltraps>
...
801077d8:	6a 70                	push   $0x70
  jmp alltraps
801077da:	e9 e8 f6 ff ff       	jmp    80106ec7 <alltraps>
...
801077e1:	6a 71                	push   $0x71
  jmp alltraps
801077e3:	e9 df f6 ff ff       	jmp    80106ec7 <alltraps>
...
801077ea:	6a 72                	push   $0x72
  jmp alltraps
801077ec:	e9 d6 f6 ff ff       	jmp    80106ec7 <alltraps>
...
801077f3:	6a 73                	push   $0x73
  jmp alltraps
801077f5:	e9 cd f6 ff ff       	jmp    80106ec7 <alltraps>
...
801077fc:	6a 74                	push   $0x74
  jmp alltraps
801077fe:	e9 c4 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107805:	6a 75                	push   $0x75
  jmp alltraps
80107807:	e9 bb f6 ff ff       	jmp    80106ec7 <alltraps>
...
8010780e:	6a 76                	push   $0x76
  jmp alltraps
80107810:	e9 b2 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107817:	6a 77                	push   $0x77
  jmp alltraps
80107819:	e9 a9 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107820:	6a 78                	push   $0x78
  jmp alltraps
80107822:	e9 a0 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107829:	6a 79                	push   $0x79
  jmp alltraps
8010782b:	e9 97 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107832:	6a 7a                	push   $0x7a
  jmp alltraps
80107834:	e9 8e f6 ff ff       	jmp    80106ec7 <alltraps>
...
8010783b:	6a 7b                	push   $0x7b
  jmp alltraps
8010783d:	e9 85 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107844:	6a 7c                	push   $0x7c
  jmp alltraps
80107846:	e9 7c f6 ff ff       	jmp    80106ec7 <alltraps>
...
8010784d:	6a 7d                	push   $0x7d
  jmp alltraps
8010784f:	e9 73 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107856:	6a 7e                	push   $0x7e
  jmp alltraps
80107858:	e9 6a f6 ff ff       	jmp    80106ec7 <alltraps>
...
8010785f:	6a 7f                	push   $0x7f
  jmp alltraps
80107861:	e9 61 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107868:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010786d:	e9 55 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107874:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80107879:	e9 49 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107880:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80107885:	e9 3d f6 ff ff       	jmp    80106ec7 <alltraps>
...
8010788c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80107891:	e9 31 f6 ff ff       	jmp    80106ec7 <alltraps>
...
80107898:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010789d:	e9 25 f6 ff ff       	jmp    80106ec7 <alltraps>
...
801078a4:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801078a9:	e9 19 f6 ff ff       	jmp    80106ec7 <alltraps>
...
801078b0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801078b5:	e9 0d f6 ff ff       	jmp    80106ec7 <alltraps>
...
801078bc:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801078c1:	e9 01 f6 ff ff       	jmp    80106ec7 <alltraps>
...
801078c8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801078cd:	e9 f5 f5 ff ff       	jmp    80106ec7 <alltraps>
...
801078d4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801078d9:	e9 e9 f5 ff ff       	jmp    80106ec7 <alltraps>
...
801078e0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801078e5:	e9 dd f5 ff ff       	jmp    80106ec7 <alltraps>
...
801078ec:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801078f1:	e9 d1 f5 ff ff       	jmp    80106ec7 <alltraps>
...
801078f8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801078fd:	e9 c5 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107904:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80107909:	e9 b9 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107910:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80107915:	e9 ad f5 ff ff       	jmp    80106ec7 <alltraps>
...
8010791c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107921:	e9 a1 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107928:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010792d:	e9 95 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107934:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80107939:	e9 89 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107940:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107945:	e9 7d f5 ff ff       	jmp    80106ec7 <alltraps>
...
8010794c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107951:	e9 71 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107958:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010795d:	e9 65 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107964:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80107969:	e9 59 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107970:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107975:	e9 4d f5 ff ff       	jmp    80106ec7 <alltraps>
...
8010797c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107981:	e9 41 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107988:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010798d:	e9 35 f5 ff ff       	jmp    80106ec7 <alltraps>
...
80107994:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80107999:	e9 29 f5 ff ff       	jmp    80106ec7 <alltraps>
...
801079a0:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801079a5:	e9 1d f5 ff ff       	jmp    80106ec7 <alltraps>
...
801079ac:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801079b1:	e9 11 f5 ff ff       	jmp    80106ec7 <alltraps>
...
801079b8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801079bd:	e9 05 f5 ff ff       	jmp    80106ec7 <alltraps>
...
801079c4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801079c9:	e9 f9 f4 ff ff       	jmp    80106ec7 <alltraps>
...
801079d0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801079d5:	e9 ed f4 ff ff       	jmp    80106ec7 <alltraps>
...
801079dc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801079e1:	e9 e1 f4 ff ff       	jmp    80106ec7 <alltraps>
...
801079e8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801079ed:	e9 d5 f4 ff ff       	jmp    80106ec7 <alltraps>
...
801079f4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801079f9:	e9 c9 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a00:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80107a05:	e9 bd f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a0c:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80107a11:	e9 b1 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a18:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107a1d:	e9 a5 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a24:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80107a29:	e9 99 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a30:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107a35:	e9 8d f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a3c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107a41:	e9 81 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a48:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107a4d:	e9 75 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a54:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80107a59:	e9 69 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a60:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107a65:	e9 5d f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a6c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107a71:	e9 51 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a78:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107a7d:	e9 45 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a84:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80107a89:	e9 39 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a90:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107a95:	e9 2d f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107a9c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107aa1:	e9 21 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107aa8:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107aad:	e9 15 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107ab4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80107ab9:	e9 09 f4 ff ff       	jmp    80106ec7 <alltraps>
...
80107ac0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80107ac5:	e9 fd f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107acc:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80107ad1:	e9 f1 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107ad8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80107add:	e9 e5 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107ae4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80107ae9:	e9 d9 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107af0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80107af5:	e9 cd f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107afc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80107b01:	e9 c1 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b08:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80107b0d:	e9 b5 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b14:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80107b19:	e9 a9 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b20:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107b25:	e9 9d f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b2c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107b31:	e9 91 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b38:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107b3d:	e9 85 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b44:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80107b49:	e9 79 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b50:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107b55:	e9 6d f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b5c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107b61:	e9 61 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b68:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107b6d:	e9 55 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b74:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80107b79:	e9 49 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b80:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107b85:	e9 3d f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b8c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107b91:	e9 31 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107b98:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107b9d:	e9 25 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107ba4:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80107ba9:	e9 19 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107bb0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107bb5:	e9 0d f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107bbc:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80107bc1:	e9 01 f3 ff ff       	jmp    80106ec7 <alltraps>
...
80107bc8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80107bcd:	e9 f5 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107bd4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80107bd9:	e9 e9 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107be0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80107be5:	e9 dd f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107bec:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80107bf1:	e9 d1 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107bf8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80107bfd:	e9 c5 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c04:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80107c09:	e9 b9 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c10:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80107c15:	e9 ad f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c1c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107c21:	e9 a1 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c28:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107c2d:	e9 95 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c34:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80107c39:	e9 89 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c40:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107c45:	e9 7d f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c4c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107c51:	e9 71 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c58:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107c5d:	e9 65 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c64:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80107c69:	e9 59 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c70:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107c75:	e9 4d f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c7c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107c81:	e9 41 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c88:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107c8d:	e9 35 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107c94:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80107c99:	e9 29 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107ca0:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107ca5:	e9 1d f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107cac:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107cb1:	e9 11 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107cb8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80107cbd:	e9 05 f2 ff ff       	jmp    80106ec7 <alltraps>
...
80107cc4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80107cc9:	e9 f9 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107cd0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107cd5:	e9 ed f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107cdc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107ce1:	e9 e1 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107ce8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80107ced:	e9 d5 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107cf4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80107cf9:	e9 c9 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d00:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107d05:	e9 bd f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d0c:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107d11:	e9 b1 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d18:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107d1d:	e9 a5 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d24:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80107d29:	e9 99 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d30:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107d35:	e9 8d f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d3c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107d41:	e9 81 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d48:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107d4d:	e9 75 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d54:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80107d59:	e9 69 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d60:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107d65:	e9 5d f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d6c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107d71:	e9 51 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d78:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107d7d:	e9 45 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d84:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80107d89:	e9 39 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d90:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107d95:	e9 2d f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107d9c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107da1:	e9 21 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107da8:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107dad:	e9 15 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107db4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80107db9:	e9 09 f1 ff ff       	jmp    80106ec7 <alltraps>
...
80107dc0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107dc5:	e9 fd f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107dcc:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107dd1:	e9 f1 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107dd8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80107ddd:	e9 e5 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107de4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80107de9:	e9 d9 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107df0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107df5:	e9 cd f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107dfc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107e01:	e9 c1 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e08:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80107e0d:	e9 b5 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e14:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80107e19:	e9 a9 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e20:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107e25:	e9 9d f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e2c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107e31:	e9 91 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e38:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107e3d:	e9 85 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e44:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80107e49:	e9 79 f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e50:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107e55:	e9 6d f0 ff ff       	jmp    80106ec7 <alltraps>
...
80107e5c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107e61:	e9 61 f0 ff ff       	jmp    80106ec7 <alltraps>
80107e66:	66 90                	xchg   %ax,%ax
80107e68:	66 90                	xchg   %ax,%ax
...
80107e73:	83 ec 28             	sub    $0x28,%esp
80107e76:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80107e79:	89 d3                	mov    %edx,%ebx
80107e7b:	c1 eb 16             	shr    $0x16,%ebx
{
80107e7e:	89 75 f8             	mov    %esi,-0x8(%ebp)
  pde = &pgdir[PDX(va)];
80107e81:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80107e84:	89 7d fc             	mov    %edi,-0x4(%ebp)
80107e87:	89 d7                	mov    %edx,%edi
  if(*pde & PTE_P){
80107e89:	8b 06                	mov    (%esi),%eax
80107e8b:	a8 01                	test   $0x1,%al
80107e8d:	74 29                	je     80107eb8 <walkpgdir+0x48>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107e8f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107e94:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80107e9a:	c1 ef 0a             	shr    $0xa,%edi
}
80107e9d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  return &pgtab[PTX(va)];
80107ea0:	89 fa                	mov    %edi,%edx
}
80107ea2:	8b 7d fc             	mov    -0x4(%ebp),%edi
  return &pgtab[PTX(va)];
80107ea5:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80107eab:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
80107eae:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80107eb1:	89 ec                	mov    %ebp,%esp
80107eb3:	5d                   	pop    %ebp
80107eb4:	c3                   	ret    
80107eb5:	8d 76 00             	lea    0x0(%esi),%esi
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107eb8:	85 c9                	test   %ecx,%ecx
80107eba:	74 34                	je     80107ef0 <walkpgdir+0x80>
80107ebc:	e8 ef a6 ff ff       	call   801025b0 <kalloc>
80107ec1:	85 c0                	test   %eax,%eax
80107ec3:	89 c3                	mov    %eax,%ebx
80107ec5:	74 29                	je     80107ef0 <walkpgdir+0x80>
    memset(pgtab, 0, PGSIZE);
80107ec7:	b8 00 10 00 00       	mov    $0x1000,%eax
80107ecc:	31 d2                	xor    %edx,%edx
80107ece:	89 44 24 08          	mov    %eax,0x8(%esp)
80107ed2:	89 54 24 04          	mov    %edx,0x4(%esp)
80107ed6:	89 1c 24             	mov    %ebx,(%esp)
80107ed9:	e8 d2 dc ff ff       	call   80105bb0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80107ede:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80107ee4:	83 c8 07             	or     $0x7,%eax
80107ee7:	89 06                	mov    %eax,(%esi)
80107ee9:	eb af                	jmp    80107e9a <walkpgdir+0x2a>
80107eeb:	90                   	nop
80107eec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
}
80107ef0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
      return 0;
80107ef3:	31 c0                	xor    %eax,%eax
}
80107ef5:	8b 75 f8             	mov    -0x8(%ebp),%esi
80107ef8:	8b 7d fc             	mov    -0x4(%ebp),%edi
80107efb:	89 ec                	mov    %ebp,%esp
80107efd:	5d                   	pop    %ebp
80107efe:	c3                   	ret    
80107eff:	90                   	nop
...
80107f06:	89 d3                	mov    %edx,%ebx
{
80107f08:	83 ec 2c             	sub    $0x2c,%esp
  a = (char*)PGROUNDDOWN((uint)va);
80107f0b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
80107f11:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107f14:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
...
80107f26:	29 df                	sub    %ebx,%edi
80107f28:	83 c8 01             	or     $0x1,%eax
80107f2b:	89 45 dc             	mov    %eax,-0x24(%ebp)
80107f2e:	eb 17                	jmp    80107f47 <mappages+0x47>
    if(*pte & PTE_P)
80107f30:	f6 00 01             	testb  $0x1,(%eax)
80107f33:	75 45                	jne    80107f7a <mappages+0x7a>
    *pte = pa | perm | PTE_P;
80107f35:	8b 55 dc             	mov    -0x24(%ebp),%edx
80107f38:	09 d6                	or     %edx,%esi
    if(a == last)
80107f3a:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
    *pte = pa | perm | PTE_P;
80107f3d:	89 30                	mov    %esi,(%eax)
    if(a == last)
80107f3f:	74 2f                	je     80107f70 <mappages+0x70>
      break;
    a += PGSIZE;
80107f41:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107f47:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107f4a:	b9 01 00 00 00       	mov    $0x1,%ecx
80107f4f:	89 da                	mov    %ebx,%edx
80107f51:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80107f54:	e8 17 ff ff ff       	call   80107e70 <walkpgdir>
80107f59:	85 c0                	test   %eax,%eax
80107f5b:	75 d3                	jne    80107f30 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
80107f5d:	83 c4 2c             	add    $0x2c,%esp
      return -1;
80107f60:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107f65:	5b                   	pop    %ebx
80107f66:	5e                   	pop    %esi
80107f67:	5f                   	pop    %edi
...
80107f70:	83 c4 2c             	add    $0x2c,%esp
  return 0;
...
80107f79:	c3                   	ret    
      panic("remap");
80107f7a:	c7 04 24 18 91 10 80 	movl   $0x80109118,(%esp)
80107f81:	e8 ea 83 ff ff       	call   80100370 <panic>
80107f86:	8d 76 00             	lea    0x0(%esi),%esi
80107f89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80107f90 <deallocuvm.part.0>:
...
80107f94:	89 c7                	mov    %eax,%edi
80107f96:	56                   	push   %esi
80107f97:	53                   	push   %ebx
  uint a, pa;
  ...
  a = PGROUNDUP(newsz);
80107f98:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80107f9e:	83 ec 2c             	sub    $0x2c,%esp
  a = PGROUNDUP(newsz);
80107fa1:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80107fa7:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80107fa9:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107fac:	73 62                	jae    80108010 <deallocuvm.part.0+0x80>
80107fae:	89 d6                	mov    %edx,%esi
80107fb0:	eb 39                	jmp    80107feb <deallocuvm.part.0+0x5b>
80107fb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80107fb8:	8b 10                	mov    (%eax),%edx
80107fba:	f6 c2 01             	test   $0x1,%dl
80107fbd:	74 22                	je     80107fe1 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80107fbf:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80107fc5:	74 54                	je     8010801b <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80107fc7:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80107fcd:	89 14 24             	mov    %edx,(%esp)
80107fd0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107fd3:	e8 08 a4 ff ff       	call   801023e0 <kfree>
      *pte = 0;
80107fd8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107fdb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80107fe1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107fe7:	39 f3                	cmp    %esi,%ebx
80107fe9:	73 25                	jae    80108010 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
80107feb:	31 c9                	xor    %ecx,%ecx
80107fed:	89 da                	mov    %ebx,%edx
80107fef:	89 f8                	mov    %edi,%eax
80107ff1:	e8 7a fe ff ff       	call   80107e70 <walkpgdir>
    if(!pte)
80107ff6:	85 c0                	test   %eax,%eax
80107ff8:	75 be                	jne    80107fb8 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80107ffa:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80108000:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80108006:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010800c:	39 f3                	cmp    %esi,%ebx
8010800e:	72 db                	jb     80107feb <deallocuvm.part.0+0x5b>
    }
  }
  return newsz;
}
80108010:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108013:	83 c4 2c             	add    $0x2c,%esp
80108016:	5b                   	pop    %ebx
80108017:	5e                   	pop    %esi
80108018:	5f                   	pop    %edi
80108019:	5d                   	pop    %ebp
8010801a:	c3                   	ret    
        panic("kfree");
8010801b:	c7 04 24 26 8a 10 80 	movl   $0x80108a26,(%esp)
80108022:	e8 49 83 ff ff       	call   80100370 <panic>
...
80108033:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80108036:	e8 45 b9 ff ff       	call   80103980 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010803b:	b9 00 9a cf 00       	mov    $0xcf9a00,%ecx
  pd[0] = size-1;
80108040:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
80108046:	8d 14 80             	lea    (%eax,%eax,4),%edx
80108049:	8d 04 50             	lea    (%eax,%edx,2),%eax
8010804c:	ba ff ff 00 00       	mov    $0xffff,%edx
80108051:	c1 e0 04             	shl    $0x4,%eax
80108054:	89 90 78 48 11 80    	mov    %edx,-0x7feeb788(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010805a:	ba ff ff 00 00       	mov    $0xffff,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010805f:	89 88 7c 48 11 80    	mov    %ecx,-0x7feeb784(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108065:	b9 00 92 cf 00       	mov    $0xcf9200,%ecx
8010806a:	89 90 80 48 11 80    	mov    %edx,-0x7feeb780(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80108070:	ba ff ff 00 00       	mov    $0xffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80108075:	89 88 84 48 11 80    	mov    %ecx,-0x7feeb77c(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010807b:	b9 00 fa cf 00       	mov    $0xcffa00,%ecx
80108080:	89 90 88 48 11 80    	mov    %edx,-0x7feeb778(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108086:	ba ff ff 00 00       	mov    $0xffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010808b:	89 88 8c 48 11 80    	mov    %ecx,-0x7feeb774(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80108091:	b9 00 f2 cf 00       	mov    $0xcff200,%ecx
80108096:	89 90 90 48 11 80    	mov    %edx,-0x7feeb770(%eax)
8010809c:	89 88 94 48 11 80    	mov    %ecx,-0x7feeb76c(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
801080a2:	05 70 48 11 80       	add    $0x80114870,%eax
  pd[1] = (uint)p;
801080a7:	0f b7 d0             	movzwl %ax,%edx
  pd[2] = (uint)p >> 16;
801080aa:	c1 e8 10             	shr    $0x10,%eax
  pd[1] = (uint)p;
801080ad:	66 89 55 f4          	mov    %dx,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
801080b1:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801080b5:	8d 45 f2             	lea    -0xe(%ebp),%eax
801080b8:	0f 01 10             	lgdtl  (%eax)
}
801080bb:	c9                   	leave  
801080bc:	c3                   	ret    
...
801080c0:	a1 24 83 11 80       	mov    0x80118324,%eax
{
...
801080e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
801080ec:	85 db                	test   %ebx,%ebx
801080ee:	0f 84 c5 00 00 00    	je     801081b9 <switchuvm+0xd9>
  if(p->kstack == 0)
801080f4:	8b 7b 08             	mov    0x8(%ebx),%edi
801080f7:	85 ff                	test   %edi,%edi
801080f9:	0f 84 d2 00 00 00    	je     801081d1 <switchuvm+0xf1>
  if(p->pgdir == 0)
801080ff:	8b 73 04             	mov    0x4(%ebx),%esi
80108102:	85 f6                	test   %esi,%esi
80108104:	0f 84 bb 00 00 00    	je     801081c5 <switchuvm+0xe5>
  pushcli();
8010810a:	e8 d1 d8 ff ff       	call   801059e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010810f:	e8 ec b7 ff ff       	call   80103900 <mycpu>
80108114:	89 c6                	mov    %eax,%esi
80108116:	e8 e5 b7 ff ff       	call   80103900 <mycpu>
8010811b:	89 c7                	mov    %eax,%edi
8010811d:	e8 de b7 ff ff       	call   80103900 <mycpu>
80108122:	83 c7 08             	add    $0x8,%edi
80108125:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80108128:	e8 d3 b7 ff ff       	call   80103900 <mycpu>
8010812d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80108130:	ba 67 00 00 00       	mov    $0x67,%edx
80108135:	66 89 96 98 00 00 00 	mov    %dx,0x98(%esi)
8010813c:	66 89 be 9a 00 00 00 	mov    %di,0x9a(%esi)
80108143:	83 c1 08             	add    $0x8,%ecx
80108146:	c1 e9 10             	shr    $0x10,%ecx
80108149:	83 c0 08             	add    $0x8,%eax
8010814c:	88 8e 9c 00 00 00    	mov    %cl,0x9c(%esi)
80108152:	c1 e8 18             	shr    $0x18,%eax
80108155:	b9 99 40 00 00       	mov    $0x4099,%ecx
8010815a:	66 89 8e 9d 00 00 00 	mov    %cx,0x9d(%esi)
80108161:	88 86 9f 00 00 00    	mov    %al,0x9f(%esi)
  mycpu()->gdt[SEG_TSS].s = 0;
80108167:	e8 94 b7 ff ff       	call   80103900 <mycpu>
8010816c:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80108173:	e8 88 b7 ff ff       	call   80103900 <mycpu>
80108178:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
8010817e:	8b 73 08             	mov    0x8(%ebx),%esi
80108181:	e8 7a b7 ff ff       	call   80103900 <mycpu>
80108186:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010818c:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
8010818f:	e8 6c b7 ff ff       	call   80103900 <mycpu>
80108194:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
8010819a:	b8 28 00 00 00       	mov    $0x28,%eax
8010819f:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
801081a2:	8b 43 04             	mov    0x4(%ebx),%eax
801081a5:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801081aa:	0f 22 d8             	mov    %eax,%cr3
}
...
801081b3:	5d                   	pop    %ebp
  popcli();
801081b4:	e9 67 d8 ff ff       	jmp    80105a20 <popcli>
    panic("switchuvm: no process");
801081b9:	c7 04 24 1e 91 10 80 	movl   $0x8010911e,(%esp)
801081c0:	e8 ab 81 ff ff       	call   80100370 <panic>
    panic("switchuvm: no pgdir");
801081c5:	c7 04 24 49 91 10 80 	movl   $0x80109149,(%esp)
801081cc:	e8 9f 81 ff ff       	call   80100370 <panic>
    panic("switchuvm: no kstack");
801081d1:	c7 04 24 34 91 10 80 	movl   $0x80109134,(%esp)
801081d8:	e8 93 81 ff ff       	call   80100370 <panic>
...
801081e3:	83 ec 38             	sub    $0x38,%esp
801081e6:	89 75 f8             	mov    %esi,-0x8(%ebp)
801081e9:	8b 75 10             	mov    0x10(%ebp),%esi
801081ec:	8b 45 08             	mov    0x8(%ebp),%eax
801081ef:	89 7d fc             	mov    %edi,-0x4(%ebp)
801081f2:	8b 7d 0c             	mov    0xc(%ebp),%edi
801081f5:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  if(sz >= PGSIZE)
801081f8:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
{
801081fe:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80108201:	77 59                	ja     8010825c <inituvm+0x7c>
  mem = kalloc();
80108203:	e8 a8 a3 ff ff       	call   801025b0 <kalloc>
  memset(mem, 0, PGSIZE);
80108208:	31 d2                	xor    %edx,%edx
8010820a:	89 54 24 04          	mov    %edx,0x4(%esp)
  mem = kalloc();
8010820e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80108210:	b8 00 10 00 00       	mov    $0x1000,%eax
80108215:	89 1c 24             	mov    %ebx,(%esp)
80108218:	89 44 24 08          	mov    %eax,0x8(%esp)
8010821c:	e8 8f d9 ff ff       	call   80105bb0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80108221:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80108227:	b9 06 00 00 00       	mov    $0x6,%ecx
8010822c:	89 04 24             	mov    %eax,(%esp)
8010822f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80108232:	31 d2                	xor    %edx,%edx
80108234:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80108238:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010823d:	e8 be fc ff ff       	call   80107f00 <mappages>
  memmove(mem, init, sz);
80108242:	89 75 10             	mov    %esi,0x10(%ebp)
}
80108245:	8b 75 f8             	mov    -0x8(%ebp),%esi
  memmove(mem, init, sz);
80108248:	89 7d 0c             	mov    %edi,0xc(%ebp)
}
8010824b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  memmove(mem, init, sz);
8010824e:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80108251:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80108254:	89 ec                	mov    %ebp,%esp
80108256:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80108257:	e9 14 da ff ff       	jmp    80105c70 <memmove>
    panic("inituvm: more than a page");
8010825c:	c7 04 24 5d 91 10 80 	movl   $0x8010915d,(%esp)
80108263:	e8 08 81 ff ff       	call   80100370 <panic>
80108268:	90                   	nop
...
80108279:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
80108280:	0f 85 98 00 00 00    	jne    8010831e <loaduvm+0xae>
  for(i = 0; i < sz; i += PGSIZE){
80108286:	8b 75 18             	mov    0x18(%ebp),%esi
80108289:	31 db                	xor    %ebx,%ebx
8010828b:	85 f6                	test   %esi,%esi
8010828d:	75 1a                	jne    801082a9 <loaduvm+0x39>
8010828f:	eb 77                	jmp    80108308 <loaduvm+0x98>
80108291:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80108298:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010829e:	81 ee 00 10 00 00    	sub    $0x1000,%esi
801082a4:	39 5d 18             	cmp    %ebx,0x18(%ebp)
801082a7:	76 5f                	jbe    80108308 <loaduvm+0x98>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
801082a9:	8b 55 0c             	mov    0xc(%ebp),%edx
801082ac:	31 c9                	xor    %ecx,%ecx
801082ae:	8b 45 08             	mov    0x8(%ebp),%eax
801082b1:	01 da                	add    %ebx,%edx
801082b3:	e8 b8 fb ff ff       	call   80107e70 <walkpgdir>
801082b8:	85 c0                	test   %eax,%eax
801082ba:	74 56                	je     80108312 <loaduvm+0xa2>
    pa = PTE_ADDR(*pte);
801082bc:	8b 00                	mov    (%eax),%eax
    if(sz - i < PGSIZE)
801082be:	bf 00 10 00 00       	mov    $0x1000,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
801082c3:	8b 4d 14             	mov    0x14(%ebp),%ecx
    pa = PTE_ADDR(*pte);
801082c6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801082cb:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801082d1:	0f 46 fe             	cmovbe %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
801082d4:	05 00 00 00 80       	add    $0x80000000,%eax
801082d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801082dd:	8b 45 10             	mov    0x10(%ebp),%eax
801082e0:	01 d9                	add    %ebx,%ecx
801082e2:	89 7c 24 0c          	mov    %edi,0xc(%esp)
801082e6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801082ea:	89 04 24             	mov    %eax,(%esp)
801082ed:	e8 de 96 ff ff       	call   801019d0 <readi>
801082f2:	39 f8                	cmp    %edi,%eax
801082f4:	74 a2                	je     80108298 <loaduvm+0x28>
}
801082f6:	83 c4 1c             	add    $0x1c,%esp
      return -1;
801082f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
801082fe:	5b                   	pop    %ebx
801082ff:	5e                   	pop    %esi
80108300:	5f                   	pop    %edi
...
80108302:	c3                   	ret    
80108303:	90                   	nop
80108304:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80108308:	83 c4 1c             	add    $0x1c,%esp
  return 0;
8010830b:	31 c0                	xor    %eax,%eax
}
8010830d:	5b                   	pop    %ebx
8010830e:	5e                   	pop    %esi
8010830f:	5f                   	pop    %edi
...
80108312:	c7 04 24 77 91 10 80 	movl   $0x80109177,(%esp)
80108319:	e8 52 80 ff ff       	call   80100370 <panic>
    panic("loaduvm: addr must be page aligned");
8010831e:	c7 04 24 18 92 10 80 	movl   $0x80109218,(%esp)
80108325:	e8 46 80 ff ff       	call   80100370 <panic>
8010832a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80108336:	83 ec 2c             	sub    $0x2c,%esp
  if(newsz >= KERNBASE)
80108339:	8b 7d 10             	mov    0x10(%ebp),%edi
8010833c:	85 ff                	test   %edi,%edi
8010833e:	0f 88 91 00 00 00    	js     801083d5 <allocuvm+0xa5>
  if(newsz < oldsz)
80108344:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80108347:	0f 82 9b 00 00 00    	jb     801083e8 <allocuvm+0xb8>
  a = PGROUNDUP(oldsz);
8010834d:	8b 45 0c             	mov    0xc(%ebp),%eax
80108350:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80108356:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
8010835c:	39 5d 10             	cmp    %ebx,0x10(%ebp)
8010835f:	0f 86 86 00 00 00    	jbe    801083eb <allocuvm+0xbb>
80108365:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80108368:	8b 7d 08             	mov    0x8(%ebp),%edi
8010836b:	eb 49                	jmp    801083b6 <allocuvm+0x86>
8010836d:	8d 76 00             	lea    0x0(%esi),%esi
    memset(mem, 0, PGSIZE);
80108370:	31 d2                	xor    %edx,%edx
80108372:	b8 00 10 00 00       	mov    $0x1000,%eax
80108377:	89 54 24 04          	mov    %edx,0x4(%esp)
8010837b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010837f:	89 34 24             	mov    %esi,(%esp)
80108382:	e8 29 d8 ff ff       	call   80105bb0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80108387:	b9 06 00 00 00       	mov    $0x6,%ecx
8010838c:	89 da                	mov    %ebx,%edx
8010838e:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80108394:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80108398:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010839d:	89 04 24             	mov    %eax,(%esp)
801083a0:	89 f8                	mov    %edi,%eax
801083a2:	e8 59 fb ff ff       	call   80107f00 <mappages>
801083a7:	85 c0                	test   %eax,%eax
801083a9:	78 4d                	js     801083f8 <allocuvm+0xc8>
  for(; a < newsz; a += PGSIZE){
801083ab:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801083b1:	39 5d 10             	cmp    %ebx,0x10(%ebp)
801083b4:	76 7a                	jbe    80108430 <allocuvm+0x100>
    mem = kalloc();
801083b6:	e8 f5 a1 ff ff       	call   801025b0 <kalloc>
    if(mem == 0){
801083bb:	85 c0                	test   %eax,%eax
    mem = kalloc();
801083bd:	89 c6                	mov    %eax,%esi
    if(mem == 0){
801083bf:	75 af                	jne    80108370 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
801083c1:	c7 04 24 95 91 10 80 	movl   $0x80109195,(%esp)
801083c8:	e8 83 82 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
801083cd:	8b 45 0c             	mov    0xc(%ebp),%eax
801083d0:	39 45 10             	cmp    %eax,0x10(%ebp)
801083d3:	77 6b                	ja     80108440 <allocuvm+0x110>
}
801083d5:	83 c4 2c             	add    $0x2c,%esp
    return 0;
801083d8:	31 ff                	xor    %edi,%edi
}
801083da:	5b                   	pop    %ebx
801083db:	89 f8                	mov    %edi,%eax
801083dd:	5e                   	pop    %esi
801083de:	5f                   	pop    %edi
801083df:	5d                   	pop    %ebp
801083e0:	c3                   	ret    
801083e1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return oldsz;
801083e8:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
801083eb:	83 c4 2c             	add    $0x2c,%esp
...
801083f3:	5d                   	pop    %ebp
801083f4:	c3                   	ret    
801083f5:	8d 76 00             	lea    0x0(%esi),%esi
      cprintf("allocuvm out of memory (2)\n");
801083f8:	c7 04 24 ad 91 10 80 	movl   $0x801091ad,(%esp)
801083ff:	e8 4c 82 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80108404:	8b 45 0c             	mov    0xc(%ebp),%eax
80108407:	39 45 10             	cmp    %eax,0x10(%ebp)
8010840a:	76 0d                	jbe    80108419 <allocuvm+0xe9>
8010840c:	89 c1                	mov    %eax,%ecx
8010840e:	8b 55 10             	mov    0x10(%ebp),%edx
80108411:	8b 45 08             	mov    0x8(%ebp),%eax
80108414:	e8 77 fb ff ff       	call   80107f90 <deallocuvm.part.0>
      kfree(mem);
80108419:	89 34 24             	mov    %esi,(%esp)
      return 0;
8010841c:	31 ff                	xor    %edi,%edi
      kfree(mem);
8010841e:	e8 bd 9f ff ff       	call   801023e0 <kfree>
}
80108423:	83 c4 2c             	add    $0x2c,%esp
80108426:	89 f8                	mov    %edi,%eax
80108428:	5b                   	pop    %ebx
80108429:	5e                   	pop    %esi
8010842a:	5f                   	pop    %edi
8010842b:	5d                   	pop    %ebp
...
80108430:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80108433:	83 c4 2c             	add    $0x2c,%esp
80108436:	5b                   	pop    %ebx
80108437:	5e                   	pop    %esi
80108438:	89 f8                	mov    %edi,%eax
8010843a:	5f                   	pop    %edi
8010843b:	5d                   	pop    %ebp
8010843c:	c3                   	ret    
8010843d:	8d 76 00             	lea    0x0(%esi),%esi
80108440:	89 c1                	mov    %eax,%ecx
80108442:	8b 55 10             	mov    0x10(%ebp),%edx
      return 0;
80108445:	31 ff                	xor    %edi,%edi
80108447:	8b 45 08             	mov    0x8(%ebp),%eax
8010844a:	e8 41 fb ff ff       	call   80107f90 <deallocuvm.part.0>
8010844f:	eb 9a                	jmp    801083eb <allocuvm+0xbb>
80108451:	eb 0d                	jmp    80108460 <deallocuvm>
80108453:	90                   	nop
80108454:	90                   	nop
80108455:	90                   	nop
80108456:	90                   	nop
...
80108466:	8b 4d 10             	mov    0x10(%ebp),%ecx
80108469:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
8010846c:	39 d1                	cmp    %edx,%ecx
8010846e:	73 10                	jae    80108480 <deallocuvm+0x20>
}
80108470:	5d                   	pop    %ebp
80108471:	e9 1a fb ff ff       	jmp    80107f90 <deallocuvm.part.0>
80108476:	8d 76 00             	lea    0x0(%esi),%esi
80108479:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80108480:	89 d0                	mov    %edx,%eax
80108482:	5d                   	pop    %ebp
80108483:	c3                   	ret    
80108484:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010848a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80108499:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010849c:	85 f6                	test   %esi,%esi
8010849e:	74 55                	je     801084f5 <freevm+0x65>
801084a0:	31 c9                	xor    %ecx,%ecx
801084a2:	ba 00 00 00 80       	mov    $0x80000000,%edx
801084a7:	89 f0                	mov    %esi,%eax
801084a9:	89 f3                	mov    %esi,%ebx
801084ab:	e8 e0 fa ff ff       	call   80107f90 <deallocuvm.part.0>
801084b0:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
801084b6:	eb 0f                	jmp    801084c7 <freevm+0x37>
801084b8:	90                   	nop
...
801084c3:	39 fb                	cmp    %edi,%ebx
801084c5:	74 1f                	je     801084e6 <freevm+0x56>
    if(pgdir[i] & PTE_P){
...
801084d2:	83 c3 04             	add    $0x4,%ebx
801084d5:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
801084da:	89 04 24             	mov    %eax,(%esp)
801084dd:	e8 fe 9e ff ff       	call   801023e0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
801084e2:	39 fb                	cmp    %edi,%ebx
801084e4:	75 e1                	jne    801084c7 <freevm+0x37>
    }
  }
  kfree((char*)pgdir);
801084e6:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801084ef:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801084f0:	e9 eb 9e ff ff       	jmp    801023e0 <kfree>
    panic("freevm: no pgdir");
801084f5:	c7 04 24 c9 91 10 80 	movl   $0x801091c9,(%esp)
801084fc:	e8 6f 7e ff ff       	call   80100370 <panic>
80108501:	eb 0d                	jmp    80108510 <setupkvm>
80108503:	90                   	nop
80108504:	90                   	nop
80108505:	90                   	nop
80108506:	90                   	nop
...
80108513:	56                   	push   %esi
80108514:	53                   	push   %ebx
80108515:	83 ec 10             	sub    $0x10,%esp
  if((pgdir = (pde_t*)kalloc()) == 0)
80108518:	e8 93 a0 ff ff       	call   801025b0 <kalloc>
8010851d:	85 c0                	test   %eax,%eax
8010851f:	89 c6                	mov    %eax,%esi
80108521:	74 46                	je     80108569 <setupkvm+0x59>
  memset(pgdir, 0, PGSIZE);
80108523:	b8 00 10 00 00       	mov    $0x1000,%eax
80108528:	31 d2                	xor    %edx,%edx
8010852a:	89 44 24 08          	mov    %eax,0x8(%esp)
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010852e:	bb 20 c4 10 80       	mov    $0x8010c420,%ebx
  memset(pgdir, 0, PGSIZE);
80108533:	89 54 24 04          	mov    %edx,0x4(%esp)
80108537:	89 34 24             	mov    %esi,(%esp)
8010853a:	e8 71 d6 ff ff       	call   80105bb0 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010853f:	8b 53 0c             	mov    0xc(%ebx),%edx
                (uint)k->phys_start, k->perm) < 0) {
80108542:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80108545:	8b 4b 08             	mov    0x8(%ebx),%ecx
80108548:	89 54 24 04          	mov    %edx,0x4(%esp)
8010854c:	8b 13                	mov    (%ebx),%edx
8010854e:	89 04 24             	mov    %eax,(%esp)
80108551:	29 c1                	sub    %eax,%ecx
80108553:	89 f0                	mov    %esi,%eax
80108555:	e8 a6 f9 ff ff       	call   80107f00 <mappages>
8010855a:	85 c0                	test   %eax,%eax
8010855c:	78 1a                	js     80108578 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010855e:	83 c3 10             	add    $0x10,%ebx
80108561:	81 fb 60 c4 10 80    	cmp    $0x8010c460,%ebx
80108567:	75 d6                	jne    8010853f <setupkvm+0x2f>
}
80108569:	83 c4 10             	add    $0x10,%esp
8010856c:	89 f0                	mov    %esi,%eax
8010856e:	5b                   	pop    %ebx
8010856f:	5e                   	pop    %esi
80108570:	5d                   	pop    %ebp
80108571:	c3                   	ret    
80108572:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      freevm(pgdir);
80108578:	89 34 24             	mov    %esi,(%esp)
      return 0;
8010857b:	31 f6                	xor    %esi,%esi
      freevm(pgdir);
8010857d:	e8 0e ff ff ff       	call   80108490 <freevm>
}
80108582:	83 c4 10             	add    $0x10,%esp
80108585:	89 f0                	mov    %esi,%eax
80108587:	5b                   	pop    %ebx
80108588:	5e                   	pop    %esi
80108589:	5d                   	pop    %ebp
8010858a:	c3                   	ret    
...
80108593:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80108596:	e8 75 ff ff ff       	call   80108510 <setupkvm>
8010859b:	a3 24 83 11 80       	mov    %eax,0x80118324
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801085a0:	05 00 00 00 80       	add    $0x80000000,%eax
801085a5:	0f 22 d8             	mov    %eax,%cr3
}
801085a8:	c9                   	leave  
801085a9:	c3                   	ret    
...
801085be:	e8 ad f8 ff ff       	call   80107e70 <walkpgdir>
  if(pte == 0)
801085c3:	85 c0                	test   %eax,%eax
801085c5:	74 05                	je     801085cc <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
801085c7:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801085ca:	c9                   	leave  
801085cb:	c3                   	ret    
    panic("clearpteu");
801085cc:	c7 04 24 da 91 10 80 	movl   $0x801091da,(%esp)
801085d3:	e8 98 7d ff ff       	call   80100370 <panic>
801085d8:	90                   	nop
...
801085e6:	83 ec 2c             	sub    $0x2c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801085e9:	e8 22 ff ff ff       	call   80108510 <setupkvm>
801085ee:	85 c0                	test   %eax,%eax
801085f0:	89 45 e0             	mov    %eax,-0x20(%ebp)
801085f3:	0f 84 a3 00 00 00    	je     8010869c <copyuvm+0xbc>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801085f9:	8b 55 0c             	mov    0xc(%ebp),%edx
801085fc:	85 d2                	test   %edx,%edx
801085fe:	0f 84 98 00 00 00    	je     8010869c <copyuvm+0xbc>
80108604:	31 ff                	xor    %edi,%edi
80108606:	eb 50                	jmp    80108658 <copyuvm+0x78>
80108608:	90                   	nop
...
80108610:	b8 00 10 00 00       	mov    $0x1000,%eax
80108615:	89 44 24 08          	mov    %eax,0x8(%esp)
80108619:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010861c:	89 34 24             	mov    %esi,(%esp)
8010861f:	05 00 00 00 80       	add    $0x80000000,%eax
80108624:	89 44 24 04          	mov    %eax,0x4(%esp)
80108628:	e8 43 d6 ff ff       	call   80105c70 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
8010862d:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80108633:	b9 00 10 00 00       	mov    $0x1000,%ecx
80108638:	89 04 24             	mov    %eax,(%esp)
8010863b:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010863e:	89 fa                	mov    %edi,%edx
80108640:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80108644:	e8 b7 f8 ff ff       	call   80107f00 <mappages>
80108649:	85 c0                	test   %eax,%eax
8010864b:	78 63                	js     801086b0 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
8010864d:	81 c7 00 10 00 00    	add    $0x1000,%edi
80108653:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80108656:	76 44                	jbe    8010869c <copyuvm+0xbc>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80108658:	8b 45 08             	mov    0x8(%ebp),%eax
8010865b:	31 c9                	xor    %ecx,%ecx
8010865d:	89 fa                	mov    %edi,%edx
8010865f:	e8 0c f8 ff ff       	call   80107e70 <walkpgdir>
80108664:	85 c0                	test   %eax,%eax
80108666:	74 5e                	je     801086c6 <copyuvm+0xe6>
    if(!(*pte & PTE_P))
80108668:	8b 18                	mov    (%eax),%ebx
8010866a:	f6 c3 01             	test   $0x1,%bl
8010866d:	74 4b                	je     801086ba <copyuvm+0xda>
    pa = PTE_ADDR(*pte);
8010866f:	89 d8                	mov    %ebx,%eax
    flags = PTE_FLAGS(*pte);
80108671:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
80108677:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010867c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010867f:	e8 2c 9f ff ff       	call   801025b0 <kalloc>
80108684:	85 c0                	test   %eax,%eax
80108686:	89 c6                	mov    %eax,%esi
80108688:	75 86                	jne    80108610 <copyuvm+0x30>
    }
  }
  return d;
...
bad:
  freevm(d);
8010868a:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010868d:	89 04 24             	mov    %eax,(%esp)
80108690:	e8 fb fd ff ff       	call   80108490 <freevm>
  return 0;
80108695:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
8010869c:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010869f:	83 c4 2c             	add    $0x2c,%esp
801086a2:	5b                   	pop    %ebx
801086a3:	5e                   	pop    %esi
801086a4:	5f                   	pop    %edi
801086a5:	5d                   	pop    %ebp
801086a6:	c3                   	ret    
801086a7:	89 f6                	mov    %esi,%esi
801086a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      kfree(mem);
801086b0:	89 34 24             	mov    %esi,(%esp)
801086b3:	e8 28 9d ff ff       	call   801023e0 <kfree>
      goto bad;
801086b8:	eb d0                	jmp    8010868a <copyuvm+0xaa>
      panic("copyuvm: page not present");
801086ba:	c7 04 24 fe 91 10 80 	movl   $0x801091fe,(%esp)
801086c1:	e8 aa 7c ff ff       	call   80100370 <panic>
      panic("copyuvm: pte should exist");
801086c6:	c7 04 24 e4 91 10 80 	movl   $0x801091e4,(%esp)
801086cd:	e8 9e 7c ff ff       	call   80100370 <panic>
801086d2:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801086ee:	e8 7d f7 ff ff       	call   80107e70 <walkpgdir>
  if((*pte & PTE_P) == 0)
801086f3:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
801086f5:	89 c2                	mov    %eax,%edx
801086f7:	83 e2 05             	and    $0x5,%edx
801086fa:	83 fa 05             	cmp    $0x5,%edx
801086fd:	75 11                	jne    80108710 <uva2ka+0x30>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
801086ff:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108704:	05 00 00 00 80       	add    $0x80000000,%eax
}
80108709:	c9                   	leave  
8010870a:	c3                   	ret    
8010870b:	90                   	nop
8010870c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return 0;
80108710:	31 c0                	xor    %eax,%eax
}
80108712:	c9                   	leave  
80108713:	c3                   	ret    
80108714:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010871a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80108726:	83 ec 2c             	sub    $0x2c,%esp
80108729:	8b 75 14             	mov    0x14(%ebp),%esi
8010872c:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
8010872f:	85 f6                	test   %esi,%esi
80108731:	74 75                	je     801087a8 <copyout+0x88>
80108733:	89 da                	mov    %ebx,%edx
80108735:	eb 3f                	jmp    80108776 <copyout+0x56>
80108737:	89 f6                	mov    %esi,%esi
80108739:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80108740:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80108743:	89 df                	mov    %ebx,%edi
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80108745:	8b 4d 10             	mov    0x10(%ebp),%ecx
    n = PGSIZE - (va - va0);
80108748:	29 d7                	sub    %edx,%edi
8010874a:	81 c7 00 10 00 00    	add    $0x1000,%edi
80108750:	39 f7                	cmp    %esi,%edi
80108752:	0f 47 fe             	cmova  %esi,%edi
    memmove(pa0 + (va - va0), buf, n);
80108755:	29 da                	sub    %ebx,%edx
80108757:	01 c2                	add    %eax,%edx
80108759:	89 14 24             	mov    %edx,(%esp)
8010875c:	89 7c 24 08          	mov    %edi,0x8(%esp)
80108760:	89 4c 24 04          	mov    %ecx,0x4(%esp)
80108764:	e8 07 d5 ff ff       	call   80105c70 <memmove>
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
80108769:	8d 93 00 10 00 00    	lea    0x1000(%ebx),%edx
    buf += n;
8010876f:	01 7d 10             	add    %edi,0x10(%ebp)
  while(len > 0){
80108772:	29 fe                	sub    %edi,%esi
80108774:	74 32                	je     801087a8 <copyout+0x88>
    pa0 = uva2ka(pgdir, (char*)va0);
80108776:	8b 45 08             	mov    0x8(%ebp),%eax
    va0 = (uint)PGROUNDDOWN(va);
80108779:	89 d3                	mov    %edx,%ebx
8010877b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    pa0 = uva2ka(pgdir, (char*)va0);
80108781:	89 5c 24 04          	mov    %ebx,0x4(%esp)
    va0 = (uint)PGROUNDDOWN(va);
80108785:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80108788:	89 04 24             	mov    %eax,(%esp)
8010878b:	e8 50 ff ff ff       	call   801086e0 <uva2ka>
    if(pa0 == 0)
80108790:	85 c0                	test   %eax,%eax
80108792:	75 ac                	jne    80108740 <copyout+0x20>
  }
  return 0;
}
80108794:	83 c4 2c             	add    $0x2c,%esp
      return -1;
...
801087a8:	83 c4 2c             	add    $0x2c,%esp
  return 0;
801087ab:	31 c0                	xor    %eax,%eax
}
801087ad:	5b                   	pop    %ebx
801087ae:	5e                   	pop    %esi
801087af:	5f                   	pop    %edi
