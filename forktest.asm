...
00000050 <forktest>:
{
  ...
  54:	53                   	push   %ebx
  write(fd, s, strlen(s));
  55:	bb 80 04 00 00       	mov    $0x480,%ebx
{
  5a:	83 ec 20             	sub    $0x20,%esp
  write(fd, s, strlen(s));
  5d:	c7 04 24 80 04 00 00 	movl   $0x480,(%esp)
  ...
  write(fd, s, strlen(s));
  ce:	c7 04 24 b2 04 00 00 	movl   $0x4b2,(%esp)
  d5:	e8 26 01 00 00       	call   200 <strlen>
  da:	ba b2 04 00 00       	mov    $0x4b2,%edx
 ...
 12c:	e8 97 02 00 00       	call   3c8 <exit>
  write(fd, s, strlen(s));
 131:	c7 04 24 8b 04 00 00 	movl   $0x48b,(%esp)
 138:	e8 c3 00 00 00       	call   200 <strlen>
 13d:	b9 8b 04 00 00       	mov    $0x48b,%ecx
 ...
 15d:	e8 66 02 00 00       	call   3c8 <exit>
  write(fd, s, strlen(s));
 162:	c7 04 24 9f 04 00 00 	movl   $0x49f,(%esp)
 169:	e8 92 00 00 00       	call   200 <strlen>
 16e:	c7 44 24 04 9f 04 00 	movl   $0x49f,0x4(%esp)
 175:	00 
