...
main(void)
{
  ...
  printf(1, "My first xv6 program\n");
   1:	b8 28 07 00 00       	mov    $0x728,%eax
{
   6:	89 e5                	mov    %esp,%ebp
  ...
  19:	e8 92 03 00 00       	call   3b0 <printf>
  exit(0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 588:	e9 7e fe ff ff       	jmp    40b <printf+0x5b>
          s = "(null)";
 58d:	bb 3e 07 00 00       	mov    $0x73e,%ebx
        while(*s != 0){
 ...
 5a1:	a1 d4 09 00 00       	mov    0x9d4,%eax
{
 ...
 5e7:	5b                   	pop    %ebx
  freep = p;
 5e8:	a3 d4 09 00 00       	mov    %eax,0x9d4
}
 5ed:	5e                   	pop    %esi
 5ee:	5f                   	pop    %edi
 5ef:	5d                   	pop    %ebp
 ...
 5fe:	72 ce                	jb     5ce <free+0x2e>
{
 ...
 621:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 624:	a3 d4 09 00 00       	mov    %eax,0x9d4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b1:	e8 ea fe ff ff       	call   5a0 <free>
  return freep;
 6b6:	8b 15 d4 09 00 00    	mov    0x9d4,%edx
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	b8 d8 09 00 00       	mov    $0x9d8,%eax
 6f5:	ba d8 09 00 00       	mov    $0x9d8,%edx
    base.s.size = 0;
 6fa:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 6fc:	a3 d4 09 00 00       	mov    %eax,0x9d4
    base.s.size = 0;
 701:	b8 d8 09 00 00       	mov    $0x9d8,%eax
    base.s.ptr = freep = prevp = &base;
 706:	89 15 d8 09 00 00    	mov    %edx,0x9d8
    base.s.size = 0;
 70c:	89 0d dc 09 00 00    	mov    %ecx,0x9dc
