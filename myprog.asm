...
main(void)
{
  ...
  printf(1, "My first xv6 program\n");
   1:	b8 58 07 00 00       	mov    $0x758,%eax
{
   6:	89 e5                	mov    %esp,%ebp
  ...
  19:	e8 c2 03 00 00       	call   3e0 <printf>
  priority(5);
  1e:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  25:	e8 06 03 00 00       	call   330 <priority>
  priority(10);
  2a:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
  31:	e8 fa 02 00 00       	call   330 <priority>
  priority(1);
  36:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  3d:	e8 ee 02 00 00       	call   330 <priority>
  priority(0);
  42:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  49:	e8 e2 02 00 00       	call   330 <priority>
  exit(0);
  4e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  55:	e8 2e 02 00 00       	call   288 <exit>
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b8:	e9 7e fe ff ff       	jmp    43b <printf+0x5b>
          s = "(null)";
 5bd:	bb 6e 07 00 00       	mov    $0x76e,%ebx
        while(*s != 0){
